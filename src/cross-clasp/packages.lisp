(defpackage #:cross-clasp.clasp.core
  ...
  (:export #:simple-fun #:gfbytecode-simple-fun #:gfbytecode-simple-fun/make
  ...
  (:export #:make-weak-pointer #:weak-pointer-valid #:weak-pointer-value)
...
(defpackage #:cross-clasp.clasp.mp
  ...
  (:export #:make-lock #:get-lock #:giveup-lock #:holding-lock-p)
...
(defpackage #:cross-clasp.clasp.cmp
  (:use #:cl)
  (:export #:code-walk)
  (:export #:module/make #:module/link #:module/create-bytecode #:module/literals
