...
(eval-when (:compile-toplevel :load-toplevel :execute)
  ...
  (defun clear-atomic-expanders ()
    (setf *atomic-expanders* (make-hash-table)))
...
beyond that is your extension."
  (let ((expander (expand-atomic-expander
                   accessor place-lambda-list expander-lambda-list body)))
    `(progn
       (eval-when (:compile-toplevel)
         (unless (atomic-expander ',accessor)
           (setf (atomic-expander ',accessor) #',expander)))
