...
// not-exposing {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::TranslationFunctor),_sourceFileInfoHandle), "_sourceFileInfoHandle" }, // public: (T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::TranslationFunctor),_filePos), "_filePos" }, // public: (T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::TranslationFunctor),_lineno), "_lineno" }, // public: (T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::TranslationFunctor),_column), "_column" }, // public: (T) fixable: NIL good-name: T
...
#if defined(GC_SET_CLASS_STAMPS)
set_one_static_class_Header<llvmo::NamedMDNode_O>();
set_one_static_class_Header<core::MDArray_size_t_O>();
set_one_static_class_Header<core::SimpleVector_byte16_t_O>();
set_one_static_class_Header<mp::ConcurrentQueue_O>();
set_one_static_class_Header<gctools::GCVector_moveable<float>>();
set_one_static_class_Header<gctools::GCArray_moveable<unsigned short>>();
set_one_static_class_Header<core::SimpleMDArray_fixnum_O>();
set_one_static_class_Header<core::SimpleVector_byte64_t_O>();
set_one_static_class_Header<llvmo::TargetMachine_O>();
set_one_static_class_Header<llvmo::Value_O>();
set_one_static_class_Header<core::SimpleBaseString_O>();
set_one_static_class_Header<core::Integer_O>();
set_one_static_class_Header<core::SimpleMDArray_int32_t_O>();
set_one_static_class_Header<clbind::ClassRegistry_O>();
set_one_static_class_Header<llvmo::Metadata_O>();
set_one_static_class_Header<asttooling::AstVisitor_O>();
set_one_static_class_Header<mp::Process_O>();
set_one_static_class_Header<core::MDArray_O>();
set_one_static_class_Header<core::Record_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::OptionalArgument>>();
set_one_static_class_Header<core::LightUserData_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::T_O *>>();
set_one_static_class_Header<clcenv::FunctionIgnore_O>();
set_one_static_class_Header<core::MDArrayT_O>();
set_one_static_class_Header<clbind::ClassRep_O>();
set_one_static_class_Header<core::DirectoryEntry_O>();
set_one_static_class_Header<clcenv::GlobalFunctionInfo_O>();
set_one_static_class_Header<llvmo::ConstantInt_O>();
set_one_static_class_Header<llvmo::Linker_O>();
set_one_static_class_Header<core::SourceFileInfo_O>();
set_one_static_class_Header<core::IntArray_O>();
set_one_static_class_Header<gctools::GCArray_moveable<double>>();
set_one_static_class_Header<core::SimpleMDArray_int16_t_O>();
set_one_static_class_Header<llvmo::CompositeType_O>();
set_one_static_class_Header<core::SimpleMDArrayT_O>();
set_one_static_class_Header<core::SourcePosInfo_O>();
set_one_static_class_Header<llvmo::BranchInst_O>();
set_one_static_class_Header<clcenv::Entry_O>();
set_one_static_class_Header<core::ActivationFrame_O>();
set_one_static_class_Header<llvmo::PassManagerBase_O>();
set_one_static_class_Header<llvmo::AllocaInst_O>();
set_one_static_class_Header<llvmo::LoadInst_O>();
set_one_static_class_Header<core::StandardClassCreator_O>();
set_one_static_class_Header<llvmo::ConstantStruct_O>();
set_one_static_class_Header<core::Exposer_O>();
set_one_static_class_Header<core::SingleDispatchCxxEffectiveMethodFunction_O>();
set_one_static_class_Header<core::DirectoryIterator_O>();
set_one_static_class_Header<clcenv::Macro_O>();
set_one_static_class_Header<clbind::detail::class_map>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::SourceFileInfo_O>>>();
set_one_static_class_Header<llvmo::DISubroutineType_O>();
set_one_static_class_Header<core::LexicalEnvironment_O>();
set_one_static_class_Header<clcenv::LambdaNameInfo_O>();
set_one_static_class_Header<core::HashTable_O>();
set_one_static_class_Header<core::PosixTime_O>();
set_one_static_class_Header<gctools::GCArray_moveable<float>>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::Package_O>>>();
set_one_static_class_Header<core::SimpleBitVector_O>();
set_one_static_class_Header<core::FunctionContainerEnvironment_O>();
set_one_static_class_Header<clcenv::SpecialVariable_O>();
set_one_static_class_Header<core::SimpleVector_int8_t_O>();
set_one_static_class_Header<clcenv::VariableInfo_O>();
set_one_static_class_Header<llvmo::ResumeInst_O>();
set_one_static_class_Header<llvmo::Function_O>();
set_one_static_class_Header<core::InvocationHistoryFrameIterator_O>();
set_one_static_class_Header<llvmo::DIType_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::SingleDispatchMethod_O>>>();
set_one_static_class_Header<core::SimpleVector_size_t_O>();
set_one_static_class_Header<core::SimpleMDArrayFloat_O>();
set_one_static_class_Header<llvmo::DIScope_O>();
set_one_static_class_Header<core::FileStatus_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::SymbolClassPair>>();
set_one_static_class_Header<llvmo::IndirectBrInst_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>();
set_one_static_class_Header<clcenv::LexicalVariable_O>();
set_one_static_class_Header<clcenv::VariableDynamicExtent_O>();
set_one_static_class_Header<llvmo::IRBuilder_O>();
set_one_static_class_Header<llvmo::ConstantArray_O>();
set_one_static_class_Header<llvmo::PHINode_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::Symbol_O>>>();
set_one_static_class_Header<llvmo::ClaspJIT_O>();
set_one_static_class_Header<core::NamedFunction_O>();
set_one_static_class_Header<core::Package_O>();
set_one_static_class_Header<core::SimpleMDArrayBaseChar_O>();
set_one_static_class_Header<core::FunctionClosure_O>();
set_one_static_class_Header<clcenv::GlobalEnvironment_O>();
set_one_static_class_Header<core::SimpleVector_byte8_t_O>();
set_one_static_class_Header<llvmo::DILexicalBlockBase_O>();
set_one_static_class_Header<core::SimpleMDArray_O>();
set_one_static_class_Header<llvmo::MDNode_O>();
set_one_static_class_Header<core::Stream_O>();
set_one_static_class_Header<core::CandoException_O>();
set_one_static_class_Header<gctools::GCVector_moveable<int>>();
set_one_static_class_Header<mp::RecursiveMutex_O>();
set_one_static_class_Header<gctools::GCArray_moveable<long>>();
set_one_static_class_Header<clcenv::FunctionType_O>();
set_one_static_class_Header<clcenv::Block_O>();
set_one_static_class_Header<llvmo::VAArgInst_O>();
set_one_static_class_Header<llvmo::MDString_O>();
set_one_static_class_Header<core::ShortFloat_O>();
set_one_static_class_Header<core::MDArray_fixnum_O>();
set_one_static_class_Header<core::Number_O>();
set_one_static_class_Header<core::SharpEqualWrapper_O>();
set_one_static_class_Header<core::T_O>();
set_one_static_class_Header<llvmo::DICompileUnit_O>();
set_one_static_class_Header<clcenv::Tag_O>();
set_one_static_class_Header<clcenv::ConstantVariableInfo_O>();
set_one_static_class_Header<core::SimpleMDArrayDouble_O>();
set_one_static_class_Header<asttooling::DerivableMatchCallback>();
set_one_static_class_Header<core::Cache_O>();
set_one_static_class_Header<core::LoadTimeValues_O>();
set_one_static_class_Header<llvmo::DIFile_O>();
set_one_static_class_Header<core::AbstractSimpleVector_O>();
set_one_static_class_Header<core::InterpretedClosure_O>();
set_one_static_class_Header<core::SimpleMDArray_byte16_t_O>();
set_one_static_class_Header<core::Pathname_O>();
set_one_static_class_Header<core::Str8Ns_O>();
set_one_static_class_Header<llvmo::DataLayout_O>();
set_one_static_class_Header<llvmo::FunctionPass_O>();
set_one_static_class_Header<core::SourceManager_O>();
set_one_static_class_Header<llvmo::BasicBlock_O>();
set_one_static_class_Header<core::SimpleMDArray_int8_t_O>();
set_one_static_class_Header<llvmo::UndefValue_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::AuxArgument>>();
set_one_static_class_Header<llvmo::EngineBuilder_O>();
set_one_static_class_Header<gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>>>();
set_one_static_class_Header<core::MDArray_byte32_t_O>();
set_one_static_class_Header<core::Character_dummy_O>();
set_one_static_class_Header<core::TagbodyEnvironment_O>();
set_one_static_class_Header<core::ConsStepper_O>();
set_one_static_class_Header<llvmo::Constant_O>();
set_one_static_class_Header<core::CompileTimeEnvironment_O>();
set_one_static_class_Header<core::SpecialForm_O>();
set_one_static_class_Header<core::Path_O>();
set_one_static_class_Header<mp::SharedMutex_O>();
set_one_static_class_Header<mp::BlockingConcurrentQueue_O>();
set_one_static_class_Header<clcenv::SpecialOperatorInfo_O>();
set_one_static_class_Header<core::SexpSaveArchive_O>();
set_one_static_class_Header<clcenv::SymbolMacroInfo_O>();
set_one_static_class_Header<gctools::GCArray_moveable<unsigned char>>();
set_one_static_class_Header<gctools::GCArray_moveable<int>>();
set_one_static_class_Header<core::NativeVector_int_O>();
set_one_static_class_Header<llvmo::DIBasicType_O>();
set_one_static_class_Header<llvmo::DIBuilder_O>();
set_one_static_class_Header<asttooling::DerivableASTFrontendAction>();
set_one_static_class_Header<core::InstanceCreator_O>();
set_one_static_class_Header<llvmo::APInt_O>();
set_one_static_class_Header<core::StandardObject_O>();
set_one_static_class_Header<core::Symbol_O>();
set_one_static_class_Header<core::IOStreamStream_O>();
set_one_static_class_Header<clcenv::FunctionInfo_O>();
set_one_static_class_Header<llvmo::APFloat_O>();
set_one_static_class_Header<gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::T_O>,gctools::smart_ptr<core::T_O>>>>();
set_one_static_class_Header<core::SimpleMDArrayCharacter_O>();
set_one_static_class_Header<core::SimpleCharacterString_O>();
set_one_static_class_Header<clcenv::LambdaName_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::List_V>>>();
set_one_static_class_Header<clcenv::LocalFunctionInfo_O>();
set_one_static_class_Header<core::Array_O>();
set_one_static_class_Header<llvmo::InsertPoint_O>();
set_one_static_class_Header<llvmo::Argument_O>();
set_one_static_class_Header<clcenv::Optimize_O>();
set_one_static_class_Header<core::StrWNs_O>();
set_one_static_class_Header<core::Iterator_O>();
set_one_static_class_Header<llvmo::IRBuilderBase_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::ExceptionEntry>>();
set_one_static_class_Header<core::EchoStream_O>();
set_one_static_class_Header<core::Null_O>();
set_one_static_class_Header<core::MDArrayBit_O>();
set_one_static_class_Header<core::SimpleMDArrayBit_O>();
set_one_static_class_Header<gctools::GCArray_moveable<signed char>>();
set_one_static_class_Header<core::SingleDispatchMethod_O>();
set_one_static_class_Header<clcenv::Closure_O>();
set_one_static_class_Header<clcenv::Inline_O>();
set_one_static_class_Header<clcenv::LexicalVariableInfo_O>();
set_one_static_class_Header<core::TagbodyFrame_O>();
set_one_static_class_Header<core::NativeVector_double_O>();
set_one_static_class_Header<llvmo::DILocalScope_O>();
set_one_static_class_Header<core::GlueEnvironment_O>();
set_one_static_class_Header<core::CxxObject_O>();
set_one_static_class_Header<asttooling::DerivableFrontendActionFactory>();
set_one_static_class_Header<llvmo::ReturnInst_O>();
set_one_static_class_Header<llvmo::FunctionType_O>();
set_one_static_class_Header<clbind::DummyCreator_O>();
set_one_static_class_Header<core::ClassCreator_O>();
set_one_static_class_Header<core::MDArray_byte16_t_O>();
set_one_static_class_Header<gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::Symbol_O>,gctools::smart_ptr<core::T_O>>>>();
set_one_static_class_Header<llvmo::DILexicalBlock_O>();
set_one_static_class_Header<llvmo::DITypeRefArray_O>();
set_one_static_class_Header<core::Pointer_O>();
set_one_static_class_Header<llvmo::Type_O>();
set_one_static_class_Header<core::SimpleVectorFloat_O>();
set_one_static_class_Header<mp::Mutex_O>();
set_one_static_class_Header<llvmo::ModuleHandle_O>();
set_one_static_class_Header<clcenv::BlockInfo_O>();
set_one_static_class_Header<core::RecursiveDirectoryIterator_O>();
set_one_static_class_Header<llvmo::UnreachableInst_O>();
set_one_static_class_Header<core::MacroClosure_O>();
set_one_static_class_Header<core::SNode_O>();
set_one_static_class_Header<core::VectorStepper_O>();
set_one_static_class_Header<core::LoadArchive_O>();
set_one_static_class_Header<core::StringInputStream_O>();
set_one_static_class_Header<llvmo::ModulePass_O>();
set_one_static_class_Header<core::Float_O>();
set_one_static_class_Header<llvmo::DIDerivedType_O>();
set_one_static_class_Header<clbind::ConstructorCreator_O>();
set_one_static_class_Header<core::FunctionFrame_O>();
set_one_static_class_Header<core::LongFloat_O>();
set_one_static_class_Header<core::SimpleVector_int64_t_O>();
set_one_static_class_Header<llvmo::ConstantDataSequential_O>();
set_one_static_class_Header<gctools::GCBitUnitArray_moveable<1,unsigned int,int>>();
set_one_static_class_Header<llvmo::TargetLibraryInfoWrapperPass_O>();
set_one_static_class_Header<llvmo::StoreInst_O>();
set_one_static_class_Header<asttooling::DerivableSyntaxOnlyAction>();
set_one_static_class_Header<llvmo::User_O>();
set_one_static_class_Header<llvmo::DebugLoc_O>();
set_one_static_class_Header<core::WeakPointer_O>();
set_one_static_class_Header<core::LeafSNode_O>();
set_one_static_class_Header<core::MDArray_int16_t_O>();
set_one_static_class_Header<clcenv::OptimizeInfo_O>();
set_one_static_class_Header<core::IOFileStream_O>();
set_one_static_class_Header<llvmo::FenceInst_O>();
set_one_static_class_Header<core::RuntimeVisibleEnvironment_O>();
set_one_static_class_Header<llvmo::AtomicCmpXchgInst_O>();
set_one_static_class_Header<core::ValueFrame_O>();
set_one_static_class_Header<gctools::GCArray_moveable<unsigned long>>();
set_one_static_class_Header<core::SimpleMDArray_byte8_t_O>();
set_one_static_class_Header<core::SaveArchive_O>();
set_one_static_class_Header<core::SimpleVector_int32_t_O>();
set_one_static_class_Header<core::SequenceStepper_O>();
set_one_static_class_Header<core::Complex_O>();
set_one_static_class_Header<llvmo::ConstantPointerNull_O>();
set_one_static_class_Header<llvmo::VectorType_O>();
set_one_static_class_Header<llvmo::Instruction_O>();
set_one_static_class_Header<core::FileStream_O>();
set_one_static_class_Header<llvmo::ValueAsMetadata_O>();
set_one_static_class_Header<core::Rational_O>();
set_one_static_class_Header<llvmo::ConstantExpr_O>();
set_one_static_class_Header<core::SingleDispatchEffectiveMethodFunction_O>();
set_one_static_class_Header<llvmo::LandingPadInst_O>();
set_one_static_class_Header<core::MDArrayCharacter_O>();
set_one_static_class_Header<core::Function_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<clbind::ClassRep_O>>>();
set_one_static_class_Header<llvmo::StructType_O>();
set_one_static_class_Header<clcenv::FunctionDynamicExtent_O>();
set_one_static_class_Header<core::RandomState_O>();
set_one_static_class_Header<core::MDArrayFloat_O>();
set_one_static_class_Header<core::HashTableEql_O>();
set_one_static_class_Header<llvmo::Target_O>();
set_one_static_class_Header<core::MDArray_byte64_t_O>();
set_one_static_class_Header<mp::ConditionVariable_O>();
set_one_static_class_Header<core::Real_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::DynamicBinding>>();
set_one_static_class_Header<core::SimpleVector_fixnum_O>();
set_one_static_class_Header<core::FuncallableInstanceCreator_O>();
set_one_static_class_Header<core::SimpleVector_byte32_t_O>();
set_one_static_class_Header<core::SexpLoadArchive_O>();
set_one_static_class_Header<core::MDArray_byte8_t_O>();
set_one_static_class_Header<core::SingleDispatchGenericFunctionClosure_O>();
set_one_static_class_Header<core::StringOutputStream_O>();
set_one_static_class_Header<core::AnsiStream_O>();
set_one_static_class_Header<core::BranchSNode_O>();
set_one_static_class_Header<llvmo::TerminatorInst_O>();
set_one_static_class_Header<llvmo::Module_O>();
set_one_static_class_Header<core::BuiltinClosure_O>();
set_one_static_class_Header<core::SingleFloat_dummy_O>();
set_one_static_class_Header<core::ValueEnvironment_O>();
set_one_static_class_Header<core::CxxMethodFunction_O>();
set_one_static_class_Header<llvmo::InvokeInst_O>();
set_one_static_class_Header<core::Environment_O>();
set_one_static_class_Header<clcenv::SymbolMacro_O>();
set_one_static_class_Header<llvmo::AttributeSet_O>();
set_one_static_class_Header<clcenv::LocalMacroInfo_O>();
set_one_static_class_Header<llvmo::AtomicRMWInst_O>();
set_one_static_class_Header<core::StrNs_O>();
set_one_static_class_Header<llvmo::PassManager_O>();
set_one_static_class_Header<core::UnwindProtectEnvironment_O>();
set_one_static_class_Header<clasp_ffi::ForeignData_O>();
set_one_static_class_Header<core::SimpleVector_O>();
set_one_static_class_Header<clcenv::GlobalMacroInfo_O>();
set_one_static_class_Header<llvmo::CallInst_O>();
set_one_static_class_Header<llvmo::DISubprogram_O>();
set_one_static_class_Header<llvmo::FunctionPassManager_O>();
set_one_static_class_Header<core::DoubleFloat_O>();
set_one_static_class_Header<clcenv::Info_O>();
set_one_static_class_Header<core::Creator_O>();
set_one_static_class_Header<llvmo::ArrayType_O>();
set_one_static_class_Header<core::SimpleMDArray_int64_t_O>();
set_one_static_class_Header<core::SimpleString_O>();
set_one_static_class_Header<llvmo::MCSubtargetInfo_O>();
set_one_static_class_Header<llvmo::BlockAddress_O>();
set_one_static_class_Header<gctools::GCArray_moveable<short>>();
set_one_static_class_Header<llvmo::DICompositeType_O>();
set_one_static_class_Header<core::FunctionValueEnvironment_O>();
set_one_static_class_Header<core::DerivableCxxClassCreator_O>();
set_one_static_class_Header<core::TemplatedFunctionBase_O>();
set_one_static_class_Header<core::HashTableEq_O>();
set_one_static_class_Header<core::StringStream_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::SymbolStorage>>();
set_one_static_class_Header<core::MDArray_int32_t_O>();
set_one_static_class_Header<llvmo::IntegerType_O>();
set_one_static_class_Header<asttooling::AsttoolingExposer_O>();
set_one_static_class_Header<core::HashTableEqualp_O>();
set_one_static_class_Header<core::LambdaListHandler_O>();
set_one_static_class_Header<core::MDArray_int64_t_O>();
set_one_static_class_Header<core::SimpleMDArray_size_t_O>();
set_one_static_class_Header<core::StructureClassCreator_O>();
set_one_static_class_Header<gctools::GCVector_moveable<double>>();
set_one_static_class_Header<core::ConcatenatedStream_O>();
set_one_static_class_Header<core::SmallMultimap_O>();
set_one_static_class_Header<llvmo::PassManagerBuilder_O>();
set_one_static_class_Header<core::SymbolMacroletEnvironment_O>();
set_one_static_class_Header<core::MDArray_int8_t_O>();
set_one_static_class_Header<core::Fixnum_dummy_O>();
set_one_static_class_Header<llvmo::ConstantFP_O>();
set_one_static_class_Header<core::SingleDispatchMethodFunction_O>();
set_one_static_class_Header<core::MacroletEnvironment_O>();
set_one_static_class_Header<core::Cons_O>();
set_one_static_class_Header<core::CompiledFunction_O>();
set_one_static_class_Header<llvmo::ImmutablePass_O>();
set_one_static_class_Header<core::FuncallableInstance_O>();
set_one_static_class_Header<llvmo::LLVMContext_O>();
set_one_static_class_Header<core::MDArrayDouble_O>();
set_one_static_class_Header<core::SynonymStream_O>();
set_one_static_class_Header<core::WeakKeyHashTable_O>();
set_one_static_class_Header<core::CompiledDispatchFunction_O>();
set_one_static_class_Header<core::Ratio_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::SequenceStepper_O>>>();
set_one_static_class_Header<core::MDArrayBaseChar_O>();
set_one_static_class_Header<core::UserData_O>();
set_one_static_class_Header<core::ExternalObject_O>();
set_one_static_class_Header<llvmo::DINode_O>();
set_one_static_class_Header<llvmo::GlobalVariable_O>();
set_one_static_class_Header<core::ClosureWithSlots_O>();
set_one_static_class_Header<core::BroadcastStream_O>();
set_one_static_class_Header<llvmo::ExecutionEngine_O>();
set_one_static_class_Header<gctools::GCVector_moveable<gctools::smart_ptr<core::Cons_O>>>();
set_one_static_class_Header<core::SimpleVector_int16_t_O>();
set_one_static_class_Header<clcenv::Function_O>();
set_one_static_class_Header<core::General_O>();
set_one_static_class_Header<llvmo::Attribute_O>();
set_one_static_class_Header<core::DerivableCxxObject_O>();
set_one_static_class_Header<core::WeakKeyMapping_O>();
set_one_static_class_Header<core::Closure_O>();
set_one_static_class_Header<core::Reader_O>();
set_one_static_class_Header<llvmo::SwitchInst_O>();
set_one_static_class_Header<core::SymbolToEnumConverter_O>();
set_one_static_class_Header<clcenv::VariableIgnore_O>();
set_one_static_class_Header<clcenv::SpecialVariableInfo_O>();
set_one_static_class_Header<core::NativeVector_float_O>();
set_one_static_class_Header<core::SimpleVectorDouble_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::RequiredArgument>>();
set_one_static_class_Header<llvmo::Pass_O>();
set_one_static_class_Header<core::Lisp_O>();
set_one_static_class_Header<core::VaList_dummy_O>();
set_one_static_class_Header<core::BlockEnvironment_O>();
set_one_static_class_Header<core::ClosureWithFrame_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::CacheRecord>>();
set_one_static_class_Header<core::CatchEnvironment_O>();
set_one_static_class_Header<llvmo::DINodeArray_O>();
set_one_static_class_Header<core::LogicalPathname_O>();
set_one_static_class_Header<llvmo::TargetSubtargetInfo_O>();
set_one_static_class_Header<core::Archive_O>();
set_one_static_class_Header<core::CompiledClosure_O>();
set_one_static_class_Header<llvmo::ConstantDataArray_O>();
set_one_static_class_Header<core::SmallMap_O>();
set_one_static_class_Header<core::WrappedPointer_O>();
set_one_static_class_Header<llvmo::TargetOptions_O>();
set_one_static_class_Header<core::Instance_O>();
set_one_static_class_Header<clasp_ffi::ForeignTypeSpec_O>();
set_one_static_class_Header<core::SimpleMDArray_byte32_t_O>();
set_one_static_class_Header<core::Bignum_O>();
set_one_static_class_Header<core::TranslationFunctor>();
set_one_static_class_Header<core::PosixTimeDuration_O>();
set_one_static_class_Header<llvmo::LLVMTargetMachine_O>();
set_one_static_class_Header<core::ReadTable_O>();
set_one_static_class_Header<clcenv::VariableType_O>();
set_one_static_class_Header<core::HashTableEqual_O>();
set_one_static_class_Header<llvmo::SequentialType_O>();
set_one_static_class_Header<llvmo::Triple_O>();
set_one_static_class_Header<core::BitVectorNs_O>();
set_one_static_class_Header<core::SimpleMDArray_byte64_t_O>();
set_one_static_class_Header<llvmo::UnaryInstruction_O>();
set_one_static_class_Header<core::CoreExposer_O>();
set_one_static_class_Header<llvmo::GlobalValue_O>();
set_one_static_class_Header<llvmo::PointerType_O>();
set_one_static_class_Header<gctools::GCArray_moveable<unsigned int>>();
set_one_static_class_Header<core::WeakHashTable_O>();
set_one_static_class_Header<gctools::GCVector_moveable<core::KeywordArgument>>();
set_one_static_class_Header<core::TwoWayStream_O>();
set_one_static_class_Header<core::MultiStringBuffer_O>();
#endif
