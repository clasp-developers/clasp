...
KIND_CLASSALLOC_core__SequenceStepper = 246,
KIND_CLASSALLOC_core__ConsStepper = 247,
KIND_CLASSALLOC_core__VectorStepper = 248,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 249,
KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor = 250,
KIND_CLASSALLOC_core__CoreExposer = 251,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_ = 252,
KIND_CLASSALLOC_core__InstanceClosure = 253,
KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_ = 254,
...
KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_ = 257,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 258,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__ = 259,
KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_ = 260,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_ = 261,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__ = 262,
KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory = 263,
KIND_GCSTRING_gctools__GCString_moveable_char_ = 264,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__ = 265,
KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor = 266,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_ = 267,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_ = 268,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_ = 269,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 270,
KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure = 271,
KIND_CLASSALLOC_llvmo__CompiledClosure = 272,
KIND_LISPALLOC_asttooling__DerivableMatchCallback = 273,
KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_ = 274,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__ = 275,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_ = 276,
KIND_CLASSALLOC_core__MacroClosure = 277,
KIND_LISPALLOC_asttooling__DerivableASTFrontendAction = 278,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_ = 279,
...
KIND_CLASSALLOC_core__InterpretedClosure = 282,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_ = 283,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 284,
...
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 287,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 288,
...
static void* KIND_NAME_MAP_table[] = { NULL 
  ...
  /* 246 */ , &&kind_name_KIND_CLASSALLOC_core__SequenceStepper
  /* 247 */ , &&kind_name_KIND_CLASSALLOC_core__ConsStepper
  /* 248 */ , &&kind_name_KIND_CLASSALLOC_core__VectorStepper
  /* 249 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 250 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 251 */ , &&kind_name_KIND_CLASSALLOC_core__CoreExposer
  /* 252 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 253 */ , &&kind_name_KIND_CLASSALLOC_core__InstanceClosure
  /* 254 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 255 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 256 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 257 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 258 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 260 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 261 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 262 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 263 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 264 */ , &&kind_name_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 265 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 266 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 267 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 268 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 269 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 270 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 271 */ , &&kind_name_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 272 */ , &&kind_name_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 273 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 274 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 275 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 276 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 277 */ , &&kind_name_KIND_CLASSALLOC_core__MacroClosure
  /* 278 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 279 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 280 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 281 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 282 */ , &&kind_name_KIND_CLASSALLOC_core__InterpretedClosure
  /* 283 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 284 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 285 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 286 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 287 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 288 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
...
static void* OBJ_DUMP_MAP_table[] = { NULL 
  ...
  /* 246 */ , &&obj_dump_KIND_CLASSALLOC_core__SequenceStepper
  /* 247 */ , &&obj_dump_KIND_CLASSALLOC_core__ConsStepper
  /* 248 */ , &&obj_dump_KIND_CLASSALLOC_core__VectorStepper
  /* 249 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 250 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 251 */ , &&obj_dump_KIND_CLASSALLOC_core__CoreExposer
  /* 252 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 253 */ , &&obj_dump_KIND_CLASSALLOC_core__InstanceClosure
  /* 254 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 255 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 256 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 257 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 258 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 260 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 261 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 262 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 263 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 264 */ , &&obj_dump_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 265 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 266 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 267 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 268 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 269 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 270 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 271 */ , &&obj_dump_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 272 */ , &&obj_dump_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 273 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 274 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 275 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 276 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 277 */ , &&obj_dump_KIND_CLASSALLOC_core__MacroClosure
  /* 278 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 279 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 280 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 281 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 282 */ , &&obj_dump_KIND_CLASSALLOC_core__InterpretedClosure
  /* 283 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 284 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 285 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 286 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 287 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 288 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
...
static void* OBJ_SKIP_table[] = { NULL 
  ...
  /* 246 */ , &&obj_skip_KIND_CLASSALLOC_core__SequenceStepper
  /* 247 */ , &&obj_skip_KIND_CLASSALLOC_core__ConsStepper
  /* 248 */ , &&obj_skip_KIND_CLASSALLOC_core__VectorStepper
  /* 249 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 250 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 251 */ , &&obj_skip_KIND_CLASSALLOC_core__CoreExposer
  /* 252 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 253 */ , &&obj_skip_KIND_CLASSALLOC_core__InstanceClosure
  /* 254 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 255 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 256 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 257 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 258 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 260 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 261 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 262 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 263 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 264 */ , &&obj_skip_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 265 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 266 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 267 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 268 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 269 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 270 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 271 */ , &&obj_skip_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 272 */ , &&obj_skip_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 273 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 274 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 275 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 276 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 277 */ , &&obj_skip_KIND_CLASSALLOC_core__MacroClosure
  /* 278 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 279 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 280 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 281 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 282 */ , &&obj_skip_KIND_CLASSALLOC_core__InterpretedClosure
  /* 283 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 284 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 285 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 286 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 287 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 288 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
...
static void* OBJ_SCAN_table[] = { NULL 
  ...
  /* 246 */ , &&obj_scan_KIND_CLASSALLOC_core__SequenceStepper
  /* 247 */ , &&obj_scan_KIND_CLASSALLOC_core__ConsStepper
  /* 248 */ , &&obj_scan_KIND_CLASSALLOC_core__VectorStepper
  /* 249 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 250 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 251 */ , &&obj_scan_KIND_CLASSALLOC_core__CoreExposer
  /* 252 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 253 */ , &&obj_scan_KIND_CLASSALLOC_core__InstanceClosure
  /* 254 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 255 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 256 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 257 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 258 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 260 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 261 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 262 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 263 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 264 */ , &&obj_scan_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 265 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 266 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 267 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 268 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 269 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 270 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 271 */ , &&obj_scan_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 272 */ , &&obj_scan_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 273 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 274 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 275 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 276 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 277 */ , &&obj_scan_KIND_CLASSALLOC_core__MacroClosure
  /* 278 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 279 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 280 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 281 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 282 */ , &&obj_scan_KIND_CLASSALLOC_core__InterpretedClosure
  /* 283 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 284 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 285 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 286 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 287 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 288 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
...
static void* OBJ_FINALIZE_table[] = { NULL 
  ...
  /* 246 */ , &&obj_finalize_KIND_CLASSALLOC_core__SequenceStepper
  /* 247 */ , &&obj_finalize_KIND_CLASSALLOC_core__ConsStepper
  /* 248 */ , &&obj_finalize_KIND_CLASSALLOC_core__VectorStepper
  /* 249 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 250 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 251 */ , &&obj_finalize_KIND_CLASSALLOC_core__CoreExposer
  /* 252 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 253 */ , &&obj_finalize_KIND_CLASSALLOC_core__InstanceClosure
  /* 254 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 255 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 256 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 257 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 258 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 260 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 261 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 262 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 263 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 264 */ , &&obj_finalize_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 265 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 266 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 267 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 268 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 269 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 270 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 271 */ , &&obj_finalize_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 272 */ , &&obj_finalize_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 273 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 274 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 275 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 276 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 277 */ , &&obj_finalize_KIND_CLASSALLOC_core__MacroClosure
  /* 278 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 279 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  ...
  /* 281 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 282 */ , &&obj_finalize_KIND_CLASSALLOC_core__InterpretedClosure
  /* 283 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 284 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  ...
  /* 287 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 288 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
