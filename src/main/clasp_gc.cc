...
KIND_LISPALLOC_core__SharpEqualWrapper_O = 194,
KIND_LISPALLOC_core__Cons_O = 195,
KIND_LISPALLOC_core__Archive_O = 196,
KIND_LISPALLOC_core__SaveArchive_O = 197,
KIND_LISPALLOC_core__SexpSaveArchive_O = 198,
KIND_LISPALLOC_core__LoadArchive_O = 199,
KIND_LISPALLOC_core__SexpLoadArchive_O = 200,
KIND_LISPALLOC_core__HashTable_O = 201,
KIND_LISPALLOC_core__HashTableEq_O = 202,
KIND_LISPALLOC_core__HashTableEqualp_O = 203,
KIND_LISPALLOC_core__HashTableEql_O = 204,
KIND_LISPALLOC_core__HashTableEqual_O = 205,
KIND_LISPALLOC_cffi__Pointer_O = 206,
KIND_LISPALLOC_core__CxxObject_O = 207,
KIND_LISPALLOC_core__WeakKeyMapping_O = 208,
KIND_LISPALLOC_core__LambdaListHandler_O = 209,
KIND_LISPALLOC_llvmo__InsertPoint_O = 210,
KIND_LISPALLOC_core__SourceFileInfo_O = 211,
KIND_LISPALLOC_core__SNode_O = 212,
KIND_LISPALLOC_core__LeafSNode_O = 213,
KIND_LISPALLOC_core__BranchSNode_O = 214,
KIND_LISPALLOC_core__Path_O = 215,
KIND_LISPALLOC_asttooling__AstVisitor_O = 216,
KIND_LISPALLOC_llvmo__AttributeSet_O = 217,
KIND_LISPALLOC_core__StructureObject_O = 218,
KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O = 219,
KIND_LISPALLOC_core__Package_O = 220,
KIND_LISPALLOC_core__DirectoryEntry_O = 221,
KIND_LISPALLOC_core__Character_dummy_O = 222,
KIND_LISPALLOC_core__Function_O = 223,
KIND_LISPALLOC_core__CompiledFunction_O = 224,
KIND_LISPALLOC_core__SingleDispatchGenericFunction_O = 225,
KIND_LISPALLOC_core__SpecialForm_O = 226,
KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O = 227,
KIND_LISPALLOC_core__Instance_O = 228,
KIND_LISPALLOC_core__Pointer_O = 229,
KIND_LISPALLOC_clbind__ClassRegistry_O = 230,
KIND_LISPALLOC_llvmo__DebugInfo_O = 231,
KIND_LISPALLOC_llvmo__DIDerivedType_O = 232,
KIND_LISPALLOC_llvmo__DIArray_O = 233,
KIND_LISPALLOC_llvmo__DIBasicType_O = 234,
KIND_LISPALLOC_llvmo__DISubprogram_O = 235,
KIND_LISPALLOC_llvmo__DILexicalBlock_O = 236,
KIND_LISPALLOC_llvmo__DICompileUnit_O = 237,
KIND_LISPALLOC_llvmo__DIDescriptor_O = 238,
KIND_LISPALLOC_llvmo__DIType_O = 239,
KIND_LISPALLOC_llvmo__DISubroutineType_O = 240,
KIND_LISPALLOC_llvmo__DICompositeType_O = 241,
KIND_LISPALLOC_llvmo__DITypeArray_O = 242,
KIND_LISPALLOC_llvmo__DIFile_O = 243,
KIND_LISPALLOC_llvmo__DIScope_O = 244,
KIND_LISPALLOC_core__SmallMultimap_O = 245,
KIND_LISPALLOC_core__Pathname_O = 246,
KIND_LISPALLOC_core__LogicalPathname_O = 247,
KIND_LISPALLOC_core__PosixTime_O = 248,
KIND_LISPALLOC_core__SmallMap_O = 249,
KIND_CLASSALLOC_core__Cache = 250,
KIND_ROOTCLASSALLOC_core__Lisp_O = 251,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__ = 252,
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 253,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_ = 254,
KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure = 255,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__ = 256,
KIND_GCSTRING_gctools__GCString_moveable_char_ = 257,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 258,
KIND_CLASSALLOC_llvmo__CompiledClosure = 259,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 260,
KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor = 261,
KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___ = 262,
...
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__2_ = 287,
KIND_CLASSALLOC_core__CoreExposer = 288,
...
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 293,
KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure = 294,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 295,
KIND_CLASSALLOC_core__InterpretedClosure = 296,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 297,
KIND_CLASSALLOC_core__VectorStepper = 298,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__ = 299,
  KIND_max = 299
}
...
template <typename FP> struct Cast<llvmo::DebugInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 231 244 
      return ((231 <= kindVal) && (kindVal <= 244));
  };
};
...
template <typename FP> struct Cast<core::Function_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 223 228 
      return ((223 <= kindVal) && (kindVal <= 228));
  };
};
...
static void* OBJ_SKIP_table[] = { 
  ...
  /* 252 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__,
  /* 253 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 254 */ &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_,
  /* 256 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 257 */ &&obj_skip_KIND_GCSTRING_gctools__GCString_moveable_char_,
  /* 258 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 260 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 262 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  ...
  /* 287 */ &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__2_,
  /* 289 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 291 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 292 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 293 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 294 */ &&obj_skip_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure,
  /* 295 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 297 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 299 */ &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
   NULL
};
...
{ class_size, sizeof(asttooling::RegMap::RegistryMaps), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::RegMap::RegistryMaps),Constructors._Vector._Contents), "Constructors._Vector._Contents" },
...
{ class_size, sizeof(clbind::detail::class_map), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(clbind::detail::class_map),m_classes._Vector._Contents), "m_classes._Vector._Contents" },
...
{ class_size, sizeof(core::InstanceCreator), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceCreator),_className), "_className" },
...
{ templated_class_jump_table_index, 1, "" },
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(clbind::ConstructorCreator),_mostDerivedClassSymbol),"_mostDerivedClassSymbol" }, 
...
{ class_size, sizeof(core::ReadTable_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ReadTable_O),_Case), "_Case" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ReadTable_O),_SyntaxTypes), "_SyntaxTypes" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ReadTable_O),_MacroCharacters), "_MacroCharacters" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ReadTable_O),_DispatchMacroCharacters), "_DispatchMacroCharacters" },
...
{ class_size, sizeof(core::Complex_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Complex_O),_real), "_real" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Complex_O),_imaginary), "_imaginary" },
...
{ class_size, sizeof(core::Ratio_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Ratio_O),_numerator), "_numerator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Ratio_O),_denominator), "_denominator" },
...
{ class_size, sizeof(core::WeakKeyHashTable_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::WeakKeyHashTable_O),_HashTable._Keys), "_HashTable._Keys" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::WeakKeyHashTable_O),_HashTable._Values), "_HashTable._Values" },
...
{ class_size, sizeof(core::TagbodyFrame_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyFrame_O),_ParentFrame), "_ParentFrame" },
{ class_kind, KIND_LISPALLOC_core__ValueFrame_O, "core::ValueFrame_O" },
{ class_size, sizeof(core::ValueFrame_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueFrame_O),_ParentFrame), "_ParentFrame" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueFrame_O),_Objects._Array._Contents), "_Objects._Array._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueFrame_O),_DebuggingInfo), "_DebuggingInfo" },
{ class_kind, KIND_LISPALLOC_core__FunctionFrame_O, "core::FunctionFrame_O" },
{ class_size, sizeof(core::FunctionFrame_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionFrame_O),_ParentFrame), "_ParentFrame" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionFrame_O),_Objects._Array._Contents), "_Objects._Array._Contents" },
...
{ class_size, sizeof(core::LexicalEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LexicalEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LexicalEnvironment_O),_Metadata), "_Metadata" },
...
{ class_size, sizeof(core::RuntimeVisibleEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::RuntimeVisibleEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::RuntimeVisibleEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::RuntimeVisibleEnvironment_O),_RuntimeEnvironment), "_RuntimeEnvironment" },
...
{ class_size, sizeof(core::FunctionValueEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionValueEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionValueEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionValueEnvironment_O),_RuntimeEnvironment), "_RuntimeEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionValueEnvironment_O),_FunctionIndices), "_FunctionIndices" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionValueEnvironment_O),_FunctionFrame), "_FunctionFrame" },
{ class_kind, KIND_LISPALLOC_core__ValueEnvironment_O, "core::ValueEnvironment_O" },
{ class_size, sizeof(core::ValueEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueEnvironment_O),_RuntimeEnvironment), "_RuntimeEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueEnvironment_O),_SymbolIndex), "_SymbolIndex" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ValueEnvironment_O),_ActivationFrame), "_ActivationFrame" },
...
{ class_size, sizeof(core::TagbodyEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyEnvironment_O),_RuntimeEnvironment), "_RuntimeEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyEnvironment_O),_Tags), "_Tags" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyEnvironment_O),_TagCode._Vector._Contents), "_TagCode._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TagbodyEnvironment_O),_ActivationFrame), "_ActivationFrame" },
...
{ class_size, sizeof(core::CompileTimeEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CompileTimeEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CompileTimeEnvironment_O),_Metadata), "_Metadata" },
...
{ class_size, sizeof(core::UnwindProtectEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::UnwindProtectEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::UnwindProtectEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::UnwindProtectEnvironment_O),_CleanupForm), "_CleanupForm" },
...
{ class_size, sizeof(core::SymbolMacroletEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolMacroletEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolMacroletEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolMacroletEnvironment_O),_Macros), "_Macros" },
...
{ class_size, sizeof(core::FunctionContainerEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionContainerEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FunctionContainerEnvironment_O),_Metadata), "_Metadata" },
...
{ class_size, sizeof(core::StackValueEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StackValueEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StackValueEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StackValueEnvironment_O),_Values), "_Values" },
{ class_kind, KIND_LISPALLOC_core__BlockEnvironment_O, "core::BlockEnvironment_O" },
{ class_size, sizeof(core::BlockEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BlockEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BlockEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BlockEnvironment_O),_BlockSymbol), "_BlockSymbol" },
...
{ class_size, sizeof(core::MacroletEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroletEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroletEnvironment_O),_Metadata), "_Metadata" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroletEnvironment_O),_Macros), "_Macros" },
{ class_kind, KIND_LISPALLOC_core__CatchEnvironment_O, "core::CatchEnvironment_O" },
{ class_size, sizeof(core::CatchEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CatchEnvironment_O),_ParentEnvironment), "_ParentEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CatchEnvironment_O),_Metadata), "_Metadata" },
{ class_kind, KIND_LISPALLOC_core__GlueEnvironment_O, "core::GlueEnvironment_O" },
{ class_size, sizeof(core::GlueEnvironment_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::GlueEnvironment_O),_Map), "_Map" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::GlueEnvironment_O),_Args), "_Args" },
...
{ class_size, sizeof(core::ArrayObjects_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ArrayObjects_O),_ElementType), "_ElementType" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ArrayObjects_O),_Values._Vector._Contents), "_Values._Vector._Contents" },
{ class_kind, KIND_LISPALLOC_core__ArrayDisplaced_O, "core::ArrayDisplaced_O" },
{ class_size, sizeof(core::ArrayDisplaced_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ArrayDisplaced_O),_ElementType), "_ElementType" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ArrayDisplaced_O),_Array), "_Array" },
...
{ class_size, sizeof(core::VectorDisplaced_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorDisplaced_O),_ElementType), "_ElementType" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorDisplaced_O),_Vector), "_Vector" },
...
{ class_size, sizeof(core::Str_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Str_O),_Contents._Contents), "_Contents._Contents" },
{ class_kind, KIND_LISPALLOC_core__StrWithFillPtr_O, "core::StrWithFillPtr_O" },
{ class_size, sizeof(core::StrWithFillPtr_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StrWithFillPtr_O),_Contents._Contents), "_Contents._Contents" },
{ class_kind, KIND_LISPALLOC_core__VectorObjects_O, "core::VectorObjects_O" },
{ class_size, sizeof(core::VectorObjects_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorObjects_O),_ElementType), "_ElementType" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorObjects_O),_Values._Vector._Contents), "_Values._Vector._Contents" },
...
{ class_size, sizeof(core::VectorObjectsWithFillPtr_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorObjectsWithFillPtr_O),_ElementType), "_ElementType" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorObjectsWithFillPtr_O),_Values._Vector._Contents), "_Values._Vector._Contents" },
...
{ class_size, sizeof(core::SingleDispatchMethod_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchMethod_O),_name), "_name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchMethod_O),_receiver_class), "_receiver_class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchMethod_O),code), "code" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchMethod_O),_argument_handler), "_argument_handler" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchMethod_O),_declares), "_declares" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchMethod_O),_docstring), "_docstring" },
...
{ templated_class_jump_table_index, 2, "" },
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(core::WrappedPointer_O),_Class),"_Class" }, 
...
{ class_size, sizeof(core::WeakPointer_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::WeakPointer_O),_WeakObject.pointer), "_WeakObject.pointer" },
...
{ class_size, sizeof(core::Class_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Class_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Class_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Class_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
{ class_kind, KIND_BOOTSTRAP_core__StdClass_O, "core::StdClass_O" },
{ class_size, sizeof(core::StdClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StdClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StdClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StdClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
{ class_kind, KIND_BOOTSTRAP_core__StandardClass_O, "core::StandardClass_O" },
{ class_size, sizeof(core::StandardClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StandardClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StandardClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StandardClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StandardClass_O),_InstanceCoreClass), "_InstanceCoreClass" },
...
{ class_size, sizeof(core::FuncallableStandardClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FuncallableStandardClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FuncallableStandardClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FuncallableStandardClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FuncallableStandardClass_O),_InstanceCoreClass), "_InstanceCoreClass" },
{ class_kind, KIND_BOOTSTRAP_core__StructureClass_O, "core::StructureClass_O" },
{ class_size, sizeof(core::StructureClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StructureClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StructureClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StructureClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StructureClass_O),_InstanceCoreClass), "_InstanceCoreClass" },
...
{ class_size, sizeof(core::ForwardReferencedClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ForwardReferencedClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ForwardReferencedClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ForwardReferencedClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ForwardReferencedClass_O),_InstanceCoreClass), "_InstanceCoreClass" },
{ class_kind, KIND_LISPALLOC_core__CxxClass_O, "core::CxxClass_O" },
{ class_size, sizeof(core::CxxClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CxxClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CxxClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CxxClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
{ class_kind, KIND_BOOTSTRAP_core__BuiltInClass_O, "core::BuiltInClass_O" },
{ class_size, sizeof(core::BuiltInClass_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltInClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltInClass_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltInClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
{ class_kind, KIND_LISPALLOC_clbind__ClassRep_O, "clbind::ClassRep_O" },
{ class_size, sizeof(clbind::ClassRep_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(clbind::ClassRep_O),_Signature_ClassSlots), "_Signature_ClassSlots" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(clbind::ClassRep_O),_theCreator), "_theCreator" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(clbind::ClassRep_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(clbind::ClassRep_O),m_bases._Vector._Contents), "m_bases._Vector._Contents" },
{ class_kind, KIND_LISPALLOC_core__ExternalObject_O, "core::ExternalObject_O" },
{ class_size, sizeof(core::ExternalObject_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ExternalObject_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__Value_O, "llvmo::Value_O" },
{ class_size, sizeof(llvmo::Value_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::Value_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__Argument_O, "llvmo::Argument_O" },
{ class_size, sizeof(llvmo::Argument_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::Argument_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__User_O, "llvmo::User_O" },
{ class_size, sizeof(llvmo::User_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::User_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__Instruction_O, "llvmo::Instruction_O" },
{ class_size, sizeof(llvmo::Instruction_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::Instruction_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__AtomicRMWInst_O, "llvmo::AtomicRMWInst_O" },
{ class_size, sizeof(llvmo::AtomicRMWInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::AtomicRMWInst_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__LandingPadInst_O, "llvmo::LandingPadInst_O" },
{ class_size, sizeof(llvmo::LandingPadInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::LandingPadInst_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__PHINode_O, "llvmo::PHINode_O" },
{ class_size, sizeof(llvmo::PHINode_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::PHINode_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__CallInst_O, "llvmo::CallInst_O" },
{ class_size, sizeof(llvmo::CallInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CallInst_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__StoreInst_O, "llvmo::StoreInst_O" },
{ class_size, sizeof(llvmo::StoreInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::StoreInst_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__UnaryInstruction_O, "llvmo::UnaryInstruction_O" },
{ class_size, sizeof(llvmo::UnaryInstruction_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::UnaryInstruction_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__LoadInst_O, "llvmo::LoadInst_O" },
{ class_size, sizeof(llvmo::LoadInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::LoadInst_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__AllocaInst_O, "llvmo::AllocaInst_O" },
{ class_size, sizeof(llvmo::AllocaInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::AllocaInst_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__VAArgInst_O, "llvmo::VAArgInst_O" },
{ class_size, sizeof(llvmo::VAArgInst_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::VAArgInst_O),_Class), "_Class" },
...
{ class_size, sizeof(llvmo::ConstantDataSequential_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::ConstantDataSequential_O),_Class), "_Class" },
...
{ class_size, sizeof(llvmo::FunctionPassManager_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::FunctionPassManager_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__PassManager_O, "llvmo::PassManager_O" },
{ class_size, sizeof(llvmo::PassManager_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::PassManager_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__TargetMachine_O, "llvmo::TargetMachine_O" },
{ class_size, sizeof(llvmo::TargetMachine_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::TargetMachine_O),_Class), "_Class" },
...
{ class_size, sizeof(llvmo::TargetLibraryInfo_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::TargetLibraryInfo_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__MCSubtargetInfo_O, "llvmo::MCSubtargetInfo_O" },
{ class_size, sizeof(llvmo::MCSubtargetInfo_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::MCSubtargetInfo_O),_Class), "_Class" },
...
{ class_size, sizeof(llvmo::TargetSubtargetInfo_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::TargetSubtargetInfo_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__Module_O, "llvmo::Module_O" },
{ class_size, sizeof(llvmo::Module_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::Module_O),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::Module_O),_UniqueGlobalVariableStrings), "_UniqueGlobalVariableStrings" },
{ class_kind, KIND_LISPALLOC_llvmo__EngineBuilder_O, "llvmo::EngineBuilder_O" },
{ class_size, sizeof(llvmo::EngineBuilder_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::EngineBuilder_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_core__ForeignData_O, "core::ForeignData_O" },
{ class_size, sizeof(core::ForeignData_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ForeignData_O),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ForeignData_O),_Kind), "_Kind" },
{ class_kind, KIND_LISPALLOC_llvmo__LLVMContext_O, "llvmo::LLVMContext_O" },
{ class_size, sizeof(llvmo::LLVMContext_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::LLVMContext_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_llvmo__Target_O, "llvmo::Target_O" },
{ class_size, sizeof(llvmo::Target_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::Target_O),_Class), "_Class" },
{ class_kind, KIND_LISPALLOC_core__LoadTimeValues_O, "core::LoadTimeValues_O" },
{ class_size, sizeof(core::LoadTimeValues_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LoadTimeValues_O),_Objects._Vector._Contents), "_Objects._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LoadTimeValues_O),_Symbols._Vector._Contents), "_Symbols._Vector._Contents" },
{ class_kind, KIND_LISPALLOC_core__Binder_O, "core::Binder_O" },
{ class_size, sizeof(core::Binder_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Binder_O),_Bindings), "_Bindings" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Binder_O),_Values), "_Values" },
...
{ class_size, sizeof(core::SourceManager_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SourceManager_O),_SourcePosInfo), "_SourcePosInfo" },
{ class_kind, KIND_LISPALLOC_core__Record_O, "core::Record_O" },
{ class_size, sizeof(core::Record_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Record_O),_alist), "_alist" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Record_O),_replacement_table), "_replacement_table" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Record_O),_Seen), "_Seen" },
...
{ class_size, sizeof(core::Symbol_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Symbol_O),_Name), "_Name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Symbol_O),_HomePackage), "_HomePackage" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Symbol_O),_Value), "_Value" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Symbol_O),_Function), "_Function" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Symbol_O),_SetfFunction), "_SetfFunction" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Symbol_O),_PropertyList), "_PropertyList" },
{ class_kind, KIND_LISPALLOC_core__Null_O, "core::Null_O" },
{ class_size, sizeof(core::Null_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Null_O),_Name), "_Name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Null_O),_HomePackage), "_HomePackage" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Null_O),_Value), "_Value" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Null_O),_Function), "_Function" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Null_O),_SetfFunction), "_SetfFunction" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Null_O),_PropertyList), "_PropertyList" },
...
{ class_size, sizeof(core::DirectoryIterator_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::DirectoryIterator_O),_Path), "_Path" },
...
{ class_size, sizeof(core::RecursiveDirectoryIterator_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::RecursiveDirectoryIterator_O),_Path), "_Path" },
...
{ class_size, sizeof(core::SymbolToEnumConverter_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolToEnumConverter_O),_WhatTheEnumsRepresent._Contents), "_WhatTheEnumsRepresent._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolToEnumConverter_O),_EnumToSymbol), "_EnumToSymbol" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolToEnumConverter_O),_ArchiveSymbolToEnum), "_ArchiveSymbolToEnum" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolToEnumConverter_O),_EnumToArchiveSymbol), "_EnumToArchiveSymbol" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SymbolToEnumConverter_O),_SymbolToEnum), "_SymbolToEnum" },
{ class_kind, KIND_LISPALLOC_core__CandoException_O, "core::CandoException_O" },
{ class_size, sizeof(core::CandoException_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CandoException_O),_message._Contents), "_message._Contents" },
{ class_kind, KIND_LISPALLOC_core__Stream_O, "core::Stream_O" },
{ class_size, sizeof(core::Stream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Stream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Stream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Stream_O),_ExternalFormat), "_ExternalFormat" },
{ class_kind, KIND_LISPALLOC_core__AnsiStream_O, "core::AnsiStream_O" },
{ class_size, sizeof(core::AnsiStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::AnsiStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::AnsiStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::AnsiStream_O),_ExternalFormat), "_ExternalFormat" },
{ class_kind, KIND_LISPALLOC_core__FileStream_O, "core::FileStream_O" },
{ class_size, sizeof(core::FileStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FileStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FileStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FileStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FileStream_O),_Filename), "_Filename" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::FileStream_O),_ElementType), "_ElementType" },
{ class_kind, KIND_LISPALLOC_core__IOStreamStream_O, "core::IOStreamStream_O" },
{ class_size, sizeof(core::IOStreamStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOStreamStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOStreamStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOStreamStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOStreamStream_O),_Filename), "_Filename" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOStreamStream_O),_ElementType), "_ElementType" },
{ class_kind, KIND_LISPALLOC_core__IOFileStream_O, "core::IOFileStream_O" },
{ class_size, sizeof(core::IOFileStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOFileStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOFileStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOFileStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOFileStream_O),_Filename), "_Filename" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::IOFileStream_O),_ElementType), "_ElementType" },
...
{ class_size, sizeof(core::ConcatenatedStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ConcatenatedStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ConcatenatedStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ConcatenatedStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ConcatenatedStream_O),_List), "_List" },
{ class_kind, KIND_LISPALLOC_core__StringStream_O, "core::StringStream_O" },
{ class_size, sizeof(core::StringStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringStream_O),_ExternalFormat), "_ExternalFormat" },
{ class_kind, KIND_LISPALLOC_core__StringInputStream_O, "core::StringInputStream_O" },
{ class_size, sizeof(core::StringInputStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringInputStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringInputStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringInputStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringInputStream_O),_Contents), "_Contents" },
...
{ class_size, sizeof(core::StringOutputStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringOutputStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringOutputStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringOutputStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StringOutputStream_O),_Contents), "_Contents" },
{ class_kind, KIND_LISPALLOC_core__SynonymStream_O, "core::SynonymStream_O" },
{ class_size, sizeof(core::SynonymStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SynonymStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SynonymStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SynonymStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SynonymStream_O),_SynonymSymbol), "_SynonymSymbol" },
{ class_kind, KIND_LISPALLOC_core__EchoStream_O, "core::EchoStream_O" },
{ class_size, sizeof(core::EchoStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::EchoStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::EchoStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::EchoStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::EchoStream_O),_In), "_In" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::EchoStream_O),_Out), "_Out" },
{ class_kind, KIND_LISPALLOC_core__TwoWayStream_O, "core::TwoWayStream_O" },
{ class_size, sizeof(core::TwoWayStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TwoWayStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TwoWayStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TwoWayStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TwoWayStream_O),_In), "_In" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::TwoWayStream_O),_Out), "_Out" },
{ class_kind, KIND_LISPALLOC_core__BroadcastStream_O, "core::BroadcastStream_O" },
{ class_size, sizeof(core::BroadcastStream_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BroadcastStream_O),_Format), "_Format" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BroadcastStream_O),_ByteStack), "_ByteStack" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BroadcastStream_O),_ExternalFormat), "_ExternalFormat" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BroadcastStream_O),_Streams), "_Streams" },
{ class_kind, KIND_LISPALLOC_core__Reader_O, "core::Reader_O" },
{ class_size, sizeof(core::Reader_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Reader_O),_Input), "_Input" },
{ class_kind, KIND_LISPALLOC_core__SharpEqualWrapper_O, "core::SharpEqualWrapper_O" },
{ class_size, sizeof(core::SharpEqualWrapper_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SharpEqualWrapper_O),_Value), "_Value" },
{ class_kind, KIND_LISPALLOC_core__Cons_O, "core::Cons_O" },
{ class_size, sizeof(core::Cons_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Cons_O),_Car), "_Car" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Cons_O),_Cdr), "_Cdr" },
{ class_kind, KIND_LISPALLOC_core__Archive_O, "core::Archive_O" },
{ class_size, sizeof(core::Archive_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Archive_O),_TopNode.theObject), "_TopNode.theObject" },
{ class_kind, KIND_LISPALLOC_core__SaveArchive_O, "core::SaveArchive_O" },
{ class_size, sizeof(core::SaveArchive_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SaveArchive_O),_TopNode.theObject), "_TopNode.theObject" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SaveArchive_O),_SNodeForObject), "_SNodeForObject" },
{ class_kind, KIND_LISPALLOC_core__SexpSaveArchive_O, "core::SexpSaveArchive_O" },
{ class_size, sizeof(core::SexpSaveArchive_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SexpSaveArchive_O),_TopNode.theObject), "_TopNode.theObject" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SexpSaveArchive_O),_SNodeForObject), "_SNodeForObject" },
{ class_kind, KIND_LISPALLOC_core__LoadArchive_O, "core::LoadArchive_O" },
{ class_size, sizeof(core::LoadArchive_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LoadArchive_O),_TopNode.theObject), "_TopNode.theObject" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LoadArchive_O),_ObjectForSNode), "_ObjectForSNode" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LoadArchive_O),_NodesToFinalize), "_NodesToFinalize" },
{ class_kind, KIND_LISPALLOC_core__SexpLoadArchive_O, "core::SexpLoadArchive_O" },
{ class_size, sizeof(core::SexpLoadArchive_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SexpLoadArchive_O),_TopNode.theObject), "_TopNode.theObject" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SexpLoadArchive_O),_ObjectForSNode), "_ObjectForSNode" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SexpLoadArchive_O),_NodesToFinalize), "_NodesToFinalize" },
{ class_kind, KIND_LISPALLOC_core__HashTable_O, "core::HashTable_O" },
{ class_size, sizeof(core::HashTable_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTable_O),_RehashSize), "_RehashSize" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTable_O),_HashTable), "_HashTable" },
{ class_kind, KIND_LISPALLOC_core__HashTableEq_O, "core::HashTableEq_O" },
{ class_size, sizeof(core::HashTableEq_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEq_O),_RehashSize), "_RehashSize" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEq_O),_HashTable), "_HashTable" },
{ class_kind, KIND_LISPALLOC_core__HashTableEqualp_O, "core::HashTableEqualp_O" },
{ class_size, sizeof(core::HashTableEqualp_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEqualp_O),_RehashSize), "_RehashSize" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEqualp_O),_HashTable), "_HashTable" },
{ class_kind, KIND_LISPALLOC_core__HashTableEql_O, "core::HashTableEql_O" },
{ class_size, sizeof(core::HashTableEql_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEql_O),_RehashSize), "_RehashSize" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEql_O),_HashTable), "_HashTable" },
{ class_kind, KIND_LISPALLOC_core__HashTableEqual_O, "core::HashTableEqual_O" },
{ class_size, sizeof(core::HashTableEqual_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEqual_O),_RehashSize), "_RehashSize" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::HashTableEqual_O),_HashTable), "_HashTable" },
...
{ class_size, sizeof(core::WeakKeyMapping_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::WeakKeyMapping_O),_WeakObject.Key), "_WeakObject.Key" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::WeakKeyMapping_O),_WeakObject.Value), "_WeakObject.Value" },
{ class_kind, KIND_LISPALLOC_core__LambdaListHandler_O, "core::LambdaListHandler_O" },
{ class_size, sizeof(core::LambdaListHandler_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_ClassifiedSymbolList), "_ClassifiedSymbolList" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_SpecialSymbolSet.theObject), "_SpecialSymbolSet.theObject" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_DeclareSpecifierList), "_DeclareSpecifierList" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_RequiredArguments._Vector._Contents), "_RequiredArguments._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_OptionalArguments._Vector._Contents), "_OptionalArguments._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_RestArgument._ArgTarget), "_RestArgument._ArgTarget" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_KeyFlag), "_KeyFlag" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_KeywordArguments._Vector._Contents), "_KeywordArguments._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_AllowOtherKeys), "_AllowOtherKeys" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_AuxArguments._Vector._Contents), "_AuxArguments._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_Comment._Contents), "_Comment._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LambdaListHandler_O),_LexicalVariableNamesForDebugging), "_LexicalVariableNamesForDebugging" },
...
{ class_size, sizeof(core::SourceFileInfo_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SourceFileInfo_O),_pathname), "_pathname" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SourceFileInfo_O),_SourceDebugNamestring), "_SourceDebugNamestring" },
...
{ class_size, sizeof(core::LeafSNode_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LeafSNode_O),_Object), "_Object" },
{ class_kind, KIND_LISPALLOC_core__BranchSNode_O, "core::BranchSNode_O" },
{ class_size, sizeof(core::BranchSNode_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BranchSNode_O),_Kind), "_Kind" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BranchSNode_O),_SNodePList), "_SNodePList" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::BranchSNode_O),_VectorSNodes.theObject), "_VectorSNodes.theObject" },
...
{ class_size, sizeof(asttooling::AstVisitor_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::AstVisitor_O),_Target), "_Target" },
...
{ class_size, sizeof(core::StructureObject_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StructureObject_O),_Type), "_Type" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::StructureObject_O),_Slots._Vector._Contents), "_Slots._Vector._Contents" },
...
{ class_size, sizeof(core::Package_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_Name._Contents), "_Name._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_InternalSymbols), "_InternalSymbols" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_ExternalSymbols), "_ExternalSymbols" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_Shadowing), "_Shadowing" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_UsingPackages._Vector._Contents), "_UsingPackages._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_PackagesUsedBy._Vector._Contents), "_PackagesUsedBy._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Package_O),_Nicknames), "_Nicknames" },
...
{ class_size, sizeof(core::Function_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Function_O),closure), "closure" },
{ class_kind, KIND_LISPALLOC_core__CompiledFunction_O, "core::CompiledFunction_O" },
{ class_size, sizeof(core::CompiledFunction_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CompiledFunction_O),closure), "closure" },
...
{ class_size, sizeof(core::SingleDispatchGenericFunction_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunction_O),closure), "closure" },
{ class_kind, KIND_LISPALLOC_core__SpecialForm_O, "core::SpecialForm_O" },
{ class_size, sizeof(core::SpecialForm_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SpecialForm_O),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SpecialForm_O),_SpecialSymbol), "_SpecialSymbol" },
...
{ class_size, sizeof(core::SingleDispatchEffectiveMethodFunction_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchEffectiveMethodFunction_O),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchEffectiveMethodFunction_O),_Methods), "_Methods" },
{ class_kind, KIND_LISPALLOC_core__Instance_O, "core::Instance_O" },
{ class_size, sizeof(core::Instance_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Instance_O),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Instance_O),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Instance_O),_Slots._Vector._Contents), "_Slots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Instance_O),_Sig), "_Sig" },
...
{ class_size, sizeof(clbind::ClassRegistry_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(clbind::ClassRegistry_O),m_classes), "m_classes" },
...
{ class_size, sizeof(core::SmallMultimap_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SmallMultimap_O),map._Contents), "map._Contents" },
{ class_kind, KIND_LISPALLOC_core__Pathname_O, "core::Pathname_O" },
{ class_size, sizeof(core::Pathname_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Pathname_O),_Host), "_Host" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Pathname_O),_Device), "_Device" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Pathname_O),_Directory), "_Directory" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Pathname_O),_Name), "_Name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Pathname_O),_Type), "_Type" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Pathname_O),_Version), "_Version" },
{ class_kind, KIND_LISPALLOC_core__LogicalPathname_O, "core::LogicalPathname_O" },
{ class_size, sizeof(core::LogicalPathname_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LogicalPathname_O),_Host), "_Host" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LogicalPathname_O),_Device), "_Device" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LogicalPathname_O),_Directory), "_Directory" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LogicalPathname_O),_Name), "_Name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LogicalPathname_O),_Type), "_Type" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::LogicalPathname_O),_Version), "_Version" },
...
{ class_size, sizeof(core::SmallMap_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SmallMap_O),map._Contents), "map._Contents" },
{ class_kind, KIND_CLASSALLOC_core__Cache, "core::Cache" },
{ class_size, sizeof(core::Cache), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Cache),_keys._Vector._Contents), "_keys._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Cache),_table._Vector._Contents), "_table._Vector._Contents" },
{ class_kind, KIND_ROOTCLASSALLOC_core__Lisp_O, "core::Lisp_O" },
{ class_size, sizeof(core::Lisp_O), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._BufferStringPool), "_Roots._BufferStringPool" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._ExceptionStack._Stack._Vector._Contents), "_Roots._ExceptionStack._Stack._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._TerminalIO), "_Roots._TerminalIO" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._BformatStringOutputStream), "_Roots._BformatStringOutputStream" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._BignumRegister0), "_Roots._BignumRegister0" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._BignumRegister1), "_Roots._BignumRegister1" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._BignumRegister2), "_Roots._BignumRegister2" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._IntegerOverflowAdjust), "_Roots._IntegerOverflowAdjust" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots.charInfo.gIndexedCharacters._Vector._Contents), "_Roots.charInfo.gIndexedCharacters._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots.charInfo.gCharacterNames._Vector._Contents), "_Roots.charInfo.gCharacterNames._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._ClassSymbolsHolder._Vector._Contents), "_Roots._ClassSymbolsHolder._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SystemProperties), "_Roots._SystemProperties" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._Bindings._Bindings._Vector._Contents), "_Roots._Bindings._Bindings._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SourceFiles._Vector._Contents), "_Roots._SourceFiles._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._CatchInfo), "_Roots._CatchInfo" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots.bootClassTable._Vector._Contents), "_Roots.bootClassTable._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._LoadTimeValueArrays), "_Roots._LoadTimeValueArrays" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._CommandLineArguments), "_Roots._CommandLineArguments" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._Packages._Vector._Contents), "_Roots._Packages._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SetfDefinitions), "_Roots._SetfDefinitions" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._CorePackage), "_Roots._CorePackage" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._KeywordPackage), "_Roots._KeywordPackage" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._CommonLispPackage), "_Roots._CommonLispPackage" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SpecialForms), "_Roots._SpecialForms" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SingleDispatchGenericFunctionTable), "_Roots._SingleDispatchGenericFunctionTable" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._TrueObject), "_Roots._TrueObject" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SingleDispatchMethodCachePtr), "_Roots._SingleDispatchMethodCachePtr" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._MethodCachePtr), "_Roots._MethodCachePtr" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SlotCachePtr), "_Roots._SlotCachePtr" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._RehashSize), "_Roots._RehashSize" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._RehashThreshold), "_Roots._RehashThreshold" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._NullStream), "_Roots._NullStream" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._PathnameTranslations), "_Roots._PathnameTranslations" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._ImaginaryUnit), "_Roots._ImaginaryUnit" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._ImaginaryUnitNegative), "_Roots._ImaginaryUnitNegative" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._PlusHalf), "_Roots._PlusHalf" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._MinusHalf), "_Roots._MinusHalf" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SingleFloatMinusZero), "_Roots._SingleFloatMinusZero" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SingleFloatPlusZero), "_Roots._SingleFloatPlusZero" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._DoubleFloatMinusZero), "_Roots._DoubleFloatMinusZero" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._DoubleFloatPlusZero), "_Roots._DoubleFloatPlusZero" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._SingleFloatOne), "_Roots._SingleFloatOne" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::Lisp_O),_Roots._DoubleFloatOne), "_Roots._DoubleFloatOne" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::tagged_pointer<core::SequenceStepper>>::value_type), "gctools::GCVector_moveable<gctools::tagged_pointer<core::SequenceStepper>>" },
{ container_content_field_fix, 0, "TAGGED_POINTER_FIX-only" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::KeywordArgument>::value_type), "gctools::GCVector_moveable<core::KeywordArgument>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::KeywordArgument>::value_type),_ArgTarget),"_ArgTarget" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::KeywordArgument>::value_type),_Default),"_Default" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::KeywordArgument>::value_type),_Keyword),"_Keyword" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::KeywordArgument>::value_type),_Sensor._ArgTarget),"_Sensor._ArgTarget" }, 
...
{ container_content_size, sizeof(gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,0>::value_type), "gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,0>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ class_size, sizeof(core::SingleDispatchGenericFunctionClosure), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunctionClosure),name), "name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunctionClosure),closedEnvironment), "closedEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunctionClosure),kind), "kind" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunctionClosure),_cleavir_ast), "_cleavir_ast" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunctionClosure),_Methods), "_Methods" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::SingleDispatchGenericFunctionClosure),_lambdaListHandler), "_lambdaListHandler" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::List_V>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::List_V>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::RequiredArgument>::value_type), "gctools::GCVector_moveable<core::RequiredArgument>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::RequiredArgument>::value_type),_ArgTarget),"_ArgTarget" }, 
{ class_kind, KIND_CLASSALLOC_llvmo__CompiledClosure, "llvmo::CompiledClosure" },
{ class_size, sizeof(llvmo::CompiledClosure), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),name), "name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),closedEnvironment), "closedEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),kind), "kind" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),_cleavir_ast), "_cleavir_ast" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),llvmFunction), "llvmFunction" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),associatedFunctions), "associatedFunctions" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(llvmo::CompiledClosure),_lambdaList), "_lambdaList" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::SourceFileInfo_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::SourceFileInfo_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ class_size, sizeof(asttooling::internal::VariadicOperatorMatcherDescriptor), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::internal::VariadicOperatorMatcherDescriptor),MatcherName), "MatcherName" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::Symbol_O>,gctools::smart_ptr<core::T_O>>>::value_type), "gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::Symbol_O>,gctools::smart_ptr<core::T_O>>>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::Symbol_O>,gctools::smart_ptr<core::T_O>>>::value_type),first),"first" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::Symbol_O>,gctools::smart_ptr<core::T_O>>>::value_type),second),"second" }, 
...
{ class_size, sizeof(asttooling::internal::OverloadedMatcherDescriptor), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::internal::OverloadedMatcherDescriptor),Overloads._Vector._Contents), "Overloads._Vector._Contents" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::SymbolStorage>::value_type), "gctools::GCVector_moveable<core::SymbolStorage>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::SymbolStorage>::value_type),_Symbol),"_Symbol" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<asttooling::ContextFrame>::value_type), "gctools::GCVector_moveable<asttooling::ContextFrame>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::ContextFrame>::value_type),Range),"Range" }, 
...
{ class_size, sizeof(asttooling::internal::FixedArgCountMatcherDescriptor), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::internal::FixedArgCountMatcherDescriptor),MatcherName), "MatcherName" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::T_O *>::value_type), "gctools::GCVector_moveable<core::T_O *>" },
{ container_content_field_fix, 0, "SIMPLE_POINTER_FIX-only" },
...
{ class_size, sizeof(asttooling::internal::FreeFuncMatcherDescriptor), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::internal::FreeFuncMatcherDescriptor),MatcherName), "MatcherName" },
{ class_kind, KIND_CLASSALLOC_core__MacroClosure, "core::MacroClosure" },
{ class_size, sizeof(core::MacroClosure), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroClosure),name), "name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroClosure),closedEnvironment), "closedEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroClosure),kind), "kind" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroClosure),_cleavir_ast), "_cleavir_ast" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::MacroClosure),_lambdaListHandler), "_lambdaListHandler" },
{ class_kind, KIND_CLASSALLOC_core__ConsStepper, "core::ConsStepper" },
{ class_size, sizeof(core::ConsStepper), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::ConsStepper),_Cur), "_Cur" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::AuxArgument>::value_type), "gctools::GCVector_moveable<core::AuxArgument>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::AuxArgument>::value_type),_ArgTarget),"_ArgTarget" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::AuxArgument>::value_type),_Expression),"_Expression" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<asttooling::ParserValue>::value_type), "gctools::GCVector_moveable<asttooling::ParserValue>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::ParserValue>::value_type),Range),"Range" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::Symbol_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::Symbol_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::SymbolClassPair>::value_type), "gctools::GCVector_moveable<core::SymbolClassPair>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::SymbolClassPair>::value_type),symbol),"symbol" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::SymbolClassPair>::value_type),theClass),"theClass" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<asttooling::RegMap::SymbolMatcherDescriptorPair>::value_type), "gctools::GCVector_moveable<asttooling::RegMap::SymbolMatcherDescriptorPair>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::RegMap::SymbolMatcherDescriptorPair>::value_type),Name),"Name" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::RegMap::SymbolMatcherDescriptorPair>::value_type),matcher),"matcher" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::T_O>,gctools::smart_ptr<core::T_O>>>::value_type), "gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::T_O>,gctools::smart_ptr<core::T_O>>>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::T_O>,gctools::smart_ptr<core::T_O>>>::value_type),first),"first" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<std::pair<gctools::smart_ptr<core::T_O>,gctools::smart_ptr<core::T_O>>>::value_type),second),"second" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::CacheRecord>::value_type), "gctools::GCVector_moveable<core::CacheRecord>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::CacheRecord>::value_type),_key),"_key" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::CacheRecord>::value_type),_value),"_value" }, 
{ class_kind, KIND_CLASSALLOC_core__InstanceClosure, "core::InstanceClosure" },
{ class_size, sizeof(core::InstanceClosure), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceClosure),name), "name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceClosure),closedEnvironment), "closedEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceClosure),kind), "kind" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceClosure),_cleavir_ast), "_cleavir_ast" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceClosure),instance), "instance" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InstanceClosure),lambda_list), "lambda_list" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::Cons_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::Cons_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ class_size, sizeof(asttooling::DerivableFrontendActionFactory), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableFrontendActionFactory),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableFrontendActionFactory),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableFrontendActionFactory),_Slots._Vector._Contents), "_Slots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableFrontendActionFactory),_Sig), "_Sig" },
...
{ container_content_size, sizeof(gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,1>::value_type), "gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,1>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ class_size, sizeof(asttooling::DerivableMatchCallback), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableMatchCallback),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableMatchCallback),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableMatchCallback),_Slots._Vector._Contents), "_Slots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableMatchCallback),_Sig), "_Sig" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<asttooling::ErrorContent>::value_type), "gctools::GCVector_moveable<asttooling::ErrorContent>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::ErrorContent>::value_type),ContextStack._Vector._Contents),"ContextStack._Vector._Contents" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::ErrorContent>::value_type),Messages._Vector._Contents),"Messages._Vector._Contents" }, 
...
{ class_size, sizeof(asttooling::DerivableASTFrontendAction), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableASTFrontendAction),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableASTFrontendAction),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableASTFrontendAction),_Slots._Vector._Contents), "_Slots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableASTFrontendAction),_Sig), "_Sig" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<asttooling::Message>::value_type), "gctools::GCVector_moveable<asttooling::Message>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<asttooling::Message>::value_type),Range),"Range" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::tagged_pointer<asttooling::internal::MatcherDescriptor>>::value_type), "gctools::GCVector_moveable<gctools::tagged_pointer<asttooling::internal::MatcherDescriptor>>" },
{ container_content_field_fix, 0, "TAGGED_POINTER_FIX-only" },
...
{ container_content_size, sizeof(gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,2>::value_type), "gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,2>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
{ class_kind, KIND_CLASSALLOC_core__CoreExposer, "core::CoreExposer" },
{ class_size, sizeof(core::CoreExposer), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::CoreExposer),_Package), "_Package" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ class_size, sizeof(asttooling::DerivableSyntaxOnlyAction), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableSyntaxOnlyAction),closure), "closure" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableSyntaxOnlyAction),_Class), "_Class" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableSyntaxOnlyAction),_Slots._Vector._Contents), "_Slots._Vector._Contents" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(asttooling::DerivableSyntaxOnlyAction),_Sig), "_Sig" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::SingleDispatchMethod_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::SingleDispatchMethod_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::OptionalArgument>::value_type), "gctools::GCVector_moveable<core::OptionalArgument>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::OptionalArgument>::value_type),_ArgTarget),"_ArgTarget" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::OptionalArgument>::value_type),_Default),"_Default" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::OptionalArgument>::value_type),_Sensor._ArgTarget),"_Sensor._ArgTarget" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<core::Package_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<core::Package_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
{ templated_class_jump_table_index, 32, "" },
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltinClosure),name),"name" }, 
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltinClosure),closedEnvironment),"closedEnvironment" }, 
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltinClosure),kind),"kind" }, 
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltinClosure),_cleavir_ast),"_cleavir_ast" }, 
    { templated_class_field_fix, offsetof(MACRO_SAFE_TYPE(core::BuiltinClosure),_lambdaListHandler),"_lambdaListHandler" }, 
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::ExceptionEntry>::value_type), "gctools::GCVector_moveable<core::ExceptionEntry>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::ExceptionEntry>::value_type),_Key),"_Key" }, 
{ class_kind, KIND_CLASSALLOC_core__InterpretedClosure, "core::InterpretedClosure" },
{ class_size, sizeof(core::InterpretedClosure), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),name), "name" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),closedEnvironment), "closedEnvironment" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),kind), "kind" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),_cleavir_ast), "_cleavir_ast" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),_lambdaListHandler), "_lambdaListHandler" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),_declares), "_declares" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),_docstring), "_docstring" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::InterpretedClosure),_code), "_code" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<core::DynamicBinding>::value_type), "gctools::GCVector_moveable<core::DynamicBinding>" },
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::DynamicBinding>::value_type),_Var),"_Var" }, 
    { container_content_field_fix, offsetof(MACRO_SAFE_TYPE(gctools::GCVector_moveable<core::DynamicBinding>::value_type),_Val),"_Val" }, 
{ class_kind, KIND_CLASSALLOC_core__VectorStepper, "core::VectorStepper" },
{ class_size, sizeof(core::VectorStepper), "" },
 { field_fix, offsetof(MACRO_SAFE_TYPE(core::VectorStepper),_Domain), "_Domain" },
...
{ container_content_size, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<clbind::ClassRep_O>>::value_type), "gctools::GCVector_moveable<gctools::smart_ptr<clbind::ClassRep_O>>" },
{ container_content_field_fix, 0, "SMART_PTR_FIX-only" },
...
static void* OBJ_SCAN_table[] = { 
  ...
  /* 252 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__,
  /* 253 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 254 */ &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_,
  /* 256 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 257 */ &&obj_scan_KIND_GCSTRING_gctools__GCString_moveable_char_,
  /* 258 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 260 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 262 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  ...
  /* 287 */ &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__2_,
  /* 289 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 291 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 292 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 293 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 294 */ &&obj_scan_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure,
  /* 295 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 297 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 299 */ &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
   NULL
};
...
static void* OBJ_VALIDATE_table[] = { 
  ...
  /* 252 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__,
  /* 253 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 254 */ &&obj_validate_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_,
  /* 256 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 257 */ &&obj_validate_KIND_GCSTRING_gctools__GCString_moveable_char_,
  /* 258 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 260 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 262 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  /* 264 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_,
  /* 265 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_,
  /* 267 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_,
  /* 271 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_,
  /* 272 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_,
  /* 273 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__,
  /* 274 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_,
  /* 275 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_,
  /* 276 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___,
  /* 277 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_,
  /* 279 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__,
  /* 281 */ &&obj_validate_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_,
  /* 283 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_,
  /* 285 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_,
  /* 286 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__,
  /* 287 */ &&obj_validate_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__2_,
  /* 289 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 291 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 292 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 293 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 294 */ &&obj_validate_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure,
  /* 295 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 297 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 299 */ &&obj_validate_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
   NULL
};
...
static void* OBJ_FINALIZE_table[] = { 
  ...
  /* 194 */ &&obj_finalize_KIND_LISPALLOC_core__SharpEqualWrapper_O,
  /* 195 */ &&obj_finalize_KIND_LISPALLOC_core__Cons_O,
  /* 196 */ &&obj_finalize_KIND_LISPALLOC_core__Archive_O,
  /* 197 */ &&obj_finalize_KIND_LISPALLOC_core__SaveArchive_O,
  /* 198 */ &&obj_finalize_KIND_LISPALLOC_core__SexpSaveArchive_O,
  /* 199 */ &&obj_finalize_KIND_LISPALLOC_core__LoadArchive_O,
  /* 200 */ &&obj_finalize_KIND_LISPALLOC_core__SexpLoadArchive_O,
  /* 201 */ &&obj_finalize_KIND_LISPALLOC_core__HashTable_O,
  /* 202 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEq_O,
  /* 203 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEqualp_O,
  /* 204 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEql_O,
  /* 205 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEqual_O,
  /* 206 */ &&obj_finalize_KIND_LISPALLOC_cffi__Pointer_O,
  /* 207 */ &&obj_finalize_KIND_LISPALLOC_core__CxxObject_O,
  /* 208 */ &&obj_finalize_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 209 */ &&obj_finalize_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 210 */ &&obj_finalize_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 211 */ &&obj_finalize_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 212 */ &&obj_finalize_KIND_LISPALLOC_core__SNode_O,
  /* 213 */ &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O,
  /* 214 */ &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O,
  /* 215 */ &&obj_finalize_KIND_LISPALLOC_core__Path_O,
  /* 216 */ &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 217 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 218 */ &&obj_finalize_KIND_LISPALLOC_core__StructureObject_O,
  /* 219 */ &&obj_finalize_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 220 */ &&obj_finalize_KIND_LISPALLOC_core__Package_O,
  /* 221 */ &&obj_finalize_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 222 */ &&obj_finalize_KIND_LISPALLOC_core__Character_dummy_O,
  /* 223 */ &&obj_finalize_KIND_LISPALLOC_core__Function_O,
  /* 224 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 225 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O,
  /* 226 */ &&obj_finalize_KIND_LISPALLOC_core__SpecialForm_O,
  /* 227 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 228 */ &&obj_finalize_KIND_LISPALLOC_core__Instance_O,
  /* 229 */ &&obj_finalize_KIND_LISPALLOC_core__Pointer_O,
  /* 230 */ &&obj_finalize_KIND_LISPALLOC_clbind__ClassRegistry_O,
  /* 231 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DebugInfo_O,
  /* 232 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIDerivedType_O,
  /* 233 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIArray_O,
  /* 234 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIBasicType_O,
  /* 235 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DISubprogram_O,
  /* 236 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlock_O,
  /* 237 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DICompileUnit_O,
  /* 238 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIDescriptor_O,
  /* 239 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIType_O,
  /* 240 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DISubroutineType_O,
  /* 241 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DICompositeType_O,
  /* 242 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DITypeArray_O,
  /* 243 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIFile_O,
  /* 244 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIScope_O,
  /* 245 */ &&obj_finalize_KIND_LISPALLOC_core__SmallMultimap_O,
  /* 246 */ &&obj_finalize_KIND_LISPALLOC_core__Pathname_O,
  /* 247 */ &&obj_finalize_KIND_LISPALLOC_core__LogicalPathname_O,
  /* 248 */ &&obj_finalize_KIND_LISPALLOC_core__PosixTime_O,
  /* 249 */ &&obj_finalize_KIND_LISPALLOC_core__SmallMap_O,
  /* 250 */ &&obj_finalize_KIND_CLASSALLOC_core__Cache,
  /* 251 */ &&obj_finalize_KIND_ROOTCLASSALLOC_core__Lisp_O,
  /* 252 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__,
  /* 253 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 254 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_,
  /* 255 */ &&obj_finalize_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure,
  /* 256 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 257 */ &&obj_finalize_KIND_GCSTRING_gctools__GCString_moveable_char_,
  /* 258 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 259 */ &&obj_finalize_KIND_CLASSALLOC_llvmo__CompiledClosure,
  /* 260 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 261 */ &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor,
  /* 262 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  ...
  /* 287 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__2_,
  /* 288 */ &&obj_finalize_KIND_CLASSALLOC_core__CoreExposer,
  ...
  /* 293 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 294 */ &&obj_finalize_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure,
  /* 295 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 296 */ &&obj_finalize_KIND_CLASSALLOC_core__InterpretedClosure,
  /* 297 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 298 */ &&obj_finalize_KIND_CLASSALLOC_core__VectorStepper,
  /* 299 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
   NULL
};
...
static void* OBJ_DEALLOCATOR_table[] = { 
  ...
  /* 194 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SharpEqualWrapper_O,
  /* 195 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Cons_O,
  /* 196 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Archive_O,
  /* 197 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SaveArchive_O,
  /* 198 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SexpSaveArchive_O,
  /* 199 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LoadArchive_O,
  /* 200 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SexpLoadArchive_O,
  /* 201 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTable_O,
  /* 202 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEq_O,
  /* 203 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEqualp_O,
  /* 204 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEql_O,
  /* 205 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEqual_O,
  /* 206 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_cffi__Pointer_O,
  /* 207 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxObject_O,
  /* 208 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 209 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 210 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 211 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 212 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SNode_O,
  /* 213 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LeafSNode_O,
  /* 214 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BranchSNode_O,
  /* 215 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Path_O,
  /* 216 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 217 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 218 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StructureObject_O,
  /* 219 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 220 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Package_O,
  /* 221 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 222 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Character_dummy_O,
  /* 223 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Function_O,
  /* 224 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 225 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O,
  /* 226 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecialForm_O,
  /* 227 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 228 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Instance_O,
  /* 229 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pointer_O,
  /* 230 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__ClassRegistry_O,
  /* 231 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DebugInfo_O,
  /* 232 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIDerivedType_O,
  /* 233 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIArray_O,
  /* 234 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIBasicType_O,
  /* 235 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DISubprogram_O,
  /* 236 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILexicalBlock_O,
  /* 237 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DICompileUnit_O,
  /* 238 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIDescriptor_O,
  /* 239 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIType_O,
  /* 240 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DISubroutineType_O,
  /* 241 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DICompositeType_O,
  /* 242 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DITypeArray_O,
  /* 243 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIFile_O,
  /* 244 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIScope_O,
  /* 245 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SmallMultimap_O,
  /* 246 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pathname_O,
  /* 247 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LogicalPathname_O,
  /* 248 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__PosixTime_O,
  /* 249 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SmallMap_O,
  /* 250 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_core__Cache,
  /* 251 */ &&obj_deallocate_unmanaged_instance_KIND_ROOTCLASSALLOC_core__Lisp_O,
  /* 252 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__,
  /* 253 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 254 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_,
  /* 255 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure,
  /* 256 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 257 */ &&obj_deallocate_unmanaged_instance_KIND_GCSTRING_gctools__GCString_moveable_char_,
  /* 258 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 259 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_llvmo__CompiledClosure,
  /* 260 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 261 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor,
  /* 262 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  /* 263 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor,
  /* 264 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_,
  ...
  /* 287 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__2_,
  /* 288 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_core__CoreExposer,
  ...
  /* 293 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 294 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure,
  /* 295 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 296 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_core__InterpretedClosure,
  /* 297 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 298 */ &&obj_deallocate_unmanaged_instance_KIND_CLASSALLOC_core__VectorStepper,
  /* 299 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
   NULL
};
