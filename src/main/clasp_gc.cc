...
KIND_LISPALLOC_llvmo__DebugLoc_O = 63,
KIND_LISPALLOC_llvmo__Attribute_O = 64,
KIND_LISPALLOC_core__RegexMatch_O = 65,
KIND_LISPALLOC_core__WeakPointer_O = 66,
KIND_LISPALLOC_core__VaList_dummy_O = 67,
...
KIND_LISPALLOC_core__LightUserData_O = 167,
KIND_LISPALLOC_core__UserData_O = 168,
KIND_BOOTSTRAP_core__Symbol_O = 169,
KIND_LISPALLOC_core__Null_O = 170,
KIND_LISPALLOC_core__SourcePosInfo_O = 171,
KIND_TEMPLATED_LISPALLOC_core__Iterator_O = 172,
KIND_LISPALLOC_core__DirectoryIterator_O = 173,
KIND_LISPALLOC_core__RecursiveDirectoryIterator_O = 174,
KIND_LISPALLOC_core__Regex_O = 175,
KIND_LISPALLOC_core__PosixTimeDuration_O = 176,
KIND_LISPALLOC_core__SymbolToEnumConverter_O = 177,
KIND_LISPALLOC_core__CandoException_O = 178,
KIND_LISPALLOC_core__Stream_O = 179,
KIND_LISPALLOC_core__AnsiStream_O = 180,
KIND_LISPALLOC_core__FileStream_O = 181,
KIND_LISPALLOC_core__IOStreamStream_O = 182,
KIND_LISPALLOC_core__IOFileStream_O = 183,
KIND_LISPALLOC_core__ConcatenatedStream_O = 184,
KIND_LISPALLOC_core__StringStream_O = 185,
KIND_LISPALLOC_core__StringInputStream_O = 186,
KIND_LISPALLOC_core__StringOutputStream_O = 187,
KIND_LISPALLOC_core__SynonymStream_O = 188,
KIND_LISPALLOC_core__EchoStream_O = 189,
KIND_LISPALLOC_core__TwoWayStream_O = 190,
KIND_LISPALLOC_core__BroadcastStream_O = 191,
KIND_LISPALLOC_core__Reader_O = 192,
KIND_LISPALLOC_core__Cons_O = 193,
KIND_LISPALLOC_core__Archive_O = 194,
KIND_LISPALLOC_core__SaveArchive_O = 195,
KIND_LISPALLOC_core__SexpSaveArchive_O = 196,
KIND_LISPALLOC_core__LoadArchive_O = 197,
KIND_LISPALLOC_core__SexpLoadArchive_O = 198,
KIND_LISPALLOC_core__HashTable_O = 199,
KIND_LISPALLOC_core__HashTableEq_O = 200,
KIND_LISPALLOC_core__HashTableEqualp_O = 201,
KIND_LISPALLOC_core__HashTableEql_O = 202,
KIND_LISPALLOC_core__HashTableEqual_O = 203,
KIND_LISPALLOC_cffi__Pointer_O = 204,
KIND_LISPALLOC_core__CxxObject_O = 205,
KIND_LISPALLOC_core__WeakKeyMapping_O = 206,
KIND_LISPALLOC_core__LambdaListHandler_O = 207,
KIND_LISPALLOC_llvmo__InsertPoint_O = 208,
KIND_LISPALLOC_core__SourceFileInfo_O = 209,
KIND_LISPALLOC_core__SNode_O = 210,
KIND_LISPALLOC_core__LeafSNode_O = 211,
KIND_LISPALLOC_core__BranchSNode_O = 212,
KIND_LISPALLOC_core__Path_O = 213,
KIND_LISPALLOC_asttooling__AstVisitor_O = 214,
KIND_LISPALLOC_llvmo__AttributeSet_O = 215,
KIND_LISPALLOC_core__StructureObject_O = 216,
KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O = 217,
KIND_LISPALLOC_core__Package_O = 218,
KIND_LISPALLOC_core__DirectoryEntry_O = 219,
KIND_LISPALLOC_core__Character_dummy_O = 220,
KIND_LISPALLOC_core__Function_O = 221,
KIND_LISPALLOC_core__CompiledFunction_O = 222,
KIND_LISPALLOC_core__SingleDispatchGenericFunction_O = 223,
KIND_LISPALLOC_core__SpecialForm_O = 224,
KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O = 225,
KIND_LISPALLOC_core__Instance_O = 226,
KIND_LISPALLOC_core__Pointer_O = 227,
KIND_LISPALLOC_clbind__ClassRegistry_O = 228,
KIND_LISPALLOC_llvmo__DebugInfo_O = 229,
KIND_LISPALLOC_llvmo__DIDerivedType_O = 230,
KIND_LISPALLOC_llvmo__DIArray_O = 231,
KIND_LISPALLOC_llvmo__DIBasicType_O = 232,
KIND_LISPALLOC_llvmo__DISubprogram_O = 233,
KIND_LISPALLOC_llvmo__DILexicalBlock_O = 234,
KIND_LISPALLOC_llvmo__DICompileUnit_O = 235,
KIND_LISPALLOC_llvmo__DIDescriptor_O = 236,
KIND_LISPALLOC_llvmo__DIType_O = 237,
KIND_LISPALLOC_llvmo__DISubroutineType_O = 238,
KIND_LISPALLOC_llvmo__DICompositeType_O = 239,
KIND_LISPALLOC_llvmo__DITypeArray_O = 240,
KIND_LISPALLOC_llvmo__DIFile_O = 241,
KIND_LISPALLOC_llvmo__DIScope_O = 242,
KIND_LISPALLOC_core__SmallMultimap_O = 243,
KIND_LISPALLOC_core__Pathname_O = 244,
KIND_LISPALLOC_core__LogicalPathname_O = 245,
KIND_LISPALLOC_core__PosixTime_O = 246,
KIND_LISPALLOC_core__SmallMap_O = 247,
KIND_CLASSALLOC_core__Cache = 248,
KIND_ROOTCLASSALLOC_core__Lisp_O = 249,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__ = 250,
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 251,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_ = 252,
KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure = 253,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__ = 254,
KIND_GCSTRING_gctools__GCString_moveable_char_ = 255,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 256,
KIND_CLASSALLOC_llvmo__CompiledClosure = 257,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 258,
KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor = 259,
KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___ = 260,
KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor = 261,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_ = 262,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_ = 263,
...
KIND_CLASSALLOC_core__CoreExposer = 286,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__ = 287,
KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction = 288,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__ = 289,
KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_ = 290,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 291,
KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure = 292,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 293,
KIND_CLASSALLOC_core__InterpretedClosure = 294,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 295,
KIND_CLASSALLOC_core__VectorStepper = 296,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__ = 297,
  KIND_max = 297
}
...
template <typename FP> struct Cast<llvmo::DebugInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 229 242 
      return ((229 <= kindVal) && (kindVal <= 242));
  };
};
...
template <typename FP> struct Cast<core::Function_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 221 226 
      return ((221 <= kindVal) && (kindVal <= 226));
  };
};
...
template <typename FP> struct Cast<core::SNode_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 210 212 
      return ((210 <= kindVal) && (kindVal <= 212));
  };
};
...
template <typename FP> struct Cast<core::HashTable_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 199 203 
      return ((199 <= kindVal) && (kindVal <= 203));
  };
};
...
template <typename FP> struct Cast<core::Iterator_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 172 174 
      return ((172 <= kindVal) && (kindVal <= 174));
  };
};
...
template <typename FP> struct Cast<core::SaveArchive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 195 196 
      return ((195 <= kindVal) && (kindVal <= 196));
  };
};
...
template <typename FP> struct Cast<core::AnsiStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 180 191 
      return ((180 <= kindVal) && (kindVal <= 191));
  };
};
...
static void* KIND_NAME_MAP_table[] = { NULL 
  ...
  /* 55 */ , &&kind_name_KIND_LISPALLOC_core__String_O
  /* 56 */ , &&kind_name_KIND_BOOTSTRAP_core__Str_O
  /* 57 */ , &&kind_name_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 58 */ , &&kind_name_KIND_LISPALLOC_core__VectorObjects_O
  /* 59 */ , &&kind_name_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 60 */ , &&kind_name_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 61 */ , &&kind_name_KIND_LISPALLOC_core__RandomState_O
  /* 62 */ , &&kind_name_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 63 */ , &&kind_name_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 64 */ , &&kind_name_KIND_LISPALLOC_llvmo__Attribute_O
  /* 65 */ , &&kind_name_KIND_LISPALLOC_core__RegexMatch_O
  /* 66 */ , &&kind_name_KIND_LISPALLOC_core__WeakPointer_O
  /* 67 */ , &&kind_name_KIND_LISPALLOC_core__VaList_dummy_O
  /* 68 */ , &&kind_name_KIND_BOOTSTRAP_core__StandardObject_O
  /* 69 */ , &&kind_name_KIND_BOOTSTRAP_core__Metaobject_O
  /* 70 */ , &&kind_name_KIND_BOOTSTRAP_core__Specializer_O
  /* 71 */ , &&kind_name_KIND_BOOTSTRAP_core__Class_O
  /* 72 */ , &&kind_name_KIND_BOOTSTRAP_core__StdClass_O
  /* 73 */ , &&kind_name_KIND_BOOTSTRAP_core__StandardClass_O
  /* 74 */ , &&kind_name_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 75 */ , &&kind_name_KIND_BOOTSTRAP_core__StructureClass_O
  /* 76 */ , &&kind_name_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 77 */ , &&kind_name_KIND_LISPALLOC_core__CxxClass_O
  /* 78 */ , &&kind_name_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 79 */ , &&kind_name_KIND_LISPALLOC_clbind__ClassRep_O
  /* 80 */ , &&kind_name_KIND_LISPALLOC_core__ExternalObject_O
  /* 81 */ , &&kind_name_KIND_LISPALLOC_llvmo__Value_O
  /* 82 */ , &&kind_name_KIND_LISPALLOC_llvmo__Argument_O
  /* 83 */ , &&kind_name_KIND_LISPALLOC_llvmo__User_O
  /* 84 */ , &&kind_name_KIND_LISPALLOC_llvmo__Instruction_O
  /* 85 */ , &&kind_name_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 86 */ , &&kind_name_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 87 */ , &&kind_name_KIND_LISPALLOC_llvmo__PHINode_O
  /* 88 */ , &&kind_name_KIND_LISPALLOC_llvmo__CallInst_O
  /* 89 */ , &&kind_name_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 90 */ , &&kind_name_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 91 */ , &&kind_name_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 92 */ , &&kind_name_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 93 */ , &&kind_name_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 94 */ , &&kind_name_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 95 */ , &&kind_name_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 96 */ , &&kind_name_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 97 */ , &&kind_name_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 98 */ , &&kind_name_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 99 */ , &&kind_name_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 100 */ , &&kind_name_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 101 */ , &&kind_name_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 102 */ , &&kind_name_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 103 */ , &&kind_name_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 104 */ , &&kind_name_KIND_LISPALLOC_llvmo__Constant_O
  /* 105 */ , &&kind_name_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 106 */ , &&kind_name_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 107 */ , &&kind_name_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 108 */ , &&kind_name_KIND_LISPALLOC_llvmo__Function_O
  /* 109 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 110 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 111 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 112 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 113 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 114 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 115 */ , &&kind_name_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 116 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 117 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 118 */ , &&kind_name_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 119 */ , &&kind_name_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 120 */ , &&kind_name_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 121 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 122 */ , &&kind_name_KIND_LISPALLOC_llvmo__Metadata_O
  /* 123 */ , &&kind_name_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 124 */ , &&kind_name_KIND_LISPALLOC_llvmo__MDNode_O
  /* 125 */ , &&kind_name_KIND_LISPALLOC_llvmo__MDString_O
  /* 126 */ , &&kind_name_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 127 */ , &&kind_name_KIND_LISPALLOC_llvmo__APFloat_O
  /* 128 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 129 */ , &&kind_name_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 130 */ , &&kind_name_KIND_LISPALLOC_llvmo__Triple_O
  /* 131 */ , &&kind_name_KIND_LISPALLOC_llvmo__APInt_O
  /* 132 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 133 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 134 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManager_O
  /* 135 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 136 */ , &&kind_name_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 137 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 138 */ , &&kind_name_KIND_LISPALLOC_llvmo__Type_O
  /* 139 */ , &&kind_name_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 140 */ , &&kind_name_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 141 */ , &&kind_name_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 142 */ , &&kind_name_KIND_LISPALLOC_llvmo__VectorType_O
  /* 143 */ , &&kind_name_KIND_LISPALLOC_llvmo__PointerType_O
  /* 144 */ , &&kind_name_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 145 */ , &&kind_name_KIND_LISPALLOC_llvmo__StructType_O
  /* 146 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 147 */ , &&kind_name_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 148 */ , &&kind_name_KIND_LISPALLOC_llvmo__Linker_O
  /* 149 */ , &&kind_name_KIND_LISPALLOC_llvmo__Pass_O
  /* 150 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 151 */ , &&kind_name_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 152 */ , &&kind_name_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 153 */ , &&kind_name_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 154 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 155 */ , &&kind_name_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 156 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 157 */ , &&kind_name_KIND_LISPALLOC_llvmo__Module_O
  /* 158 */ , &&kind_name_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 159 */ , &&kind_name_KIND_LISPALLOC_core__ForeignData_O
  /* 160 */ , &&kind_name_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 161 */ , &&kind_name_KIND_LISPALLOC_llvmo__Target_O
  /* 162 */ , &&kind_name_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 163 */ , &&kind_name_KIND_LISPALLOC_core__Binder_O
  /* 164 */ , &&kind_name_KIND_LISPALLOC_core__IntArray_O
  /* 165 */ , &&kind_name_KIND_LISPALLOC_core__SourceManager_O
  /* 166 */ , &&kind_name_KIND_LISPALLOC_core__Record_O
  /* 167 */ , &&kind_name_KIND_LISPALLOC_core__LightUserData_O
  /* 168 */ , &&kind_name_KIND_LISPALLOC_core__UserData_O
  /* 169 */ , &&kind_name_KIND_BOOTSTRAP_core__Symbol_O
  /* 170 */ , &&kind_name_KIND_LISPALLOC_core__Null_O
  /* 171 */ , &&kind_name_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 172 */ , &&kind_name_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 173 */ , &&kind_name_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 174 */ , &&kind_name_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 175 */ , &&kind_name_KIND_LISPALLOC_core__Regex_O
  /* 176 */ , &&kind_name_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 177 */ , &&kind_name_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 178 */ , &&kind_name_KIND_LISPALLOC_core__CandoException_O
  /* 179 */ , &&kind_name_KIND_LISPALLOC_core__Stream_O
  /* 180 */ , &&kind_name_KIND_LISPALLOC_core__AnsiStream_O
  /* 181 */ , &&kind_name_KIND_LISPALLOC_core__FileStream_O
  /* 182 */ , &&kind_name_KIND_LISPALLOC_core__IOStreamStream_O
  /* 183 */ , &&kind_name_KIND_LISPALLOC_core__IOFileStream_O
  /* 184 */ , &&kind_name_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 185 */ , &&kind_name_KIND_LISPALLOC_core__StringStream_O
  /* 186 */ , &&kind_name_KIND_LISPALLOC_core__StringInputStream_O
  /* 187 */ , &&kind_name_KIND_LISPALLOC_core__StringOutputStream_O
  /* 188 */ , &&kind_name_KIND_LISPALLOC_core__SynonymStream_O
  /* 189 */ , &&kind_name_KIND_LISPALLOC_core__EchoStream_O
  /* 190 */ , &&kind_name_KIND_LISPALLOC_core__TwoWayStream_O
  /* 191 */ , &&kind_name_KIND_LISPALLOC_core__BroadcastStream_O
  /* 192 */ , &&kind_name_KIND_LISPALLOC_core__Reader_O
  /* 193 */ , &&kind_name_KIND_LISPALLOC_core__Cons_O
  /* 194 */ , &&kind_name_KIND_LISPALLOC_core__Archive_O
  /* 195 */ , &&kind_name_KIND_LISPALLOC_core__SaveArchive_O
  /* 196 */ , &&kind_name_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 197 */ , &&kind_name_KIND_LISPALLOC_core__LoadArchive_O
  /* 198 */ , &&kind_name_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 199 */ , &&kind_name_KIND_LISPALLOC_core__HashTable_O
  /* 200 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEq_O
  /* 201 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 202 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEql_O
  /* 203 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEqual_O
  /* 204 */ , &&kind_name_KIND_LISPALLOC_cffi__Pointer_O
  /* 205 */ , &&kind_name_KIND_LISPALLOC_core__CxxObject_O
  /* 206 */ , &&kind_name_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 207 */ , &&kind_name_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 208 */ , &&kind_name_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 209 */ , &&kind_name_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 210 */ , &&kind_name_KIND_LISPALLOC_core__SNode_O
  /* 211 */ , &&kind_name_KIND_LISPALLOC_core__LeafSNode_O
  /* 212 */ , &&kind_name_KIND_LISPALLOC_core__BranchSNode_O
  /* 213 */ , &&kind_name_KIND_LISPALLOC_core__Path_O
  /* 214 */ , &&kind_name_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 215 */ , &&kind_name_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 216 */ , &&kind_name_KIND_LISPALLOC_core__StructureObject_O
  /* 217 */ , &&kind_name_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 218 */ , &&kind_name_KIND_LISPALLOC_core__Package_O
  /* 219 */ , &&kind_name_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 220 */ , &&kind_name_KIND_LISPALLOC_core__Character_dummy_O
  /* 221 */ , &&kind_name_KIND_LISPALLOC_core__Function_O
  /* 222 */ , &&kind_name_KIND_LISPALLOC_core__CompiledFunction_O
  /* 223 */ , &&kind_name_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 224 */ , &&kind_name_KIND_LISPALLOC_core__SpecialForm_O
  /* 225 */ , &&kind_name_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 226 */ , &&kind_name_KIND_LISPALLOC_core__Instance_O
  /* 227 */ , &&kind_name_KIND_LISPALLOC_core__Pointer_O
  /* 228 */ , &&kind_name_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 229 */ , &&kind_name_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 230 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 231 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIArray_O
  /* 232 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 233 */ , &&kind_name_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 234 */ , &&kind_name_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 235 */ , &&kind_name_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 236 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 237 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIType_O
  /* 238 */ , &&kind_name_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 239 */ , &&kind_name_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 240 */ , &&kind_name_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 241 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIFile_O
  /* 242 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIScope_O
  /* 243 */ , &&kind_name_KIND_LISPALLOC_core__SmallMultimap_O
  /* 244 */ , &&kind_name_KIND_LISPALLOC_core__Pathname_O
  /* 245 */ , &&kind_name_KIND_LISPALLOC_core__LogicalPathname_O
  /* 246 */ , &&kind_name_KIND_LISPALLOC_core__PosixTime_O
  /* 247 */ , &&kind_name_KIND_LISPALLOC_core__SmallMap_O
  /* 248 */ , &&kind_name_KIND_CLASSALLOC_core__Cache
  /* 249 */ , &&kind_name_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 250 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 251 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 252 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 253 */ , &&kind_name_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 254 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 255 */ , &&kind_name_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 256 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 257 */ , &&kind_name_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 258 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 260 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 261 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 262 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 263 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  ...
  /* 286 */ , &&kind_name_KIND_CLASSALLOC_core__CoreExposer
  /* 287 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 288 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 289 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 290 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 291 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 292 */ , &&kind_name_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 293 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 294 */ , &&kind_name_KIND_CLASSALLOC_core__InterpretedClosure
  /* 295 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 296 */ , &&kind_name_KIND_CLASSALLOC_core__VectorStepper
  /* 297 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
static void* OBJ_DUMP_MAP_table[] = { NULL 
  ...
  /* 55 */ , &&obj_dump_KIND_LISPALLOC_core__String_O
  /* 56 */ , &&obj_dump_KIND_BOOTSTRAP_core__Str_O
  /* 57 */ , &&obj_dump_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 58 */ , &&obj_dump_KIND_LISPALLOC_core__VectorObjects_O
  /* 59 */ , &&obj_dump_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 60 */ , &&obj_dump_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 61 */ , &&obj_dump_KIND_LISPALLOC_core__RandomState_O
  /* 62 */ , &&obj_dump_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 63 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 64 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Attribute_O
  /* 65 */ , &&obj_dump_KIND_LISPALLOC_core__RegexMatch_O
  /* 66 */ , &&obj_dump_KIND_LISPALLOC_core__WeakPointer_O
  /* 67 */ , &&obj_dump_KIND_LISPALLOC_core__VaList_dummy_O
  /* 68 */ , &&obj_dump_KIND_BOOTSTRAP_core__StandardObject_O
  /* 69 */ , &&obj_dump_KIND_BOOTSTRAP_core__Metaobject_O
  /* 70 */ , &&obj_dump_KIND_BOOTSTRAP_core__Specializer_O
  /* 71 */ , &&obj_dump_KIND_BOOTSTRAP_core__Class_O
  /* 72 */ , &&obj_dump_KIND_BOOTSTRAP_core__StdClass_O
  /* 73 */ , &&obj_dump_KIND_BOOTSTRAP_core__StandardClass_O
  /* 74 */ , &&obj_dump_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 75 */ , &&obj_dump_KIND_BOOTSTRAP_core__StructureClass_O
  /* 76 */ , &&obj_dump_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 77 */ , &&obj_dump_KIND_LISPALLOC_core__CxxClass_O
  /* 78 */ , &&obj_dump_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 79 */ , &&obj_dump_KIND_LISPALLOC_clbind__ClassRep_O
  /* 80 */ , &&obj_dump_KIND_LISPALLOC_core__ExternalObject_O
  /* 81 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Value_O
  /* 82 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Argument_O
  /* 83 */ , &&obj_dump_KIND_LISPALLOC_llvmo__User_O
  /* 84 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Instruction_O
  /* 85 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 86 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 87 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PHINode_O
  /* 88 */ , &&obj_dump_KIND_LISPALLOC_llvmo__CallInst_O
  /* 89 */ , &&obj_dump_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 90 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 91 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 92 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 93 */ , &&obj_dump_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 94 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 95 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 96 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 97 */ , &&obj_dump_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 98 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 99 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 100 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 101 */ , &&obj_dump_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 102 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 103 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 104 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Constant_O
  /* 105 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 106 */ , &&obj_dump_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 107 */ , &&obj_dump_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 108 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Function_O
  /* 109 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 110 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 111 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 112 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 113 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 114 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 115 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 116 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 117 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 118 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 119 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 120 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 121 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 122 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Metadata_O
  /* 123 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 124 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MDNode_O
  /* 125 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MDString_O
  /* 126 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 127 */ , &&obj_dump_KIND_LISPALLOC_llvmo__APFloat_O
  /* 128 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 129 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 130 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Triple_O
  /* 131 */ , &&obj_dump_KIND_LISPALLOC_llvmo__APInt_O
  /* 132 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 133 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 134 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManager_O
  /* 135 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 136 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 137 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 138 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Type_O
  /* 139 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 140 */ , &&obj_dump_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 141 */ , &&obj_dump_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 142 */ , &&obj_dump_KIND_LISPALLOC_llvmo__VectorType_O
  /* 143 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PointerType_O
  /* 144 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 145 */ , &&obj_dump_KIND_LISPALLOC_llvmo__StructType_O
  /* 146 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 147 */ , &&obj_dump_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 148 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Linker_O
  /* 149 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Pass_O
  /* 150 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 151 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 152 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 153 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 154 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 155 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 156 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 157 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Module_O
  /* 158 */ , &&obj_dump_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 159 */ , &&obj_dump_KIND_LISPALLOC_core__ForeignData_O
  /* 160 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 161 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Target_O
  /* 162 */ , &&obj_dump_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 163 */ , &&obj_dump_KIND_LISPALLOC_core__Binder_O
  /* 164 */ , &&obj_dump_KIND_LISPALLOC_core__IntArray_O
  /* 165 */ , &&obj_dump_KIND_LISPALLOC_core__SourceManager_O
  /* 166 */ , &&obj_dump_KIND_LISPALLOC_core__Record_O
  /* 167 */ , &&obj_dump_KIND_LISPALLOC_core__LightUserData_O
  /* 168 */ , &&obj_dump_KIND_LISPALLOC_core__UserData_O
  /* 169 */ , &&obj_dump_KIND_BOOTSTRAP_core__Symbol_O
  /* 170 */ , &&obj_dump_KIND_LISPALLOC_core__Null_O
  /* 171 */ , &&obj_dump_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 172 */ , &&obj_dump_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 173 */ , &&obj_dump_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 174 */ , &&obj_dump_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 175 */ , &&obj_dump_KIND_LISPALLOC_core__Regex_O
  /* 176 */ , &&obj_dump_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 177 */ , &&obj_dump_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 178 */ , &&obj_dump_KIND_LISPALLOC_core__CandoException_O
  /* 179 */ , &&obj_dump_KIND_LISPALLOC_core__Stream_O
  /* 180 */ , &&obj_dump_KIND_LISPALLOC_core__AnsiStream_O
  /* 181 */ , &&obj_dump_KIND_LISPALLOC_core__FileStream_O
  /* 182 */ , &&obj_dump_KIND_LISPALLOC_core__IOStreamStream_O
  /* 183 */ , &&obj_dump_KIND_LISPALLOC_core__IOFileStream_O
  /* 184 */ , &&obj_dump_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 185 */ , &&obj_dump_KIND_LISPALLOC_core__StringStream_O
  /* 186 */ , &&obj_dump_KIND_LISPALLOC_core__StringInputStream_O
  /* 187 */ , &&obj_dump_KIND_LISPALLOC_core__StringOutputStream_O
  /* 188 */ , &&obj_dump_KIND_LISPALLOC_core__SynonymStream_O
  /* 189 */ , &&obj_dump_KIND_LISPALLOC_core__EchoStream_O
  /* 190 */ , &&obj_dump_KIND_LISPALLOC_core__TwoWayStream_O
  /* 191 */ , &&obj_dump_KIND_LISPALLOC_core__BroadcastStream_O
  /* 192 */ , &&obj_dump_KIND_LISPALLOC_core__Reader_O
  /* 193 */ , &&obj_dump_KIND_LISPALLOC_core__Cons_O
  /* 194 */ , &&obj_dump_KIND_LISPALLOC_core__Archive_O
  /* 195 */ , &&obj_dump_KIND_LISPALLOC_core__SaveArchive_O
  /* 196 */ , &&obj_dump_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 197 */ , &&obj_dump_KIND_LISPALLOC_core__LoadArchive_O
  /* 198 */ , &&obj_dump_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 199 */ , &&obj_dump_KIND_LISPALLOC_core__HashTable_O
  /* 200 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEq_O
  /* 201 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 202 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEql_O
  /* 203 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEqual_O
  /* 204 */ , &&obj_dump_KIND_LISPALLOC_cffi__Pointer_O
  /* 205 */ , &&obj_dump_KIND_LISPALLOC_core__CxxObject_O
  /* 206 */ , &&obj_dump_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 207 */ , &&obj_dump_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 208 */ , &&obj_dump_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 209 */ , &&obj_dump_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 210 */ , &&obj_dump_KIND_LISPALLOC_core__SNode_O
  /* 211 */ , &&obj_dump_KIND_LISPALLOC_core__LeafSNode_O
  /* 212 */ , &&obj_dump_KIND_LISPALLOC_core__BranchSNode_O
  /* 213 */ , &&obj_dump_KIND_LISPALLOC_core__Path_O
  /* 214 */ , &&obj_dump_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 215 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 216 */ , &&obj_dump_KIND_LISPALLOC_core__StructureObject_O
  /* 217 */ , &&obj_dump_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 218 */ , &&obj_dump_KIND_LISPALLOC_core__Package_O
  /* 219 */ , &&obj_dump_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 220 */ , &&obj_dump_KIND_LISPALLOC_core__Character_dummy_O
  /* 221 */ , &&obj_dump_KIND_LISPALLOC_core__Function_O
  /* 222 */ , &&obj_dump_KIND_LISPALLOC_core__CompiledFunction_O
  /* 223 */ , &&obj_dump_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 224 */ , &&obj_dump_KIND_LISPALLOC_core__SpecialForm_O
  /* 225 */ , &&obj_dump_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 226 */ , &&obj_dump_KIND_LISPALLOC_core__Instance_O
  /* 227 */ , &&obj_dump_KIND_LISPALLOC_core__Pointer_O
  /* 228 */ , &&obj_dump_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 229 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 230 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 231 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIArray_O
  /* 232 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 233 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 234 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 235 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 236 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 237 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIType_O
  /* 238 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 239 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 240 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 241 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIFile_O
  /* 242 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIScope_O
  /* 243 */ , &&obj_dump_KIND_LISPALLOC_core__SmallMultimap_O
  /* 244 */ , &&obj_dump_KIND_LISPALLOC_core__Pathname_O
  /* 245 */ , &&obj_dump_KIND_LISPALLOC_core__LogicalPathname_O
  /* 246 */ , &&obj_dump_KIND_LISPALLOC_core__PosixTime_O
  /* 247 */ , &&obj_dump_KIND_LISPALLOC_core__SmallMap_O
  /* 248 */ , &&obj_dump_KIND_CLASSALLOC_core__Cache
  /* 249 */ , &&obj_dump_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 250 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 251 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 252 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 253 */ , &&obj_dump_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 254 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 255 */ , &&obj_dump_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 256 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 257 */ , &&obj_dump_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 258 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 260 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 261 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 262 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 263 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  ...
  /* 286 */ , &&obj_dump_KIND_CLASSALLOC_core__CoreExposer
  /* 287 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 288 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 289 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 290 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 291 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 292 */ , &&obj_dump_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 293 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 294 */ , &&obj_dump_KIND_CLASSALLOC_core__InterpretedClosure
  /* 295 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 296 */ , &&obj_dump_KIND_CLASSALLOC_core__VectorStepper
  /* 297 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
static void* OBJ_SKIP_table[] = { NULL 
  ...
  /* 55 */ , &&obj_skip_KIND_LISPALLOC_core__String_O
  /* 56 */ , &&obj_skip_KIND_BOOTSTRAP_core__Str_O
  /* 57 */ , &&obj_skip_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 58 */ , &&obj_skip_KIND_LISPALLOC_core__VectorObjects_O
  /* 59 */ , &&obj_skip_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 60 */ , &&obj_skip_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 61 */ , &&obj_skip_KIND_LISPALLOC_core__RandomState_O
  /* 62 */ , &&obj_skip_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 63 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 64 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Attribute_O
  /* 65 */ , &&obj_skip_KIND_LISPALLOC_core__RegexMatch_O
  /* 66 */ , &&obj_skip_KIND_LISPALLOC_core__WeakPointer_O
  /* 67 */ , &&obj_skip_KIND_LISPALLOC_core__VaList_dummy_O
  /* 68 */ , &&obj_skip_KIND_BOOTSTRAP_core__StandardObject_O
  /* 69 */ , &&obj_skip_KIND_BOOTSTRAP_core__Metaobject_O
  /* 70 */ , &&obj_skip_KIND_BOOTSTRAP_core__Specializer_O
  /* 71 */ , &&obj_skip_KIND_BOOTSTRAP_core__Class_O
  /* 72 */ , &&obj_skip_KIND_BOOTSTRAP_core__StdClass_O
  /* 73 */ , &&obj_skip_KIND_BOOTSTRAP_core__StandardClass_O
  /* 74 */ , &&obj_skip_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 75 */ , &&obj_skip_KIND_BOOTSTRAP_core__StructureClass_O
  /* 76 */ , &&obj_skip_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 77 */ , &&obj_skip_KIND_LISPALLOC_core__CxxClass_O
  /* 78 */ , &&obj_skip_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 79 */ , &&obj_skip_KIND_LISPALLOC_clbind__ClassRep_O
  /* 80 */ , &&obj_skip_KIND_LISPALLOC_core__ExternalObject_O
  /* 81 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Value_O
  /* 82 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Argument_O
  /* 83 */ , &&obj_skip_KIND_LISPALLOC_llvmo__User_O
  /* 84 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Instruction_O
  /* 85 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 86 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 87 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PHINode_O
  /* 88 */ , &&obj_skip_KIND_LISPALLOC_llvmo__CallInst_O
  /* 89 */ , &&obj_skip_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 90 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 91 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 92 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 93 */ , &&obj_skip_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 94 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 95 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 96 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 97 */ , &&obj_skip_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 98 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 99 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 100 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 101 */ , &&obj_skip_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 102 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 103 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 104 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Constant_O
  /* 105 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 106 */ , &&obj_skip_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 107 */ , &&obj_skip_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 108 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Function_O
  /* 109 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 110 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 111 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 112 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 113 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 114 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 115 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 116 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 117 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 118 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 119 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 120 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 121 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 122 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Metadata_O
  /* 123 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 124 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MDNode_O
  /* 125 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MDString_O
  /* 126 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 127 */ , &&obj_skip_KIND_LISPALLOC_llvmo__APFloat_O
  /* 128 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 129 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 130 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Triple_O
  /* 131 */ , &&obj_skip_KIND_LISPALLOC_llvmo__APInt_O
  /* 132 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 133 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 134 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManager_O
  /* 135 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 136 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 137 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 138 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Type_O
  /* 139 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 140 */ , &&obj_skip_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 141 */ , &&obj_skip_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 142 */ , &&obj_skip_KIND_LISPALLOC_llvmo__VectorType_O
  /* 143 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PointerType_O
  /* 144 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 145 */ , &&obj_skip_KIND_LISPALLOC_llvmo__StructType_O
  /* 146 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 147 */ , &&obj_skip_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 148 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Linker_O
  /* 149 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Pass_O
  /* 150 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 151 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 152 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 153 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 154 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 155 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 156 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 157 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Module_O
  /* 158 */ , &&obj_skip_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 159 */ , &&obj_skip_KIND_LISPALLOC_core__ForeignData_O
  /* 160 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 161 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Target_O
  /* 162 */ , &&obj_skip_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 163 */ , &&obj_skip_KIND_LISPALLOC_core__Binder_O
  /* 164 */ , &&obj_skip_KIND_LISPALLOC_core__IntArray_O
  /* 165 */ , &&obj_skip_KIND_LISPALLOC_core__SourceManager_O
  /* 166 */ , &&obj_skip_KIND_LISPALLOC_core__Record_O
  /* 167 */ , &&obj_skip_KIND_LISPALLOC_core__LightUserData_O
  /* 168 */ , &&obj_skip_KIND_LISPALLOC_core__UserData_O
  /* 169 */ , &&obj_skip_KIND_BOOTSTRAP_core__Symbol_O
  /* 170 */ , &&obj_skip_KIND_LISPALLOC_core__Null_O
  /* 171 */ , &&obj_skip_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 172 */ , &&obj_skip_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 173 */ , &&obj_skip_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 174 */ , &&obj_skip_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 175 */ , &&obj_skip_KIND_LISPALLOC_core__Regex_O
  /* 176 */ , &&obj_skip_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 177 */ , &&obj_skip_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 178 */ , &&obj_skip_KIND_LISPALLOC_core__CandoException_O
  /* 179 */ , &&obj_skip_KIND_LISPALLOC_core__Stream_O
  /* 180 */ , &&obj_skip_KIND_LISPALLOC_core__AnsiStream_O
  /* 181 */ , &&obj_skip_KIND_LISPALLOC_core__FileStream_O
  /* 182 */ , &&obj_skip_KIND_LISPALLOC_core__IOStreamStream_O
  /* 183 */ , &&obj_skip_KIND_LISPALLOC_core__IOFileStream_O
  /* 184 */ , &&obj_skip_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 185 */ , &&obj_skip_KIND_LISPALLOC_core__StringStream_O
  /* 186 */ , &&obj_skip_KIND_LISPALLOC_core__StringInputStream_O
  /* 187 */ , &&obj_skip_KIND_LISPALLOC_core__StringOutputStream_O
  /* 188 */ , &&obj_skip_KIND_LISPALLOC_core__SynonymStream_O
  /* 189 */ , &&obj_skip_KIND_LISPALLOC_core__EchoStream_O
  /* 190 */ , &&obj_skip_KIND_LISPALLOC_core__TwoWayStream_O
  /* 191 */ , &&obj_skip_KIND_LISPALLOC_core__BroadcastStream_O
  /* 192 */ , &&obj_skip_KIND_LISPALLOC_core__Reader_O
  /* 193 */ , &&obj_skip_KIND_LISPALLOC_core__Cons_O
  /* 194 */ , &&obj_skip_KIND_LISPALLOC_core__Archive_O
  /* 195 */ , &&obj_skip_KIND_LISPALLOC_core__SaveArchive_O
  /* 196 */ , &&obj_skip_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 197 */ , &&obj_skip_KIND_LISPALLOC_core__LoadArchive_O
  /* 198 */ , &&obj_skip_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 199 */ , &&obj_skip_KIND_LISPALLOC_core__HashTable_O
  /* 200 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEq_O
  /* 201 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 202 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEql_O
  /* 203 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEqual_O
  /* 204 */ , &&obj_skip_KIND_LISPALLOC_cffi__Pointer_O
  /* 205 */ , &&obj_skip_KIND_LISPALLOC_core__CxxObject_O
  /* 206 */ , &&obj_skip_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 207 */ , &&obj_skip_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 208 */ , &&obj_skip_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 209 */ , &&obj_skip_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 210 */ , &&obj_skip_KIND_LISPALLOC_core__SNode_O
  /* 211 */ , &&obj_skip_KIND_LISPALLOC_core__LeafSNode_O
  /* 212 */ , &&obj_skip_KIND_LISPALLOC_core__BranchSNode_O
  /* 213 */ , &&obj_skip_KIND_LISPALLOC_core__Path_O
  /* 214 */ , &&obj_skip_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 215 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 216 */ , &&obj_skip_KIND_LISPALLOC_core__StructureObject_O
  /* 217 */ , &&obj_skip_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 218 */ , &&obj_skip_KIND_LISPALLOC_core__Package_O
  /* 219 */ , &&obj_skip_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 220 */ , &&obj_skip_KIND_LISPALLOC_core__Character_dummy_O
  /* 221 */ , &&obj_skip_KIND_LISPALLOC_core__Function_O
  /* 222 */ , &&obj_skip_KIND_LISPALLOC_core__CompiledFunction_O
  /* 223 */ , &&obj_skip_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 224 */ , &&obj_skip_KIND_LISPALLOC_core__SpecialForm_O
  /* 225 */ , &&obj_skip_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 226 */ , &&obj_skip_KIND_LISPALLOC_core__Instance_O
  /* 227 */ , &&obj_skip_KIND_LISPALLOC_core__Pointer_O
  /* 228 */ , &&obj_skip_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 229 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 230 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 231 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIArray_O
  /* 232 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 233 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 234 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 235 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 236 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 237 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIType_O
  /* 238 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 239 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 240 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 241 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIFile_O
  /* 242 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIScope_O
  /* 243 */ , &&obj_skip_KIND_LISPALLOC_core__SmallMultimap_O
  /* 244 */ , &&obj_skip_KIND_LISPALLOC_core__Pathname_O
  /* 245 */ , &&obj_skip_KIND_LISPALLOC_core__LogicalPathname_O
  /* 246 */ , &&obj_skip_KIND_LISPALLOC_core__PosixTime_O
  /* 247 */ , &&obj_skip_KIND_LISPALLOC_core__SmallMap_O
  /* 248 */ , &&obj_skip_KIND_CLASSALLOC_core__Cache
  /* 249 */ , &&obj_skip_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 250 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 251 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 252 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 253 */ , &&obj_skip_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 254 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 255 */ , &&obj_skip_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 256 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 257 */ , &&obj_skip_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 258 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 260 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 261 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 262 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 263 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  ...
  /* 286 */ , &&obj_skip_KIND_CLASSALLOC_core__CoreExposer
  /* 287 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 288 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 289 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 290 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 291 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 292 */ , &&obj_skip_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 293 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 294 */ , &&obj_skip_KIND_CLASSALLOC_core__InterpretedClosure
  /* 295 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 296 */ , &&obj_skip_KIND_CLASSALLOC_core__VectorStepper
  /* 297 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
template <>
 mps_res_t obj_scan_helper<core::BitVectorWithFillPtr_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::BitVectorWithFillPtr_O type_KIND_LISPALLOC_core__BitVectorWithFillPtr_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__BitVectorWithFillPtr_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
static void* OBJ_SCAN_table[] = { NULL 
  ...
  /* 55 */ , &&obj_scan_KIND_LISPALLOC_core__String_O
  /* 56 */ , &&obj_scan_KIND_BOOTSTRAP_core__Str_O
  /* 57 */ , &&obj_scan_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 58 */ , &&obj_scan_KIND_LISPALLOC_core__VectorObjects_O
  /* 59 */ , &&obj_scan_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 60 */ , &&obj_scan_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 61 */ , &&obj_scan_KIND_LISPALLOC_core__RandomState_O
  /* 62 */ , &&obj_scan_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 63 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 64 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Attribute_O
  /* 65 */ , &&obj_scan_KIND_LISPALLOC_core__RegexMatch_O
  /* 66 */ , &&obj_scan_KIND_LISPALLOC_core__WeakPointer_O
  /* 67 */ , &&obj_scan_KIND_LISPALLOC_core__VaList_dummy_O
  /* 68 */ , &&obj_scan_KIND_BOOTSTRAP_core__StandardObject_O
  /* 69 */ , &&obj_scan_KIND_BOOTSTRAP_core__Metaobject_O
  /* 70 */ , &&obj_scan_KIND_BOOTSTRAP_core__Specializer_O
  /* 71 */ , &&obj_scan_KIND_BOOTSTRAP_core__Class_O
  /* 72 */ , &&obj_scan_KIND_BOOTSTRAP_core__StdClass_O
  /* 73 */ , &&obj_scan_KIND_BOOTSTRAP_core__StandardClass_O
  /* 74 */ , &&obj_scan_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 75 */ , &&obj_scan_KIND_BOOTSTRAP_core__StructureClass_O
  /* 76 */ , &&obj_scan_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 77 */ , &&obj_scan_KIND_LISPALLOC_core__CxxClass_O
  /* 78 */ , &&obj_scan_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 79 */ , &&obj_scan_KIND_LISPALLOC_clbind__ClassRep_O
  /* 80 */ , &&obj_scan_KIND_LISPALLOC_core__ExternalObject_O
  /* 81 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Value_O
  /* 82 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Argument_O
  /* 83 */ , &&obj_scan_KIND_LISPALLOC_llvmo__User_O
  /* 84 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Instruction_O
  /* 85 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 86 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 87 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PHINode_O
  /* 88 */ , &&obj_scan_KIND_LISPALLOC_llvmo__CallInst_O
  /* 89 */ , &&obj_scan_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 90 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 91 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 92 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 93 */ , &&obj_scan_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 94 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 95 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 96 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 97 */ , &&obj_scan_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 98 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 99 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 100 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 101 */ , &&obj_scan_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 102 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 103 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 104 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Constant_O
  /* 105 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 106 */ , &&obj_scan_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 107 */ , &&obj_scan_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 108 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Function_O
  /* 109 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 110 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 111 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 112 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 113 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 114 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 115 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 116 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 117 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 118 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 119 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 120 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 121 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 122 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Metadata_O
  /* 123 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 124 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MDNode_O
  /* 125 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MDString_O
  /* 126 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 127 */ , &&obj_scan_KIND_LISPALLOC_llvmo__APFloat_O
  /* 128 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 129 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 130 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Triple_O
  /* 131 */ , &&obj_scan_KIND_LISPALLOC_llvmo__APInt_O
  /* 132 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 133 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 134 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManager_O
  /* 135 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 136 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 137 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 138 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Type_O
  /* 139 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 140 */ , &&obj_scan_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 141 */ , &&obj_scan_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 142 */ , &&obj_scan_KIND_LISPALLOC_llvmo__VectorType_O
  /* 143 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PointerType_O
  /* 144 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 145 */ , &&obj_scan_KIND_LISPALLOC_llvmo__StructType_O
  /* 146 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 147 */ , &&obj_scan_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 148 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Linker_O
  /* 149 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Pass_O
  /* 150 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 151 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 152 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 153 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 154 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 155 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 156 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 157 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Module_O
  /* 158 */ , &&obj_scan_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 159 */ , &&obj_scan_KIND_LISPALLOC_core__ForeignData_O
  /* 160 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 161 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Target_O
  /* 162 */ , &&obj_scan_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 163 */ , &&obj_scan_KIND_LISPALLOC_core__Binder_O
  /* 164 */ , &&obj_scan_KIND_LISPALLOC_core__IntArray_O
  /* 165 */ , &&obj_scan_KIND_LISPALLOC_core__SourceManager_O
  /* 166 */ , &&obj_scan_KIND_LISPALLOC_core__Record_O
  /* 167 */ , &&obj_scan_KIND_LISPALLOC_core__LightUserData_O
  /* 168 */ , &&obj_scan_KIND_LISPALLOC_core__UserData_O
  /* 169 */ , &&obj_scan_KIND_BOOTSTRAP_core__Symbol_O
  /* 170 */ , &&obj_scan_KIND_LISPALLOC_core__Null_O
  /* 171 */ , &&obj_scan_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 172 */ , &&obj_scan_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 173 */ , &&obj_scan_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 174 */ , &&obj_scan_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 175 */ , &&obj_scan_KIND_LISPALLOC_core__Regex_O
  /* 176 */ , &&obj_scan_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 177 */ , &&obj_scan_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 178 */ , &&obj_scan_KIND_LISPALLOC_core__CandoException_O
  /* 179 */ , &&obj_scan_KIND_LISPALLOC_core__Stream_O
  /* 180 */ , &&obj_scan_KIND_LISPALLOC_core__AnsiStream_O
  /* 181 */ , &&obj_scan_KIND_LISPALLOC_core__FileStream_O
  /* 182 */ , &&obj_scan_KIND_LISPALLOC_core__IOStreamStream_O
  /* 183 */ , &&obj_scan_KIND_LISPALLOC_core__IOFileStream_O
  /* 184 */ , &&obj_scan_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 185 */ , &&obj_scan_KIND_LISPALLOC_core__StringStream_O
  /* 186 */ , &&obj_scan_KIND_LISPALLOC_core__StringInputStream_O
  /* 187 */ , &&obj_scan_KIND_LISPALLOC_core__StringOutputStream_O
  /* 188 */ , &&obj_scan_KIND_LISPALLOC_core__SynonymStream_O
  /* 189 */ , &&obj_scan_KIND_LISPALLOC_core__EchoStream_O
  /* 190 */ , &&obj_scan_KIND_LISPALLOC_core__TwoWayStream_O
  /* 191 */ , &&obj_scan_KIND_LISPALLOC_core__BroadcastStream_O
  /* 192 */ , &&obj_scan_KIND_LISPALLOC_core__Reader_O
  /* 193 */ , &&obj_scan_KIND_LISPALLOC_core__Cons_O
  /* 194 */ , &&obj_scan_KIND_LISPALLOC_core__Archive_O
  /* 195 */ , &&obj_scan_KIND_LISPALLOC_core__SaveArchive_O
  /* 196 */ , &&obj_scan_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 197 */ , &&obj_scan_KIND_LISPALLOC_core__LoadArchive_O
  /* 198 */ , &&obj_scan_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 199 */ , &&obj_scan_KIND_LISPALLOC_core__HashTable_O
  /* 200 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEq_O
  /* 201 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 202 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEql_O
  /* 203 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEqual_O
  /* 204 */ , &&obj_scan_KIND_LISPALLOC_cffi__Pointer_O
  /* 205 */ , &&obj_scan_KIND_LISPALLOC_core__CxxObject_O
  /* 206 */ , &&obj_scan_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 207 */ , &&obj_scan_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 208 */ , &&obj_scan_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 209 */ , &&obj_scan_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 210 */ , &&obj_scan_KIND_LISPALLOC_core__SNode_O
  /* 211 */ , &&obj_scan_KIND_LISPALLOC_core__LeafSNode_O
  /* 212 */ , &&obj_scan_KIND_LISPALLOC_core__BranchSNode_O
  /* 213 */ , &&obj_scan_KIND_LISPALLOC_core__Path_O
  /* 214 */ , &&obj_scan_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 215 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 216 */ , &&obj_scan_KIND_LISPALLOC_core__StructureObject_O
  /* 217 */ , &&obj_scan_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 218 */ , &&obj_scan_KIND_LISPALLOC_core__Package_O
  /* 219 */ , &&obj_scan_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 220 */ , &&obj_scan_KIND_LISPALLOC_core__Character_dummy_O
  /* 221 */ , &&obj_scan_KIND_LISPALLOC_core__Function_O
  /* 222 */ , &&obj_scan_KIND_LISPALLOC_core__CompiledFunction_O
  /* 223 */ , &&obj_scan_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 224 */ , &&obj_scan_KIND_LISPALLOC_core__SpecialForm_O
  /* 225 */ , &&obj_scan_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 226 */ , &&obj_scan_KIND_LISPALLOC_core__Instance_O
  /* 227 */ , &&obj_scan_KIND_LISPALLOC_core__Pointer_O
  /* 228 */ , &&obj_scan_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 229 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 230 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 231 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIArray_O
  /* 232 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 233 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 234 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 235 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 236 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 237 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIType_O
  /* 238 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 239 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 240 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 241 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIFile_O
  /* 242 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIScope_O
  /* 243 */ , &&obj_scan_KIND_LISPALLOC_core__SmallMultimap_O
  /* 244 */ , &&obj_scan_KIND_LISPALLOC_core__Pathname_O
  /* 245 */ , &&obj_scan_KIND_LISPALLOC_core__LogicalPathname_O
  /* 246 */ , &&obj_scan_KIND_LISPALLOC_core__PosixTime_O
  /* 247 */ , &&obj_scan_KIND_LISPALLOC_core__SmallMap_O
  /* 248 */ , &&obj_scan_KIND_CLASSALLOC_core__Cache
  /* 249 */ , &&obj_scan_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 250 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 251 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 252 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 253 */ , &&obj_scan_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 254 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 255 */ , &&obj_scan_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 256 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 257 */ , &&obj_scan_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 258 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 260 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 261 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 262 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 263 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  ...
  /* 286 */ , &&obj_scan_KIND_CLASSALLOC_core__CoreExposer
  /* 287 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 288 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 289 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 290 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 291 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 292 */ , &&obj_scan_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 293 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 294 */ , &&obj_scan_KIND_CLASSALLOC_core__InterpretedClosure
  /* 295 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 296 */ , &&obj_scan_KIND_CLASSALLOC_core__VectorStepper
  /* 297 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
static void* OBJ_FINALIZE_table[] = { NULL 
  ...
  /* 63 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 64 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Attribute_O
  /* 65 */ , &&obj_finalize_KIND_LISPALLOC_core__RegexMatch_O
  /* 66 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakPointer_O
  /* 67 */ , &&obj_finalize_KIND_LISPALLOC_core__VaList_dummy_O
  ...
  /* 167 */ , &&obj_finalize_KIND_LISPALLOC_core__LightUserData_O
  /* 168 */ , &&obj_finalize_KIND_LISPALLOC_core__UserData_O
  /* 169 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Symbol_O
  /* 170 */ , &&obj_finalize_KIND_LISPALLOC_core__Null_O
  /* 171 */ , &&obj_finalize_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 172 */ , &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 173 */ , &&obj_finalize_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 174 */ , &&obj_finalize_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 175 */ , &&obj_finalize_KIND_LISPALLOC_core__Regex_O
  /* 176 */ , &&obj_finalize_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 177 */ , &&obj_finalize_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 178 */ , &&obj_finalize_KIND_LISPALLOC_core__CandoException_O
  /* 179 */ , &&obj_finalize_KIND_LISPALLOC_core__Stream_O
  /* 180 */ , &&obj_finalize_KIND_LISPALLOC_core__AnsiStream_O
  /* 181 */ , &&obj_finalize_KIND_LISPALLOC_core__FileStream_O
  /* 182 */ , &&obj_finalize_KIND_LISPALLOC_core__IOStreamStream_O
  /* 183 */ , &&obj_finalize_KIND_LISPALLOC_core__IOFileStream_O
  /* 184 */ , &&obj_finalize_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 185 */ , &&obj_finalize_KIND_LISPALLOC_core__StringStream_O
  /* 186 */ , &&obj_finalize_KIND_LISPALLOC_core__StringInputStream_O
  /* 187 */ , &&obj_finalize_KIND_LISPALLOC_core__StringOutputStream_O
  /* 188 */ , &&obj_finalize_KIND_LISPALLOC_core__SynonymStream_O
  /* 189 */ , &&obj_finalize_KIND_LISPALLOC_core__EchoStream_O
  /* 190 */ , &&obj_finalize_KIND_LISPALLOC_core__TwoWayStream_O
  /* 191 */ , &&obj_finalize_KIND_LISPALLOC_core__BroadcastStream_O
  /* 192 */ , &&obj_finalize_KIND_LISPALLOC_core__Reader_O
  /* 193 */ , &&obj_finalize_KIND_LISPALLOC_core__Cons_O
  /* 194 */ , &&obj_finalize_KIND_LISPALLOC_core__Archive_O
  /* 195 */ , &&obj_finalize_KIND_LISPALLOC_core__SaveArchive_O
  /* 196 */ , &&obj_finalize_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 197 */ , &&obj_finalize_KIND_LISPALLOC_core__LoadArchive_O
  /* 198 */ , &&obj_finalize_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 199 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTable_O
  /* 200 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEq_O
  /* 201 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 202 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEql_O
  /* 203 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEqual_O
  /* 204 */ , &&obj_finalize_KIND_LISPALLOC_cffi__Pointer_O
  /* 205 */ , &&obj_finalize_KIND_LISPALLOC_core__CxxObject_O
  /* 206 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 207 */ , &&obj_finalize_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 208 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 209 */ , &&obj_finalize_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 210 */ , &&obj_finalize_KIND_LISPALLOC_core__SNode_O
  /* 211 */ , &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O
  /* 212 */ , &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O
  /* 213 */ , &&obj_finalize_KIND_LISPALLOC_core__Path_O
  /* 214 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 215 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 216 */ , &&obj_finalize_KIND_LISPALLOC_core__StructureObject_O
  /* 217 */ , &&obj_finalize_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 218 */ , &&obj_finalize_KIND_LISPALLOC_core__Package_O
  /* 219 */ , &&obj_finalize_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 220 */ , &&obj_finalize_KIND_LISPALLOC_core__Character_dummy_O
  /* 221 */ , &&obj_finalize_KIND_LISPALLOC_core__Function_O
  /* 222 */ , &&obj_finalize_KIND_LISPALLOC_core__CompiledFunction_O
  /* 223 */ , &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 224 */ , &&obj_finalize_KIND_LISPALLOC_core__SpecialForm_O
  /* 225 */ , &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 226 */ , &&obj_finalize_KIND_LISPALLOC_core__Instance_O
  /* 227 */ , &&obj_finalize_KIND_LISPALLOC_core__Pointer_O
  /* 228 */ , &&obj_finalize_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 229 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 230 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 231 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIArray_O
  /* 232 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 233 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 234 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 235 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 236 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 237 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIType_O
  /* 238 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 239 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 240 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 241 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIFile_O
  /* 242 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIScope_O
  /* 243 */ , &&obj_finalize_KIND_LISPALLOC_core__SmallMultimap_O
  /* 244 */ , &&obj_finalize_KIND_LISPALLOC_core__Pathname_O
  /* 245 */ , &&obj_finalize_KIND_LISPALLOC_core__LogicalPathname_O
  /* 246 */ , &&obj_finalize_KIND_LISPALLOC_core__PosixTime_O
  /* 247 */ , &&obj_finalize_KIND_LISPALLOC_core__SmallMap_O
  /* 248 */ , &&obj_finalize_KIND_CLASSALLOC_core__Cache
  /* 249 */ , &&obj_finalize_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 250 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 251 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 252 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 253 */ , &&obj_finalize_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 254 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 255 */ , &&obj_finalize_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 256 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 257 */ , &&obj_finalize_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 258 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 259 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 260 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 261 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 262 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 263 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  ...
  /* 286 */ , &&obj_finalize_KIND_CLASSALLOC_core__CoreExposer
  /* 287 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 288 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 289 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 290 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 291 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 292 */ , &&obj_finalize_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 293 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 294 */ , &&obj_finalize_KIND_CLASSALLOC_core__InterpretedClosure
  /* 295 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 296 */ , &&obj_finalize_KIND_CLASSALLOC_core__VectorStepper
  /* 297 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
