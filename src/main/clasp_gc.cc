...
#if defined(GC_ENUM)
KIND_null = 0, 
KIND_ABSTRACT_clang__FrontendAction = 6,
KIND_ABSTRACT_clang__ASTFrontendAction = 7,
KIND_ABSTRACT_clang__SyntaxOnlyAction = 10,
KIND_ROOTCLASSALLOC_clbind__detail__class_map = 13,
KIND_BOOTSTRAP_core__T_O = 14,
KIND_LISPALLOC_core__VaList_dummy_O = 15,
KIND_LISPALLOC_core__Cons_O = 16,
KIND_LISPALLOC_core__General_O = 17,
KIND_LISPALLOC_core__MultiStringBuffer_O = 18,
KIND_LISPALLOC_core__ReadTable_O = 19,
KIND_LISPALLOC_core__Number_O = 20,
KIND_LISPALLOC_core__Complex_O = 21,
KIND_LISPALLOC_core__Real_O = 22,
KIND_LISPALLOC_core__Rational_O = 23,
KIND_LISPALLOC_core__Integer_O = 24,
KIND_LISPALLOC_core__Bignum_O = 25,
KIND_LISPALLOC_core__Fixnum_dummy_O = 26,
KIND_LISPALLOC_core__Ratio_O = 27,
KIND_LISPALLOC_core__Float_O = 28,
KIND_LISPALLOC_core__DoubleFloat_O = 29,
KIND_LISPALLOC_core__LongFloat_O = 30,
KIND_LISPALLOC_core__SingleFloat_dummy_O = 31,
KIND_LISPALLOC_core__ShortFloat_O = 32,
KIND_LISPALLOC_core__FileStatus_O = 33,
KIND_LISPALLOC_core__WeakHashTable_O = 34,
KIND_LISPALLOC_core__WeakKeyHashTable_O = 35,
KIND_LISPALLOC_core__Environment_O = 36,
KIND_LISPALLOC_core__ActivationFrame_O = 37,
KIND_LISPALLOC_core__TagbodyFrame_O = 38,
KIND_LISPALLOC_core__ValueFrame_O = 39,
KIND_LISPALLOC_core__FunctionFrame_O = 40,
KIND_LISPALLOC_core__LexicalEnvironment_O = 41,
KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O = 42,
KIND_LISPALLOC_core__FunctionValueEnvironment_O = 43,
KIND_LISPALLOC_core__ValueEnvironment_O = 44,
KIND_LISPALLOC_core__TagbodyEnvironment_O = 45,
KIND_LISPALLOC_core__CompileTimeEnvironment_O = 46,
KIND_LISPALLOC_core__UnwindProtectEnvironment_O = 47,
KIND_LISPALLOC_core__SymbolMacroletEnvironment_O = 48,
KIND_LISPALLOC_core__FunctionContainerEnvironment_O = 49,
KIND_LISPALLOC_core__StackValueEnvironment_O = 50,
KIND_LISPALLOC_core__BlockEnvironment_O = 51,
KIND_LISPALLOC_core__MacroletEnvironment_O = 52,
KIND_LISPALLOC_core__CatchEnvironment_O = 53,
KIND_LISPALLOC_core__GlueEnvironment_O = 54,
KIND_LISPALLOC_core__Array_O = 55,
KIND_LISPALLOC_core__AbstractSimpleVector_O = 56,
KIND_ABSTRACT_core__template_SimpleVector_core__SimpleVector_O_gctools__smart_ptr_core__T_O__core__AbstractSimpleVector_O_ = 57,
KIND_LISPALLOC_core__SimpleVector_O = 58,
KIND_LISPALLOC_core__SimpleBitVector_O = 59,
KIND_LISPALLOC_core__SimpleString_O = 60,
KIND_ABSTRACT_core__template_SimpleVector_core__SimpleCharacterString_O_int_core__SimpleString_O_ = 61,
KIND_LISPALLOC_core__SimpleCharacterString_O = 62,
KIND_ABSTRACT_core__template_SimpleVector_core__SimpleBaseString_O_unsigned_char_core__SimpleString_O_ = 63,
KIND_LISPALLOC_core__SimpleBaseString_O = 64,
KIND_ABSTRACT_core__template_SimpleVector_core__SimpleVectorDouble_O_double_core__AbstractSimpleVector_O_ = 65,
KIND_LISPALLOC_core__SimpleVectorDouble_O = 66,
KIND_ABSTRACT_core__template_SimpleVector_core__SimpleVector_size_t_O_unsigned_long_core__AbstractSimpleVector_O_ = 67,
KIND_LISPALLOC_core__SimpleVector_size_t_O = 68,
KIND_LISPALLOC_core__MDArray_O = 69,
KIND_LISPALLOC_core__StrNs_O = 70,
KIND_ABSTRACT_core__template_Array_core__Str8Ns_O_core__SimpleBaseString_O_core__StrNs_O_ = 71,
KIND_LISPALLOC_core__Str8Ns_O = 72,
KIND_ABSTRACT_core__template_Array_core__StrWNs_O_core__SimpleCharacterString_O_core__StrNs_O_ = 73,
KIND_LISPALLOC_core__StrWNs_O = 74,
KIND_ABSTRACT_core__template_Array_core__MDArrayT_O_core__SimpleVector_O_core__MDArray_O_ = 75,
KIND_LISPALLOC_core__MDArrayT_O = 76,
KIND_LISPALLOC_core__BitVectorNs_O = 77,
KIND_LISPALLOC_core__SimpleMDArray_O = 78,
KIND_ABSTRACT_core__template_SimpleArray_core__SimpleMDArray_size_t_O_core__SimpleVector_size_t_O_core__SimpleMDArray_O_ = 79,
KIND_LISPALLOC_core__SimpleMDArray_size_t_O = 80,
KIND_ABSTRACT_core__template_SimpleArray_core__SimpleMDArrayDouble_O_core__SimpleVectorDouble_O_core__SimpleMDArray_O_ = 81,
KIND_LISPALLOC_core__SimpleMDArrayDouble_O = 82,
KIND_ABSTRACT_core__template_SimpleArray_core__SimpleMDArrayBaseChar_O_core__SimpleBaseString_O_core__SimpleMDArray_O_ = 83,
KIND_LISPALLOC_core__SimpleMDArrayBaseChar_O = 84,
KIND_ABSTRACT_core__template_SimpleArray_core__SimpleMDArrayCharacter_O_core__SimpleCharacterString_O_core__SimpleMDArray_O_ = 85,
KIND_LISPALLOC_core__SimpleMDArrayCharacter_O = 86,
KIND_ABSTRACT_core__template_SimpleArray_core__SimpleMDArrayT_O_core__SimpleVector_O_core__SimpleMDArray_O_ = 87,
KIND_LISPALLOC_core__SimpleMDArrayT_O = 88,
KIND_LISPALLOC_core__SimpleMDArrayBit_O = 89,
KIND_LISPALLOC_core__MDArrayBit_O = 90,
KIND_ABSTRACT_core__template_Array_core__MDArrayBaseChar_O_core__SimpleBaseString_O_core__MDArray_O_ = 91,
KIND_LISPALLOC_core__MDArrayBaseChar_O = 92,
KIND_ABSTRACT_core__template_Array_core__MDArrayDouble_O_core__SimpleVectorDouble_O_core__MDArray_O_ = 93,
KIND_LISPALLOC_core__MDArrayDouble_O = 94,
KIND_ABSTRACT_core__template_Array_core__MDArray_size_t_O_core__SimpleVector_size_t_O_core__MDArray_O_ = 95,
KIND_LISPALLOC_core__MDArray_size_t_O = 96,
KIND_ABSTRACT_core__template_Array_core__MDArrayCharacter_O_core__SimpleCharacterString_O_core__MDArray_O_ = 97,
KIND_LISPALLOC_core__MDArrayCharacter_O = 98,
KIND_LISPALLOC_core__Exposer_O = 99,
KIND_LISPALLOC_asttooling__AsttoolingExposer_O = 100,
KIND_LISPALLOC_core__CoreExposer_O = 101,
KIND_LISPALLOC_core__SingleDispatchMethod_O = 102,
KIND_LISPALLOC_core__RandomState_O = 103,
KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O = 104,
KIND_LISPALLOC_core__SequenceStepper_O = 105,
KIND_LISPALLOC_core__ConsStepper_O = 106,
KIND_LISPALLOC_core__VectorStepper_O = 107,
KIND_LISPALLOC_llvmo__DebugLoc_O = 108,
KIND_LISPALLOC_llvmo__Attribute_O = 109,
KIND_LISPALLOC_core__WeakPointer_O = 110,
KIND_BOOTSTRAP_core__StandardObject_O = 111,
KIND_BOOTSTRAP_core__Metaobject_O = 112,
KIND_BOOTSTRAP_core__Specializer_O = 113,
KIND_BOOTSTRAP_core__Class_O = 114,
KIND_BOOTSTRAP_core__StdClass_O = 115,
KIND_BOOTSTRAP_core__StandardClass_O = 116,
KIND_LISPALLOC_core__FuncallableStandardClass_O = 117,
KIND_BOOTSTRAP_core__StructureClass_O = 118,
KIND_LISPALLOC_core__ForwardReferencedClass_O = 119,
KIND_LISPALLOC_core__CxxClass_O = 120,
KIND_BOOTSTRAP_core__BuiltInClass_O = 121,
KIND_LISPALLOC_clbind__ClassRep_O = 122,
KIND_LISPALLOC_core__ExternalObject_O = 123,
KIND_LISPALLOC_clasp_ffi__ForeignData_O = 124,
KIND_LISPALLOC_llvmo__Value_O = 125,
KIND_LISPALLOC_llvmo__Argument_O = 126,
KIND_LISPALLOC_llvmo__User_O = 127,
KIND_LISPALLOC_llvmo__Instruction_O = 128,
KIND_LISPALLOC_llvmo__AtomicRMWInst_O = 129,
KIND_LISPALLOC_llvmo__LandingPadInst_O = 130,
KIND_LISPALLOC_llvmo__PHINode_O = 131,
KIND_LISPALLOC_llvmo__CallInst_O = 132,
KIND_LISPALLOC_llvmo__StoreInst_O = 133,
KIND_LISPALLOC_llvmo__UnaryInstruction_O = 134,
KIND_LISPALLOC_llvmo__LoadInst_O = 135,
KIND_LISPALLOC_llvmo__AllocaInst_O = 136,
KIND_LISPALLOC_llvmo__VAArgInst_O = 137,
KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O = 138,
KIND_LISPALLOC_llvmo__TerminatorInst_O = 139,
KIND_LISPALLOC_llvmo__UnreachableInst_O = 140,
KIND_LISPALLOC_llvmo__SwitchInst_O = 141,
KIND_LISPALLOC_llvmo__ReturnInst_O = 142,
KIND_LISPALLOC_llvmo__ResumeInst_O = 143,
KIND_LISPALLOC_llvmo__BranchInst_O = 144,
KIND_LISPALLOC_llvmo__InvokeInst_O = 145,
KIND_LISPALLOC_llvmo__IndirectBrInst_O = 146,
KIND_LISPALLOC_llvmo__FenceInst_O = 147,
KIND_LISPALLOC_llvmo__Constant_O = 148,
KIND_LISPALLOC_llvmo__BlockAddress_O = 149,
KIND_LISPALLOC_llvmo__GlobalValue_O = 150,
KIND_LISPALLOC_llvmo__GlobalVariable_O = 151,
KIND_LISPALLOC_llvmo__Function_O = 152,
KIND_LISPALLOC_llvmo__ConstantArray_O = 153,
KIND_LISPALLOC_llvmo__ConstantInt_O = 154,
KIND_LISPALLOC_llvmo__ConstantDataSequential_O = 155,
KIND_LISPALLOC_llvmo__ConstantDataArray_O = 156,
KIND_LISPALLOC_llvmo__ConstantStruct_O = 157,
KIND_LISPALLOC_llvmo__ConstantFP_O = 158,
KIND_LISPALLOC_llvmo__UndefValue_O = 159,
KIND_LISPALLOC_llvmo__ConstantPointerNull_O = 160,
KIND_LISPALLOC_llvmo__ConstantExpr_O = 161,
KIND_LISPALLOC_llvmo__BasicBlock_O = 162,
KIND_LISPALLOC_llvmo__IRBuilderBase_O = 163,
KIND_LISPALLOC_llvmo__IRBuilder_O = 164,
KIND_LISPALLOC_llvmo__DIBuilder_O = 165,
KIND_LISPALLOC_llvmo__Metadata_O = 166,
KIND_LISPALLOC_llvmo__ValueAsMetadata_O = 167,
KIND_LISPALLOC_llvmo__MDNode_O = 168,
KIND_LISPALLOC_llvmo__DINode_O = 169,
KIND_LISPALLOC_llvmo__DIScope_O = 170,
KIND_LISPALLOC_llvmo__DICompileUnit_O = 171,
KIND_LISPALLOC_llvmo__DILocalScope_O = 172,
KIND_LISPALLOC_llvmo__DISubprogram_O = 173,
KIND_LISPALLOC_llvmo__DILexicalBlockBase_O = 174,
KIND_LISPALLOC_llvmo__DILexicalBlock_O = 175,
KIND_LISPALLOC_llvmo__DIType_O = 176,
KIND_LISPALLOC_llvmo__DIDerivedType_O = 177,
KIND_LISPALLOC_llvmo__DIBasicType_O = 178,
KIND_LISPALLOC_llvmo__DISubroutineType_O = 179,
KIND_LISPALLOC_llvmo__DICompositeType_O = 180,
KIND_LISPALLOC_llvmo__DIFile_O = 181,
KIND_LISPALLOC_llvmo__MDString_O = 182,
KIND_LISPALLOC_llvmo__ExecutionEngine_O = 183,
KIND_LISPALLOC_llvmo__APFloat_O = 184,
KIND_LISPALLOC_llvmo__PassManagerBuilder_O = 185,
KIND_LISPALLOC_llvmo__Triple_O = 186,
KIND_LISPALLOC_llvmo__APInt_O = 187,
KIND_LISPALLOC_llvmo__PassManagerBase_O = 188,
KIND_LISPALLOC_llvmo__FunctionPassManager_O = 189,
KIND_LISPALLOC_llvmo__PassManager_O = 190,
KIND_LISPALLOC_llvmo__TargetMachine_O = 191,
KIND_LISPALLOC_llvmo__LLVMTargetMachine_O = 192,
KIND_LISPALLOC_llvmo__TargetOptions_O = 193,
KIND_LISPALLOC_llvmo__Type_O = 194,
KIND_LISPALLOC_llvmo__IntegerType_O = 195,
KIND_LISPALLOC_llvmo__CompositeType_O = 196,
KIND_LISPALLOC_llvmo__SequentialType_O = 197,
KIND_LISPALLOC_llvmo__VectorType_O = 198,
KIND_LISPALLOC_llvmo__PointerType_O = 199,
KIND_LISPALLOC_llvmo__ArrayType_O = 200,
KIND_LISPALLOC_llvmo__StructType_O = 201,
KIND_LISPALLOC_llvmo__FunctionType_O = 202,
KIND_LISPALLOC_llvmo__NamedMDNode_O = 203,
KIND_LISPALLOC_llvmo__Linker_O = 204,
KIND_LISPALLOC_llvmo__Pass_O = 205,
KIND_LISPALLOC_llvmo__FunctionPass_O = 206,
KIND_LISPALLOC_llvmo__ModulePass_O = 207,
KIND_LISPALLOC_llvmo__ImmutablePass_O = 208,
KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O = 209,
KIND_LISPALLOC_llvmo__MCSubtargetInfo_O = 210,
KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O = 211,
KIND_LISPALLOC_llvmo__Module_O = 212,
KIND_LISPALLOC_llvmo__EngineBuilder_O = 213,
KIND_LISPALLOC_llvmo__LLVMContext_O = 214,
KIND_LISPALLOC_llvmo__Target_O = 215,
KIND_LISPALLOC_core__LoadTimeValues_O = 216,
KIND_LISPALLOC_core__IntArray_O = 217,
KIND_LISPALLOC_core__SourceManager_O = 218,
KIND_LISPALLOC_core__Record_O = 219,
KIND_LISPALLOC_core__LightUserData_O = 220,
KIND_LISPALLOC_core__UserData_O = 221,
KIND_LISPALLOC_llvmo__DataLayout_O = 222,
KIND_BOOTSTRAP_core__Symbol_O = 223,
KIND_LISPALLOC_core__Null_O = 224,
KIND_LISPALLOC_llvmo__ModuleHandle_O = 225,
KIND_LISPALLOC_core__SourcePosInfo_O = 226,
KIND_LISPALLOC_llvmo__ClaspJIT_O = 227,
KIND_TEMPLATED_LISPALLOC_core__Iterator_O = 228,
KIND_LISPALLOC_core__DirectoryIterator_O = 229,
KIND_LISPALLOC_core__RecursiveDirectoryIterator_O = 230,
KIND_LISPALLOC_core__PosixTimeDuration_O = 231,
KIND_LISPALLOC_core__SymbolToEnumConverter_O = 232,
KIND_LISPALLOC_core__CandoException_O = 233,
KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O = 234,
KIND_LISPALLOC_core__Stream_O = 235,
KIND_LISPALLOC_core__AnsiStream_O = 236,
KIND_LISPALLOC_core__FileStream_O = 237,
KIND_LISPALLOC_core__IOStreamStream_O = 238,
KIND_LISPALLOC_core__IOFileStream_O = 239,
KIND_LISPALLOC_core__ConcatenatedStream_O = 240,
KIND_LISPALLOC_core__StringStream_O = 241,
KIND_LISPALLOC_core__StringInputStream_O = 242,
KIND_LISPALLOC_core__StringOutputStream_O = 243,
KIND_LISPALLOC_core__SynonymStream_O = 244,
KIND_LISPALLOC_core__EchoStream_O = 245,
KIND_LISPALLOC_core__TwoWayStream_O = 246,
KIND_LISPALLOC_core__BroadcastStream_O = 247,
KIND_LISPALLOC_core__Reader_O = 248,
KIND_LISPALLOC_core__SharpEqualWrapper_O = 249,
KIND_LISPALLOC_core__Archive_O = 250,
KIND_LISPALLOC_core__SaveArchive_O = 251,
KIND_LISPALLOC_core__SexpSaveArchive_O = 252,
KIND_LISPALLOC_core__LoadArchive_O = 253,
KIND_LISPALLOC_core__SexpLoadArchive_O = 254,
KIND_LISPALLOC_core__HashTable_O = 255,
KIND_LISPALLOC_core__HashTableEq_O = 256,
KIND_LISPALLOC_core__HashTableEqualp_O = 257,
KIND_LISPALLOC_core__HashTableEql_O = 258,
KIND_LISPALLOC_core__HashTableEqual_O = 259,
KIND_TEMPLATED_LISPALLOC_core__Creator_O = 260,
KIND_LISPALLOC_clbind__DummyCreator_O = 261,
KIND_TEMPLATED_LISPALLOC_clbind__ConstructorCreator_O = 262,
KIND_LISPALLOC_core__InstanceCreator_O = 263,
KIND_LISPALLOC_core__CxxObject_O = 264,
KIND_LISPALLOC_core__NativeVector_float_O = 265,
KIND_LISPALLOC_clcenv__Info_O = 266,
KIND_LISPALLOC_clcenv__FunctionInfo_O = 267,
KIND_LISPALLOC_clcenv__LocalFunctionInfo_O = 268,
KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O = 269,
KIND_LISPALLOC_clcenv__LambdaNameInfo_O = 270,
KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O = 271,
KIND_LISPALLOC_clcenv__GlobalMacroInfo_O = 272,
KIND_LISPALLOC_clcenv__LocalMacroInfo_O = 273,
KIND_LISPALLOC_clcenv__OptimizeInfo_O = 274,
KIND_LISPALLOC_clcenv__BlockInfo_O = 275,
KIND_LISPALLOC_clcenv__VariableInfo_O = 276,
KIND_LISPALLOC_clcenv__SpecialVariableInfo_O = 277,
KIND_LISPALLOC_clcenv__SymbolMacroInfo_O = 278,
KIND_LISPALLOC_clcenv__ConstantVariableInfo_O = 279,
KIND_LISPALLOC_clcenv__LexicalVariableInfo_O = 280,
KIND_LISPALLOC_core__NativeVector_int_O = 281,
KIND_LISPALLOC_llvmo__DINodeArray_O = 282,
KIND_LISPALLOC_llvmo__DITypeRefArray_O = 283,
KIND_LISPALLOC_clcenv__Entry_O = 284,
KIND_LISPALLOC_clcenv__Inline_O = 285,
KIND_LISPALLOC_clcenv__Closure_O = 286,
KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O = 287,
KIND_LISPALLOC_clcenv__VariableDynamicExtent_O = 288,
KIND_LISPALLOC_clcenv__SymbolMacro_O = 289,
KIND_LISPALLOC_clcenv__FunctionIgnore_O = 290,
KIND_LISPALLOC_clcenv__Function_O = 291,
KIND_LISPALLOC_clcenv__LambdaName_O = 292,
KIND_LISPALLOC_clcenv__Block_O = 293,
KIND_LISPALLOC_clcenv__SpecialVariable_O = 294,
KIND_LISPALLOC_clcenv__LexicalVariable_O = 295,
KIND_LISPALLOC_clcenv__GlobalEnvironment_O = 296,
KIND_LISPALLOC_clcenv__Tag_O = 297,
KIND_LISPALLOC_clcenv__FunctionType_O = 298,
KIND_LISPALLOC_clcenv__Macro_O = 299,
KIND_LISPALLOC_clcenv__VariableType_O = 300,
KIND_LISPALLOC_clcenv__VariableIgnore_O = 301,
KIND_LISPALLOC_clcenv__Optimize_O = 302,
KIND_LISPALLOC_core__NativeVector_double_O = 303,
KIND_LISPALLOC_core__WeakKeyMapping_O = 304,
KIND_LISPALLOC_core__Cache_O = 305,
KIND_LISPALLOC_core__LambdaListHandler_O = 306,
KIND_LISPALLOC_llvmo__InsertPoint_O = 307,
KIND_LISPALLOC_core__SourceFileInfo_O = 308,
KIND_LISPALLOC_core__SNode_O = 309,
KIND_LISPALLOC_core__LeafSNode_O = 310,
KIND_LISPALLOC_core__BranchSNode_O = 311,
KIND_LISPALLOC_core__Path_O = 312,
KIND_LISPALLOC_llvmo__AttributeSet_O = 314,
KIND_LISPALLOC_core__StructureObject_O = 315,
KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O = 316,
KIND_LISPALLOC_core__Package_O = 317,
KIND_LISPALLOC_core__DirectoryEntry_O = 318,
KIND_LISPALLOC_core__Character_dummy_O = 319,
KIND_LISPALLOC_core__Function_O = 320,
KIND_LISPALLOC_core__NamedFunction_O = 321,
KIND_LISPALLOC_core__SpecialForm_O = 322,
KIND_LISPALLOC_core__Closure_O = 323,
KIND_LISPALLOC_core__CompiledFunction_O = 324,
KIND_LISPALLOC_core__FunctionClosure_O = 325,
KIND_LISPALLOC_core__ClosureWithSlots_O = 326,
KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O = 327,
KIND_LISPALLOC_core__TranslationFunctor = 328,
KIND_LISPALLOC_core__MacroClosure_O = 329,
KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O = 330,
KIND_LISPALLOC_core__ClosureWithFrame_O = 331,
KIND_LISPALLOC_core__CompiledClosure_O = 332,
KIND_LISPALLOC_core__CompiledDispatchFunction_O = 333,
KIND_LISPALLOC_core__InterpretedClosure_O = 334,
KIND_LISPALLOC_core__SingleDispatchMethodFunction_O = 335,
KIND_LISPALLOC_core__CxxMethodFunction_O = 336,
KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O = 337,
KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O = 338,
KIND_LISPALLOC_core__Instance_O = 339,
KIND_ABSTRACT_clbind__Derivable_clang__ASTFrontendAction_ = 342,
KIND_LISPALLOC_asttooling__DerivableASTFrontendAction = 343,
KIND_ABSTRACT_clbind__Derivable_clang__SyntaxOnlyAction_ = 346,
KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction = 347,
KIND_LISPALLOC_core__Pointer_O = 348,
KIND_LISPALLOC_clbind__ClassRegistry_O = 349,
KIND_LISPALLOC_core__SmallMultimap_O = 350,
KIND_LISPALLOC_core__Pathname_O = 351,
KIND_LISPALLOC_core__LogicalPathname_O = 352,
KIND_LISPALLOC_core__PosixTime_O = 353,
KIND_LISPALLOC_core__SmallMap_O = 354,
KIND_ABSTRACT_gctools__GCContainer = 355,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__ = 356,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 357,
KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_ = 358,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 359,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 360,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__ = 361,
KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_ = 362,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__ = 363,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__ = 364,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__ = 365,
KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_ = 366,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__ = 367,
KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___ = 368,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_ = 369,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__ = 370,
KIND_GCVECTOR_gctools__GCVector_moveable_int_ = 371,
KIND_GCVECTOR_gctools__GCVector_moveable_double_ = 372,
KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_ = 373,
KIND_GCARRAY_gctools__GCArray_moveable_double_ = 374,
KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___ = 375,
KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_ = 376,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_ = 377,
KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_ = 378,
KIND_GCVECTOR_gctools__GCVector_moveable_float_ = 379,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 380,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 381,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__ = 382,
KIND_GCARRAY_gctools__GCArray_moveable_int_ = 383,
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 384,
KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_ = 385,
KIND_ABSTRACT_clang__ast_matchers__MatchFinder__MatchCallback = 386,
KIND_ABSTRACT_clbind__Derivable_clang__ast_matchers__MatchFinder__MatchCallback_ = 387,
KIND_LISPALLOC_asttooling__DerivableMatchCallback = 388,
KIND_ABSTRACT_clang__RecursiveASTVisitor_asttooling__AstVisitor_O_ = 389,
KIND_LISPALLOC_asttooling__AstVisitor_O = 390,
KIND_ROOTCLASSALLOC_core__Lisp_O = 391,
KIND_ABSTRACT_clang__tooling__ToolAction = 392,
KIND_ABSTRACT_clang__tooling__FrontendActionFactory = 393,
KIND_ABSTRACT_clbind__Derivable_clang__tooling__FrontendActionFactory_ = 394,
KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory = 395,
  KIND_max = 395,
...
template <typename FP> struct Cast<core::LoadArchive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 253 254 
      return ((253 <= kindVal) && (kindVal <= 254));
  };
};
...
template <typename FP> struct Cast<clcenv::VariableInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 276 280 
      return ((276 <= kindVal) && (kindVal <= 280));
  };
};
...
// KIND_LISPALLOC_llvmo__FenceInst_O
...
template <typename FP> struct Cast<core::Pathname_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 351 352 
      return ((351 <= kindVal) && (kindVal <= 352));
  };
};
// KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
...
// KIND_LISPALLOC_core__LexicalEnvironment_O
template <typename FP> struct Cast<core::LexicalEnvironment_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 41 53 
      return ((41 <= kindVal) && (kindVal <= 53));
  };
};
...
template <typename FP> struct Cast<core::Instance_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 339 347 
      return ((339 <= kindVal) && (kindVal <= 347));
  };
};
...
template <typename FP> struct Cast<llvmo::DIScope_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 170 181 
      return ((170 <= kindVal) && (kindVal <= 181));
  };
};
...
// KIND_LISPALLOC_core__WeakKeyHashTable_O
...
// KIND_LISPALLOC_llvmo__ConstantPointerNull_O
...
template <typename FP> struct Cast<core::Function_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 320 347 
      return ((320 <= kindVal) && (kindVal <= 347));
  };
};
...
// KIND_LISPALLOC_core__DirectoryEntry_O
...
// KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
...
template <typename FP> struct Cast<core::Class_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 114 122 
      return ((114 <= kindVal) && (kindVal <= 122));
  };
};
// KIND_LISPALLOC_core__FuncallableStandardClass_O
...
template <typename FP> struct Cast<llvmo::Pass_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 205 209 
      return ((205 <= kindVal) && (kindVal <= 209));
  };
};
// KIND_LISPALLOC_llvmo__Linker_O
...
template <typename FP> struct Cast<clcenv::Entry_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 284 302 
      return ((284 <= kindVal) && (kindVal <= 302));
  };
};
...
template <typename FP> struct Cast<llvmo::TerminatorInst_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 139 146 
      return ((139 <= kindVal) && (kindVal <= 146));
  };
};
...
template <typename FP> struct Cast<llvmo::Type_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 194 202 
      return ((194 <= kindVal) && (kindVal <= 202));
  };
};
...
// KIND_LISPALLOC_core__Package_O
...
template <typename FP> struct Cast<llvmo::CompositeType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 196 201 
      return ((196 <= kindVal) && (kindVal <= 201));
  };
};
...
// KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_
...
// KIND_BOOTSTRAP_core__BuiltInClass_O
...
// KIND_LISPALLOC_core__CxxClass_O
...
template <typename FP> struct Cast<llvmo::DINode_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 169 181 
      return ((169 <= kindVal) && (kindVal <= 181));
  };
};
...
template <typename FP> struct Cast<core::NamedFunction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 321 338 
      return ((321 <= kindVal) && (kindVal <= 338));
  };
};
...
// KIND_LISPALLOC_core__ForwardReferencedClass_O
...
// KIND_BOOTSTRAP_core__Metaobject_O
template <typename FP> struct Cast<core::Metaobject_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 112 122 
      return ((112 <= kindVal) && (kindVal <= 122));
  };
};
...
template <typename FP> struct Cast<core::CxxObject_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 264 303 
      return ((264 <= kindVal) && (kindVal <= 303));
  };
};
...
template <typename FP> struct Cast<core::Creator_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 260 263 
      return ((260 <= kindVal) && (kindVal <= 263));
  };
};
...
template <typename FP> struct Cast<core::HashTable_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 255 259 
      return ((255 <= kindVal) && (kindVal <= 259));
  };
};
...
template <typename FP> struct Cast<core::Archive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 250 254 
      return ((250 <= kindVal) && (kindVal <= 254));
  };
};
// KIND_LISPALLOC_clcenv__FunctionType_O
...
template <typename FP> struct Cast<core::Stream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 235 247 
      return ((235 <= kindVal) && (kindVal <= 247));
  };
};
...
// KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O
...
// KIND_LISPALLOC_llvmo__UnaryInstruction_O
...
// KIND_LISPALLOC_core__BranchSNode_O
...
// KIND_BOOTSTRAP_core__StandardClass_O
...
template <typename FP> struct Cast<llvmo::PassManagerBase_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 188 190 
      return ((188 <= kindVal) && (kindVal <= 190));
  };
};
...
template <typename FP> struct Cast<core::Iterator_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 228 230 
      return ((228 <= kindVal) && (kindVal <= 230));
  };
};
...
// KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
...
// KIND_LISPALLOC_core__TranslationFunctor
...
template <typename FP> struct Cast<llvmo::DIType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 176 180 
      return ((176 <= kindVal) && (kindVal <= 180));
  };
};
...
// KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
...
// KIND_LISPALLOC_clcenv__LambdaNameInfo_O
...
// KIND_LISPALLOC_llvmo__ClaspJIT_O
...
// KIND_LISPALLOC_llvmo__MDNode_O
template <typename FP> struct Cast<llvmo::MDNode_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 168 181 
      return ((168 <= kindVal) && (kindVal <= 181));
  };
};
...
// KIND_LISPALLOC_llvmo__Triple_O
...
template <typename FP> struct Cast<core::Symbol_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 223 224 
      return ((223 <= kindVal) && (kindVal <= 224));
  };
};
...
// KIND_BOOTSTRAP_core__Specializer_O
template <typename FP> struct Cast<core::Specializer_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 113 122 
      return ((113 <= kindVal) && (kindVal <= 122));
  };
};
// KIND_LISPALLOC_core__StackValueEnvironment_O
...
// KIND_LISPALLOC_llvmo__ConstantFP_O
...
// KIND_LISPALLOC_clcenv__SymbolMacroInfo_O
...
template <typename FP> struct Cast<core::SaveArchive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 251 252 
      return ((251 <= kindVal) && (kindVal <= 252));
  };
};
// KIND_LISPALLOC_core__SourceManager_O
...
// KIND_LISPALLOC_clcenv__OptimizeInfo_O
...
// KIND_LISPALLOC_core__SimpleString_O
template <typename FP> struct Cast<core::SimpleString_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 60 64 
      return ((60 <= kindVal) && (kindVal <= 64));
  };
};
...
// KIND_LISPALLOC_core__MDArrayT_O
...
template <typename FP> struct Cast<llvmo::Constant_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 148 161 
      return ((148 <= kindVal) && (kindVal <= 161));
  };
};
// KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
...
// KIND_LISPALLOC_core__LoadTimeValues_O
...
template <typename FP> struct Cast<core::ExternalObject_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 123 215 
      return ((123 <= kindVal) && (kindVal <= 215));
  };
};
...
template <typename FP> struct Cast<core::StandardObject_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 111 122 
      return ((111 <= kindVal) && (kindVal <= 122));
  };
};
...
template <typename FP> struct Cast<llvmo::DILocalScope_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 172 175 
      return ((172 <= kindVal) && (kindVal <= 175));
  };
};
...
template <typename FP> struct Cast<llvmo::ImmutablePass_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 208 209 
      return ((208 <= kindVal) && (kindVal <= 209));
  };
};
...
template <typename FP> struct Cast<core::Closure_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 323 338 
      return ((323 <= kindVal) && (kindVal <= 338));
  };
};
// KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
...
template <typename FP> struct Cast<core::SingleDispatchMethodFunction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 335 336 
      return ((335 <= kindVal) && (kindVal <= 336));
  };
};
...
// KIND_LISPALLOC_llvmo__StructType_O
...
// KIND_LISPALLOC_core__ClosureWithFrame_O
template <typename FP> struct Cast<core::ClosureWithFrame_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 331 334 
      return ((331 <= kindVal) && (kindVal <= 334));
  };
};
...
// KIND_LISPALLOC_core__FunctionValueEnvironment_O
...
template <typename FP> struct Cast<core::BuiltinClosure_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 327 329 
      return ((327 <= kindVal) && (kindVal <= 329));
  };
};
...
template <typename FP> struct Cast<core::Integer_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 24 26 
      return ((24 <= kindVal) && (kindVal <= 26));
  };
};
// KIND_BOOTSTRAP_core__StructureClass_O
...
// KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
...
// KIND_BOOTSTRAP_core__StdClass_O
template <typename FP> struct Cast<core::StdClass_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 115 117 
      return ((115 <= kindVal) && (kindVal <= 117));
  };
};
...
template <typename FP> struct Cast<core::SequenceStepper_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 105 107 
      return ((105 <= kindVal) && (kindVal <= 107));
  };
};
...
template <typename FP> struct Cast<llvmo::Metadata_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 166 182 
      return ((166 <= kindVal) && (kindVal <= 182));
  };
};
...
template <typename FP> struct Cast<llvmo::User_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 127 161 
      return ((127 <= kindVal) && (kindVal <= 161));
  };
};
...
template <typename FP> struct Cast<llvmo::SequentialType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 197 200 
      return ((197 <= kindVal) && (kindVal <= 200));
  };
};
...
// KIND_LISPALLOC_core__StringStream_O
template <typename FP> struct Cast<core::StringStream_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 241 243 
      return ((241 <= kindVal) && (kindVal <= 243));
  };
};
...
// KIND_LISPALLOC_llvmo__DIBuilder_O
...
template <typename FP> struct Cast<llvmo::Instruction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 128 147 
      return ((128 <= kindVal) && (kindVal <= 147));
  };
};
...
template <typename FP> struct Cast<core::AnsiStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 236 247 
      return ((236 <= kindVal) && (kindVal <= 247));
  };
};
...
// KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
...
// KIND_LISPALLOC_core__WeakHashTable_O
...
// KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
...
// KIND_LISPALLOC_llvmo__GlobalValue_O
...
// KIND_LISPALLOC_clcenv__SpecialVariableInfo_O
...
template <typename FP> struct Cast<llvmo::IRBuilderBase_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 163 164 
      return ((163 <= kindVal) && (kindVal <= 164));
  };
};
...
// KIND_LISPALLOC_llvmo__Value_O
template <typename FP> struct Cast<llvmo::Value_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 125 162 
      return ((125 <= kindVal) && (kindVal <= 162));
  };
};
// KIND_LISPALLOC_core__Number_O
template <typename FP> struct Cast<core::Number_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 20 32 
      return ((20 <= kindVal) && (kindVal <= 32));
  };
};
...
template <typename FP> struct Cast<clcenv::Info_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 266 280 
      return ((266 <= kindVal) && (kindVal <= 280));
  };
};
...
template <typename FP> struct Cast<llvmo::ModulePass_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 207 209 
      return ((207 <= kindVal) && (kindVal <= 209));
  };
};
// KIND_LISPALLOC_llvmo__DIDerivedType_O
...
// KIND_LISPALLOC_core__Complex_O
...
template <typename FP> struct Cast<core::FileStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 237 239 
      return ((237 <= kindVal) && (kindVal <= 239));
  };
};
...
template <typename FP> struct Cast<clcenv::FunctionInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 267 273 
      return ((267 <= kindVal) && (kindVal <= 273));
  };
};
...
// KIND_LISPALLOC_core__MultiStringBuffer_O
...
{ class_kind, KIND_LISPALLOC_core__AbstractSimpleVector_O, sizeof(core::AbstractSimpleVector_O), 0, "core::AbstractSimpleVector_O" },
...
{ class_kind, KIND_LISPALLOC_core__SimpleBaseString_O, sizeof(core::SimpleBaseString_O), 0, "core::SimpleBaseString_O" },
...
{ class_kind, KIND_LISPALLOC_core__SimpleVectorDouble_O, sizeof(core::SimpleVectorDouble_O), 0, "core::SimpleVectorDouble_O" },
...
{ class_kind, KIND_LISPALLOC_core__SimpleVector_size_t_O, sizeof(core::SimpleVector_size_t_O), 0, "core::SimpleVector_size_t_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArray_O, sizeof(core::SimpleMDArray_O), 0, "core::SimpleMDArray_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArray_size_t_O, sizeof(core::SimpleMDArray_size_t_O), 0, "core::SimpleMDArray_size_t_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArrayDouble_O, sizeof(core::SimpleMDArrayDouble_O), 0, "core::SimpleMDArrayDouble_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArrayBaseChar_O, sizeof(core::SimpleMDArrayBaseChar_O), 0, "core::SimpleMDArrayBaseChar_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArrayCharacter_O, sizeof(core::SimpleMDArrayCharacter_O), 0, "core::SimpleMDArrayCharacter_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArrayT_O, sizeof(core::SimpleMDArrayT_O), 0, "core::SimpleMDArrayT_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleMDArrayBit_O, sizeof(core::SimpleMDArrayBit_O), 0, "core::SimpleMDArrayBit_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__MDArrayBit_O, sizeof(core::MDArrayBit_O), 0, "core::MDArrayBit_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__MDArrayDouble_O, sizeof(core::MDArrayDouble_O), 0, "core::MDArrayDouble_O" },
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__MDArray_size_t_O, sizeof(core::MDArray_size_t_O), 0, "core::MDArray_size_t_O" },
...
{ class_kind, KIND_LISPALLOC_llvmo__ClaspJIT_O, sizeof(llvmo::ClaspJIT_O), 0, "llvmo::ClaspJIT_O" },
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::ClaspJIT_O),DL.StringRepresentation.__r_.__first_.NO-NAME.__l.__cap_), "DL.StringRepresentation.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::ClaspJIT_O),DL.StringRepresentation.__r_.__first_.NO-NAME.__l.__size_), "DL.StringRepresentation.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(llvmo::ClaspJIT_O),DL.StringRepresentation.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "DL.StringRepresentation.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(llvmo::ClaspJIT_O),DL.StringRepresentation.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "DL.StringRepresentation.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::ClaspJIT_O),ObjectLayer.LinkedObjSetList.__size_alloc_.__first_), "ObjectLayer.LinkedObjSetList.__size_alloc_.__first_" }, // public: (NIL NIL NIL NIL) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__CompiledDispatchFunction_O, sizeof(core::CompiledDispatchFunction_O), 0, "core::CompiledDispatchFunction_O" },
// {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
 ...
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Symbol_O>), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),kind), "kind" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_cleavir_ast), "_cleavir_ast" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_sourceFileInfoHandle), "_sourceFileInfoHandle" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_filePos), "_filePos" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_lineno), "_lineno" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_long, sizeof(long), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_column), "_column" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_closedEnvironment), "_closedEnvironment" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::CompiledDispatchFunction_O),_llvmModule), "_llvmModule" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
...
{ container_kind, KIND_GCARRAY_gctools__GCArray_moveable_int_, sizeof(gctools::GCArray_moveable<int>), 0, "gctools::GCArray_moveable<int>" },
...
obj_finalize_KIND_LISPALLOC_core__AbstractSimpleVector_O:
{
...
obj_finalize_KIND_LISPALLOC_core__SimpleMDArray_O:
{
    core::SimpleMDArray_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArray_O*>(client);
    obj_gc_safe->~SimpleMDArray_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SimpleMDArray_size_t_O:
{
...
obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayDouble_O:
{
...
obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayBaseChar_O:
{
...
obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayCharacter_O:
{
...
obj_finalize_KIND_LISPALLOC_llvmo__ModuleHandle_O:
{
...
obj_finalize_KIND_LISPALLOC_llvmo__ClaspJIT_O:
{
...
obj_finalize_KIND_LISPALLOC_core__CompiledDispatchFunction_O:
{
...
static void* OBJ_FINALIZE_table[] = { 
  /* 13 */ &&obj_finalize_KIND_ROOTCLASSALLOC_clbind__detail__class_map,
  /* 14 */ &&obj_finalize_KIND_BOOTSTRAP_core__T_O,
  /* 15 */ &&obj_finalize_KIND_LISPALLOC_core__VaList_dummy_O,
  /* 16 */ &&obj_finalize_KIND_LISPALLOC_core__Cons_O,
  /* 17 */ &&obj_finalize_KIND_LISPALLOC_core__General_O,
  /* 18 */ &&obj_finalize_KIND_LISPALLOC_core__MultiStringBuffer_O,
  /* 19 */ &&obj_finalize_KIND_LISPALLOC_core__ReadTable_O,
  /* 20 */ &&obj_finalize_KIND_LISPALLOC_core__Number_O,
  /* 21 */ &&obj_finalize_KIND_LISPALLOC_core__Complex_O,
  /* 22 */ &&obj_finalize_KIND_LISPALLOC_core__Real_O,
  /* 23 */ &&obj_finalize_KIND_LISPALLOC_core__Rational_O,
  /* 24 */ &&obj_finalize_KIND_LISPALLOC_core__Integer_O,
  /* 25 */ &&obj_finalize_KIND_LISPALLOC_core__Bignum_O,
  /* 26 */ &&obj_finalize_KIND_LISPALLOC_core__Fixnum_dummy_O,
  /* 27 */ &&obj_finalize_KIND_LISPALLOC_core__Ratio_O,
  /* 28 */ &&obj_finalize_KIND_LISPALLOC_core__Float_O,
  /* 29 */ &&obj_finalize_KIND_LISPALLOC_core__DoubleFloat_O,
  /* 30 */ &&obj_finalize_KIND_LISPALLOC_core__LongFloat_O,
  /* 31 */ &&obj_finalize_KIND_LISPALLOC_core__SingleFloat_dummy_O,
  /* 32 */ &&obj_finalize_KIND_LISPALLOC_core__ShortFloat_O,
  /* 33 */ &&obj_finalize_KIND_LISPALLOC_core__FileStatus_O,
  /* 34 */ &&obj_finalize_KIND_LISPALLOC_core__WeakHashTable_O,
  /* 35 */ &&obj_finalize_KIND_LISPALLOC_core__WeakKeyHashTable_O,
  /* 36 */ &&obj_finalize_KIND_LISPALLOC_core__Environment_O,
  /* 37 */ &&obj_finalize_KIND_LISPALLOC_core__ActivationFrame_O,
  /* 38 */ &&obj_finalize_KIND_LISPALLOC_core__TagbodyFrame_O,
  /* 39 */ &&obj_finalize_KIND_LISPALLOC_core__ValueFrame_O,
  /* 40 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionFrame_O,
  /* 41 */ &&obj_finalize_KIND_LISPALLOC_core__LexicalEnvironment_O,
  /* 42 */ &&obj_finalize_KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O,
  /* 43 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionValueEnvironment_O,
  /* 44 */ &&obj_finalize_KIND_LISPALLOC_core__ValueEnvironment_O,
  /* 45 */ &&obj_finalize_KIND_LISPALLOC_core__TagbodyEnvironment_O,
  /* 46 */ &&obj_finalize_KIND_LISPALLOC_core__CompileTimeEnvironment_O,
  /* 47 */ &&obj_finalize_KIND_LISPALLOC_core__UnwindProtectEnvironment_O,
  /* 48 */ &&obj_finalize_KIND_LISPALLOC_core__SymbolMacroletEnvironment_O,
  /* 49 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionContainerEnvironment_O,
  /* 50 */ &&obj_finalize_KIND_LISPALLOC_core__StackValueEnvironment_O,
  /* 51 */ &&obj_finalize_KIND_LISPALLOC_core__BlockEnvironment_O,
  /* 52 */ &&obj_finalize_KIND_LISPALLOC_core__MacroletEnvironment_O,
  /* 53 */ &&obj_finalize_KIND_LISPALLOC_core__CatchEnvironment_O,
  /* 54 */ &&obj_finalize_KIND_LISPALLOC_core__GlueEnvironment_O,
  /* 55 */ &&obj_finalize_KIND_LISPALLOC_core__Array_O,
  /* 56 */ &&obj_finalize_KIND_LISPALLOC_core__AbstractSimpleVector_O,
  /* 58 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleVector_O,
  /* 59 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleBitVector_O,
  /* 60 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleString_O,
  /* 62 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleCharacterString_O,
  /* 64 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleBaseString_O,
  /* 66 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleVectorDouble_O,
  /* 68 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleVector_size_t_O,
  /* 69 */ &&obj_finalize_KIND_LISPALLOC_core__MDArray_O,
  /* 70 */ &&obj_finalize_KIND_LISPALLOC_core__StrNs_O,
  /* 72 */ &&obj_finalize_KIND_LISPALLOC_core__Str8Ns_O,
  /* 74 */ &&obj_finalize_KIND_LISPALLOC_core__StrWNs_O,
  /* 76 */ &&obj_finalize_KIND_LISPALLOC_core__MDArrayT_O,
  /* 77 */ &&obj_finalize_KIND_LISPALLOC_core__BitVectorNs_O,
  /* 78 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArray_O,
  /* 80 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArray_size_t_O,
  /* 82 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayDouble_O,
  /* 84 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayBaseChar_O,
  /* 86 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayCharacter_O,
  /* 88 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayT_O,
  /* 89 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleMDArrayBit_O,
  /* 90 */ &&obj_finalize_KIND_LISPALLOC_core__MDArrayBit_O,
  /* 92 */ &&obj_finalize_KIND_LISPALLOC_core__MDArrayBaseChar_O,
  /* 94 */ &&obj_finalize_KIND_LISPALLOC_core__MDArrayDouble_O,
  /* 96 */ &&obj_finalize_KIND_LISPALLOC_core__MDArray_size_t_O,
  /* 98 */ &&obj_finalize_KIND_LISPALLOC_core__MDArrayCharacter_O,
  /* 99 */ &&obj_finalize_KIND_LISPALLOC_core__Exposer_O,
  /* 100 */ &&obj_finalize_KIND_LISPALLOC_asttooling__AsttoolingExposer_O,
  /* 101 */ &&obj_finalize_KIND_LISPALLOC_core__CoreExposer_O,
  /* 102 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchMethod_O,
  /* 103 */ &&obj_finalize_KIND_LISPALLOC_core__RandomState_O,
  /* 104 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O,
  /* 105 */ &&obj_finalize_KIND_LISPALLOC_core__SequenceStepper_O,
  /* 106 */ &&obj_finalize_KIND_LISPALLOC_core__ConsStepper_O,
  /* 107 */ &&obj_finalize_KIND_LISPALLOC_core__VectorStepper_O,
  /* 108 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DebugLoc_O,
  /* 109 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Attribute_O,
  /* 110 */ &&obj_finalize_KIND_LISPALLOC_core__WeakPointer_O,
  /* 111 */ &&obj_finalize_KIND_BOOTSTRAP_core__StandardObject_O,
  /* 112 */ &&obj_finalize_KIND_BOOTSTRAP_core__Metaobject_O,
  /* 113 */ &&obj_finalize_KIND_BOOTSTRAP_core__Specializer_O,
  /* 114 */ &&obj_finalize_KIND_BOOTSTRAP_core__Class_O,
  /* 115 */ &&obj_finalize_KIND_BOOTSTRAP_core__StdClass_O,
  /* 116 */ &&obj_finalize_KIND_BOOTSTRAP_core__StandardClass_O,
  /* 117 */ &&obj_finalize_KIND_LISPALLOC_core__FuncallableStandardClass_O,
  /* 118 */ &&obj_finalize_KIND_BOOTSTRAP_core__StructureClass_O,
  /* 119 */ &&obj_finalize_KIND_LISPALLOC_core__ForwardReferencedClass_O,
  /* 120 */ &&obj_finalize_KIND_LISPALLOC_core__CxxClass_O,
  /* 121 */ &&obj_finalize_KIND_BOOTSTRAP_core__BuiltInClass_O,
  /* 122 */ &&obj_finalize_KIND_LISPALLOC_clbind__ClassRep_O,
  /* 123 */ &&obj_finalize_KIND_LISPALLOC_core__ExternalObject_O,
  /* 124 */ &&obj_finalize_KIND_LISPALLOC_clasp_ffi__ForeignData_O,
  /* 125 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Value_O,
  /* 126 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Argument_O,
  /* 127 */ &&obj_finalize_KIND_LISPALLOC_llvmo__User_O,
  /* 128 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Instruction_O,
  /* 129 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicRMWInst_O,
  /* 130 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LandingPadInst_O,
  /* 131 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PHINode_O,
  /* 132 */ &&obj_finalize_KIND_LISPALLOC_llvmo__CallInst_O,
  /* 133 */ &&obj_finalize_KIND_LISPALLOC_llvmo__StoreInst_O,
  /* 134 */ &&obj_finalize_KIND_LISPALLOC_llvmo__UnaryInstruction_O,
  /* 135 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LoadInst_O,
  /* 136 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AllocaInst_O,
  /* 137 */ &&obj_finalize_KIND_LISPALLOC_llvmo__VAArgInst_O,
  /* 138 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O,
  /* 139 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TerminatorInst_O,
  /* 140 */ &&obj_finalize_KIND_LISPALLOC_llvmo__UnreachableInst_O,
  /* 141 */ &&obj_finalize_KIND_LISPALLOC_llvmo__SwitchInst_O,
  /* 142 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ReturnInst_O,
  /* 143 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ResumeInst_O,
  /* 144 */ &&obj_finalize_KIND_LISPALLOC_llvmo__BranchInst_O,
  /* 145 */ &&obj_finalize_KIND_LISPALLOC_llvmo__InvokeInst_O,
  /* 146 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IndirectBrInst_O,
  /* 147 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FenceInst_O,
  /* 148 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Constant_O,
  /* 149 */ &&obj_finalize_KIND_LISPALLOC_llvmo__BlockAddress_O,
  /* 150 */ &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalValue_O,
  /* 151 */ &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalVariable_O,
  /* 152 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Function_O,
  /* 153 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantArray_O,
  /* 154 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantInt_O,
  /* 155 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataSequential_O,
  /* 156 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataArray_O,
  /* 157 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantStruct_O,
  /* 158 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantFP_O,
  /* 159 */ &&obj_finalize_KIND_LISPALLOC_llvmo__UndefValue_O,
  /* 160 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantPointerNull_O,
  /* 161 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantExpr_O,
  /* 162 */ &&obj_finalize_KIND_LISPALLOC_llvmo__BasicBlock_O,
  /* 163 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IRBuilderBase_O,
  /* 164 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IRBuilder_O,
  /* 165 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIBuilder_O,
  /* 166 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Metadata_O,
  /* 167 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ValueAsMetadata_O,
  /* 168 */ &&obj_finalize_KIND_LISPALLOC_llvmo__MDNode_O,
  /* 169 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DINode_O,
  /* 170 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIScope_O,
  /* 171 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DICompileUnit_O,
  /* 172 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILocalScope_O,
  /* 173 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DISubprogram_O,
  /* 174 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlockBase_O,
  /* 175 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlock_O,
  /* 176 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIType_O,
  /* 177 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIDerivedType_O,
  /* 178 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIBasicType_O,
  /* 179 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DISubroutineType_O,
  /* 180 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DICompositeType_O,
  /* 181 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIFile_O,
  /* 182 */ &&obj_finalize_KIND_LISPALLOC_llvmo__MDString_O,
  /* 183 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ExecutionEngine_O,
  /* 184 */ &&obj_finalize_KIND_LISPALLOC_llvmo__APFloat_O,
  /* 185 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBuilder_O,
  /* 186 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Triple_O,
  /* 187 */ &&obj_finalize_KIND_LISPALLOC_llvmo__APInt_O,
  /* 188 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBase_O,
  /* 189 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPassManager_O,
  /* 190 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PassManager_O,
  /* 191 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetMachine_O,
  /* 192 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O,
  /* 193 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetOptions_O,
  /* 194 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Type_O,
  /* 195 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IntegerType_O,
  /* 196 */ &&obj_finalize_KIND_LISPALLOC_llvmo__CompositeType_O,
  /* 197 */ &&obj_finalize_KIND_LISPALLOC_llvmo__SequentialType_O,
  /* 198 */ &&obj_finalize_KIND_LISPALLOC_llvmo__VectorType_O,
  /* 199 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PointerType_O,
  /* 200 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ArrayType_O,
  /* 201 */ &&obj_finalize_KIND_LISPALLOC_llvmo__StructType_O,
  /* 202 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionType_O,
  /* 203 */ &&obj_finalize_KIND_LISPALLOC_llvmo__NamedMDNode_O,
  /* 204 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Linker_O,
  /* 205 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Pass_O,
  /* 206 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPass_O,
  /* 207 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ModulePass_O,
  /* 208 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ImmutablePass_O,
  /* 209 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O,
  /* 210 */ &&obj_finalize_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O,
  /* 211 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O,
  /* 212 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Module_O,
  /* 213 */ &&obj_finalize_KIND_LISPALLOC_llvmo__EngineBuilder_O,
  /* 214 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMContext_O,
  /* 215 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Target_O,
  /* 216 */ &&obj_finalize_KIND_LISPALLOC_core__LoadTimeValues_O,
  /* 217 */ &&obj_finalize_KIND_LISPALLOC_core__IntArray_O,
  /* 218 */ &&obj_finalize_KIND_LISPALLOC_core__SourceManager_O,
  /* 219 */ &&obj_finalize_KIND_LISPALLOC_core__Record_O,
  /* 220 */ &&obj_finalize_KIND_LISPALLOC_core__LightUserData_O,
  /* 221 */ &&obj_finalize_KIND_LISPALLOC_core__UserData_O,
  /* 222 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DataLayout_O,
  /* 223 */ &&obj_finalize_KIND_BOOTSTRAP_core__Symbol_O,
  /* 224 */ &&obj_finalize_KIND_LISPALLOC_core__Null_O,
  /* 225 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ModuleHandle_O,
  /* 226 */ &&obj_finalize_KIND_LISPALLOC_core__SourcePosInfo_O,
  /* 227 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ClaspJIT_O,
  /* 228 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__Iterator_O,
  /* 229 */ &&obj_finalize_KIND_LISPALLOC_core__DirectoryIterator_O,
  /* 230 */ &&obj_finalize_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O,
  /* 231 */ &&obj_finalize_KIND_LISPALLOC_core__PosixTimeDuration_O,
  /* 232 */ &&obj_finalize_KIND_LISPALLOC_core__SymbolToEnumConverter_O,
  /* 233 */ &&obj_finalize_KIND_LISPALLOC_core__CandoException_O,
  /* 234 */ &&obj_finalize_KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O,
  /* 235 */ &&obj_finalize_KIND_LISPALLOC_core__Stream_O,
  /* 236 */ &&obj_finalize_KIND_LISPALLOC_core__AnsiStream_O,
  /* 237 */ &&obj_finalize_KIND_LISPALLOC_core__FileStream_O,
  /* 238 */ &&obj_finalize_KIND_LISPALLOC_core__IOStreamStream_O,
  /* 239 */ &&obj_finalize_KIND_LISPALLOC_core__IOFileStream_O,
  /* 240 */ &&obj_finalize_KIND_LISPALLOC_core__ConcatenatedStream_O,
  /* 241 */ &&obj_finalize_KIND_LISPALLOC_core__StringStream_O,
  /* 242 */ &&obj_finalize_KIND_LISPALLOC_core__StringInputStream_O,
  /* 243 */ &&obj_finalize_KIND_LISPALLOC_core__StringOutputStream_O,
  /* 244 */ &&obj_finalize_KIND_LISPALLOC_core__SynonymStream_O,
  /* 245 */ &&obj_finalize_KIND_LISPALLOC_core__EchoStream_O,
  /* 246 */ &&obj_finalize_KIND_LISPALLOC_core__TwoWayStream_O,
  /* 247 */ &&obj_finalize_KIND_LISPALLOC_core__BroadcastStream_O,
  /* 248 */ &&obj_finalize_KIND_LISPALLOC_core__Reader_O,
  /* 249 */ &&obj_finalize_KIND_LISPALLOC_core__SharpEqualWrapper_O,
  /* 250 */ &&obj_finalize_KIND_LISPALLOC_core__Archive_O,
  /* 251 */ &&obj_finalize_KIND_LISPALLOC_core__SaveArchive_O,
  /* 252 */ &&obj_finalize_KIND_LISPALLOC_core__SexpSaveArchive_O,
  /* 253 */ &&obj_finalize_KIND_LISPALLOC_core__LoadArchive_O,
  /* 254 */ &&obj_finalize_KIND_LISPALLOC_core__SexpLoadArchive_O,
  /* 255 */ &&obj_finalize_KIND_LISPALLOC_core__HashTable_O,
  /* 256 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEq_O,
  /* 257 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEqualp_O,
  /* 258 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEql_O,
  /* 259 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEqual_O,
  /* 260 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__Creator_O,
  /* 261 */ &&obj_finalize_KIND_LISPALLOC_clbind__DummyCreator_O,
  /* 262 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_clbind__ConstructorCreator_O,
  /* 263 */ &&obj_finalize_KIND_LISPALLOC_core__InstanceCreator_O,
  /* 264 */ &&obj_finalize_KIND_LISPALLOC_core__CxxObject_O,
  /* 265 */ &&obj_finalize_KIND_LISPALLOC_core__NativeVector_float_O,
  /* 266 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Info_O,
  /* 267 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionInfo_O,
  /* 268 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LocalFunctionInfo_O,
  /* 269 */ &&obj_finalize_KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O,
  /* 270 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LambdaNameInfo_O,
  /* 271 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O,
  /* 272 */ &&obj_finalize_KIND_LISPALLOC_clcenv__GlobalMacroInfo_O,
  /* 273 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LocalMacroInfo_O,
  /* 274 */ &&obj_finalize_KIND_LISPALLOC_clcenv__OptimizeInfo_O,
  /* 275 */ &&obj_finalize_KIND_LISPALLOC_clcenv__BlockInfo_O,
  /* 276 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableInfo_O,
  /* 277 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SpecialVariableInfo_O,
  /* 278 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SymbolMacroInfo_O,
  /* 279 */ &&obj_finalize_KIND_LISPALLOC_clcenv__ConstantVariableInfo_O,
  /* 280 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LexicalVariableInfo_O,
  /* 281 */ &&obj_finalize_KIND_LISPALLOC_core__NativeVector_int_O,
  /* 282 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DINodeArray_O,
  /* 283 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DITypeRefArray_O,
  /* 284 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Entry_O,
  /* 285 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Inline_O,
  /* 286 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Closure_O,
  /* 287 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O,
  /* 288 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableDynamicExtent_O,
  /* 289 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SymbolMacro_O,
  /* 290 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionIgnore_O,
  /* 291 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Function_O,
  /* 292 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LambdaName_O,
  /* 293 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Block_O,
  /* 294 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SpecialVariable_O,
  /* 295 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LexicalVariable_O,
  /* 296 */ &&obj_finalize_KIND_LISPALLOC_clcenv__GlobalEnvironment_O,
  /* 297 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Tag_O,
  /* 298 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionType_O,
  /* 299 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Macro_O,
  /* 300 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableType_O,
  /* 301 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableIgnore_O,
  /* 302 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Optimize_O,
  /* 303 */ &&obj_finalize_KIND_LISPALLOC_core__NativeVector_double_O,
  /* 304 */ &&obj_finalize_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 305 */ &&obj_finalize_KIND_LISPALLOC_core__Cache_O,
  /* 306 */ &&obj_finalize_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 307 */ &&obj_finalize_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 308 */ &&obj_finalize_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 309 */ &&obj_finalize_KIND_LISPALLOC_core__SNode_O,
  /* 310 */ &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O,
  /* 311 */ &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O,
  /* 312 */ &&obj_finalize_KIND_LISPALLOC_core__Path_O,
  /* 314 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 315 */ &&obj_finalize_KIND_LISPALLOC_core__StructureObject_O,
  /* 316 */ &&obj_finalize_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 317 */ &&obj_finalize_KIND_LISPALLOC_core__Package_O,
  /* 318 */ &&obj_finalize_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 319 */ &&obj_finalize_KIND_LISPALLOC_core__Character_dummy_O,
  /* 320 */ &&obj_finalize_KIND_LISPALLOC_core__Function_O,
  /* 321 */ &&obj_finalize_KIND_LISPALLOC_core__NamedFunction_O,
  /* 322 */ &&obj_finalize_KIND_LISPALLOC_core__SpecialForm_O,
  /* 323 */ &&obj_finalize_KIND_LISPALLOC_core__Closure_O,
  /* 324 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 325 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionClosure_O,
  /* 326 */ &&obj_finalize_KIND_LISPALLOC_core__ClosureWithSlots_O,
  /* 327 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O,
  /* 328 */ &&obj_finalize_KIND_LISPALLOC_core__TranslationFunctor,
  /* 329 */ &&obj_finalize_KIND_LISPALLOC_core__MacroClosure_O,
  /* 330 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O,
  /* 331 */ &&obj_finalize_KIND_LISPALLOC_core__ClosureWithFrame_O,
  /* 332 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledClosure_O,
  /* 333 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledDispatchFunction_O,
  /* 334 */ &&obj_finalize_KIND_LISPALLOC_core__InterpretedClosure_O,
  /* 335 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchMethodFunction_O,
  /* 336 */ &&obj_finalize_KIND_LISPALLOC_core__CxxMethodFunction_O,
  /* 337 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 338 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O,
  /* 339 */ &&obj_finalize_KIND_LISPALLOC_core__Instance_O,
  /* 343 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction,
  /* 347 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction,
  /* 348 */ &&obj_finalize_KIND_LISPALLOC_core__Pointer_O,
  /* 349 */ &&obj_finalize_KIND_LISPALLOC_clbind__ClassRegistry_O,
  /* 350 */ &&obj_finalize_KIND_LISPALLOC_core__SmallMultimap_O,
  /* 351 */ &&obj_finalize_KIND_LISPALLOC_core__Pathname_O,
  /* 352 */ &&obj_finalize_KIND_LISPALLOC_core__LogicalPathname_O,
  /* 353 */ &&obj_finalize_KIND_LISPALLOC_core__PosixTime_O,
  /* 354 */ &&obj_finalize_KIND_LISPALLOC_core__SmallMap_O,
  /* 356 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
  /* 357 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 358 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_,
  /* 359 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 360 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 361 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__,
  /* 362 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 363 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 364 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 365 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__,
  /* 366 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_,
  /* 367 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__,
  /* 368 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  /* 369 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_,
  /* 370 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__,
  /* 371 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_int_,
  /* 372 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_double_,
  /* 373 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_,
  /* 374 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_double_,
  /* 375 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___,
  /* 376 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_,
  /* 377 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_,
  /* 378 */ &&obj_finalize_KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_,
  /* 379 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_float_,
  /* 380 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 381 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 382 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 383 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_int_,
  /* 384 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 385 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_,
  /* 388 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableMatchCallback,
  /* 390 */ &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 391 */ &&obj_finalize_KIND_ROOTCLASSALLOC_core__Lisp_O,
  /* 395 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory,
   NULL
};
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__AbstractSimpleVector_O:
{
    core::AbstractSimpleVector_O* obj_gc_safe = reinterpret_cast<core::AbstractSimpleVector_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleBaseString_O:
{
    core::SimpleBaseString_O* obj_gc_safe = reinterpret_cast<core::SimpleBaseString_O*>(client);
    GC<core::SimpleBaseString_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleVectorDouble_O:
{
    core::SimpleVectorDouble_O* obj_gc_safe = reinterpret_cast<core::SimpleVectorDouble_O*>(client);
    GC<core::SimpleVectorDouble_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleVector_size_t_O:
{
    core::SimpleVector_size_t_O* obj_gc_safe = reinterpret_cast<core::SimpleVector_size_t_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArray_O:
{
    core::SimpleMDArray_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArray_O*>(client);
    GC<core::SimpleMDArray_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArray_size_t_O:
{
    core::SimpleMDArray_size_t_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArray_size_t_O*>(client);
    GC<core::SimpleMDArray_size_t_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayDouble_O:
{
    core::SimpleMDArrayDouble_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArrayDouble_O*>(client);
    GC<core::SimpleMDArrayDouble_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayBaseChar_O:
{
    core::SimpleMDArrayBaseChar_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArrayBaseChar_O*>(client);
    GC<core::SimpleMDArrayBaseChar_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayCharacter_O:
{
    core::SimpleMDArrayCharacter_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArrayCharacter_O*>(client);
    GC<core::SimpleMDArrayCharacter_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayT_O:
{
    core::SimpleMDArrayT_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArrayT_O*>(client);
    GC<core::SimpleMDArrayT_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayBit_O:
{
    core::SimpleMDArrayBit_O* obj_gc_safe = reinterpret_cast<core::SimpleMDArrayBit_O*>(client);
    GC<core::SimpleMDArrayBit_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayBit_O:
{
    core::MDArrayBit_O* obj_gc_safe = reinterpret_cast<core::MDArrayBit_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayDouble_O:
{
    core::MDArrayDouble_O* obj_gc_safe = reinterpret_cast<core::MDArrayDouble_O*>(client);
    GC<core::MDArrayDouble_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArray_size_t_O:
{
    core::MDArray_size_t_O* obj_gc_safe = reinterpret_cast<core::MDArray_size_t_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ModuleHandle_O:
{
    llvmo::ModuleHandle_O* obj_gc_safe = reinterpret_cast<llvmo::ModuleHandle_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ClaspJIT_O:
{
    llvmo::ClaspJIT_O* obj_gc_safe = reinterpret_cast<llvmo::ClaspJIT_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledDispatchFunction_O:
{
    core::CompiledDispatchFunction_O* obj_gc_safe = reinterpret_cast<core::CompiledDispatchFunction_O*>(client);
...
static void* OBJ_DEALLOCATOR_table[] = { 
  /* 13 */ &&obj_deallocate_unmanaged_instance_KIND_ROOTCLASSALLOC_clbind__detail__class_map,
  /* 14 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__T_O,
  /* 15 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VaList_dummy_O,
  /* 16 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Cons_O,
  /* 17 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__General_O,
  /* 18 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MultiStringBuffer_O,
  /* 19 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ReadTable_O,
  /* 20 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Number_O,
  /* 21 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Complex_O,
  /* 22 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Real_O,
  /* 23 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Rational_O,
  /* 24 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Integer_O,
  /* 25 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Bignum_O,
  /* 26 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Fixnum_dummy_O,
  /* 27 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Ratio_O,
  /* 28 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Float_O,
  /* 29 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DoubleFloat_O,
  /* 30 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LongFloat_O,
  /* 31 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleFloat_dummy_O,
  /* 32 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ShortFloat_O,
  /* 33 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FileStatus_O,
  /* 34 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakHashTable_O,
  /* 35 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakKeyHashTable_O,
  /* 36 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Environment_O,
  /* 37 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ActivationFrame_O,
  /* 38 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TagbodyFrame_O,
  /* 39 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ValueFrame_O,
  /* 40 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionFrame_O,
  /* 41 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LexicalEnvironment_O,
  /* 42 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O,
  /* 43 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionValueEnvironment_O,
  /* 44 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ValueEnvironment_O,
  /* 45 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TagbodyEnvironment_O,
  /* 46 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompileTimeEnvironment_O,
  /* 47 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__UnwindProtectEnvironment_O,
  /* 48 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SymbolMacroletEnvironment_O,
  /* 49 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionContainerEnvironment_O,
  /* 50 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StackValueEnvironment_O,
  /* 51 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BlockEnvironment_O,
  /* 52 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MacroletEnvironment_O,
  /* 53 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CatchEnvironment_O,
  /* 54 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__GlueEnvironment_O,
  /* 55 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Array_O,
  /* 56 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__AbstractSimpleVector_O,
  /* 58 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleVector_O,
  /* 59 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleBitVector_O,
  /* 60 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleString_O,
  /* 62 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleCharacterString_O,
  /* 64 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleBaseString_O,
  /* 66 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleVectorDouble_O,
  /* 68 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleVector_size_t_O,
  /* 69 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArray_O,
  /* 70 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StrNs_O,
  /* 72 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Str8Ns_O,
  /* 74 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StrWNs_O,
  /* 76 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayT_O,
  /* 77 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BitVectorNs_O,
  /* 78 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArray_O,
  /* 80 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArray_size_t_O,
  /* 82 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayDouble_O,
  /* 84 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayBaseChar_O,
  /* 86 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayCharacter_O,
  /* 88 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayT_O,
  /* 89 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleMDArrayBit_O,
  /* 90 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayBit_O,
  /* 92 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayBaseChar_O,
  /* 94 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayDouble_O,
  /* 96 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArray_size_t_O,
  /* 98 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayCharacter_O,
  /* 99 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Exposer_O,
  /* 100 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AsttoolingExposer_O,
  /* 101 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CoreExposer_O,
  /* 102 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchMethod_O,
  /* 103 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__RandomState_O,
  /* 104 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O,
  /* 105 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SequenceStepper_O,
  /* 106 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ConsStepper_O,
  /* 107 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VectorStepper_O,
  /* 108 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DebugLoc_O,
  /* 109 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Attribute_O,
  /* 110 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakPointer_O,
  /* 111 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StandardObject_O,
  /* 112 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Metaobject_O,
  /* 113 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Specializer_O,
  /* 114 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Class_O,
  /* 115 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StdClass_O,
  /* 116 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StandardClass_O,
  /* 117 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FuncallableStandardClass_O,
  /* 118 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StructureClass_O,
  /* 119 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ForwardReferencedClass_O,
  /* 120 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxClass_O,
  /* 121 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__BuiltInClass_O,
  /* 122 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__ClassRep_O,
  /* 123 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ExternalObject_O,
  /* 124 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clasp_ffi__ForeignData_O,
  /* 125 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Value_O,
  /* 126 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Argument_O,
  /* 127 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__User_O,
  /* 128 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Instruction_O,
  /* 129 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AtomicRMWInst_O,
  /* 130 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LandingPadInst_O,
  /* 131 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PHINode_O,
  /* 132 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__CallInst_O,
  /* 133 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__StoreInst_O,
  /* 134 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__UnaryInstruction_O,
  /* 135 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LoadInst_O,
  /* 136 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AllocaInst_O,
  /* 137 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__VAArgInst_O,
  /* 138 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O,
  /* 139 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TerminatorInst_O,
  /* 140 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__UnreachableInst_O,
  /* 141 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__SwitchInst_O,
  /* 142 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ReturnInst_O,
  /* 143 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ResumeInst_O,
  /* 144 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__BranchInst_O,
  /* 145 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__InvokeInst_O,
  /* 146 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IndirectBrInst_O,
  /* 147 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FenceInst_O,
  /* 148 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Constant_O,
  /* 149 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__BlockAddress_O,
  /* 150 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__GlobalValue_O,
  /* 151 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__GlobalVariable_O,
  /* 152 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Function_O,
  /* 153 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantArray_O,
  /* 154 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantInt_O,
  /* 155 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantDataSequential_O,
  /* 156 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantDataArray_O,
  /* 157 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantStruct_O,
  /* 158 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantFP_O,
  /* 159 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__UndefValue_O,
  /* 160 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantPointerNull_O,
  /* 161 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantExpr_O,
  /* 162 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__BasicBlock_O,
  /* 163 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IRBuilderBase_O,
  /* 164 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IRBuilder_O,
  /* 165 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIBuilder_O,
  /* 166 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Metadata_O,
  /* 167 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ValueAsMetadata_O,
  /* 168 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__MDNode_O,
  /* 169 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINode_O,
  /* 170 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIScope_O,
  /* 171 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DICompileUnit_O,
  /* 172 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILocalScope_O,
  /* 173 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DISubprogram_O,
  /* 174 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILexicalBlockBase_O,
  /* 175 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILexicalBlock_O,
  /* 176 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIType_O,
  /* 177 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIDerivedType_O,
  /* 178 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIBasicType_O,
  /* 179 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DISubroutineType_O,
  /* 180 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DICompositeType_O,
  /* 181 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIFile_O,
  /* 182 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__MDString_O,
  /* 183 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ExecutionEngine_O,
  /* 184 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__APFloat_O,
  /* 185 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PassManagerBuilder_O,
  /* 186 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Triple_O,
  /* 187 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__APInt_O,
  /* 188 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PassManagerBase_O,
  /* 189 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FunctionPassManager_O,
  /* 190 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PassManager_O,
  /* 191 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetMachine_O,
  /* 192 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O,
  /* 193 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetOptions_O,
  /* 194 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Type_O,
  /* 195 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IntegerType_O,
  /* 196 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__CompositeType_O,
  /* 197 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__SequentialType_O,
  /* 198 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__VectorType_O,
  /* 199 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PointerType_O,
  /* 200 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ArrayType_O,
  /* 201 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__StructType_O,
  /* 202 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FunctionType_O,
  /* 203 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__NamedMDNode_O,
  /* 204 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Linker_O,
  /* 205 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Pass_O,
  /* 206 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FunctionPass_O,
  /* 207 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ModulePass_O,
  /* 208 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ImmutablePass_O,
  /* 209 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O,
  /* 210 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O,
  /* 211 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O,
  /* 212 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Module_O,
  /* 213 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__EngineBuilder_O,
  /* 214 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LLVMContext_O,
  /* 215 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Target_O,
  /* 216 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LoadTimeValues_O,
  /* 217 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__IntArray_O,
  /* 218 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourceManager_O,
  /* 219 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Record_O,
  /* 220 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LightUserData_O,
  /* 221 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__UserData_O,
  /* 222 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DataLayout_O,
  /* 223 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Symbol_O,
  /* 224 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Null_O,
  /* 225 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ModuleHandle_O,
  /* 226 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourcePosInfo_O,
  /* 227 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ClaspJIT_O,
  /* 228 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__Iterator_O,
  /* 229 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DirectoryIterator_O,
  /* 230 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O,
  /* 231 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__PosixTimeDuration_O,
  /* 232 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SymbolToEnumConverter_O,
  /* 233 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CandoException_O,
  /* 234 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O,
  /* 235 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Stream_O,
  /* 236 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__AnsiStream_O,
  /* 237 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FileStream_O,
  /* 238 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__IOStreamStream_O,
  /* 239 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__IOFileStream_O,
  /* 240 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ConcatenatedStream_O,
  /* 241 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StringStream_O,
  /* 242 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StringInputStream_O,
  /* 243 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StringOutputStream_O,
  /* 244 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SynonymStream_O,
  /* 245 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__EchoStream_O,
  /* 246 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TwoWayStream_O,
  /* 247 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BroadcastStream_O,
  /* 248 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Reader_O,
  /* 249 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SharpEqualWrapper_O,
  /* 250 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Archive_O,
  /* 251 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SaveArchive_O,
  /* 252 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SexpSaveArchive_O,
  /* 253 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LoadArchive_O,
  /* 254 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SexpLoadArchive_O,
  /* 255 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTable_O,
  /* 256 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEq_O,
  /* 257 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEqualp_O,
  /* 258 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEql_O,
  /* 259 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEqual_O,
  /* 260 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__Creator_O,
  /* 261 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__DummyCreator_O,
  /* 262 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_clbind__ConstructorCreator_O,
  /* 263 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InstanceCreator_O,
  /* 264 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxObject_O,
  /* 265 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_float_O,
  /* 266 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Info_O,
  /* 267 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionInfo_O,
  /* 268 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LocalFunctionInfo_O,
  /* 269 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O,
  /* 270 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LambdaNameInfo_O,
  /* 271 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O,
  /* 272 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalMacroInfo_O,
  /* 273 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LocalMacroInfo_O,
  /* 274 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__OptimizeInfo_O,
  /* 275 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__BlockInfo_O,
  /* 276 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableInfo_O,
  /* 277 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialVariableInfo_O,
  /* 278 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SymbolMacroInfo_O,
  /* 279 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__ConstantVariableInfo_O,
  /* 280 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LexicalVariableInfo_O,
  /* 281 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_int_O,
  /* 282 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINodeArray_O,
  /* 283 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DITypeRefArray_O,
  /* 284 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Entry_O,
  /* 285 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Inline_O,
  /* 286 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Closure_O,
  /* 287 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O,
  /* 288 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableDynamicExtent_O,
  /* 289 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SymbolMacro_O,
  /* 290 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionIgnore_O,
  /* 291 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Function_O,
  /* 292 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LambdaName_O,
  /* 293 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Block_O,
  /* 294 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialVariable_O,
  /* 295 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LexicalVariable_O,
  /* 296 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalEnvironment_O,
  /* 297 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Tag_O,
  /* 298 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionType_O,
  /* 299 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Macro_O,
  /* 300 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableType_O,
  /* 301 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableIgnore_O,
  /* 302 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Optimize_O,
  /* 303 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_double_O,
  /* 304 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 305 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Cache_O,
  /* 306 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 307 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 308 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 309 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SNode_O,
  /* 310 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LeafSNode_O,
  /* 311 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BranchSNode_O,
  /* 312 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Path_O,
  /* 314 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 315 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StructureObject_O,
  /* 316 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 317 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Package_O,
  /* 318 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 319 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Character_dummy_O,
  /* 320 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Function_O,
  /* 321 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NamedFunction_O,
  /* 322 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecialForm_O,
  /* 323 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Closure_O,
  /* 324 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 325 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionClosure_O,
  /* 326 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithSlots_O,
  /* 327 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O,
  /* 328 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TranslationFunctor,
  /* 329 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MacroClosure_O,
  /* 330 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O,
  /* 331 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithFrame_O,
  /* 332 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledClosure_O,
  /* 333 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledDispatchFunction_O,
  /* 334 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InterpretedClosure_O,
  /* 335 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchMethodFunction_O,
  /* 336 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxMethodFunction_O,
  /* 337 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 338 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O,
  /* 339 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Instance_O,
  /* 343 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction,
  /* 347 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction,
  /* 348 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pointer_O,
  /* 349 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__ClassRegistry_O,
  /* 350 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SmallMultimap_O,
  /* 351 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pathname_O,
  /* 352 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LogicalPathname_O,
  /* 353 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__PosixTime_O,
  /* 354 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SmallMap_O,
  /* 356 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
  /* 357 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 358 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_,
  /* 359 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 360 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 361 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__,
  /* 362 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 363 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 364 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 365 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__,
  /* 366 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_,
  /* 367 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__,
  /* 368 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  /* 369 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_,
  /* 370 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__,
  /* 371 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_int_,
  /* 372 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_double_,
  /* 373 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_,
  /* 374 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_double_,
  /* 375 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___,
  /* 376 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_,
  /* 377 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_,
  /* 378 */ &&obj_deallocate_unmanaged_instance_KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_,
  /* 379 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_float_,
  /* 380 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 381 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 382 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 383 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_int_,
  /* 384 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 385 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_,
  /* 388 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableMatchCallback,
  /* 390 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 391 */ &&obj_deallocate_unmanaged_instance_KIND_ROOTCLASSALLOC_core__Lisp_O,
  /* 395 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory,
   NULL
};
