...
register_stamp_name("STAMP_core__SmallMap_O",  13);
register_stamp_name("STAMP_core__WrappedPointer_O",  14);
...
register_stamp_name("STAMP_core__Reader_O",  21);
...
register_stamp_name("STAMP_clcenv__Info_O",  172);
register_stamp_name("STAMP_clcenv__OptimizeInfo_O",  173);
register_stamp_name("STAMP_clcenv__BlockInfo_O",  174);
register_stamp_name("STAMP_clcenv__FunctionInfo_O",  175);
register_stamp_name("STAMP_clcenv__GlobalMacroInfo_O",  176);
register_stamp_name("STAMP_clcenv__LocalMacroInfo_O",  177);
register_stamp_name("STAMP_clcenv__LocalFunctionInfo_O",  178);
register_stamp_name("STAMP_clcenv__SpecialOperatorInfo_O",  179);
register_stamp_name("STAMP_clcenv__LambdaNameInfo_O",  180);
register_stamp_name("STAMP_clcenv__GlobalFunctionInfo_O",  181);
register_stamp_name("STAMP_clcenv__VariableInfo_O",  182);
register_stamp_name("STAMP_clcenv__SpecialVariableInfo_O",  183);
register_stamp_name("STAMP_clcenv__LexicalVariableInfo_O",  184);
register_stamp_name("STAMP_clcenv__SymbolMacroInfo_O",  185);
register_stamp_name("STAMP_clcenv__ConstantVariableInfo_O",  186);
register_stamp_name("STAMP_mp__ConditionVariable_O",  187);
register_stamp_name("STAMP_mp__Mutex_O",  188);
register_stamp_name("STAMP_mp__RecursiveMutex_O",  189);
register_stamp_name("STAMP_llvmo__DITypeRefArray_O",  190);
register_stamp_name("STAMP_core__NativeVector_double_O",  191);
register_stamp_name("STAMP_core__NativeVector_int_O",  192);
register_stamp_name("STAMP_mp__SharedMutex_O",  193);
register_stamp_name("STAMP_clcenv__Entry_O",  194);
register_stamp_name("STAMP_clcenv__VariableType_O",  195);
register_stamp_name("STAMP_clcenv__VariableIgnore_O",  196);
register_stamp_name("STAMP_clcenv__Function_O",  197);
register_stamp_name("STAMP_clcenv__SymbolMacro_O",  198);
register_stamp_name("STAMP_clcenv__FunctionDynamicExtent_O",  199);
register_stamp_name("STAMP_clcenv__Inline_O",  200);
register_stamp_name("STAMP_clcenv__Closure_O",  201);
register_stamp_name("STAMP_clcenv__Optimize_O",  202);
register_stamp_name("STAMP_clcenv__LambdaName_O",  203);
register_stamp_name("STAMP_clcenv__Tag_O",  204);
register_stamp_name("STAMP_clcenv__Block_O",  205);
register_stamp_name("STAMP_clcenv__FunctionType_O",  206);
register_stamp_name("STAMP_clcenv__GlobalEnvironment_O",  207);
register_stamp_name("STAMP_clcenv__VariableDynamicExtent_O",  208);
register_stamp_name("STAMP_clcenv__LexicalVariable_O",  209);
register_stamp_name("STAMP_clcenv__SpecialVariable_O",  210);
register_stamp_name("STAMP_clcenv__Macro_O",  211);
register_stamp_name("STAMP_clcenv__FunctionIgnore_O",  212);
register_stamp_name("STAMP_mp__Process_O",  213);
register_stamp_name("STAMP_core__SingleDispatchMethod_O",  214);
register_stamp_name("STAMP_core__Iterator_O",  215);
register_stamp_name("STAMP_core__RecursiveDirectoryIterator_O",  216);
register_stamp_name("STAMP_core__DirectoryIterator_O",  217);
register_stamp_name("STAMP_llvmo__InsertPoint_O",  218);
register_stamp_name("STAMP_core__Array_O",  219);
register_stamp_name("STAMP_core__AbstractSimpleVector_O",  220);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVectorFloat_O_float_core__AbstractSimpleVector_O_",  221);
register_stamp_name("STAMP_core__SimpleVectorFloat_O",  222);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_byte64_t_O_unsigned_long_core__AbstractSimpleVector_O_",  223);
register_stamp_name("STAMP_core__SimpleVector_byte64_t_O",  224);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_int64_t_O_long_core__AbstractSimpleVector_O_",  225);
register_stamp_name("STAMP_core__SimpleVector_int64_t_O",  226);
register_stamp_name("STAMP_core__SimpleString_O",  227);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleCharacterString_O_int_core__SimpleString_O_",  228);
register_stamp_name("STAMP_core__SimpleCharacterString_O",  229);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleBaseString_O_unsigned_char_core__SimpleString_O_",  230);
register_stamp_name("STAMP_core__SimpleBaseString_O",  231);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_int16_t_O_short_core__AbstractSimpleVector_O_",  232);
register_stamp_name("STAMP_core__SimpleVector_int16_t_O",  233);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_byte16_t_O_unsigned_short_core__AbstractSimpleVector_O_",  234);
register_stamp_name("STAMP_core__SimpleVector_byte16_t_O",  235);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_fixnum_O_long_core__AbstractSimpleVector_O_",  236);
register_stamp_name("STAMP_core__SimpleVector_fixnum_O",  237);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_int8_t_O_signed_char_core__AbstractSimpleVector_O_",  238);
register_stamp_name("STAMP_core__SimpleVector_int8_t_O",  239);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_O_gctools__smart_ptr_core__T_O__core__AbstractSimpleVector_O_",  240);
register_stamp_name("STAMP_core__SimpleVector_O",  241);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_byte8_t_O_unsigned_char_core__AbstractSimpleVector_O_",  242);
register_stamp_name("STAMP_core__SimpleVector_byte8_t_O",  243);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_int32_t_O_int_core__AbstractSimpleVector_O_",  244);
register_stamp_name("STAMP_core__SimpleVector_int32_t_O",  245);
register_stamp_name("STAMP_core__SimpleBitVector_O",  246);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_byte32_t_O_unsigned_int_core__AbstractSimpleVector_O_",  247);
register_stamp_name("STAMP_core__SimpleVector_byte32_t_O",  248);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVector_size_t_O_unsigned_long_core__AbstractSimpleVector_O_",  249);
register_stamp_name("STAMP_core__SimpleVector_size_t_O",  250);
register_stamp_name("STAMP_core__template_SimpleVector_core__SimpleVectorDouble_O_double_core__AbstractSimpleVector_O_",  251);
register_stamp_name("STAMP_core__SimpleVectorDouble_O",  252);
register_stamp_name("STAMP_core__MDArray_O",  253);
register_stamp_name("STAMP_core__BitVectorNs_O",  254);
register_stamp_name("STAMP_core__template_Array_core__MDArray_byte64_t_O_core__SimpleMDArray_byte64_t_O_core__SimpleVector_byte64_t_O_core__MDArray_O_",  255);
register_stamp_name("STAMP_core__MDArray_byte64_t_O",  256);
register_stamp_name("STAMP_core__template_Array_core__MDArray_int16_t_O_core__SimpleMDArray_int16_t_O_core__SimpleVector_int16_t_O_core__MDArray_O_",  257);
register_stamp_name("STAMP_core__MDArray_int16_t_O",  258);
register_stamp_name("STAMP_core__template_Array_core__MDArray_int8_t_O_core__SimpleMDArray_int8_t_O_core__SimpleVector_int8_t_O_core__MDArray_O_",  259);
register_stamp_name("STAMP_core__MDArray_int8_t_O",  260);
register_stamp_name("STAMP_core__template_Array_core__MDArrayCharacter_O_core__SimpleMDArrayCharacter_O_core__SimpleCharacterString_O_core__MDArray_O_",  261);
register_stamp_name("STAMP_core__MDArrayCharacter_O",  262);
register_stamp_name("STAMP_core__template_Array_core__MDArray_int32_t_O_core__SimpleMDArray_int32_t_O_core__SimpleVector_int32_t_O_core__MDArray_O_",  263);
register_stamp_name("STAMP_core__MDArray_int32_t_O",  264);
register_stamp_name("STAMP_core__template_Array_core__MDArrayFloat_O_core__SimpleMDArrayFloat_O_core__SimpleVectorFloat_O_core__MDArray_O_",  265);
register_stamp_name("STAMP_core__MDArrayFloat_O",  266);
register_stamp_name("STAMP_core__StrNs_O",  267);
register_stamp_name("STAMP_core__template_Vector_core__StrWNs_O_core__SimpleCharacterString_O_core__StrNs_O_",  268);
register_stamp_name("STAMP_core__StrWNs_O",  269);
register_stamp_name("STAMP_core__template_Vector_core__Str8Ns_O_core__SimpleBaseString_O_core__StrNs_O_",  270);
register_stamp_name("STAMP_core__Str8Ns_O",  271);
register_stamp_name("STAMP_core__template_Array_core__MDArrayDouble_O_core__SimpleMDArrayDouble_O_core__SimpleVectorDouble_O_core__MDArray_O_",  272);
register_stamp_name("STAMP_core__MDArrayDouble_O",  273);
register_stamp_name("STAMP_core__template_Array_core__MDArrayT_O_core__SimpleMDArrayT_O_core__SimpleVector_O_core__MDArray_O_",  274);
register_stamp_name("STAMP_core__MDArrayT_O",  275);
register_stamp_name("STAMP_core__template_Array_core__MDArray_size_t_O_core__SimpleMDArray_size_t_O_core__SimpleVector_size_t_O_core__MDArray_O_",  276);
register_stamp_name("STAMP_core__MDArray_size_t_O",  277);
register_stamp_name("STAMP_core__template_Array_core__MDArray_byte8_t_O_core__SimpleMDArray_byte8_t_O_core__SimpleVector_byte8_t_O_core__MDArray_O_",  278);
register_stamp_name("STAMP_core__MDArray_byte8_t_O",  279);
register_stamp_name("STAMP_core__MDArrayBit_O",  280);
register_stamp_name("STAMP_core__template_Array_core__MDArray_int64_t_O_core__SimpleMDArray_int64_t_O_core__SimpleVector_int64_t_O_core__MDArray_O_",  281);
register_stamp_name("STAMP_core__MDArray_int64_t_O",  282);
register_stamp_name("STAMP_core__template_Array_core__MDArray_byte16_t_O_core__SimpleMDArray_byte16_t_O_core__SimpleVector_byte16_t_O_core__MDArray_O_",  283);
register_stamp_name("STAMP_core__MDArray_byte16_t_O",  284);
register_stamp_name("STAMP_core__template_Array_core__MDArray_byte32_t_O_core__SimpleMDArray_byte32_t_O_core__SimpleVector_byte32_t_O_core__MDArray_O_",  285);
register_stamp_name("STAMP_core__MDArray_byte32_t_O",  286);
register_stamp_name("STAMP_core__SimpleMDArray_O",  287);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_int8_t_O_core__SimpleVector_int8_t_O_core__SimpleMDArray_O_",  288);
register_stamp_name("STAMP_core__SimpleMDArray_int8_t_O",  289);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArrayCharacter_O_core__SimpleCharacterString_O_core__SimpleMDArray_O_",  290);
register_stamp_name("STAMP_core__SimpleMDArrayCharacter_O",  291);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_fixnum_O_core__SimpleVector_fixnum_O_core__SimpleMDArray_O_",  292);
register_stamp_name("STAMP_core__SimpleMDArray_fixnum_O",  293);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_byte32_t_O_core__SimpleVector_byte32_t_O_core__SimpleMDArray_O_",  294);
register_stamp_name("STAMP_core__SimpleMDArray_byte32_t_O",  295);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_byte16_t_O_core__SimpleVector_byte16_t_O_core__SimpleMDArray_O_",  296);
register_stamp_name("STAMP_core__SimpleMDArray_byte16_t_O",  297);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArrayT_O_core__SimpleVector_O_core__SimpleMDArray_O_",  298);
register_stamp_name("STAMP_core__SimpleMDArrayT_O",  299);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_int32_t_O_core__SimpleVector_int32_t_O_core__SimpleMDArray_O_",  300);
register_stamp_name("STAMP_core__SimpleMDArray_int32_t_O",  301);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArrayDouble_O_core__SimpleVectorDouble_O_core__SimpleMDArray_O_",  302);
register_stamp_name("STAMP_core__SimpleMDArrayDouble_O",  303);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArrayBaseChar_O_core__SimpleBaseString_O_core__SimpleMDArray_O_",  304);
register_stamp_name("STAMP_core__SimpleMDArrayBaseChar_O",  305);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_byte64_t_O_core__SimpleVector_byte64_t_O_core__SimpleMDArray_O_",  306);
register_stamp_name("STAMP_core__SimpleMDArray_byte64_t_O",  307);
register_stamp_name("STAMP_core__SimpleMDArrayBit_O",  308);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_int16_t_O_core__SimpleVector_int16_t_O_core__SimpleMDArray_O_",  309);
register_stamp_name("STAMP_core__SimpleMDArray_int16_t_O",  310);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_byte8_t_O_core__SimpleVector_byte8_t_O_core__SimpleMDArray_O_",  311);
register_stamp_name("STAMP_core__SimpleMDArray_byte8_t_O",  312);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_size_t_O_core__SimpleVector_size_t_O_core__SimpleMDArray_O_",  313);
register_stamp_name("STAMP_core__SimpleMDArray_size_t_O",  314);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArray_int64_t_O_core__SimpleVector_int64_t_O_core__SimpleMDArray_O_",  315);
register_stamp_name("STAMP_core__SimpleMDArray_int64_t_O",  316);
register_stamp_name("STAMP_core__template_SimpleArray_core__SimpleMDArrayFloat_O_core__SimpleVectorFloat_O_core__SimpleMDArray_O_",  317);
register_stamp_name("STAMP_core__SimpleMDArrayFloat_O",  318);
register_stamp_name("STAMP_core__template_Array_core__MDArray_fixnum_O_core__SimpleMDArray_fixnum_O_core__SimpleVector_fixnum_O_core__MDArray_O_",  319);
register_stamp_name("STAMP_core__MDArray_fixnum_O",  320);
register_stamp_name("STAMP_core__template_Array_core__MDArrayBaseChar_O_core__SimpleMDArrayBaseChar_O_core__SimpleBaseString_O_core__MDArray_O_",  321);
register_stamp_name("STAMP_core__MDArrayBaseChar_O",  322);
register_stamp_name("STAMP_core__Symbol_O",  323);
register_stamp_name("STAMP_core__Null_O",  324);
register_stamp_name("STAMP_mp__BlockingConcurrentQueue_O",  325);
register_stamp_name("STAMP_core__Path_O",  326);
register_stamp_name("STAMP_core__Character_dummy_O",  327);
register_stamp_name("STAMP_core__SourceManager_O",  328);
register_stamp_name("STAMP_llvmo__DataLayout_O",  329);
register_stamp_name("STAMP_core__Pathname_O",  330);
register_stamp_name("STAMP_core__LogicalPathname_O",  331);
register_stamp_name("STAMP_core__Cache_O",  332);
register_stamp_name("STAMP_core__LoadTimeValues_O",  333);
register_stamp_name("STAMP_core__SharpEqualWrapper_O",  334);
register_stamp_name("STAMP_core__Number_O",  335);
register_stamp_name("STAMP_core__Real_O",  336);
register_stamp_name("STAMP_core__Rational_O",  337);
register_stamp_name("STAMP_core__Ratio_O",  338);
register_stamp_name("STAMP_core__Integer_O",  339);
register_stamp_name("STAMP_core__Bignum_O",  340);
register_stamp_name("STAMP_core__Fixnum_dummy_O",  341);
register_stamp_name("STAMP_core__Float_O",  342);
register_stamp_name("STAMP_core__DoubleFloat_O",  343);
register_stamp_name("STAMP_core__SingleFloat_dummy_O",  344);
register_stamp_name("STAMP_core__LongFloat_O",  345);
register_stamp_name("STAMP_core__ShortFloat_O",  346);
register_stamp_name("STAMP_core__Complex_O",  347);
register_stamp_name("STAMP_core__Stream_O",  348);
register_stamp_name("STAMP_core__AnsiStream_O",  349);
register_stamp_name("STAMP_core__TwoWayStream_O",  350);
register_stamp_name("STAMP_core__BroadcastStream_O",  351);
register_stamp_name("STAMP_core__SynonymStream_O",  352);
register_stamp_name("STAMP_core__ConcatenatedStream_O",  353);
register_stamp_name("STAMP_core__StringStream_O",  354);
register_stamp_name("STAMP_core__StringOutputStream_O",  355);
register_stamp_name("STAMP_core__StringInputStream_O",  356);
register_stamp_name("STAMP_core__FileStream_O",  357);
register_stamp_name("STAMP_core__IOFileStream_O",  358);
register_stamp_name("STAMP_core__IOStreamStream_O",  359);
register_stamp_name("STAMP_core__EchoStream_O",  360);
register_stamp_name("STAMP_core__Package_O",  361);
register_stamp_name("STAMP_llvmo__ClaspJIT_O",  362);
register_stamp_name("STAMP_core__FileStatus_O",  363);
register_stamp_name("STAMP_core__InvocationHistoryFrameIterator_O",  364);
register_stamp_name("STAMP_core__PosixTime_O",  365);
register_stamp_name("STAMP_core__HashTable_O",  366);
register_stamp_name("STAMP_core__HashTableEqual_O",  367);
register_stamp_name("STAMP_core__HashTableEqualp_O",  368);
register_stamp_name("STAMP_core__HashTableEq_O",  369);
register_stamp_name("STAMP_core__HashTableEql_O",  370);
register_stamp_name("STAMP_core__Exposer_O",  371);
register_stamp_name("STAMP_core__CoreExposer_O",  372);
register_stamp_name("STAMP_asttooling__AsttoolingExposer_O",  373);
register_stamp_name("STAMP_core__SourcePosInfo_O",  374);
register_stamp_name("STAMP_core__IntArray_O",  375);
register_stamp_name("STAMP_core__SourceFileInfo_O",  376);
register_stamp_name("STAMP_core__DirectoryEntry_O",  377);
register_stamp_name("STAMP_core__LightUserData_O",  378);
register_stamp_name("STAMP_core__UserData_O",  379);
register_stamp_name("STAMP_core__Record_O",  380);
register_stamp_name("STAMP_clbind__ClassRegistry_O",  381);
register_stamp_name("STAMP_mp__ConcurrentQueue_O",  382);
register_stamp_name("STAMP_core__Cons_O",  383);
register_stamp_name("STAMP_clang__ast_matchers__MatchFinder__MatchCallback",  384);
register_stamp_name("STAMP_core__Lisp_O",  385);
register_stamp_name("STAMP_clang__RecursiveASTVisitor_asttooling__AstVisitor_O_",  386);
register_stamp_name("STAMP_asttooling__AstVisitor_O",  387);
register_stamp_name("STAMP_gctools__GCContainer",  388);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__KeywordArgument_",  389);
register_stamp_name("STAMP_gctools__GCArray_moveable_unsigned_int_",  390);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__CacheRecord_",  391);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__RequiredArgument_",  392);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__",  393);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__",  394);
register_stamp_name("STAMP_gctools__GCVector_moveable_double_",  395);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__SymbolStorage_",  396);
register_stamp_name("STAMP_gctools__GCArray_moveable_short_",  397);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__DynamicBinding_",  398);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__",  399);
register_stamp_name("STAMP_gctools__GCArray_moveable_unsigned_long_",  400);
register_stamp_name("STAMP_gctools__GCBitUnitArray_moveable_1_unsigned_int_int_",  401);
register_stamp_name("STAMP_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___",  402);
register_stamp_name("STAMP_gctools__GCArray_moveable_signed_char_",  403);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__ExceptionEntry_",  404);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__",  405);
register_stamp_name("STAMP_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___",  406);
register_stamp_name("STAMP_gctools__GCArray_moveable_int_",  407);
register_stamp_name("STAMP_gctools__GCArray_moveable_unsigned_char_",  408);
register_stamp_name("STAMP_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__",  409);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__AuxArgument_",  410);
register_stamp_name("STAMP_gctools__GCArray_moveable_long_",  411);
register_stamp_name("STAMP_gctools__GCVector_moveable_int_",  412);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__",  413);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__",  414);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__SymbolClassPair_",  415);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__",  416);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__",  417);
register_stamp_name("STAMP_gctools__GCArray_moveable_float_",  418);
register_stamp_name("STAMP_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__",  419);
register_stamp_name("STAMP_gctools__GCArray_moveable_double_",  420);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__T_O___",  421);
register_stamp_name("STAMP_gctools__GCVector_moveable_core__OptionalArgument_",  422);
register_stamp_name("STAMP_gctools__GCArray_moveable_unsigned_short_",  423);
register_stamp_name("STAMP_gctools__GCVector_moveable_float_",  424);
register_stamp_name("STAMP_clang__FrontendAction",  425);
register_stamp_name("STAMP_clang__ASTFrontendAction",  426);
register_stamp_name("STAMP_clang__SyntaxOnlyAction",  427);
register_stamp_name("STAMP_clang__tooling__ToolAction",  428);
register_stamp_name("STAMP_clang__tooling__FrontendActionFactory",  429);
register_stamp_name("STAMP_clbind__detail__class_map",  430);
