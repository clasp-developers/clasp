...
KIND_LISPALLOC_llvmo__TargetLibraryInfo_O = 138,
...
KIND_LISPALLOC_llvmo__TargetOptions_O = 143,
KIND_LISPALLOC_llvmo__EngineBuilder_O = 144,
KIND_LISPALLOC_llvmo__APInt_O = 145,
KIND_LISPALLOC_llvmo__MCSubtargetInfo_O = 146,
KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O = 147,
KIND_LISPALLOC_llvmo__Target_O = 148,
KIND_LISPALLOC_llvmo__APFloat_O = 149,
KIND_LISPALLOC_core__ForeignData_O = 150,
KIND_LISPALLOC_llvmo__PassManagerBuilder_O = 151,
KIND_LISPALLOC_llvmo__PassManagerBase_O = 152,
KIND_LISPALLOC_llvmo__PassManager_O = 153,
KIND_LISPALLOC_llvmo__FunctionPassManager_O = 154,
KIND_LISPALLOC_llvmo__DataLayout_O = 155,
KIND_LISPALLOC_llvmo__Type_O = 156,
KIND_LISPALLOC_llvmo__CompositeType_O = 157,
KIND_LISPALLOC_llvmo__SequentialType_O = 158,
KIND_LISPALLOC_llvmo__PointerType_O = 159,
KIND_LISPALLOC_llvmo__VectorType_O = 160,
KIND_LISPALLOC_llvmo__ArrayType_O = 161,
KIND_LISPALLOC_llvmo__StructType_O = 162,
KIND_LISPALLOC_llvmo__IntegerType_O = 163,
KIND_LISPALLOC_llvmo__FunctionType_O = 164,
KIND_LISPALLOC_llvmo__Linker_O = 165,
KIND_LISPALLOC_llvmo__Value_O = 166,
KIND_LISPALLOC_llvmo__Argument_O = 167,
KIND_LISPALLOC_llvmo__MDString_O = 168,
KIND_LISPALLOC_llvmo__MDNode_O = 169,
KIND_LISPALLOC_llvmo__BasicBlock_O = 170,
KIND_LISPALLOC_llvmo__User_O = 171,
KIND_LISPALLOC_llvmo__Instruction_O = 172,
KIND_LISPALLOC_llvmo__AtomicRMWInst_O = 173,
KIND_LISPALLOC_llvmo__StoreInst_O = 174,
KIND_LISPALLOC_llvmo__PHINode_O = 175,
KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O = 176,
KIND_LISPALLOC_llvmo__LandingPadInst_O = 177,
KIND_LISPALLOC_llvmo__UnaryInstruction_O = 178,
KIND_LISPALLOC_llvmo__LoadInst_O = 179,
KIND_LISPALLOC_llvmo__VAArgInst_O = 180,
KIND_LISPALLOC_llvmo__AllocaInst_O = 181,
KIND_LISPALLOC_llvmo__TerminatorInst_O = 182,
KIND_LISPALLOC_llvmo__IndirectBrInst_O = 183,
KIND_LISPALLOC_llvmo__UnreachableInst_O = 184,
KIND_LISPALLOC_llvmo__InvokeInst_O = 185,
KIND_LISPALLOC_llvmo__ReturnInst_O = 186,
KIND_LISPALLOC_llvmo__BranchInst_O = 187,
KIND_LISPALLOC_llvmo__ResumeInst_O = 188,
KIND_LISPALLOC_llvmo__SwitchInst_O = 189,
KIND_LISPALLOC_llvmo__FenceInst_O = 190,
KIND_LISPALLOC_llvmo__CallInst_O = 191,
KIND_LISPALLOC_llvmo__Constant_O = 192,
KIND_LISPALLOC_llvmo__ConstantDataSequential_O = 193,
KIND_LISPALLOC_llvmo__ConstantDataArray_O = 194,
KIND_LISPALLOC_llvmo__ConstantStruct_O = 195,
KIND_LISPALLOC_llvmo__BlockAddress_O = 196,
KIND_LISPALLOC_llvmo__ConstantPointerNull_O = 197,
KIND_LISPALLOC_llvmo__ConstantArray_O = 198,
KIND_LISPALLOC_llvmo__ConstantFP_O = 199,
KIND_LISPALLOC_llvmo__GlobalValue_O = 200,
KIND_LISPALLOC_llvmo__Function_O = 201,
KIND_LISPALLOC_llvmo__GlobalVariable_O = 202,
KIND_LISPALLOC_llvmo__ConstantExpr_O = 203,
KIND_LISPALLOC_llvmo__UndefValue_O = 204,
KIND_LISPALLOC_llvmo__ConstantInt_O = 205,
KIND_LISPALLOC_llvmo__TargetMachine_O = 206,
KIND_LISPALLOC_llvmo__LLVMTargetMachine_O = 207,
KIND_LISPALLOC_llvmo__LLVMContext_O = 208,
KIND_LISPALLOC_llvmo__Triple_O = 209,
KIND_LISPALLOC_llvmo__Module_O = 210,
KIND_LISPALLOC_llvmo__NamedMDNode_O = 211,
KIND_LISPALLOC_core__SNode_O = 212,
KIND_LISPALLOC_core__BranchSNode_O = 213,
KIND_LISPALLOC_core__LeafSNode_O = 214,
KIND_LISPALLOC_core__LoadTimeValues_O = 215,
KIND_LISPALLOC_core__LightUserData_O = 216,
KIND_LISPALLOC_core__UserData_O = 217,
KIND_LISPALLOC_core__WeakHashTable_O = 218,
KIND_LISPALLOC_core__WeakKeyHashTable_O = 219,
KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O = 220,
KIND_BOOTSTRAP_core__StandardObject_O = 221,
KIND_BOOTSTRAP_core__Metaobject_O = 222,
KIND_BOOTSTRAP_core__Specializer_O = 223,
KIND_BOOTSTRAP_core__Class_O = 224,
KIND_LISPALLOC_core__ForwardReferencedClass_O = 225,
KIND_BOOTSTRAP_core__StdClass_O = 226,
KIND_BOOTSTRAP_core__StandardClass_O = 227,
KIND_LISPALLOC_core__FuncallableStandardClass_O = 228,
KIND_BOOTSTRAP_core__BuiltInClass_O = 229,
KIND_LISPALLOC_clbind__ClassRep_O = 230,
KIND_BOOTSTRAP_core__StructureClass_O = 231,
KIND_LISPALLOC_asttooling__AstVisitor_O = 232,
KIND_BOOTSTRAP_core__Symbol_O = 233,
KIND_LISPALLOC_core__Null_O = 234,
KIND_LISPALLOC_core__StringSet_O = 235,
KIND_LISPALLOC_core__SymbolToEnumConverter_O = 236,
KIND_LISPALLOC_core__MultiStringBuffer_O = 237,
KIND_LISPALLOC_core__SymbolList_O = 238,
KIND_LISPALLOC_core__WeakPointer_O = 239,
KIND_LISPALLOC_core__HashTable_O = 240,
KIND_LISPALLOC_core__HashTableEqual_O = 241,
KIND_LISPALLOC_core__HashTableEqualp_O = 242,
KIND_LISPALLOC_core__HashTableEql_O = 243,
KIND_LISPALLOC_core__HashTableEq_O = 244,
KIND_LISPALLOC_core__SymbolSet_O = 245,
KIND_LISPALLOC_core__Binder_O = 246,
KIND_CLASSALLOC_core__Cache = 247,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 248,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 249,
KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory = 250,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_ = 251,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_ = 252,
KIND_GCSTRING_gctools__GCString_moveable_char_ = 253,
KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___ = 254,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_ = 255,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 256,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 257,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_ = 258,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_ = 259,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__ = 260,
KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction = 261,
KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure = 262,
KIND_CLASSALLOC_core__InterpretedClosure = 263,
KIND_CLASSALLOC_llvmo__CompiledClosure = 264,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_ = 265,
KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor = 266,
KIND_LISPALLOC_asttooling__DerivableMatchCallback = 267,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__ = 268,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__ = 269,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__ = 270,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_ = 271,
KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure = 272,
KIND_CLASSALLOC_core__CoreExposer = 273,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_ = 274,
KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_ = 275,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_ = 276,
KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster = 277,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_ = 278,
KIND_CLASSALLOC_core__MacroClosure = 279,
KIND_LISPALLOC_asttooling__DerivableASTFrontendAction = 280,
KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor = 281,
KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor = 282,
KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_ = 283,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_ = 284,
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 285,
KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_ = 286,
KIND_CLASSALLOC_core__InstanceClosure = 287,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 288,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__ = 289,
KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor = 290,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__ = 291,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_ = 292,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__ = 293,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_ = 294,
  KIND_max = 294
}
...
template <typename FP> struct DynamicCast<core::HashTable_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 240 244 
    return ((240 <= kindVal) && (kindVal <= 244));
  };
...
template <typename FP> struct DynamicCast<llvmo::TerminatorInst_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 182 189 
    return ((182 <= kindVal) && (kindVal <= 189));
  };
...
template <typename FP> struct DynamicCast<core::StandardObject_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 221 231 
    return ((221 <= kindVal) && (kindVal <= 231));
  };
...
template <typename FP> struct DynamicCast<llvmo::Value_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 166 205 
    return ((166 <= kindVal) && (kindVal <= 205));
  };
...
template <typename FP> struct DynamicCast<llvmo::Constant_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 192 205 
    return ((192 <= kindVal) && (kindVal <= 205));
  };
...
template <typename FP> struct DynamicCast<core::ExternalObject_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 132 211 
    return ((132 <= kindVal) && (kindVal <= 211));
  };
...
template <typename FP> struct DynamicCast<llvmo::User_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 171 205 
    return ((171 <= kindVal) && (kindVal <= 205));
  };
...
template <typename FP> struct DynamicCast<llvmo::TargetLibraryInfo_O*,FP> {
  static bool isA(FP client) {
    gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 138 138 
  ...
  static llvmo::TargetLibraryInfo_O* castOrNULL(FP client) {
    if (DynamicCast<llvmo::TargetLibraryInfo_O*,FP>::isA(client)) {
...
template <typename FP> struct DynamicCast<core::Specializer_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 223 231 
    return ((223 <= kindVal) && (kindVal <= 231));
  };
...
template <typename FP> struct DynamicCast<llvmo::UnaryInstruction_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 178 181 
    return ((178 <= kindVal) && (kindVal <= 181));
  };
...
template <typename FP> struct DynamicCast<core::Class_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 224 231 
    return ((224 <= kindVal) && (kindVal <= 231));
  };
...
template <typename FP> struct DynamicCast<core::Metaobject_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 222 231 
    return ((222 <= kindVal) && (kindVal <= 231));
  };
...
template <typename FP> struct DynamicCast<llvmo::Instruction_O*,FP> {
  static bool isA(FP client) {
    ...
    int kindVal = header->kind();
    // low high --> 172 191 
    return ((172 <= kindVal) && (kindVal <= 191));
  };
...
kind_name_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster:
{
...
static void* KIND_NAME_MAP_table[] = { NULL 
  ...
  /* 138 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 139 */ , &&kind_name_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 140 */ , &&kind_name_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 141 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 142 */ , &&kind_name_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 143 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 144 */ , &&kind_name_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 145 */ , &&kind_name_KIND_LISPALLOC_llvmo__APInt_O
  /* 146 */ , &&kind_name_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 147 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 148 */ , &&kind_name_KIND_LISPALLOC_llvmo__Target_O
  /* 149 */ , &&kind_name_KIND_LISPALLOC_llvmo__APFloat_O
  /* 150 */ , &&kind_name_KIND_LISPALLOC_core__ForeignData_O
  /* 151 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 152 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 153 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManager_O
  /* 154 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 155 */ , &&kind_name_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 156 */ , &&kind_name_KIND_LISPALLOC_llvmo__Type_O
  /* 157 */ , &&kind_name_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 158 */ , &&kind_name_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 159 */ , &&kind_name_KIND_LISPALLOC_llvmo__PointerType_O
  /* 160 */ , &&kind_name_KIND_LISPALLOC_llvmo__VectorType_O
  /* 161 */ , &&kind_name_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 162 */ , &&kind_name_KIND_LISPALLOC_llvmo__StructType_O
  /* 163 */ , &&kind_name_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 164 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 165 */ , &&kind_name_KIND_LISPALLOC_llvmo__Linker_O
  /* 166 */ , &&kind_name_KIND_LISPALLOC_llvmo__Value_O
  /* 167 */ , &&kind_name_KIND_LISPALLOC_llvmo__Argument_O
  /* 168 */ , &&kind_name_KIND_LISPALLOC_llvmo__MDString_O
  /* 169 */ , &&kind_name_KIND_LISPALLOC_llvmo__MDNode_O
  /* 170 */ , &&kind_name_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 171 */ , &&kind_name_KIND_LISPALLOC_llvmo__User_O
  /* 172 */ , &&kind_name_KIND_LISPALLOC_llvmo__Instruction_O
  /* 173 */ , &&kind_name_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 174 */ , &&kind_name_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 175 */ , &&kind_name_KIND_LISPALLOC_llvmo__PHINode_O
  /* 176 */ , &&kind_name_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 177 */ , &&kind_name_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 178 */ , &&kind_name_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 179 */ , &&kind_name_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 180 */ , &&kind_name_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 181 */ , &&kind_name_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 182 */ , &&kind_name_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 183 */ , &&kind_name_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 184 */ , &&kind_name_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 185 */ , &&kind_name_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 186 */ , &&kind_name_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 187 */ , &&kind_name_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 188 */ , &&kind_name_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 189 */ , &&kind_name_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 190 */ , &&kind_name_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 191 */ , &&kind_name_KIND_LISPALLOC_llvmo__CallInst_O
  /* 192 */ , &&kind_name_KIND_LISPALLOC_llvmo__Constant_O
  /* 193 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 194 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 195 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 196 */ , &&kind_name_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 197 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 198 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 199 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 200 */ , &&kind_name_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 201 */ , &&kind_name_KIND_LISPALLOC_llvmo__Function_O
  /* 202 */ , &&kind_name_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 203 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 204 */ , &&kind_name_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 205 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 206 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 207 */ , &&kind_name_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 208 */ , &&kind_name_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 209 */ , &&kind_name_KIND_LISPALLOC_llvmo__Triple_O
  /* 210 */ , &&kind_name_KIND_LISPALLOC_llvmo__Module_O
  /* 211 */ , &&kind_name_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 212 */ , &&kind_name_KIND_LISPALLOC_core__SNode_O
  /* 213 */ , &&kind_name_KIND_LISPALLOC_core__BranchSNode_O
  /* 214 */ , &&kind_name_KIND_LISPALLOC_core__LeafSNode_O
  /* 215 */ , &&kind_name_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 216 */ , &&kind_name_KIND_LISPALLOC_core__LightUserData_O
  /* 217 */ , &&kind_name_KIND_LISPALLOC_core__UserData_O
  /* 218 */ , &&kind_name_KIND_LISPALLOC_core__WeakHashTable_O
  /* 219 */ , &&kind_name_KIND_LISPALLOC_core__WeakKeyHashTable_O
  /* 220 */ , &&kind_name_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 221 */ , &&kind_name_KIND_BOOTSTRAP_core__StandardObject_O
  /* 222 */ , &&kind_name_KIND_BOOTSTRAP_core__Metaobject_O
  /* 223 */ , &&kind_name_KIND_BOOTSTRAP_core__Specializer_O
  /* 224 */ , &&kind_name_KIND_BOOTSTRAP_core__Class_O
  /* 225 */ , &&kind_name_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 226 */ , &&kind_name_KIND_BOOTSTRAP_core__StdClass_O
  /* 227 */ , &&kind_name_KIND_BOOTSTRAP_core__StandardClass_O
  /* 228 */ , &&kind_name_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 229 */ , &&kind_name_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 230 */ , &&kind_name_KIND_LISPALLOC_clbind__ClassRep_O
  /* 231 */ , &&kind_name_KIND_BOOTSTRAP_core__StructureClass_O
  /* 232 */ , &&kind_name_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 233 */ , &&kind_name_KIND_BOOTSTRAP_core__Symbol_O
  /* 234 */ , &&kind_name_KIND_LISPALLOC_core__Null_O
  /* 235 */ , &&kind_name_KIND_LISPALLOC_core__StringSet_O
  /* 236 */ , &&kind_name_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 237 */ , &&kind_name_KIND_LISPALLOC_core__MultiStringBuffer_O
  /* 238 */ , &&kind_name_KIND_LISPALLOC_core__SymbolList_O
  /* 239 */ , &&kind_name_KIND_LISPALLOC_core__WeakPointer_O
  /* 240 */ , &&kind_name_KIND_LISPALLOC_core__HashTable_O
  /* 241 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEqual_O
  /* 242 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 243 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEql_O
  /* 244 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEq_O
  /* 245 */ , &&kind_name_KIND_LISPALLOC_core__SymbolSet_O
  /* 246 */ , &&kind_name_KIND_LISPALLOC_core__Binder_O
  /* 247 */ , &&kind_name_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 249 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 250 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 251 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 252 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 253 */ , &&kind_name_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 254 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 255 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 256 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 257 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 258 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 259 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 260 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 261 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 262 */ , &&kind_name_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 263 */ , &&kind_name_KIND_CLASSALLOC_core__InterpretedClosure
  /* 264 */ , &&kind_name_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 265 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 266 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 267 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 268 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 269 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 270 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__
  /* 271 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 272 */ , &&kind_name_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 273 */ , &&kind_name_KIND_CLASSALLOC_core__CoreExposer
  /* 274 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 275 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 276 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 277 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster
  /* 278 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_
  /* 279 */ , &&kind_name_KIND_CLASSALLOC_core__MacroClosure
  /* 280 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 281 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 282 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 283 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 284 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 285 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 286 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 287 */ , &&kind_name_KIND_CLASSALLOC_core__InstanceClosure
  /* 288 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 289 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 290 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 291 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 292 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 293 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__
  /* 294 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
};
...
static void* OBJ_DUMP_MAP_table[] = { NULL 
  ...
  /* 138 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 139 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 140 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 141 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 142 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 143 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 144 */ , &&obj_dump_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 145 */ , &&obj_dump_KIND_LISPALLOC_llvmo__APInt_O
  /* 146 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 147 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 148 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Target_O
  /* 149 */ , &&obj_dump_KIND_LISPALLOC_llvmo__APFloat_O
  /* 150 */ , &&obj_dump_KIND_LISPALLOC_core__ForeignData_O
  /* 151 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 152 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 153 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManager_O
  /* 154 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 155 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 156 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Type_O
  /* 157 */ , &&obj_dump_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 158 */ , &&obj_dump_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 159 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PointerType_O
  /* 160 */ , &&obj_dump_KIND_LISPALLOC_llvmo__VectorType_O
  /* 161 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 162 */ , &&obj_dump_KIND_LISPALLOC_llvmo__StructType_O
  /* 163 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 164 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 165 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Linker_O
  /* 166 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Value_O
  /* 167 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Argument_O
  /* 168 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MDString_O
  /* 169 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MDNode_O
  /* 170 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 171 */ , &&obj_dump_KIND_LISPALLOC_llvmo__User_O
  /* 172 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Instruction_O
  /* 173 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 174 */ , &&obj_dump_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 175 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PHINode_O
  /* 176 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 177 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 178 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 179 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 180 */ , &&obj_dump_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 181 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 182 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 183 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 184 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 185 */ , &&obj_dump_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 186 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 187 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 188 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 189 */ , &&obj_dump_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 190 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 191 */ , &&obj_dump_KIND_LISPALLOC_llvmo__CallInst_O
  /* 192 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Constant_O
  /* 193 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 194 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 195 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 196 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 197 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 198 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 199 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 200 */ , &&obj_dump_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 201 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Function_O
  /* 202 */ , &&obj_dump_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 203 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 204 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 205 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 206 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 207 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 208 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 209 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Triple_O
  /* 210 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Module_O
  /* 211 */ , &&obj_dump_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 212 */ , &&obj_dump_KIND_LISPALLOC_core__SNode_O
  /* 213 */ , &&obj_dump_KIND_LISPALLOC_core__BranchSNode_O
  /* 214 */ , &&obj_dump_KIND_LISPALLOC_core__LeafSNode_O
  /* 215 */ , &&obj_dump_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 216 */ , &&obj_dump_KIND_LISPALLOC_core__LightUserData_O
  /* 217 */ , &&obj_dump_KIND_LISPALLOC_core__UserData_O
  /* 218 */ , &&obj_dump_KIND_LISPALLOC_core__WeakHashTable_O
  /* 219 */ , &&obj_dump_KIND_LISPALLOC_core__WeakKeyHashTable_O
  /* 220 */ , &&obj_dump_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 221 */ , &&obj_dump_KIND_BOOTSTRAP_core__StandardObject_O
  /* 222 */ , &&obj_dump_KIND_BOOTSTRAP_core__Metaobject_O
  /* 223 */ , &&obj_dump_KIND_BOOTSTRAP_core__Specializer_O
  /* 224 */ , &&obj_dump_KIND_BOOTSTRAP_core__Class_O
  /* 225 */ , &&obj_dump_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 226 */ , &&obj_dump_KIND_BOOTSTRAP_core__StdClass_O
  /* 227 */ , &&obj_dump_KIND_BOOTSTRAP_core__StandardClass_O
  /* 228 */ , &&obj_dump_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 229 */ , &&obj_dump_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 230 */ , &&obj_dump_KIND_LISPALLOC_clbind__ClassRep_O
  /* 231 */ , &&obj_dump_KIND_BOOTSTRAP_core__StructureClass_O
  /* 232 */ , &&obj_dump_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 233 */ , &&obj_dump_KIND_BOOTSTRAP_core__Symbol_O
  /* 234 */ , &&obj_dump_KIND_LISPALLOC_core__Null_O
  /* 235 */ , &&obj_dump_KIND_LISPALLOC_core__StringSet_O
  /* 236 */ , &&obj_dump_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 237 */ , &&obj_dump_KIND_LISPALLOC_core__MultiStringBuffer_O
  /* 238 */ , &&obj_dump_KIND_LISPALLOC_core__SymbolList_O
  /* 239 */ , &&obj_dump_KIND_LISPALLOC_core__WeakPointer_O
  /* 240 */ , &&obj_dump_KIND_LISPALLOC_core__HashTable_O
  /* 241 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEqual_O
  /* 242 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 243 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEql_O
  /* 244 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEq_O
  /* 245 */ , &&obj_dump_KIND_LISPALLOC_core__SymbolSet_O
  /* 246 */ , &&obj_dump_KIND_LISPALLOC_core__Binder_O
  /* 247 */ , &&obj_dump_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 249 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 250 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 251 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 252 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 253 */ , &&obj_dump_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 254 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 255 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 256 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 257 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 258 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 259 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 260 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 261 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 262 */ , &&obj_dump_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 263 */ , &&obj_dump_KIND_CLASSALLOC_core__InterpretedClosure
  /* 264 */ , &&obj_dump_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 265 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 266 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 267 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 268 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 269 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 270 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__
  /* 271 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 272 */ , &&obj_dump_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 273 */ , &&obj_dump_KIND_CLASSALLOC_core__CoreExposer
  /* 274 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 275 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 276 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 277 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster
  /* 278 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_
  /* 279 */ , &&obj_dump_KIND_CLASSALLOC_core__MacroClosure
  /* 280 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 281 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 282 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 283 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 284 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 285 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 286 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 287 */ , &&obj_dump_KIND_CLASSALLOC_core__InstanceClosure
  /* 288 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 289 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 290 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 291 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 292 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 293 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__
  /* 294 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
};
...
obj_skip_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster:
{
    typedef asttooling::DerivableArgumentsAdjuster type_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster;
...
static void* OBJ_SKIP_table[] = { NULL 
  ...
  /* 138 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 139 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 140 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 141 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 142 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 143 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 144 */ , &&obj_skip_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 145 */ , &&obj_skip_KIND_LISPALLOC_llvmo__APInt_O
  /* 146 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 147 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 148 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Target_O
  /* 149 */ , &&obj_skip_KIND_LISPALLOC_llvmo__APFloat_O
  /* 150 */ , &&obj_skip_KIND_LISPALLOC_core__ForeignData_O
  /* 151 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 152 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 153 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManager_O
  /* 154 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 155 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 156 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Type_O
  /* 157 */ , &&obj_skip_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 158 */ , &&obj_skip_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 159 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PointerType_O
  /* 160 */ , &&obj_skip_KIND_LISPALLOC_llvmo__VectorType_O
  /* 161 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 162 */ , &&obj_skip_KIND_LISPALLOC_llvmo__StructType_O
  /* 163 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 164 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 165 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Linker_O
  /* 166 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Value_O
  /* 167 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Argument_O
  /* 168 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MDString_O
  /* 169 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MDNode_O
  /* 170 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 171 */ , &&obj_skip_KIND_LISPALLOC_llvmo__User_O
  /* 172 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Instruction_O
  /* 173 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 174 */ , &&obj_skip_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 175 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PHINode_O
  /* 176 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 177 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 178 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 179 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 180 */ , &&obj_skip_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 181 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 182 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 183 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 184 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 185 */ , &&obj_skip_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 186 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 187 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 188 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 189 */ , &&obj_skip_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 190 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 191 */ , &&obj_skip_KIND_LISPALLOC_llvmo__CallInst_O
  /* 192 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Constant_O
  /* 193 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 194 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 195 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 196 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 197 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 198 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 199 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 200 */ , &&obj_skip_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 201 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Function_O
  /* 202 */ , &&obj_skip_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 203 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 204 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 205 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 206 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 207 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 208 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 209 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Triple_O
  /* 210 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Module_O
  /* 211 */ , &&obj_skip_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 212 */ , &&obj_skip_KIND_LISPALLOC_core__SNode_O
  /* 213 */ , &&obj_skip_KIND_LISPALLOC_core__BranchSNode_O
  /* 214 */ , &&obj_skip_KIND_LISPALLOC_core__LeafSNode_O
  /* 215 */ , &&obj_skip_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 216 */ , &&obj_skip_KIND_LISPALLOC_core__LightUserData_O
  /* 217 */ , &&obj_skip_KIND_LISPALLOC_core__UserData_O
  /* 218 */ , &&obj_skip_KIND_LISPALLOC_core__WeakHashTable_O
  /* 219 */ , &&obj_skip_KIND_LISPALLOC_core__WeakKeyHashTable_O
  /* 220 */ , &&obj_skip_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 221 */ , &&obj_skip_KIND_BOOTSTRAP_core__StandardObject_O
  /* 222 */ , &&obj_skip_KIND_BOOTSTRAP_core__Metaobject_O
  /* 223 */ , &&obj_skip_KIND_BOOTSTRAP_core__Specializer_O
  /* 224 */ , &&obj_skip_KIND_BOOTSTRAP_core__Class_O
  /* 225 */ , &&obj_skip_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 226 */ , &&obj_skip_KIND_BOOTSTRAP_core__StdClass_O
  /* 227 */ , &&obj_skip_KIND_BOOTSTRAP_core__StandardClass_O
  /* 228 */ , &&obj_skip_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 229 */ , &&obj_skip_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 230 */ , &&obj_skip_KIND_LISPALLOC_clbind__ClassRep_O
  /* 231 */ , &&obj_skip_KIND_BOOTSTRAP_core__StructureClass_O
  /* 232 */ , &&obj_skip_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 233 */ , &&obj_skip_KIND_BOOTSTRAP_core__Symbol_O
  /* 234 */ , &&obj_skip_KIND_LISPALLOC_core__Null_O
  /* 235 */ , &&obj_skip_KIND_LISPALLOC_core__StringSet_O
  /* 236 */ , &&obj_skip_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 237 */ , &&obj_skip_KIND_LISPALLOC_core__MultiStringBuffer_O
  /* 238 */ , &&obj_skip_KIND_LISPALLOC_core__SymbolList_O
  /* 239 */ , &&obj_skip_KIND_LISPALLOC_core__WeakPointer_O
  /* 240 */ , &&obj_skip_KIND_LISPALLOC_core__HashTable_O
  /* 241 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEqual_O
  /* 242 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 243 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEql_O
  /* 244 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEq_O
  /* 245 */ , &&obj_skip_KIND_LISPALLOC_core__SymbolSet_O
  /* 246 */ , &&obj_skip_KIND_LISPALLOC_core__Binder_O
  /* 247 */ , &&obj_skip_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 249 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 250 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 251 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 252 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 253 */ , &&obj_skip_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 254 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 255 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 256 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 257 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 258 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 259 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 260 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 261 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 262 */ , &&obj_skip_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 263 */ , &&obj_skip_KIND_CLASSALLOC_core__InterpretedClosure
  /* 264 */ , &&obj_skip_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 265 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 266 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 267 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 268 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 269 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 270 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__
  /* 271 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 272 */ , &&obj_skip_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 273 */ , &&obj_skip_KIND_CLASSALLOC_core__CoreExposer
  /* 274 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 275 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 276 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 277 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster
  /* 278 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_
  /* 279 */ , &&obj_skip_KIND_CLASSALLOC_core__MacroClosure
  /* 280 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 281 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 282 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 283 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 284 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 285 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 286 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 287 */ , &&obj_skip_KIND_CLASSALLOC_core__InstanceClosure
  /* 288 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 289 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 290 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 291 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 292 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 293 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__
  /* 294 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
};
...
static void* OBJ_SCAN_table[] = { NULL 
  ...
  /* 138 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 139 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 140 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 141 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 142 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 143 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 144 */ , &&obj_scan_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 145 */ , &&obj_scan_KIND_LISPALLOC_llvmo__APInt_O
  /* 146 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 147 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 148 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Target_O
  /* 149 */ , &&obj_scan_KIND_LISPALLOC_llvmo__APFloat_O
  /* 150 */ , &&obj_scan_KIND_LISPALLOC_core__ForeignData_O
  /* 151 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 152 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 153 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManager_O
  /* 154 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 155 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 156 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Type_O
  /* 157 */ , &&obj_scan_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 158 */ , &&obj_scan_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 159 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PointerType_O
  /* 160 */ , &&obj_scan_KIND_LISPALLOC_llvmo__VectorType_O
  /* 161 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 162 */ , &&obj_scan_KIND_LISPALLOC_llvmo__StructType_O
  /* 163 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 164 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 165 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Linker_O
  /* 166 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Value_O
  /* 167 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Argument_O
  /* 168 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MDString_O
  /* 169 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MDNode_O
  /* 170 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 171 */ , &&obj_scan_KIND_LISPALLOC_llvmo__User_O
  /* 172 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Instruction_O
  /* 173 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 174 */ , &&obj_scan_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 175 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PHINode_O
  /* 176 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 177 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 178 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 179 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 180 */ , &&obj_scan_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 181 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 182 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 183 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 184 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 185 */ , &&obj_scan_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 186 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 187 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 188 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 189 */ , &&obj_scan_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 190 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 191 */ , &&obj_scan_KIND_LISPALLOC_llvmo__CallInst_O
  /* 192 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Constant_O
  /* 193 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 194 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 195 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 196 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 197 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 198 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 199 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 200 */ , &&obj_scan_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 201 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Function_O
  /* 202 */ , &&obj_scan_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 203 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 204 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 205 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 206 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 207 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 208 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 209 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Triple_O
  /* 210 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Module_O
  /* 211 */ , &&obj_scan_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 212 */ , &&obj_scan_KIND_LISPALLOC_core__SNode_O
  /* 213 */ , &&obj_scan_KIND_LISPALLOC_core__BranchSNode_O
  /* 214 */ , &&obj_scan_KIND_LISPALLOC_core__LeafSNode_O
  /* 215 */ , &&obj_scan_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 216 */ , &&obj_scan_KIND_LISPALLOC_core__LightUserData_O
  /* 217 */ , &&obj_scan_KIND_LISPALLOC_core__UserData_O
  /* 218 */ , &&obj_scan_KIND_LISPALLOC_core__WeakHashTable_O
  /* 219 */ , &&obj_scan_KIND_LISPALLOC_core__WeakKeyHashTable_O
  /* 220 */ , &&obj_scan_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 221 */ , &&obj_scan_KIND_BOOTSTRAP_core__StandardObject_O
  /* 222 */ , &&obj_scan_KIND_BOOTSTRAP_core__Metaobject_O
  /* 223 */ , &&obj_scan_KIND_BOOTSTRAP_core__Specializer_O
  /* 224 */ , &&obj_scan_KIND_BOOTSTRAP_core__Class_O
  /* 225 */ , &&obj_scan_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 226 */ , &&obj_scan_KIND_BOOTSTRAP_core__StdClass_O
  /* 227 */ , &&obj_scan_KIND_BOOTSTRAP_core__StandardClass_O
  /* 228 */ , &&obj_scan_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 229 */ , &&obj_scan_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 230 */ , &&obj_scan_KIND_LISPALLOC_clbind__ClassRep_O
  /* 231 */ , &&obj_scan_KIND_BOOTSTRAP_core__StructureClass_O
  /* 232 */ , &&obj_scan_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 233 */ , &&obj_scan_KIND_BOOTSTRAP_core__Symbol_O
  /* 234 */ , &&obj_scan_KIND_LISPALLOC_core__Null_O
  /* 235 */ , &&obj_scan_KIND_LISPALLOC_core__StringSet_O
  /* 236 */ , &&obj_scan_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 237 */ , &&obj_scan_KIND_LISPALLOC_core__MultiStringBuffer_O
  /* 238 */ , &&obj_scan_KIND_LISPALLOC_core__SymbolList_O
  /* 239 */ , &&obj_scan_KIND_LISPALLOC_core__WeakPointer_O
  /* 240 */ , &&obj_scan_KIND_LISPALLOC_core__HashTable_O
  /* 241 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEqual_O
  /* 242 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 243 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEql_O
  /* 244 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEq_O
  /* 245 */ , &&obj_scan_KIND_LISPALLOC_core__SymbolSet_O
  /* 246 */ , &&obj_scan_KIND_LISPALLOC_core__Binder_O
  /* 247 */ , &&obj_scan_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 249 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 250 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 251 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 252 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 253 */ , &&obj_scan_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 254 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 255 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 256 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 257 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 258 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 259 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 260 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 261 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 262 */ , &&obj_scan_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 263 */ , &&obj_scan_KIND_CLASSALLOC_core__InterpretedClosure
  /* 264 */ , &&obj_scan_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 265 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 266 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 267 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 268 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 269 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 270 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__
  /* 271 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 272 */ , &&obj_scan_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 273 */ , &&obj_scan_KIND_CLASSALLOC_core__CoreExposer
  /* 274 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 275 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 276 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 277 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster
  /* 278 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_
  /* 279 */ , &&obj_scan_KIND_CLASSALLOC_core__MacroClosure
  /* 280 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 281 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 282 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 283 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 284 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 285 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 286 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 287 */ , &&obj_scan_KIND_CLASSALLOC_core__InstanceClosure
  /* 288 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 289 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 290 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 291 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 292 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 293 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__
  /* 294 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
};
...
obj_finalize_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster:
{
    asttooling::DerivableArgumentsAdjuster* obj_gc_safe = reinterpret_cast<asttooling::DerivableArgumentsAdjuster*>(client);
...
static void* OBJ_FINALIZE_table[] = { NULL 
  ...
  /* 138 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  ...
  /* 143 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 144 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 145 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__APInt_O
  /* 146 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 147 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 148 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Target_O
  /* 149 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__APFloat_O
  /* 150 */ , &&obj_finalize_KIND_LISPALLOC_core__ForeignData_O
  /* 151 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 152 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 153 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PassManager_O
  /* 154 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 155 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DataLayout_O
  ...
  /* 159 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PointerType_O
  ...
  /* 163 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 164 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 165 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Linker_O
  /* 166 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Value_O
  /* 167 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Argument_O
  /* 168 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__MDString_O
  /* 169 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__MDNode_O
  /* 170 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 171 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__User_O
  /* 172 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Instruction_O
  /* 173 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 174 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 175 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PHINode_O
  /* 176 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 177 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 178 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 179 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 180 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 181 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 182 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 183 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 184 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 185 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 186 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 187 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 188 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 189 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 190 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 191 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__CallInst_O
  /* 192 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Constant_O
  /* 193 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 194 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 195 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 196 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 197 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 198 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 199 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 200 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 201 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Function_O
  /* 202 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 203 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 204 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 205 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 206 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 207 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 208 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 209 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Triple_O
  /* 210 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Module_O
  /* 211 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 212 */ , &&obj_finalize_KIND_LISPALLOC_core__SNode_O
  /* 213 */ , &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O
  /* 214 */ , &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O
  /* 215 */ , &&obj_finalize_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 216 */ , &&obj_finalize_KIND_LISPALLOC_core__LightUserData_O
  /* 217 */ , &&obj_finalize_KIND_LISPALLOC_core__UserData_O
  /* 218 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakHashTable_O
  /* 219 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakKeyHashTable_O
  /* 220 */ , &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 221 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StandardObject_O
  /* 222 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Metaobject_O
  /* 223 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Specializer_O
  /* 224 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Class_O
  /* 225 */ , &&obj_finalize_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 226 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StdClass_O
  /* 227 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StandardClass_O
  /* 228 */ , &&obj_finalize_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 229 */ , &&obj_finalize_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 230 */ , &&obj_finalize_KIND_LISPALLOC_clbind__ClassRep_O
  /* 231 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StructureClass_O
  /* 232 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 233 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Symbol_O
  /* 234 */ , &&obj_finalize_KIND_LISPALLOC_core__Null_O
  /* 235 */ , &&obj_finalize_KIND_LISPALLOC_core__StringSet_O
  /* 236 */ , &&obj_finalize_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 237 */ , &&obj_finalize_KIND_LISPALLOC_core__MultiStringBuffer_O
  /* 238 */ , &&obj_finalize_KIND_LISPALLOC_core__SymbolList_O
  /* 239 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakPointer_O
  /* 240 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTable_O
  /* 241 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEqual_O
  /* 242 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 243 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEql_O
  /* 244 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEq_O
  /* 245 */ , &&obj_finalize_KIND_LISPALLOC_core__SymbolSet_O
  /* 246 */ , &&obj_finalize_KIND_LISPALLOC_core__Binder_O
  /* 247 */ , &&obj_finalize_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 249 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 250 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 251 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 252 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 253 */ , &&obj_finalize_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 254 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 255 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_
  /* 256 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 257 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 258 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 259 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 260 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 261 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 262 */ , &&obj_finalize_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 263 */ , &&obj_finalize_KIND_CLASSALLOC_core__InterpretedClosure
  /* 264 */ , &&obj_finalize_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 265 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 266 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 267 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 268 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 269 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 270 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__
  /* 271 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_
  /* 272 */ , &&obj_finalize_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 273 */ , &&obj_finalize_KIND_CLASSALLOC_core__CoreExposer
  /* 274 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 275 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 276 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 277 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableArgumentsAdjuster
  /* 278 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_
  /* 279 */ , &&obj_finalize_KIND_CLASSALLOC_core__MacroClosure
  /* 280 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 281 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 282 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 283 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 284 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 285 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 286 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 287 */ , &&obj_finalize_KIND_CLASSALLOC_core__InstanceClosure
  /* 288 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 289 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 290 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 291 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
  /* 292 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 293 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__
  /* 294 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
};
