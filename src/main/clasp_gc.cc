...
KIND_SINGLE_FLOAT = 2, 
KIND_FIXNUM = 1, 
KIND_ABSTRACT_clang__FrontendAction = 5,
KIND_ABSTRACT_clang__ASTFrontendAction = 6,
KIND_ABSTRACT_clang__SyntaxOnlyAction = 9,
KIND_ROOTCLASSALLOC_clbind__detail__class_map = 12,
KIND_BOOTSTRAP_core__T_O = 13,
KIND_LISPALLOC_core__VaList_dummy_O = 14,
KIND_LISPALLOC_core__Cons_O = 15,
KIND_LISPALLOC_core__General_O = 16,
KIND_LISPALLOC_core__MultiStringBuffer_O = 17,
KIND_LISPALLOC_core__ReadTable_O = 18,
KIND_LISPALLOC_core__Number_O = 19,
KIND_LISPALLOC_core__Complex_O = 20,
KIND_LISPALLOC_core__Real_O = 21,
KIND_LISPALLOC_core__Rational_O = 22,
KIND_LISPALLOC_core__Integer_O = 23,
KIND_LISPALLOC_core__Bignum_O = 24,
KIND_LISPALLOC_core__Fixnum_dummy_O = 25,
KIND_LISPALLOC_core__Ratio_O = 26,
KIND_LISPALLOC_core__Float_O = 27,
KIND_LISPALLOC_core__DoubleFloat_O = 28,
KIND_LISPALLOC_core__LongFloat_O = 29,
KIND_LISPALLOC_core__SingleFloat_dummy_O = 30,
KIND_LISPALLOC_core__ShortFloat_O = 31,
KIND_LISPALLOC_core__FileStatus_O = 32,
KIND_LISPALLOC_core__WeakHashTable_O = 33,
KIND_LISPALLOC_core__WeakKeyHashTable_O = 34,
KIND_LISPALLOC_core__Environment_O = 35,
KIND_LISPALLOC_core__ActivationFrame_O = 36,
KIND_LISPALLOC_core__TagbodyFrame_O = 37,
KIND_LISPALLOC_core__ValueFrame_O = 38,
KIND_LISPALLOC_core__FunctionFrame_O = 39,
KIND_LISPALLOC_core__LexicalEnvironment_O = 40,
KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O = 41,
KIND_LISPALLOC_core__FunctionValueEnvironment_O = 42,
KIND_LISPALLOC_core__ValueEnvironment_O = 43,
KIND_LISPALLOC_core__TagbodyEnvironment_O = 44,
KIND_LISPALLOC_core__CompileTimeEnvironment_O = 45,
KIND_LISPALLOC_core__UnwindProtectEnvironment_O = 46,
KIND_LISPALLOC_core__SymbolMacroletEnvironment_O = 47,
KIND_LISPALLOC_core__FunctionContainerEnvironment_O = 48,
KIND_LISPALLOC_core__StackValueEnvironment_O = 49,
KIND_LISPALLOC_core__BlockEnvironment_O = 50,
KIND_LISPALLOC_core__MacroletEnvironment_O = 51,
KIND_LISPALLOC_core__CatchEnvironment_O = 52,
KIND_LISPALLOC_core__GlueEnvironment_O = 53,
KIND_LISPALLOC_core__Array_O = 54,
KIND_LISPALLOC_core__MDArray_O = 55,
KIND_LISPALLOC_core__VectorNs_O = 56,
KIND_LISPALLOC_core__StrNs_O = 57,
KIND_ABSTRACT_core__abstract_DisplacementHandlingVector_core__Str8Ns_O_core__SimpleBaseCharString_O_core__StrNs_O_ = 58,
KIND_LISPALLOC_core__Str8Ns_O = 59,
KIND_ABSTRACT_core__abstract_DisplacementHandlingVector_core__StrWNs_O_core__SimpleCharacterString_O_core__StrNs_O_ = 60,
KIND_LISPALLOC_core__StrWNs_O = 61,
KIND_LISPALLOC_core__BitVectorNs_O = 62,
KIND_LISPALLOC_core__SpecializedVectorNs_O = 63,
KIND_ABSTRACT_core__abstract_DisplacementHandlingVector_core__VectorTNs_O_core__SimpleVector_O_core__SpecializedVectorNs_O_ = 64,
KIND_LISPALLOC_core__VectorTNs_O = 65,
KIND_LISPALLOC_core__MDArrayNs_O = 66,
KIND_LISPALLOC_core__SpecializedMDArrayNs_O = 67,
KIND_ABSTRACT_core__abstract_DisplacementHandlingArray_core__ArrayTNs_O_core__SimpleVector_O_core__SpecializedMDArrayNs_O_ = 68,
KIND_LISPALLOC_core__ArrayTNs_O = 69,
KIND_LISPALLOC_core__BaseSimpleVector_O = 70,
KIND_LISPALLOC_core__SpecializedSimpleVector_O = 71,
KIND_ABSTRACT_core__abstract_SimpleVector_core__SimpleDoubleVector_O_double_core__SpecializedSimpleVector_O_ = 72,
KIND_LISPALLOC_core__SimpleDoubleVector_O = 73,
KIND_ABSTRACT_core__abstract_SimpleVector_core__SimpleVector_O_gctools__smart_ptr_core__T_O__core__SpecializedSimpleVector_O_ = 74,
KIND_LISPALLOC_core__SimpleVector_O = 75,
KIND_LISPALLOC_core__SimpleBitVector_O = 76,
KIND_LISPALLOC_core__SimpleString_O = 77,
KIND_ABSTRACT_core__abstract_SimpleVector_core__SimpleBaseCharString_O_unsigned_char_core__SimpleString_O_ = 78,
KIND_LISPALLOC_core__SimpleBaseCharString_O = 79,
KIND_ABSTRACT_core__abstract_SimpleVector_core__SimpleCharacterString_O_unsigned_int_core__SimpleString_O_ = 80,
KIND_LISPALLOC_core__SimpleCharacterString_O = 81,
KIND_LISPALLOC_core__Exposer_O = 82,
KIND_LISPALLOC_asttooling__AsttoolingExposer_O = 83,
KIND_LISPALLOC_core__CoreExposer_O = 84,
KIND_LISPALLOC_core__SingleDispatchMethod_O = 85,
KIND_LISPALLOC_core__RandomState_O = 86,
KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O = 87,
KIND_LISPALLOC_core__SequenceStepper_O = 88,
KIND_LISPALLOC_core__ConsStepper_O = 89,
KIND_LISPALLOC_core__VectorStepper_O = 90,
KIND_LISPALLOC_llvmo__DebugLoc_O = 91,
KIND_LISPALLOC_llvmo__Attribute_O = 92,
KIND_LISPALLOC_core__WeakPointer_O = 93,
KIND_BOOTSTRAP_core__StandardObject_O = 94,
KIND_BOOTSTRAP_core__Metaobject_O = 95,
KIND_BOOTSTRAP_core__Specializer_O = 96,
KIND_BOOTSTRAP_core__Class_O = 97,
KIND_BOOTSTRAP_core__StdClass_O = 98,
KIND_BOOTSTRAP_core__StandardClass_O = 99,
KIND_LISPALLOC_core__FuncallableStandardClass_O = 100,
KIND_BOOTSTRAP_core__StructureClass_O = 101,
KIND_LISPALLOC_core__ForwardReferencedClass_O = 102,
KIND_LISPALLOC_core__CxxClass_O = 103,
KIND_BOOTSTRAP_core__BuiltInClass_O = 104,
KIND_LISPALLOC_clbind__ClassRep_O = 105,
KIND_LISPALLOC_core__ExternalObject_O = 106,
KIND_LISPALLOC_clasp_ffi__ForeignData_O = 107,
KIND_LISPALLOC_llvmo__Value_O = 108,
KIND_LISPALLOC_llvmo__Argument_O = 109,
KIND_LISPALLOC_llvmo__User_O = 110,
KIND_LISPALLOC_llvmo__Instruction_O = 111,
KIND_LISPALLOC_llvmo__AtomicRMWInst_O = 112,
KIND_LISPALLOC_llvmo__LandingPadInst_O = 113,
KIND_LISPALLOC_llvmo__PHINode_O = 114,
KIND_LISPALLOC_llvmo__CallInst_O = 115,
KIND_LISPALLOC_llvmo__StoreInst_O = 116,
KIND_LISPALLOC_llvmo__UnaryInstruction_O = 117,
KIND_LISPALLOC_llvmo__LoadInst_O = 118,
KIND_LISPALLOC_llvmo__AllocaInst_O = 119,
KIND_LISPALLOC_llvmo__VAArgInst_O = 120,
KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O = 121,
KIND_LISPALLOC_llvmo__TerminatorInst_O = 122,
KIND_LISPALLOC_llvmo__UnreachableInst_O = 123,
KIND_LISPALLOC_llvmo__SwitchInst_O = 124,
KIND_LISPALLOC_llvmo__ReturnInst_O = 125,
KIND_LISPALLOC_llvmo__ResumeInst_O = 126,
KIND_LISPALLOC_llvmo__BranchInst_O = 127,
KIND_LISPALLOC_llvmo__InvokeInst_O = 128,
KIND_LISPALLOC_llvmo__IndirectBrInst_O = 129,
KIND_LISPALLOC_llvmo__FenceInst_O = 130,
KIND_LISPALLOC_llvmo__Constant_O = 131,
KIND_LISPALLOC_llvmo__BlockAddress_O = 132,
KIND_LISPALLOC_llvmo__GlobalValue_O = 133,
KIND_LISPALLOC_llvmo__GlobalVariable_O = 134,
KIND_LISPALLOC_llvmo__Function_O = 135,
KIND_LISPALLOC_llvmo__ConstantArray_O = 136,
KIND_LISPALLOC_llvmo__ConstantInt_O = 137,
KIND_LISPALLOC_llvmo__ConstantDataSequential_O = 138,
KIND_LISPALLOC_llvmo__ConstantDataArray_O = 139,
KIND_LISPALLOC_llvmo__ConstantStruct_O = 140,
KIND_LISPALLOC_llvmo__ConstantFP_O = 141,
KIND_LISPALLOC_llvmo__UndefValue_O = 142,
KIND_LISPALLOC_llvmo__ConstantPointerNull_O = 143,
KIND_LISPALLOC_llvmo__ConstantExpr_O = 144,
KIND_LISPALLOC_llvmo__BasicBlock_O = 145,
KIND_LISPALLOC_llvmo__IRBuilderBase_O = 146,
KIND_LISPALLOC_llvmo__IRBuilder_O = 147,
KIND_LISPALLOC_llvmo__DIBuilder_O = 148,
KIND_LISPALLOC_llvmo__Metadata_O = 149,
KIND_LISPALLOC_llvmo__ValueAsMetadata_O = 150,
KIND_LISPALLOC_llvmo__MDNode_O = 151,
KIND_LISPALLOC_llvmo__DINode_O = 152,
KIND_LISPALLOC_llvmo__DIScope_O = 153,
KIND_LISPALLOC_llvmo__DICompileUnit_O = 154,
KIND_LISPALLOC_llvmo__DILocalScope_O = 155,
KIND_LISPALLOC_llvmo__DISubprogram_O = 156,
KIND_LISPALLOC_llvmo__DILexicalBlockBase_O = 157,
KIND_LISPALLOC_llvmo__DILexicalBlock_O = 158,
KIND_LISPALLOC_llvmo__DIType_O = 159,
KIND_LISPALLOC_llvmo__DIDerivedType_O = 160,
KIND_LISPALLOC_llvmo__DIBasicType_O = 161,
KIND_LISPALLOC_llvmo__DISubroutineType_O = 162,
KIND_LISPALLOC_llvmo__DICompositeType_O = 163,
KIND_LISPALLOC_llvmo__DIFile_O = 164,
KIND_LISPALLOC_llvmo__MDString_O = 165,
KIND_LISPALLOC_llvmo__ExecutionEngine_O = 166,
KIND_LISPALLOC_llvmo__APFloat_O = 167,
KIND_LISPALLOC_llvmo__PassManagerBuilder_O = 168,
KIND_LISPALLOC_llvmo__Triple_O = 169,
KIND_LISPALLOC_llvmo__APInt_O = 170,
KIND_LISPALLOC_llvmo__PassManagerBase_O = 171,
KIND_LISPALLOC_llvmo__FunctionPassManager_O = 172,
KIND_LISPALLOC_llvmo__PassManager_O = 173,
KIND_LISPALLOC_llvmo__TargetMachine_O = 174,
KIND_LISPALLOC_llvmo__LLVMTargetMachine_O = 175,
KIND_LISPALLOC_llvmo__TargetOptions_O = 176,
KIND_LISPALLOC_llvmo__Type_O = 177,
KIND_LISPALLOC_llvmo__IntegerType_O = 178,
KIND_LISPALLOC_llvmo__CompositeType_O = 179,
KIND_LISPALLOC_llvmo__SequentialType_O = 180,
KIND_LISPALLOC_llvmo__VectorType_O = 181,
KIND_LISPALLOC_llvmo__PointerType_O = 182,
KIND_LISPALLOC_llvmo__ArrayType_O = 183,
KIND_LISPALLOC_llvmo__StructType_O = 184,
KIND_LISPALLOC_llvmo__FunctionType_O = 185,
KIND_LISPALLOC_llvmo__NamedMDNode_O = 186,
KIND_LISPALLOC_llvmo__Linker_O = 187,
KIND_LISPALLOC_llvmo__Pass_O = 188,
KIND_LISPALLOC_llvmo__FunctionPass_O = 189,
KIND_LISPALLOC_llvmo__ModulePass_O = 190,
KIND_LISPALLOC_llvmo__ImmutablePass_O = 191,
KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O = 192,
KIND_LISPALLOC_llvmo__MCSubtargetInfo_O = 193,
KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O = 194,
KIND_LISPALLOC_llvmo__Module_O = 195,
KIND_LISPALLOC_llvmo__EngineBuilder_O = 196,
KIND_LISPALLOC_llvmo__LLVMContext_O = 197,
KIND_LISPALLOC_llvmo__Target_O = 198,
KIND_LISPALLOC_core__LoadTimeValues_O = 199,
KIND_LISPALLOC_core__IntArray_O = 200,
KIND_LISPALLOC_core__SourceManager_O = 201,
KIND_LISPALLOC_core__Record_O = 202,
KIND_LISPALLOC_core__LightUserData_O = 203,
KIND_LISPALLOC_core__UserData_O = 204,
KIND_LISPALLOC_llvmo__DataLayout_O = 205,
KIND_BOOTSTRAP_core__Symbol_O = 206,
KIND_LISPALLOC_core__Null_O = 207,
KIND_LISPALLOC_core__SourcePosInfo_O = 208,
KIND_TEMPLATED_LISPALLOC_core__Iterator_O = 209,
KIND_LISPALLOC_core__DirectoryIterator_O = 210,
KIND_LISPALLOC_core__RecursiveDirectoryIterator_O = 211,
KIND_LISPALLOC_core__PosixTimeDuration_O = 212,
KIND_LISPALLOC_core__SymbolToEnumConverter_O = 213,
KIND_LISPALLOC_core__CandoException_O = 214,
KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O = 215,
KIND_LISPALLOC_core__Stream_O = 216,
KIND_LISPALLOC_core__AnsiStream_O = 217,
KIND_LISPALLOC_core__FileStream_O = 218,
KIND_LISPALLOC_core__IOStreamStream_O = 219,
KIND_LISPALLOC_core__IOFileStream_O = 220,
KIND_LISPALLOC_core__ConcatenatedStream_O = 221,
KIND_LISPALLOC_core__StringStream_O = 222,
KIND_LISPALLOC_core__StringInputStream_O = 223,
KIND_LISPALLOC_core__StringOutputStream_O = 224,
KIND_LISPALLOC_core__SynonymStream_O = 225,
KIND_LISPALLOC_core__EchoStream_O = 226,
KIND_LISPALLOC_core__TwoWayStream_O = 227,
KIND_LISPALLOC_core__BroadcastStream_O = 228,
KIND_LISPALLOC_core__Reader_O = 229,
KIND_LISPALLOC_core__SharpEqualWrapper_O = 230,
KIND_LISPALLOC_core__Archive_O = 231,
KIND_LISPALLOC_core__SaveArchive_O = 232,
KIND_LISPALLOC_core__SexpSaveArchive_O = 233,
KIND_LISPALLOC_core__LoadArchive_O = 234,
KIND_LISPALLOC_core__SexpLoadArchive_O = 235,
KIND_LISPALLOC_core__HashTable_O = 236,
KIND_LISPALLOC_core__HashTableEq_O = 237,
KIND_LISPALLOC_core__HashTableEqualp_O = 238,
KIND_LISPALLOC_core__HashTableEql_O = 239,
KIND_LISPALLOC_core__HashTableEqual_O = 240,
KIND_TEMPLATED_LISPALLOC_core__Creator_O = 241,
KIND_LISPALLOC_clbind__DummyCreator_O = 242,
KIND_TEMPLATED_LISPALLOC_clbind__ConstructorCreator_O = 243,
KIND_LISPALLOC_core__InstanceCreator_O = 244,
KIND_LISPALLOC_core__CxxObject_O = 245,
KIND_LISPALLOC_core__NativeVector_float_O = 246,
KIND_LISPALLOC_clcenv__Info_O = 247,
KIND_LISPALLOC_clcenv__FunctionInfo_O = 248,
KIND_LISPALLOC_clcenv__LocalFunctionInfo_O = 249,
KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O = 250,
KIND_LISPALLOC_clcenv__LambdaNameInfo_O = 251,
KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O = 252,
KIND_LISPALLOC_clcenv__GlobalMacroInfo_O = 253,
KIND_LISPALLOC_clcenv__LocalMacroInfo_O = 254,
KIND_LISPALLOC_clcenv__OptimizeInfo_O = 255,
KIND_LISPALLOC_clcenv__BlockInfo_O = 256,
KIND_LISPALLOC_clcenv__VariableInfo_O = 257,
KIND_LISPALLOC_clcenv__SpecialVariableInfo_O = 258,
KIND_LISPALLOC_clcenv__SymbolMacroInfo_O = 259,
KIND_LISPALLOC_clcenv__ConstantVariableInfo_O = 260,
KIND_LISPALLOC_clcenv__LexicalVariableInfo_O = 261,
KIND_LISPALLOC_core__NativeVector_int_O = 262,
KIND_LISPALLOC_llvmo__DINodeArray_O = 263,
KIND_LISPALLOC_llvmo__DITypeRefArray_O = 264,
KIND_LISPALLOC_clcenv__Entry_O = 265,
KIND_LISPALLOC_clcenv__Inline_O = 266,
KIND_LISPALLOC_clcenv__Closure_O = 267,
KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O = 268,
KIND_LISPALLOC_clcenv__VariableDynamicExtent_O = 269,
KIND_LISPALLOC_clcenv__SymbolMacro_O = 270,
KIND_LISPALLOC_clcenv__FunctionIgnore_O = 271,
KIND_LISPALLOC_clcenv__Function_O = 272,
KIND_LISPALLOC_clcenv__LambdaName_O = 273,
KIND_LISPALLOC_clcenv__Block_O = 274,
KIND_LISPALLOC_clcenv__SpecialVariable_O = 275,
KIND_LISPALLOC_clcenv__LexicalVariable_O = 276,
KIND_LISPALLOC_clcenv__GlobalEnvironment_O = 277,
KIND_LISPALLOC_clcenv__Tag_O = 278,
KIND_LISPALLOC_clcenv__FunctionType_O = 279,
KIND_LISPALLOC_clcenv__Macro_O = 280,
KIND_LISPALLOC_clcenv__VariableType_O = 281,
KIND_LISPALLOC_clcenv__VariableIgnore_O = 282,
KIND_LISPALLOC_clcenv__Optimize_O = 283,
KIND_LISPALLOC_core__NativeVector_double_O = 284,
KIND_LISPALLOC_core__WeakKeyMapping_O = 285,
KIND_LISPALLOC_core__Cache_O = 286,
KIND_LISPALLOC_core__LambdaListHandler_O = 287,
KIND_LISPALLOC_llvmo__InsertPoint_O = 288,
KIND_LISPALLOC_core__SourceFileInfo_O = 289,
KIND_LISPALLOC_core__SNode_O = 290,
KIND_LISPALLOC_core__LeafSNode_O = 291,
KIND_LISPALLOC_core__BranchSNode_O = 292,
KIND_LISPALLOC_core__Path_O = 293,
KIND_LISPALLOC_llvmo__AttributeSet_O = 295,
KIND_LISPALLOC_core__StructureObject_O = 296,
KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O = 297,
KIND_LISPALLOC_core__Package_O = 298,
KIND_LISPALLOC_core__DirectoryEntry_O = 299,
KIND_LISPALLOC_core__Character_dummy_O = 300,
KIND_LISPALLOC_core__Function_O = 301,
KIND_LISPALLOC_core__NamedFunction_O = 302,
KIND_LISPALLOC_core__SpecialForm_O = 303,
KIND_LISPALLOC_core__Closure_O = 304,
KIND_LISPALLOC_core__CompiledFunction_O = 305,
KIND_LISPALLOC_core__FunctionClosure_O = 306,
KIND_LISPALLOC_core__ClosureWithSlots_O = 307,
KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O = 308,
KIND_LISPALLOC_core__TranslationFunctor = 309,
KIND_LISPALLOC_core__MacroClosure_O = 310,
KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O = 311,
KIND_LISPALLOC_core__ClosureWithFrame_O = 312,
KIND_LISPALLOC_core__CompiledClosure_O = 313,
KIND_LISPALLOC_core__InterpretedClosure_O = 314,
KIND_LISPALLOC_core__SingleDispatchMethodFunction_O = 315,
KIND_LISPALLOC_core__CxxMethodFunction_O = 316,
KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O = 317,
KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O = 318,
KIND_LISPALLOC_core__Instance_O = 319,
KIND_ABSTRACT_clbind__Derivable_clang__ASTFrontendAction_ = 322,
KIND_LISPALLOC_asttooling__DerivableASTFrontendAction = 323,
KIND_ABSTRACT_clbind__Derivable_clang__SyntaxOnlyAction_ = 326,
KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction = 327,
KIND_LISPALLOC_core__Pointer_O = 328,
KIND_LISPALLOC_clbind__ClassRegistry_O = 329,
KIND_LISPALLOC_core__SmallMultimap_O = 330,
KIND_LISPALLOC_core__Pathname_O = 331,
KIND_LISPALLOC_core__LogicalPathname_O = 332,
KIND_LISPALLOC_core__PosixTime_O = 333,
KIND_LISPALLOC_core__SmallMap_O = 334,
KIND_ABSTRACT_gctools__GCContainer = 335,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__ = 336,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 337,
KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_ = 338,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 339,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 340,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__ = 341,
KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_ = 342,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__ = 343,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__ = 344,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__ = 345,
KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_ = 346,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__ = 347,
KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___ = 348,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_ = 349,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__ = 350,
KIND_GCVECTOR_gctools__GCVector_moveable_int_ = 351,
KIND_GCVECTOR_gctools__GCVector_moveable_double_ = 352,
KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_ = 353,
KIND_GCARRAY_gctools__GCArray_moveable_double_ = 354,
KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___ = 355,
KIND_GCARRAY_gctools__GCArray_moveable_unsigned_int_ = 356,
KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_ = 357,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_ = 358,
KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_ = 359,
KIND_GCVECTOR_gctools__GCVector_moveable_float_ = 360,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 361,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 362,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__ = 363,
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 364,
KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_ = 365,
KIND_ABSTRACT_clang__ast_matchers__MatchFinder__MatchCallback = 366,
KIND_ABSTRACT_clbind__Derivable_clang__ast_matchers__MatchFinder__MatchCallback_ = 367,
KIND_LISPALLOC_asttooling__DerivableMatchCallback = 368,
KIND_ABSTRACT_clang__RecursiveASTVisitor_asttooling__AstVisitor_O_ = 369,
KIND_LISPALLOC_asttooling__AstVisitor_O = 370,
KIND_ROOTCLASSALLOC_core__Lisp_O = 371,
KIND_ABSTRACT_clang__tooling__ToolAction = 372,
KIND_ABSTRACT_clang__tooling__FrontendActionFactory = 373,
KIND_ABSTRACT_clbind__Derivable_clang__tooling__FrontendActionFactory_ = 374,
KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory = 375,
  KIND_max = 375
}
...
template <typename FP> struct Cast<core::LoadArchive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 234 235 
      return ((234 <= kindVal) && (kindVal <= 235));
  };
};
...
template <typename FP> struct Cast<core::FunctionClosure_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 306 318 
      return ((306 <= kindVal) && (kindVal <= 318));
  };
};
...
template <typename FP> struct Cast<clcenv::VariableInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 257 261 
      return ((257 <= kindVal) && (kindVal <= 261));
  };
};
...
template <typename FP> struct Cast<core::SpecializedVectorNs_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 63 65 
...
template <typename FP> struct Cast<core::SimpleDoubleVector_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 73 73 
...
template <typename FP> struct Cast<core::Instance_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 319 327 
      return ((319 <= kindVal) && (kindVal <= 327));
  };
};
...
template <typename FP> struct Cast<llvmo::DIScope_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 153 164 
      return ((153 <= kindVal) && (kindVal <= 164));
  };
};
...
template <typename FP> struct Cast<core::ArrayTNs_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 69 69 
...
template <typename FP> struct Cast<core::BaseSimpleVector_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 70 81 
...
template <typename FP> struct Cast<core::Function_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 301 327 
      return ((301 <= kindVal) && (kindVal <= 327));
  };
};
...
template <typename FP> struct Cast<llvmo::MCSubtargetInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 193 194 
      return ((193 <= kindVal) && (kindVal <= 194));
  };
};
...
template <typename FP> struct Cast<llvmo::TerminatorInst_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 122 129 
      return ((122 <= kindVal) && (kindVal <= 129));
  };
};
#ifdef moveable
template <typename FP> struct Cast<core::abstract_DisplacementHandlingVector<core::VectorTNs_O,core::SimpleVector_O,core::SpecializedVectorNs_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 64 65 
      return ((64 <= kindVal) && (kindVal <= 65));
  };
};
#endif
...
#ifdef moveable
template <typename FP> struct Cast<clbind::Derivable<clang::SyntaxOnlyAction>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 326 327 
      return ((326 <= kindVal) && (kindVal <= 327));
  };
};
#endif
...
template <typename FP> struct Cast<llvmo::Type_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 177 185 
      return ((177 <= kindVal) && (kindVal <= 185));
  };
};
...
template <typename FP> struct Cast<llvmo::CompositeType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 179 184 
      return ((179 <= kindVal) && (kindVal <= 184));
  };
};
...
#ifdef moveable
template <typename FP> struct Cast<gctools::GCBitUnitArray_moveable<1,unsigned long,long>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 359 359 
...
template <typename FP> struct Cast<llvmo::DINode_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 152 164 
      return ((152 <= kindVal) && (kindVal <= 164));
  };
};
...
template <typename FP> struct Cast<core::NamedFunction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 302 318 
      return ((302 <= kindVal) && (kindVal <= 318));
  };
};
...
template <typename FP> struct Cast<core::CxxObject_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 245 284 
      return ((245 <= kindVal) && (kindVal <= 284));
  };
};
...
template <typename FP> struct Cast<core::Creator_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 241 244 
      return ((241 <= kindVal) && (kindVal <= 244));
  };
};
...
template <typename FP> struct Cast<core::HashTable_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 236 240 
      return ((236 <= kindVal) && (kindVal <= 240));
  };
};
...
#ifdef moveable
template <typename FP> struct Cast<core::abstract_DisplacementHandlingVector<core::StrWNs_O,core::SimpleCharacterString_O,core::StrNs_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 60 61 
...
template <typename FP> struct Cast<core::Stream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 216 228 
      return ((216 <= kindVal) && (kindVal <= 228));
  };
};
...
template <typename FP> struct Cast<llvmo::UnaryInstruction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 117 120 
      return ((117 <= kindVal) && (kindVal <= 120));
  };
};
...
#ifdef moveable
template <typename FP> struct Cast<clbind::Derivable<clang::tooling::FrontendActionFactory>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 374 375 
      return ((374 <= kindVal) && (kindVal <= 375));
  };
};
#endif
...
template <typename FP> struct Cast<llvmo::PassManagerBase_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 171 173 
      return ((171 <= kindVal) && (kindVal <= 173));
  };
};
template <typename FP> struct Cast<core::Iterator_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 209 211 
      return ((209 <= kindVal) && (kindVal <= 211));
  };
};
...
#ifdef moveable
template <typename FP> struct Cast<gctools::GCVector_moveable<std::__1::pair<gctools::smart_ptr<core::T_O>,gctools::smart_ptr<core::T_O>>>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 355 355 
...
#ifdef moveable
template <typename FP> struct Cast<core::abstract_SimpleVector<core::SimpleVector_O,gctools::smart_ptr<core::T_O>,core::SpecializedSimpleVector_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 74 75 
...
template <typename FP> struct Cast<llvmo::DIType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 159 163 
      return ((159 <= kindVal) && (kindVal <= 163));
  };
};
template <typename FP> struct Cast<core::MDArrayNs_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 66 69 
      return ((66 <= kindVal) && (kindVal <= 69));
  };
};
...
template <typename FP> struct Cast<core::VectorNs_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 56 65 
      return ((56 <= kindVal) && (kindVal <= 65));
  };
};
#ifdef moveable
...
#ifdef moveable
template <typename FP> struct Cast<gctools::GCContainer*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 335 365 
      return ((335 <= kindVal) && (kindVal <= 365));
  };
};
#endif
template <typename FP> struct Cast<llvmo::MDNode_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 151 164 
      return ((151 <= kindVal) && (kindVal <= 164));
  };
};
...
template <typename FP> struct Cast<core::LightUserData_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 203 204 
      return ((203 <= kindVal) && (kindVal <= 204));
  };
};
template <typename FP> struct Cast<core::T_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 13 334 
      return ((13 <= kindVal) && (kindVal <= 334));
  };
};
#ifdef moveable
template <typename FP> struct Cast<core::abstract_DisplacementHandlingVector<core::Str8Ns_O,core::SimpleBaseCharString_O,core::StrNs_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 58 59 
...
template <typename FP> struct Cast<core::SaveArchive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 232 233 
      return ((232 <= kindVal) && (kindVal <= 233));
  };
};
...
#ifdef moveable
template <typename FP> struct Cast<core::abstract_SimpleVector<core::SimpleDoubleVector_O,double,core::SpecializedSimpleVector_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 72 73 
      return ((72 <= kindVal) && (kindVal <= 73));
  };
};
#endif
...
#endif
#ifdef moveable
template <typename FP> struct Cast<clbind::Derivable<clang::ASTFrontendAction>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 322 323 
      return ((322 <= kindVal) && (kindVal <= 323));
  };
};
#endif
...
template <typename FP> struct Cast<llvmo::Constant_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 131 144 
      return ((131 <= kindVal) && (kindVal <= 144));
  };
};
#ifdef moveable
template <typename FP> struct Cast<clbind::Derivable<clang::ast_matchers::MatchFinder::MatchCallback>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 367 368 
...
template <typename FP> struct Cast<core::ExternalObject_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 106 198 
      return ((106 <= kindVal) && (kindVal <= 198));
  };
};
...
template <typename FP> struct Cast<llvmo::DILocalScope_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 155 158 
      return ((155 <= kindVal) && (kindVal <= 158));
  };
};
...
template <typename FP> struct Cast<core::Closure_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 304 318 
      return ((304 <= kindVal) && (kindVal <= 318));
  };
};
#ifdef moveable
template <typename FP> struct Cast<gctools::GCVector_moveable<std::__1::pair<gctools::smart_ptr<core::Symbol_O>,gctools::smart_ptr<core::T_O>>>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 348 348 
...
template <typename FP> struct Cast<core::SingleDispatchMethodFunction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 315 316 
      return ((315 <= kindVal) && (kindVal <= 316));
  };
};
...
template <typename FP> struct Cast<core::ClosureWithFrame_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 312 314 
      return ((312 <= kindVal) && (kindVal <= 314));
  };
};
...
template <typename FP> struct Cast<core::SpecializedMDArrayNs_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 67 69 
...
template <typename FP> struct Cast<core::BuiltinClosure_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 308 310 
      return ((308 <= kindVal) && (kindVal <= 310));
  };
};
...
template <typename FP> struct Cast<llvmo::Metadata_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 149 165 
      return ((149 <= kindVal) && (kindVal <= 165));
  };
};
template <typename FP> struct Cast<llvmo::User_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 110 144 
      return ((110 <= kindVal) && (kindVal <= 144));
  };
};
...
template <typename FP> struct Cast<llvmo::SequentialType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 180 183 
      return ((180 <= kindVal) && (kindVal <= 183));
  };
};
...
template <typename FP> struct Cast<core::SpecializedSimpleVector_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 71 75 
...
template <typename FP> struct Cast<core::StringStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 222 224 
      return ((222 <= kindVal) && (kindVal <= 224));
  };
};
...
template <typename FP> struct Cast<core::SimpleBaseCharString_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 79 79 
...
template <typename FP> struct Cast<llvmo::ConstantDataSequential_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 138 139 
      return ((138 <= kindVal) && (kindVal <= 139));
  };
};
...
#ifdef moveable
template <typename FP> struct Cast<core::abstract_DisplacementHandlingArray<core::ArrayTNs_O,core::SimpleVector_O,core::SpecializedMDArrayNs_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 68 69 
      return ((68 <= kindVal) && (kindVal <= 69));
  };
};
#endif
...
template <typename FP> struct Cast<core::Environment_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 35 53 
      return ((35 <= kindVal) && (kindVal <= 53));
  };
};
#ifdef moveable
template <typename FP> struct Cast<core::abstract_SimpleVector<core::SimpleBaseCharString_O,unsigned char,core::SimpleString_O>*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 78 79 
...
template <typename FP> struct Cast<core::VectorTNs_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 65 65 
...
template <typename FP> struct Cast<llvmo::Instruction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 111 130 
      return ((111 <= kindVal) && (kindVal <= 130));
  };
};
...
template <typename FP> struct Cast<core::AnsiStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 217 228 
      return ((217 <= kindVal) && (kindVal <= 228));
  };
};
...
template <typename FP> struct Cast<llvmo::IRBuilderBase_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 146 147 
      return ((146 <= kindVal) && (kindVal <= 147));
  };
};
...
template <typename FP> struct Cast<llvmo::Value_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 108 145 
      return ((108 <= kindVal) && (kindVal <= 145));
  };
};
...
template <typename FP> struct Cast<clcenv::Info_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 247 261 
      return ((247 <= kindVal) && (kindVal <= 261));
  };
};
...
template <typename FP> struct Cast<llvmo::ModulePass_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 190 192 
      return ((190 <= kindVal) && (kindVal <= 192));
  };
};
...
template <typename FP> struct Cast<clcenv::FunctionInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 248 254 
      return ((248 <= kindVal) && (kindVal <= 254));
  };
};
...
template <> class gctools::GCKind<core::SpecializedVectorNs_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__SpecializedVectorNs_O ;
};
...
template <> class gctools::GCKind<core::SimpleDoubleVector_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__SimpleDoubleVector_O ;
};
...
template <> class gctools::GCKind<core::ArrayTNs_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__ArrayTNs_O ;
};
...
template <> class gctools::GCKind<core::BaseSimpleVector_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__BaseSimpleVector_O ;
};
...
template <> class gctools::GCKind<gctools::GCBitUnitArray_moveable<1,unsigned long,long>> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_ ;
};
...
template <> class gctools::GCKind<core::MDArrayNs_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__MDArrayNs_O ;
};
...
template <> class gctools::GCKind<core::VectorNs_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__VectorNs_O ;
};
...
template <> class gctools::GCKind<core::SpecializedMDArrayNs_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__SpecializedMDArrayNs_O ;
};
...
template <> class gctools::GCKind<core::SpecializedSimpleVector_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__SpecializedSimpleVector_O ;
};
...
template <> class gctools::GCKind<core::SimpleBaseCharString_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__SimpleBaseCharString_O ;
};
...
template <> class gctools::GCKind<core::VectorTNs_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_core__VectorTNs_O ;
};
...
{ class_kind, KIND_LISPALLOC_core__MDArray_O, sizeof(core::MDArray_O), 0, "core::MDArray_O" },
 ...
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::MDArray_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::MDArray_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__VectorNs_O, sizeof(core::VectorNs_O), 0, "core::VectorNs_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_FillPointerOrLengthOrDummy), "_FillPointerOrLengthOrDummy" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_ArrayTotalSize), "_ArrayTotalSize" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Array_O>), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_Data), "_Data" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_DisplacedIndexOffset), "_DisplacedIndexOffset" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_Dimensions._Data), "_Dimensions._Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_Dimensions._Length), offsetof(SAFE_TYPE_MACRO(core::VectorNs_O),_Dimensions._Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__StrNs_O, sizeof(core::StrNs_O), 0, "core::StrNs_O" },
 ...
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::StrNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::StrNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__Str8Ns_O, sizeof(core::Str8Ns_O), 0, "core::Str8Ns_O" },
 ...
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Str8Ns_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Str8Ns_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__StrWNs_O, sizeof(core::StrWNs_O), 0, "core::StrWNs_O" },
 ...
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::StrWNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::StrWNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__BitVectorNs_O, sizeof(core::BitVectorNs_O), 0, "core::BitVectorNs_O" },
 ...
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::BitVectorNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::BitVectorNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
...
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SpecializedVectorNs_O, sizeof(core::SpecializedVectorNs_O), 0, "core::SpecializedVectorNs_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_FillPointerOrLengthOrDummy), "_FillPointerOrLengthOrDummy" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_ArrayTotalSize), "_ArrayTotalSize" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Array_O>), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_Data), "_Data" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_DisplacedIndexOffset), "_DisplacedIndexOffset" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_Dimensions._Data), "_Dimensions._Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_Dimensions._Length), offsetof(SAFE_TYPE_MACRO(core::SpecializedVectorNs_O),_Dimensions._Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__VectorTNs_O, sizeof(core::VectorTNs_O), 0, "core::VectorTNs_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_FillPointerOrLengthOrDummy), "_FillPointerOrLengthOrDummy" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_ArrayTotalSize), "_ArrayTotalSize" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Array_O>), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_Data), "_Data" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_DisplacedIndexOffset), "_DisplacedIndexOffset" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_Dimensions._Data), "_Dimensions._Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_Dimensions._Length), offsetof(SAFE_TYPE_MACRO(core::VectorTNs_O),_Dimensions._Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__MDArrayNs_O, sizeof(core::MDArrayNs_O), 0, "core::MDArrayNs_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_FillPointerOrLengthOrDummy), "_FillPointerOrLengthOrDummy" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_ArrayTotalSize), "_ArrayTotalSize" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Array_O>), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_Data), "_Data" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_DisplacedIndexOffset), "_DisplacedIndexOffset" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_Dimensions._Data), "_Dimensions._Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_Dimensions._Length), offsetof(SAFE_TYPE_MACRO(core::MDArrayNs_O),_Dimensions._Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SpecializedMDArrayNs_O, sizeof(core::SpecializedMDArrayNs_O), 0, "core::SpecializedMDArrayNs_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_FillPointerOrLengthOrDummy), "_FillPointerOrLengthOrDummy" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_ArrayTotalSize), "_ArrayTotalSize" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Array_O>), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_Data), "_Data" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_DisplacedIndexOffset), "_DisplacedIndexOffset" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_Dimensions._Data), "_Dimensions._Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_Dimensions._Length), offsetof(SAFE_TYPE_MACRO(core::SpecializedMDArrayNs_O),_Dimensions._Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__ArrayTNs_O, sizeof(core::ArrayTNs_O), 0, "core::ArrayTNs_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_FillPointerOrLengthOrDummy), "_FillPointerOrLengthOrDummy" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_ArrayTotalSize), "_ArrayTotalSize" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Array_O>), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_Data), "_Data" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_DisplacedIndexOffset), "_DisplacedIndexOffset" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_DisplacedToP), "_DisplacedToP" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_FillPointerP), "_FillPointerP" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_Dimensions._Data), "_Dimensions._Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_Dimensions._Length), offsetof(SAFE_TYPE_MACRO(core::ArrayTNs_O),_Dimensions._Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__BaseSimpleVector_O, sizeof(core::BaseSimpleVector_O), 0, "core::BaseSimpleVector_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::BaseSimpleVector_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
{ class_kind, KIND_LISPALLOC_core__SpecializedSimpleVector_O, sizeof(core::SpecializedSimpleVector_O), 0, "core::SpecializedSimpleVector_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::SpecializedSimpleVector_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
{ class_kind, KIND_LISPALLOC_core__SimpleDoubleVector_O, sizeof(core::SimpleDoubleVector_O), 0, "core::SimpleDoubleVector_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::SimpleDoubleVector_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::SimpleDoubleVector_O),_Data._Data), "_Data._Data" },
{  variable_capacity, sizeof(double), offsetof(SAFE_TYPE_MACRO(core::SimpleDoubleVector_O),_Data._Length), offsetof(SAFE_TYPE_MACRO(core::SimpleDoubleVector_O),_Data._Length), NULL },
...
{ class_kind, KIND_LISPALLOC_core__SimpleString_O, sizeof(core::SimpleString_O), 0, "core::SimpleString_O" },
...
{ class_kind, KIND_LISPALLOC_core__SimpleBaseCharString_O, sizeof(core::SimpleBaseCharString_O), 0, "core::SimpleBaseCharString_O" },
 {  fixed_field, CONSTANT_ARRAY_OFFSET, sizeof(UnknownType), offsetof(SAFE_TYPE_MACRO(core::SimpleBaseCharString_O),_Length), "_Length" }, // public: (T) fixable: NIL good-name: T
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(core::SimpleBaseCharString_O),_Data._Data), "_Data._Data" },
{  variable_capacity, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::SimpleBaseCharString_O),_Data._Length), offsetof(SAFE_TYPE_MACRO(core::SimpleBaseCharString_O),_Data._Length), NULL },
{    variable_field, ctype_unsigned_char, sizeof(unsigned char), 0, "only" },
{ class_kind, KIND_LISPALLOC_core__SimpleCharacterString_O, sizeof(core::SimpleCharacterString_O), 0, "core::SimpleCharacterString_O" },
...
{  variable_capacity, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::SimpleCharacterString_O),_Data._Length), offsetof(SAFE_TYPE_MACRO(core::SimpleCharacterString_O),_Data._Length), NULL },
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Exposer_O),_PackageName.__r_.__first_.NO-NAME.__l.__cap_), "_PackageName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Exposer_O),_PackageName.__r_.__first_.NO-NAME.__l.__size_), "_PackageName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Exposer_O),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Exposer_O),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
{ class_kind, KIND_LISPALLOC_asttooling__AsttoolingExposer_O, sizeof(asttooling::AsttoolingExposer_O), 0, "asttooling::AsttoolingExposer_O" },
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::AsttoolingExposer_O),_PackageName.__r_.__first_.NO-NAME.__l.__cap_), "_PackageName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::AsttoolingExposer_O),_PackageName.__r_.__first_.NO-NAME.__l.__size_), "_PackageName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(asttooling::AsttoolingExposer_O),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(asttooling::AsttoolingExposer_O),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::CoreExposer_O),_PackageName.__r_.__first_.NO-NAME.__l.__cap_), "_PackageName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::CoreExposer_O),_PackageName.__r_.__first_.NO-NAME.__l.__size_), "_PackageName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::CoreExposer_O),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::CoreExposer_O),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
...
{ class_kind, KIND_BOOTSTRAP_core__StdClass_O, sizeof(core::StdClass_O), 0, "core::StdClass_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::StdClass_O),_instance_stamp), "_instance_stamp" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::StdClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Creator_O>), offsetof(SAFE_TYPE_MACRO(core::StdClass_O),_theCreator), "_theCreator" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>), offsetof(SAFE_TYPE_MACRO(core::StdClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" }, // public: (T T T) fixable: TAGGED-POINTER-FIX good-name: T
{ class_kind, KIND_BOOTSTRAP_core__StandardClass_O, sizeof(core::StandardClass_O), 0, "core::StandardClass_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::StandardClass_O),_instance_stamp), "_instance_stamp" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__FuncallableStandardClass_O, sizeof(core::FuncallableStandardClass_O), 0, "core::FuncallableStandardClass_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::FuncallableStandardClass_O),_instance_stamp), "_instance_stamp" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_BOOTSTRAP_core__StructureClass_O, sizeof(core::StructureClass_O), 0, "core::StructureClass_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::StructureClass_O),_instance_stamp), "_instance_stamp" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__ForwardReferencedClass_O, sizeof(core::ForwardReferencedClass_O), 0, "core::ForwardReferencedClass_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ForwardReferencedClass_O),_instance_stamp), "_instance_stamp" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__CxxClass_O, sizeof(core::CxxClass_O), 0, "core::CxxClass_O" },
 ...
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>), offsetof(SAFE_TYPE_MACRO(core::CxxClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" }, // public: (T T T) fixable: TAGGED-POINTER-FIX good-name: T
{ class_kind, KIND_BOOTSTRAP_core__BuiltInClass_O, sizeof(core::BuiltInClass_O), 0, "core::BuiltInClass_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::BuiltInClass_O),_instance_stamp), "_instance_stamp" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::BuiltInClass_O),_Signature_ClassSlots), "_Signature_ClassSlots" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::Creator_O>), offsetof(SAFE_TYPE_MACRO(core::BuiltInClass_O),_theCreator), "_theCreator" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>), offsetof(SAFE_TYPE_MACRO(core::BuiltInClass_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" }, // public: (T T T) fixable: TAGGED-POINTER-FIX good-name: T
{ class_kind, KIND_LISPALLOC_clbind__ClassRep_O, sizeof(clbind::ClassRep_O), 0, "clbind::ClassRep_O" },
 ...
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>), offsetof(SAFE_TYPE_MACRO(clbind::ClassRep_O),_MetaClassSlots._Vector._Contents), "_MetaClassSlots._Vector._Contents" }, // public: (T T T) fixable: TAGGED-POINTER-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(clbind::ClassRep_O),m_name.__r_.__first_.NO-NAME.__l.__cap_), "m_name.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(clbind::ClassRep_O),m_name.__r_.__first_.NO-NAME.__l.__size_), "m_name.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(clbind::ClassRep_O),m_name.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "m_name.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(clbind::ClassRep_O),m_name.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "m_name.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long_long, sizeof(unsigned long long), offsetof(SAFE_TYPE_MACRO(llvmo::APFloat_O),_value.U.IEEE.significand.part), "_value.U.IEEE.significand.part" }, // public: (T NIL T NIL T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::PassManagerBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__l.__cap_), "_ErrorStr.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::PassManagerBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__l.__size_), "_ErrorStr.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(llvmo::PassManagerBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(llvmo::PassManagerBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long_long, sizeof(unsigned long long), offsetof(SAFE_TYPE_MACRO(llvmo::APInt_O),_value.NO-NAME.VAL), "_value.NO-NAME.VAL" }, // public: (T NIL T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::EngineBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__l.__cap_), "_ErrorStr.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(llvmo::EngineBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__l.__size_), "_ErrorStr.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(llvmo::EngineBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(llvmo::EngineBuilder_O),_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_ErrorStr.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O, sizeof(clasp_ffi::ForeignTypeSpec_O), 0, "clasp_ffi::ForeignTypeSpec_O" },
...
{ class_kind, KIND_LISPALLOC_core__Stream_O, sizeof(core::Stream_O), 0, "core::Stream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::Stream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__AnsiStream_O, sizeof(core::AnsiStream_O), 0, "core::AnsiStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::AnsiStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__FileStream_O, sizeof(core::FileStream_O), 0, "core::FileStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::FileStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__IOStreamStream_O, sizeof(core::IOStreamStream_O), 0, "core::IOStreamStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::IOStreamStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__IOFileStream_O, sizeof(core::IOFileStream_O), 0, "core::IOFileStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::IOFileStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__ConcatenatedStream_O, sizeof(core::ConcatenatedStream_O), 0, "core::ConcatenatedStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::ConcatenatedStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__StringStream_O, sizeof(core::StringStream_O), 0, "core::StringStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::StringStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__StringInputStream_O, sizeof(core::StringInputStream_O), 0, "core::StringInputStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::StringInputStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__StringOutputStream_O, sizeof(core::StringOutputStream_O), 0, "core::StringOutputStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::StringOutputStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__SynonymStream_O, sizeof(core::SynonymStream_O), 0, "core::SynonymStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::SynonymStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__EchoStream_O, sizeof(core::EchoStream_O), 0, "core::EchoStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::EchoStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__TwoWayStream_O, sizeof(core::TwoWayStream_O), 0, "core::TwoWayStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::TwoWayStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__BroadcastStream_O, sizeof(core::BroadcastStream_O), 0, "core::BroadcastStream_O" },
 ...
 {  fixed_field, ctype_unsigned_int, sizeof(unsigned int), offsetof(SAFE_TYPE_MACRO(core::BroadcastStream_O),_EofChar), "_EofChar" }, // public: (T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_double, sizeof(double), offsetof(SAFE_TYPE_MACRO(core::HashTable_O),_RehashThreshold), "_RehashThreshold" }, // public: (NIL) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::VectorTNs_O>), offsetof(SAFE_TYPE_MACRO(core::HashTable_O),_HashTable), "_HashTable" }, // public: (NIL) fixable: SMART-PTR-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_double, sizeof(double), offsetof(SAFE_TYPE_MACRO(core::HashTableEq_O),_RehashThreshold), "_RehashThreshold" }, // public: (NIL) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::VectorTNs_O>), offsetof(SAFE_TYPE_MACRO(core::HashTableEq_O),_HashTable), "_HashTable" }, // public: (NIL) fixable: SMART-PTR-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_double, sizeof(double), offsetof(SAFE_TYPE_MACRO(core::HashTableEqualp_O),_RehashThreshold), "_RehashThreshold" }, // public: (NIL) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::VectorTNs_O>), offsetof(SAFE_TYPE_MACRO(core::HashTableEqualp_O),_HashTable), "_HashTable" }, // public: (NIL) fixable: SMART-PTR-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_double, sizeof(double), offsetof(SAFE_TYPE_MACRO(core::HashTableEql_O),_RehashThreshold), "_RehashThreshold" }, // public: (NIL) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::VectorTNs_O>), offsetof(SAFE_TYPE_MACRO(core::HashTableEql_O),_HashTable), "_HashTable" }, // public: (NIL) fixable: SMART-PTR-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_double, sizeof(double), offsetof(SAFE_TYPE_MACRO(core::HashTableEqual_O),_RehashThreshold), "_RehashThreshold" }, // public: (NIL) fixable: NIL good-name: T
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::VectorTNs_O>), offsetof(SAFE_TYPE_MACRO(core::HashTableEqual_O),_HashTable), "_HashTable" }, // public: (NIL) fixable: SMART-PTR-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(clbind::DummyCreator_O),_name.__r_.__first_.NO-NAME.__l.__size_), "_name.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(clbind::DummyCreator_O),_name.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_name.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(clbind::DummyCreator_O),_name.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_name.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_clcenv__Info_O, sizeof(clcenv::Info_O), 0, "clcenv::Info_O" },
{ class_kind, KIND_LISPALLOC_clcenv__FunctionInfo_O, sizeof(clcenv::FunctionInfo_O), 0, "clcenv::FunctionInfo_O" },
{ class_kind, KIND_LISPALLOC_clcenv__LocalFunctionInfo_O, sizeof(clcenv::LocalFunctionInfo_O), 0, "clcenv::LocalFunctionInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O, sizeof(clcenv::GlobalFunctionInfo_O), 0, "clcenv::GlobalFunctionInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__LambdaNameInfo_O, sizeof(clcenv::LambdaNameInfo_O), 0, "clcenv::LambdaNameInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O, sizeof(clcenv::SpecialOperatorInfo_O), 0, "clcenv::SpecialOperatorInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__GlobalMacroInfo_O, sizeof(clcenv::GlobalMacroInfo_O), 0, "clcenv::GlobalMacroInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__LocalMacroInfo_O, sizeof(clcenv::LocalMacroInfo_O), 0, "clcenv::LocalMacroInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__OptimizeInfo_O, sizeof(clcenv::OptimizeInfo_O), 0, "clcenv::OptimizeInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__BlockInfo_O, sizeof(clcenv::BlockInfo_O), 0, "clcenv::BlockInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__VariableInfo_O, sizeof(clcenv::VariableInfo_O), 0, "clcenv::VariableInfo_O" },
{ class_kind, KIND_LISPALLOC_clcenv__SpecialVariableInfo_O, sizeof(clcenv::SpecialVariableInfo_O), 0, "clcenv::SpecialVariableInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__SymbolMacroInfo_O, sizeof(clcenv::SymbolMacroInfo_O), 0, "clcenv::SymbolMacroInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__ConstantVariableInfo_O, sizeof(clcenv::ConstantVariableInfo_O), 0, "clcenv::ConstantVariableInfo_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__LexicalVariableInfo_O, sizeof(clcenv::LexicalVariableInfo_O), 0, "clcenv::LexicalVariableInfo_O" },
...
{ class_kind, KIND_LISPALLOC_core__NativeVector_int_O, sizeof(core::NativeVector_int_O), 0, "core::NativeVector_int_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Entry_O, sizeof(clcenv::Entry_O), 0, "clcenv::Entry_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Inline_O, sizeof(clcenv::Inline_O), 0, "clcenv::Inline_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Closure_O, sizeof(clcenv::Closure_O), 0, "clcenv::Closure_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O, sizeof(clcenv::FunctionDynamicExtent_O), 0, "clcenv::FunctionDynamicExtent_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__VariableDynamicExtent_O, sizeof(clcenv::VariableDynamicExtent_O), 0, "clcenv::VariableDynamicExtent_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__SymbolMacro_O, sizeof(clcenv::SymbolMacro_O), 0, "clcenv::SymbolMacro_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__FunctionIgnore_O, sizeof(clcenv::FunctionIgnore_O), 0, "clcenv::FunctionIgnore_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Function_O, sizeof(clcenv::Function_O), 0, "clcenv::Function_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__LambdaName_O, sizeof(clcenv::LambdaName_O), 0, "clcenv::LambdaName_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Block_O, sizeof(clcenv::Block_O), 0, "clcenv::Block_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__SpecialVariable_O, sizeof(clcenv::SpecialVariable_O), 0, "clcenv::SpecialVariable_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__LexicalVariable_O, sizeof(clcenv::LexicalVariable_O), 0, "clcenv::LexicalVariable_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__GlobalEnvironment_O, sizeof(clcenv::GlobalEnvironment_O), 0, "clcenv::GlobalEnvironment_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Tag_O, sizeof(clcenv::Tag_O), 0, "clcenv::Tag_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__FunctionType_O, sizeof(clcenv::FunctionType_O), 0, "clcenv::FunctionType_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Macro_O, sizeof(clcenv::Macro_O), 0, "clcenv::Macro_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__VariableType_O, sizeof(clcenv::VariableType_O), 0, "clcenv::VariableType_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__VariableIgnore_O, sizeof(clcenv::VariableIgnore_O), 0, "clcenv::VariableIgnore_O" },
...
{ class_kind, KIND_LISPALLOC_clcenv__Optimize_O, sizeof(clcenv::Optimize_O), 0, "clcenv::Optimize_O" },
...
{ class_kind, KIND_LISPALLOC_core__NativeVector_double_O, sizeof(core::NativeVector_double_O), 0, "core::NativeVector_double_O" },
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Path_O),_Path.m_pathname.__r_.__first_.NO-NAME.__l.__cap_), "_Path.m_pathname.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Path_O),_Path.m_pathname.__r_.__first_.NO-NAME.__l.__size_), "_Path.m_pathname.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Path_O),_Path.m_pathname.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_Path.m_pathname.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Path_O),_Path.m_pathname.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_Path.m_pathname.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__Package_O, sizeof(core::Package_O), 0, "core::Package_O" },
 ...
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Package_O),_KeywordPackage), "_KeywordPackage" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Package_O),_AmpPackage), "_AmpPackage" }, // public: (T) fixable: NIL good-name: T
 {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Package_O),_ActsLikeKeywordPackage), "_ActsLikeKeywordPackage" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__NamedFunction_O, sizeof(core::NamedFunction_O), 0, "core::NamedFunction_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::NamedFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__SpecialForm_O, sizeof(core::SpecialForm_O), 0, "core::SpecialForm_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SpecialForm_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__Closure_O, sizeof(core::Closure_O), 0, "core::Closure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Closure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__CompiledFunction_O, sizeof(core::CompiledFunction_O), 0, "core::CompiledFunction_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::CompiledFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__FunctionClosure_O, sizeof(core::FunctionClosure_O), 0, "core::FunctionClosure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::FunctionClosure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__ClosureWithSlots_O, sizeof(core::ClosureWithSlots_O), 0, "core::ClosureWithSlots_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ClosureWithSlots_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ templated_kind, KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O, sizeof(core::BuiltinClosure_O), 0, "core::BuiltinClosure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::BuiltinClosure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__TranslationFunctor, sizeof(core::TranslationFunctor), 0, "core::TranslationFunctor" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::TranslationFunctor),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__MacroClosure_O, sizeof(core::MacroClosure_O), 0, "core::MacroClosure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::MacroClosure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O, sizeof(core::SingleDispatchCxxEffectiveMethodFunction_O), 0, "core::SingleDispatchCxxEffectiveMethodFunction_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SingleDispatchCxxEffectiveMethodFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__ClosureWithFrame_O, sizeof(core::ClosureWithFrame_O), 0, "core::ClosureWithFrame_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::ClosureWithFrame_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__CompiledClosure_O, sizeof(core::CompiledClosure_O), 0, "core::CompiledClosure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::CompiledClosure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__InterpretedClosure_O, sizeof(core::InterpretedClosure_O), 0, "core::InterpretedClosure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::InterpretedClosure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__SingleDispatchMethodFunction_O, sizeof(core::SingleDispatchMethodFunction_O), 0, "core::SingleDispatchMethodFunction_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SingleDispatchMethodFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__CxxMethodFunction_O, sizeof(core::CxxMethodFunction_O), 0, "core::CxxMethodFunction_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::CxxMethodFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O, sizeof(core::SingleDispatchEffectiveMethodFunction_O), 0, "core::SingleDispatchEffectiveMethodFunction_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SingleDispatchEffectiveMethodFunction_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O, sizeof(core::SingleDispatchGenericFunctionClosure_O), 0, "core::SingleDispatchGenericFunctionClosure_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SingleDispatchGenericFunctionClosure_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_core__Instance_O, sizeof(core::Instance_O), 0, "core::Instance_O" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Instance_O),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_asttooling__DerivableASTFrontendAction, sizeof(asttooling::DerivableASTFrontendAction), 0, "asttooling::DerivableASTFrontendAction" },
 ...
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableASTFrontendAction),_lambda_list), "_lambda_list" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableASTFrontendAction),_Slots._Vector._Contents), "_Slots._Vector._Contents" }, // public: (T T T) fixable: TAGGED-POINTER-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableASTFrontendAction),CurrentInput.File.__r_.__first_.NO-NAME.__l.__cap_), "CurrentInput.File.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableASTFrontendAction),CurrentInput.File.__r_.__first_.NO-NAME.__l.__size_), "CurrentInput.File.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableASTFrontendAction),CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableASTFrontendAction),CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction, sizeof(asttooling::DerivableSyntaxOnlyAction), 0, "asttooling::DerivableSyntaxOnlyAction" },
 ...
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableSyntaxOnlyAction),_lambda_list), "_lambda_list" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<gctools::smart_ptr<core::T_O>>>), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableSyntaxOnlyAction),_Slots._Vector._Contents), "_Slots._Vector._Contents" }, // public: (T T T) fixable: TAGGED-POINTER-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableSyntaxOnlyAction),CurrentInput.File.__r_.__first_.NO-NAME.__l.__cap_), "CurrentInput.File.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableSyntaxOnlyAction),CurrentInput.File.__r_.__first_.NO-NAME.__l.__size_), "CurrentInput.File.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableSyntaxOnlyAction),CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableSyntaxOnlyAction),CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "CurrentInput.File.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL NIL T T T T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_long_long, sizeof(long long), offsetof(SAFE_TYPE_MACRO(core::PosixTime_O),_Time.time_.time_count_.value_), "_Time.time_.time_count_.value_" }, // public: (NIL NIL NIL NIL) fixable: NIL good-name: T
...
{ container_kind, KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_, sizeof(gctools::GCArray_moveable<unsigned char>), 0, "gctools::GCArray_moveable<unsigned char>" },
...
{ container_kind, KIND_GCVECTOR_gctools__GCVector_moveable_int_, sizeof(gctools::GCVector_moveable<int>), 0, "gctools::GCVector_moveable<int>" },
...
{ container_kind, KIND_GCARRAY_gctools__GCArray_moveable_double_, sizeof(gctools::GCArray_moveable<double>), 0, "gctools::GCArray_moveable<double>" },
...
{ container_kind, KIND_GCARRAY_gctools__GCArray_moveable_unsigned_int_, sizeof(gctools::GCArray_moveable<unsigned int>), 0, "gctools::GCArray_moveable<unsigned int>" },
...
// not-exposed-yet  {    variable_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_PackageName.__r_.__first_.NO-NAME.__l.__cap_), "_PackageName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_PackageName.__r_.__first_.NO-NAME.__l.__size_), "_PackageName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_PackageName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_SymbolName.__r_.__first_.NO-NAME.__l.__cap_), "_SymbolName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_SymbolName.__r_.__first_.NO-NAME.__l.__size_), "_SymbolName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_SymbolName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_SymbolName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposed-yet  {    variable_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::SymbolStorage),_SymbolName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_SymbolName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
...
{ bitunit_container_kind, KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_, sizeof(gctools::GCBitUnitArray_moveable<1,unsigned long,long>), 1, "gctools::GCBitUnitArray_moveable<1,unsigned long,long>" },
{  variable_array0, 0, 0, offsetof(SAFE_TYPE_MACRO(gctools::GCBitUnitArray_moveable<1,unsigned long,long>),_Data), "_Data" },
{  variable_capacity, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(gctools::GCBitUnitArray_moveable<1,unsigned long,long>),_Length), offsetof(SAFE_TYPE_MACRO(gctools::GCBitUnitArray_moveable<1,unsigned long,long>),_Length), NULL },
{    variable_field, ctype_unsigned_long, sizeof(unsigned long), 0, "only" },
{ container_kind, KIND_GCVECTOR_gctools__GCVector_moveable_float_, sizeof(gctools::GCVector_moveable<float>), 0, "gctools::GCVector_moveable<float>" },
...
{ container_kind, KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_, sizeof(gctools::GCArray_moveable<unsigned long>), 0, "gctools::GCArray_moveable<unsigned long>" },
...
{ class_kind, KIND_LISPALLOC_asttooling__DerivableMatchCallback, sizeof(asttooling::DerivableMatchCallback), 0, "asttooling::DerivableMatchCallback" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableMatchCallback),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
 ...
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableMatchCallback),_lambda_list), "_lambda_list" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_Roots.charInfo.gNamesToCharacterIndex.__tree_.__pair3_.__first_), "_Roots.charInfo.gNamesToCharacterIndex.__tree_.__pair3_.__first_" }, // public: (T T T NIL NIL NIL) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternPackage.__r_.__first_.NO-NAME.__l.__cap_), "_TrapInternPackage.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternPackage.__r_.__first_.NO-NAME.__l.__size_), "_TrapInternPackage.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternPackage.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_TrapInternPackage.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternPackage.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_TrapInternPackage.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternName.__r_.__first_.NO-NAME.__l.__cap_), "_TrapInternName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternName.__r_.__first_.NO-NAME.__l.__size_), "_TrapInternName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_TrapInternName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_TrapInternName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_TrapInternName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_OpenDynamicLibraryHandles.__tree_.__pair3_.__first_), "_OpenDynamicLibraryHandles.__tree_.__pair3_.__first_" }, // public: (T NIL NIL NIL) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_SourceFileIndices.__tree_.__pair3_.__first_), "_SourceFileIndices.__tree_.__pair3_.__first_" }, // public: (T NIL NIL NIL) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_FunctionName.__r_.__first_.NO-NAME.__l.__cap_), "_FunctionName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_FunctionName.__r_.__first_.NO-NAME.__l.__size_), "_FunctionName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_FunctionName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_FunctionName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_FunctionName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_FunctionName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_RCFileName.__r_.__first_.NO-NAME.__l.__cap_), "_RCFileName.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_RCFileName.__r_.__first_.NO-NAME.__l.__size_), "_RCFileName.__r_.__first_.NO-NAME.__l.__size_" }, // public: (T NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_RCFileName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_RCFileName.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_RCFileName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_RCFileName.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (T NIL NIL T T T T) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_PackageNameIndexMap.__tree_.__pair3_.__first_), "_PackageNameIndexMap.__tree_.__pair3_.__first_" }, // public: (T NIL NIL NIL) fixable: NIL good-name: T
...
// not-exposing {  fixed_field, ctype_int, sizeof(int), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_RequireLevel), "_RequireLevel" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_CoreBuiltInClassesInitialized), "_CoreBuiltInClassesInitialized" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_BuiltInClassesInitialized), "_BuiltInClassesInitialized" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_PackagesInitialized), "_PackagesInitialized" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_EnvironmentInitialized), "_EnvironmentInitialized" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_NilsCreated), "_NilsCreated" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_LastCompileErrorMessage.__r_.__first_.NO-NAME.__l.__cap_), "_LastCompileErrorMessage.__r_.__first_.NO-NAME.__l.__cap_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_LastCompileErrorMessage.__r_.__first_.NO-NAME.__l.__size_), "_LastCompileErrorMessage.__r_.__first_.NO-NAME.__l.__size_" }, // public: (NIL NIL NIL T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_unsigned_char, sizeof(unsigned char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_LastCompileErrorMessage.__r_.__first_.NO-NAME.__s.NO-NAME.__size_), "_LastCompileErrorMessage.__r_.__first_.NO-NAME.__s.NO-NAME.__size_" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_char, sizeof(char), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_LastCompileErrorMessage.__r_.__first_.NO-NAME.__s.NO-NAME.__lx), "_LastCompileErrorMessage.__r_.__first_.NO-NAME.__s.NO-NAME.__lx" }, // public: (NIL NIL NIL T T T T) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_BootClassTableIsValid), "_BootClassTableIsValid" }, // public: (NIL) fixable: NIL good-name: T
// not-exposing {  fixed_field, ctype_int, sizeof(int), offsetof(SAFE_TYPE_MACRO(core::Lisp_O),_PathMax), "_PathMax" }, // public: (NIL) fixable: NIL good-name: T
...
{ class_kind, KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory, sizeof(asttooling::DerivableFrontendActionFactory), 0, "asttooling::DerivableFrontendActionFactory" },
 {  fixed_field, ctype_unsigned_long, sizeof(unsigned long), offsetof(SAFE_TYPE_MACRO(asttooling::DerivableFrontendActionFactory),_TimesCalled), "_TimesCalled" }, // public: (T) fixable: NIL good-name: T
...
obj_finalize_KIND_LISPALLOC_core__MDArray_O:
{
    core::MDArray_O* obj_gc_safe = reinterpret_cast<core::MDArray_O*>(client);
    obj_gc_safe->~MDArray_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__VectorNs_O:
{
    core::VectorNs_O* obj_gc_safe = reinterpret_cast<core::VectorNs_O*>(client);
    obj_gc_safe->~VectorNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__StrNs_O:
{
    core::StrNs_O* obj_gc_safe = reinterpret_cast<core::StrNs_O*>(client);
    obj_gc_safe->~StrNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__Str8Ns_O:
{
    core::Str8Ns_O* obj_gc_safe = reinterpret_cast<core::Str8Ns_O*>(client);
    obj_gc_safe->~Str8Ns_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__StrWNs_O:
{
    core::StrWNs_O* obj_gc_safe = reinterpret_cast<core::StrWNs_O*>(client);
    obj_gc_safe->~StrWNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__BitVectorNs_O:
{
    core::BitVectorNs_O* obj_gc_safe = reinterpret_cast<core::BitVectorNs_O*>(client);
    obj_gc_safe->~BitVectorNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SpecializedVectorNs_O:
{
    core::SpecializedVectorNs_O* obj_gc_safe = reinterpret_cast<core::SpecializedVectorNs_O*>(client);
    obj_gc_safe->~SpecializedVectorNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__VectorTNs_O:
{
    core::VectorTNs_O* obj_gc_safe = reinterpret_cast<core::VectorTNs_O*>(client);
    obj_gc_safe->~VectorTNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__MDArrayNs_O:
{
    core::MDArrayNs_O* obj_gc_safe = reinterpret_cast<core::MDArrayNs_O*>(client);
    obj_gc_safe->~MDArrayNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SpecializedMDArrayNs_O:
{
    core::SpecializedMDArrayNs_O* obj_gc_safe = reinterpret_cast<core::SpecializedMDArrayNs_O*>(client);
    obj_gc_safe->~SpecializedMDArrayNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__ArrayTNs_O:
{
    core::ArrayTNs_O* obj_gc_safe = reinterpret_cast<core::ArrayTNs_O*>(client);
    obj_gc_safe->~ArrayTNs_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__BaseSimpleVector_O:
{
    core::BaseSimpleVector_O* obj_gc_safe = reinterpret_cast<core::BaseSimpleVector_O*>(client);
    obj_gc_safe->~BaseSimpleVector_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SpecializedSimpleVector_O:
{
    core::SpecializedSimpleVector_O* obj_gc_safe = reinterpret_cast<core::SpecializedSimpleVector_O*>(client);
    obj_gc_safe->~SpecializedSimpleVector_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SimpleDoubleVector_O:
{
    core::SimpleDoubleVector_O* obj_gc_safe = reinterpret_cast<core::SimpleDoubleVector_O*>(client);
    obj_gc_safe->~SimpleDoubleVector_O();
    goto finalize_done;
}
...
obj_finalize_KIND_LISPALLOC_core__SimpleString_O:
{
    core::SimpleString_O* obj_gc_safe = reinterpret_cast<core::SimpleString_O*>(client);
    obj_gc_safe->~SimpleString_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SimpleBaseCharString_O:
{
    core::SimpleBaseCharString_O* obj_gc_safe = reinterpret_cast<core::SimpleBaseCharString_O*>(client);
    obj_gc_safe->~SimpleBaseCharString_O();
    goto finalize_done;
}
obj_finalize_KIND_LISPALLOC_core__SimpleCharacterString_O:
{
...
obj_finalize_KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_:
{
    THROW_HARD_ERROR(BF("Should never finalize gctools::GCBitUnitArray_moveable<1,unsigned long,long>"));
}
...
static void* OBJ_FINALIZE_table[] = { 
  /* 12 */ &&obj_finalize_KIND_ROOTCLASSALLOC_clbind__detail__class_map,
  /* 13 */ &&obj_finalize_KIND_BOOTSTRAP_core__T_O,
  /* 14 */ &&obj_finalize_KIND_LISPALLOC_core__VaList_dummy_O,
  /* 15 */ &&obj_finalize_KIND_LISPALLOC_core__Cons_O,
  /* 16 */ &&obj_finalize_KIND_LISPALLOC_core__General_O,
  /* 17 */ &&obj_finalize_KIND_LISPALLOC_core__MultiStringBuffer_O,
  /* 18 */ &&obj_finalize_KIND_LISPALLOC_core__ReadTable_O,
  /* 19 */ &&obj_finalize_KIND_LISPALLOC_core__Number_O,
  /* 20 */ &&obj_finalize_KIND_LISPALLOC_core__Complex_O,
  /* 21 */ &&obj_finalize_KIND_LISPALLOC_core__Real_O,
  /* 22 */ &&obj_finalize_KIND_LISPALLOC_core__Rational_O,
  /* 23 */ &&obj_finalize_KIND_LISPALLOC_core__Integer_O,
  /* 24 */ &&obj_finalize_KIND_LISPALLOC_core__Bignum_O,
  /* 25 */ &&obj_finalize_KIND_LISPALLOC_core__Fixnum_dummy_O,
  /* 26 */ &&obj_finalize_KIND_LISPALLOC_core__Ratio_O,
  /* 27 */ &&obj_finalize_KIND_LISPALLOC_core__Float_O,
  /* 28 */ &&obj_finalize_KIND_LISPALLOC_core__DoubleFloat_O,
  /* 29 */ &&obj_finalize_KIND_LISPALLOC_core__LongFloat_O,
  /* 30 */ &&obj_finalize_KIND_LISPALLOC_core__SingleFloat_dummy_O,
  /* 31 */ &&obj_finalize_KIND_LISPALLOC_core__ShortFloat_O,
  /* 32 */ &&obj_finalize_KIND_LISPALLOC_core__FileStatus_O,
  /* 33 */ &&obj_finalize_KIND_LISPALLOC_core__WeakHashTable_O,
  /* 34 */ &&obj_finalize_KIND_LISPALLOC_core__WeakKeyHashTable_O,
  /* 35 */ &&obj_finalize_KIND_LISPALLOC_core__Environment_O,
  /* 36 */ &&obj_finalize_KIND_LISPALLOC_core__ActivationFrame_O,
  /* 37 */ &&obj_finalize_KIND_LISPALLOC_core__TagbodyFrame_O,
  /* 38 */ &&obj_finalize_KIND_LISPALLOC_core__ValueFrame_O,
  /* 39 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionFrame_O,
  /* 40 */ &&obj_finalize_KIND_LISPALLOC_core__LexicalEnvironment_O,
  /* 41 */ &&obj_finalize_KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O,
  /* 42 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionValueEnvironment_O,
  /* 43 */ &&obj_finalize_KIND_LISPALLOC_core__ValueEnvironment_O,
  /* 44 */ &&obj_finalize_KIND_LISPALLOC_core__TagbodyEnvironment_O,
  /* 45 */ &&obj_finalize_KIND_LISPALLOC_core__CompileTimeEnvironment_O,
  /* 46 */ &&obj_finalize_KIND_LISPALLOC_core__UnwindProtectEnvironment_O,
  /* 47 */ &&obj_finalize_KIND_LISPALLOC_core__SymbolMacroletEnvironment_O,
  /* 48 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionContainerEnvironment_O,
  /* 49 */ &&obj_finalize_KIND_LISPALLOC_core__StackValueEnvironment_O,
  /* 50 */ &&obj_finalize_KIND_LISPALLOC_core__BlockEnvironment_O,
  /* 51 */ &&obj_finalize_KIND_LISPALLOC_core__MacroletEnvironment_O,
  /* 52 */ &&obj_finalize_KIND_LISPALLOC_core__CatchEnvironment_O,
  /* 53 */ &&obj_finalize_KIND_LISPALLOC_core__GlueEnvironment_O,
  /* 54 */ &&obj_finalize_KIND_LISPALLOC_core__Array_O,
  /* 55 */ &&obj_finalize_KIND_LISPALLOC_core__MDArray_O,
  /* 56 */ &&obj_finalize_KIND_LISPALLOC_core__VectorNs_O,
  /* 57 */ &&obj_finalize_KIND_LISPALLOC_core__StrNs_O,
  /* 59 */ &&obj_finalize_KIND_LISPALLOC_core__Str8Ns_O,
  /* 61 */ &&obj_finalize_KIND_LISPALLOC_core__StrWNs_O,
  /* 62 */ &&obj_finalize_KIND_LISPALLOC_core__BitVectorNs_O,
  /* 63 */ &&obj_finalize_KIND_LISPALLOC_core__SpecializedVectorNs_O,
  /* 65 */ &&obj_finalize_KIND_LISPALLOC_core__VectorTNs_O,
  /* 66 */ &&obj_finalize_KIND_LISPALLOC_core__MDArrayNs_O,
  /* 67 */ &&obj_finalize_KIND_LISPALLOC_core__SpecializedMDArrayNs_O,
  /* 69 */ &&obj_finalize_KIND_LISPALLOC_core__ArrayTNs_O,
  /* 70 */ &&obj_finalize_KIND_LISPALLOC_core__BaseSimpleVector_O,
  /* 71 */ &&obj_finalize_KIND_LISPALLOC_core__SpecializedSimpleVector_O,
  /* 73 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleDoubleVector_O,
  /* 75 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleVector_O,
  /* 76 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleBitVector_O,
  /* 77 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleString_O,
  /* 79 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleBaseCharString_O,
  /* 81 */ &&obj_finalize_KIND_LISPALLOC_core__SimpleCharacterString_O,
  /* 82 */ &&obj_finalize_KIND_LISPALLOC_core__Exposer_O,
  /* 83 */ &&obj_finalize_KIND_LISPALLOC_asttooling__AsttoolingExposer_O,
  /* 84 */ &&obj_finalize_KIND_LISPALLOC_core__CoreExposer_O,
  /* 85 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchMethod_O,
  /* 86 */ &&obj_finalize_KIND_LISPALLOC_core__RandomState_O,
  /* 87 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O,
  /* 88 */ &&obj_finalize_KIND_LISPALLOC_core__SequenceStepper_O,
  /* 89 */ &&obj_finalize_KIND_LISPALLOC_core__ConsStepper_O,
  /* 90 */ &&obj_finalize_KIND_LISPALLOC_core__VectorStepper_O,
  /* 91 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DebugLoc_O,
  /* 92 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Attribute_O,
  /* 93 */ &&obj_finalize_KIND_LISPALLOC_core__WeakPointer_O,
  /* 94 */ &&obj_finalize_KIND_BOOTSTRAP_core__StandardObject_O,
  /* 95 */ &&obj_finalize_KIND_BOOTSTRAP_core__Metaobject_O,
  /* 96 */ &&obj_finalize_KIND_BOOTSTRAP_core__Specializer_O,
  /* 97 */ &&obj_finalize_KIND_BOOTSTRAP_core__Class_O,
  /* 98 */ &&obj_finalize_KIND_BOOTSTRAP_core__StdClass_O,
  /* 99 */ &&obj_finalize_KIND_BOOTSTRAP_core__StandardClass_O,
  /* 100 */ &&obj_finalize_KIND_LISPALLOC_core__FuncallableStandardClass_O,
  /* 101 */ &&obj_finalize_KIND_BOOTSTRAP_core__StructureClass_O,
  /* 102 */ &&obj_finalize_KIND_LISPALLOC_core__ForwardReferencedClass_O,
  /* 103 */ &&obj_finalize_KIND_LISPALLOC_core__CxxClass_O,
  /* 104 */ &&obj_finalize_KIND_BOOTSTRAP_core__BuiltInClass_O,
  /* 105 */ &&obj_finalize_KIND_LISPALLOC_clbind__ClassRep_O,
  /* 106 */ &&obj_finalize_KIND_LISPALLOC_core__ExternalObject_O,
  /* 107 */ &&obj_finalize_KIND_LISPALLOC_clasp_ffi__ForeignData_O,
  /* 108 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Value_O,
  /* 109 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Argument_O,
  /* 110 */ &&obj_finalize_KIND_LISPALLOC_llvmo__User_O,
  /* 111 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Instruction_O,
  /* 112 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicRMWInst_O,
  /* 113 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LandingPadInst_O,
  /* 114 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PHINode_O,
  /* 115 */ &&obj_finalize_KIND_LISPALLOC_llvmo__CallInst_O,
  /* 116 */ &&obj_finalize_KIND_LISPALLOC_llvmo__StoreInst_O,
  /* 117 */ &&obj_finalize_KIND_LISPALLOC_llvmo__UnaryInstruction_O,
  /* 118 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LoadInst_O,
  /* 119 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AllocaInst_O,
  /* 120 */ &&obj_finalize_KIND_LISPALLOC_llvmo__VAArgInst_O,
  /* 121 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O,
  /* 122 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TerminatorInst_O,
  /* 123 */ &&obj_finalize_KIND_LISPALLOC_llvmo__UnreachableInst_O,
  /* 124 */ &&obj_finalize_KIND_LISPALLOC_llvmo__SwitchInst_O,
  /* 125 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ReturnInst_O,
  /* 126 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ResumeInst_O,
  /* 127 */ &&obj_finalize_KIND_LISPALLOC_llvmo__BranchInst_O,
  /* 128 */ &&obj_finalize_KIND_LISPALLOC_llvmo__InvokeInst_O,
  /* 129 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IndirectBrInst_O,
  /* 130 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FenceInst_O,
  /* 131 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Constant_O,
  /* 132 */ &&obj_finalize_KIND_LISPALLOC_llvmo__BlockAddress_O,
  /* 133 */ &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalValue_O,
  /* 134 */ &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalVariable_O,
  /* 135 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Function_O,
  /* 136 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantArray_O,
  /* 137 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantInt_O,
  /* 138 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataSequential_O,
  /* 139 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataArray_O,
  /* 140 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantStruct_O,
  /* 141 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantFP_O,
  /* 142 */ &&obj_finalize_KIND_LISPALLOC_llvmo__UndefValue_O,
  /* 143 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantPointerNull_O,
  /* 144 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantExpr_O,
  /* 145 */ &&obj_finalize_KIND_LISPALLOC_llvmo__BasicBlock_O,
  /* 146 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IRBuilderBase_O,
  /* 147 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IRBuilder_O,
  /* 148 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIBuilder_O,
  /* 149 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Metadata_O,
  /* 150 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ValueAsMetadata_O,
  /* 151 */ &&obj_finalize_KIND_LISPALLOC_llvmo__MDNode_O,
  /* 152 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DINode_O,
  /* 153 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIScope_O,
  /* 154 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DICompileUnit_O,
  /* 155 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILocalScope_O,
  /* 156 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DISubprogram_O,
  /* 157 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlockBase_O,
  /* 158 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlock_O,
  /* 159 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIType_O,
  /* 160 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIDerivedType_O,
  /* 161 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIBasicType_O,
  /* 162 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DISubroutineType_O,
  /* 163 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DICompositeType_O,
  /* 164 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DIFile_O,
  /* 165 */ &&obj_finalize_KIND_LISPALLOC_llvmo__MDString_O,
  /* 166 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ExecutionEngine_O,
  /* 167 */ &&obj_finalize_KIND_LISPALLOC_llvmo__APFloat_O,
  /* 168 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBuilder_O,
  /* 169 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Triple_O,
  /* 170 */ &&obj_finalize_KIND_LISPALLOC_llvmo__APInt_O,
  /* 171 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBase_O,
  /* 172 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPassManager_O,
  /* 173 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PassManager_O,
  /* 174 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetMachine_O,
  /* 175 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O,
  /* 176 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetOptions_O,
  /* 177 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Type_O,
  /* 178 */ &&obj_finalize_KIND_LISPALLOC_llvmo__IntegerType_O,
  /* 179 */ &&obj_finalize_KIND_LISPALLOC_llvmo__CompositeType_O,
  /* 180 */ &&obj_finalize_KIND_LISPALLOC_llvmo__SequentialType_O,
  /* 181 */ &&obj_finalize_KIND_LISPALLOC_llvmo__VectorType_O,
  /* 182 */ &&obj_finalize_KIND_LISPALLOC_llvmo__PointerType_O,
  /* 183 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ArrayType_O,
  /* 184 */ &&obj_finalize_KIND_LISPALLOC_llvmo__StructType_O,
  /* 185 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionType_O,
  /* 186 */ &&obj_finalize_KIND_LISPALLOC_llvmo__NamedMDNode_O,
  /* 187 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Linker_O,
  /* 188 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Pass_O,
  /* 189 */ &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPass_O,
  /* 190 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ModulePass_O,
  /* 191 */ &&obj_finalize_KIND_LISPALLOC_llvmo__ImmutablePass_O,
  /* 192 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O,
  /* 193 */ &&obj_finalize_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O,
  /* 194 */ &&obj_finalize_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O,
  /* 195 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Module_O,
  /* 196 */ &&obj_finalize_KIND_LISPALLOC_llvmo__EngineBuilder_O,
  /* 197 */ &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMContext_O,
  /* 198 */ &&obj_finalize_KIND_LISPALLOC_llvmo__Target_O,
  /* 199 */ &&obj_finalize_KIND_LISPALLOC_core__LoadTimeValues_O,
  /* 200 */ &&obj_finalize_KIND_LISPALLOC_core__IntArray_O,
  /* 201 */ &&obj_finalize_KIND_LISPALLOC_core__SourceManager_O,
  /* 202 */ &&obj_finalize_KIND_LISPALLOC_core__Record_O,
  /* 203 */ &&obj_finalize_KIND_LISPALLOC_core__LightUserData_O,
  /* 204 */ &&obj_finalize_KIND_LISPALLOC_core__UserData_O,
  /* 205 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DataLayout_O,
  /* 206 */ &&obj_finalize_KIND_BOOTSTRAP_core__Symbol_O,
  /* 207 */ &&obj_finalize_KIND_LISPALLOC_core__Null_O,
  /* 208 */ &&obj_finalize_KIND_LISPALLOC_core__SourcePosInfo_O,
  /* 209 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__Iterator_O,
  /* 210 */ &&obj_finalize_KIND_LISPALLOC_core__DirectoryIterator_O,
  /* 211 */ &&obj_finalize_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O,
  /* 212 */ &&obj_finalize_KIND_LISPALLOC_core__PosixTimeDuration_O,
  /* 213 */ &&obj_finalize_KIND_LISPALLOC_core__SymbolToEnumConverter_O,
  /* 214 */ &&obj_finalize_KIND_LISPALLOC_core__CandoException_O,
  /* 215 */ &&obj_finalize_KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O,
  /* 216 */ &&obj_finalize_KIND_LISPALLOC_core__Stream_O,
  /* 217 */ &&obj_finalize_KIND_LISPALLOC_core__AnsiStream_O,
  /* 218 */ &&obj_finalize_KIND_LISPALLOC_core__FileStream_O,
  /* 219 */ &&obj_finalize_KIND_LISPALLOC_core__IOStreamStream_O,
  /* 220 */ &&obj_finalize_KIND_LISPALLOC_core__IOFileStream_O,
  /* 221 */ &&obj_finalize_KIND_LISPALLOC_core__ConcatenatedStream_O,
  /* 222 */ &&obj_finalize_KIND_LISPALLOC_core__StringStream_O,
  /* 223 */ &&obj_finalize_KIND_LISPALLOC_core__StringInputStream_O,
  /* 224 */ &&obj_finalize_KIND_LISPALLOC_core__StringOutputStream_O,
  /* 225 */ &&obj_finalize_KIND_LISPALLOC_core__SynonymStream_O,
  /* 226 */ &&obj_finalize_KIND_LISPALLOC_core__EchoStream_O,
  /* 227 */ &&obj_finalize_KIND_LISPALLOC_core__TwoWayStream_O,
  /* 228 */ &&obj_finalize_KIND_LISPALLOC_core__BroadcastStream_O,
  /* 229 */ &&obj_finalize_KIND_LISPALLOC_core__Reader_O,
  /* 230 */ &&obj_finalize_KIND_LISPALLOC_core__SharpEqualWrapper_O,
  /* 231 */ &&obj_finalize_KIND_LISPALLOC_core__Archive_O,
  /* 232 */ &&obj_finalize_KIND_LISPALLOC_core__SaveArchive_O,
  /* 233 */ &&obj_finalize_KIND_LISPALLOC_core__SexpSaveArchive_O,
  /* 234 */ &&obj_finalize_KIND_LISPALLOC_core__LoadArchive_O,
  /* 235 */ &&obj_finalize_KIND_LISPALLOC_core__SexpLoadArchive_O,
  /* 236 */ &&obj_finalize_KIND_LISPALLOC_core__HashTable_O,
  /* 237 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEq_O,
  /* 238 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEqualp_O,
  /* 239 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEql_O,
  /* 240 */ &&obj_finalize_KIND_LISPALLOC_core__HashTableEqual_O,
  /* 241 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__Creator_O,
  /* 242 */ &&obj_finalize_KIND_LISPALLOC_clbind__DummyCreator_O,
  /* 243 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_clbind__ConstructorCreator_O,
  /* 244 */ &&obj_finalize_KIND_LISPALLOC_core__InstanceCreator_O,
  /* 245 */ &&obj_finalize_KIND_LISPALLOC_core__CxxObject_O,
  /* 246 */ &&obj_finalize_KIND_LISPALLOC_core__NativeVector_float_O,
  /* 247 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Info_O,
  /* 248 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionInfo_O,
  /* 249 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LocalFunctionInfo_O,
  /* 250 */ &&obj_finalize_KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O,
  /* 251 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LambdaNameInfo_O,
  /* 252 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O,
  /* 253 */ &&obj_finalize_KIND_LISPALLOC_clcenv__GlobalMacroInfo_O,
  /* 254 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LocalMacroInfo_O,
  /* 255 */ &&obj_finalize_KIND_LISPALLOC_clcenv__OptimizeInfo_O,
  /* 256 */ &&obj_finalize_KIND_LISPALLOC_clcenv__BlockInfo_O,
  /* 257 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableInfo_O,
  /* 258 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SpecialVariableInfo_O,
  /* 259 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SymbolMacroInfo_O,
  /* 260 */ &&obj_finalize_KIND_LISPALLOC_clcenv__ConstantVariableInfo_O,
  /* 261 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LexicalVariableInfo_O,
  /* 262 */ &&obj_finalize_KIND_LISPALLOC_core__NativeVector_int_O,
  /* 263 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DINodeArray_O,
  /* 264 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DITypeRefArray_O,
  /* 265 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Entry_O,
  /* 266 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Inline_O,
  /* 267 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Closure_O,
  /* 268 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O,
  /* 269 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableDynamicExtent_O,
  /* 270 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SymbolMacro_O,
  /* 271 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionIgnore_O,
  /* 272 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Function_O,
  /* 273 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LambdaName_O,
  /* 274 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Block_O,
  /* 275 */ &&obj_finalize_KIND_LISPALLOC_clcenv__SpecialVariable_O,
  /* 276 */ &&obj_finalize_KIND_LISPALLOC_clcenv__LexicalVariable_O,
  /* 277 */ &&obj_finalize_KIND_LISPALLOC_clcenv__GlobalEnvironment_O,
  /* 278 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Tag_O,
  /* 279 */ &&obj_finalize_KIND_LISPALLOC_clcenv__FunctionType_O,
  /* 280 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Macro_O,
  /* 281 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableType_O,
  /* 282 */ &&obj_finalize_KIND_LISPALLOC_clcenv__VariableIgnore_O,
  /* 283 */ &&obj_finalize_KIND_LISPALLOC_clcenv__Optimize_O,
  /* 284 */ &&obj_finalize_KIND_LISPALLOC_core__NativeVector_double_O,
  /* 285 */ &&obj_finalize_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 286 */ &&obj_finalize_KIND_LISPALLOC_core__Cache_O,
  /* 287 */ &&obj_finalize_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 288 */ &&obj_finalize_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 289 */ &&obj_finalize_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 290 */ &&obj_finalize_KIND_LISPALLOC_core__SNode_O,
  /* 291 */ &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O,
  /* 292 */ &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O,
  /* 293 */ &&obj_finalize_KIND_LISPALLOC_core__Path_O,
  /* 295 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 296 */ &&obj_finalize_KIND_LISPALLOC_core__StructureObject_O,
  /* 297 */ &&obj_finalize_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 298 */ &&obj_finalize_KIND_LISPALLOC_core__Package_O,
  /* 299 */ &&obj_finalize_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 300 */ &&obj_finalize_KIND_LISPALLOC_core__Character_dummy_O,
  /* 301 */ &&obj_finalize_KIND_LISPALLOC_core__Function_O,
  /* 302 */ &&obj_finalize_KIND_LISPALLOC_core__NamedFunction_O,
  /* 303 */ &&obj_finalize_KIND_LISPALLOC_core__SpecialForm_O,
  /* 304 */ &&obj_finalize_KIND_LISPALLOC_core__Closure_O,
  /* 305 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 306 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionClosure_O,
  /* 307 */ &&obj_finalize_KIND_LISPALLOC_core__ClosureWithSlots_O,
  /* 308 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O,
  /* 309 */ &&obj_finalize_KIND_LISPALLOC_core__TranslationFunctor,
  /* 310 */ &&obj_finalize_KIND_LISPALLOC_core__MacroClosure_O,
  /* 311 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O,
  /* 312 */ &&obj_finalize_KIND_LISPALLOC_core__ClosureWithFrame_O,
  /* 313 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledClosure_O,
  /* 314 */ &&obj_finalize_KIND_LISPALLOC_core__InterpretedClosure_O,
  /* 315 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchMethodFunction_O,
  /* 316 */ &&obj_finalize_KIND_LISPALLOC_core__CxxMethodFunction_O,
  /* 317 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 318 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O,
  /* 319 */ &&obj_finalize_KIND_LISPALLOC_core__Instance_O,
  /* 323 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction,
  /* 327 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction,
  /* 328 */ &&obj_finalize_KIND_LISPALLOC_core__Pointer_O,
  /* 329 */ &&obj_finalize_KIND_LISPALLOC_clbind__ClassRegistry_O,
  /* 330 */ &&obj_finalize_KIND_LISPALLOC_core__SmallMultimap_O,
  /* 331 */ &&obj_finalize_KIND_LISPALLOC_core__Pathname_O,
  /* 332 */ &&obj_finalize_KIND_LISPALLOC_core__LogicalPathname_O,
  /* 333 */ &&obj_finalize_KIND_LISPALLOC_core__PosixTime_O,
  /* 334 */ &&obj_finalize_KIND_LISPALLOC_core__SmallMap_O,
  /* 336 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
  /* 337 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 338 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_,
  /* 339 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 340 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 341 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__,
  /* 342 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 343 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 344 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 345 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__,
  /* 346 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_,
  /* 347 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__,
  /* 348 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  /* 349 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_,
  /* 350 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__,
  /* 351 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_int_,
  /* 352 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_double_,
  /* 353 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_,
  /* 354 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_double_,
  /* 355 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___,
  /* 356 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_int_,
  /* 357 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_,
  /* 358 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_,
  /* 359 */ &&obj_finalize_KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_,
  /* 360 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_float_,
  /* 361 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 362 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 363 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 364 */ &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 365 */ &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_,
  /* 368 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableMatchCallback,
  /* 370 */ &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 371 */ &&obj_finalize_KIND_ROOTCLASSALLOC_core__Lisp_O,
  /* 375 */ &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory,
   NULL
};
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArray_O:
{
    core::MDArray_O* obj_gc_safe = reinterpret_cast<core::MDArray_O*>(client);
    GC<core::MDArray_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VectorNs_O:
{
    core::VectorNs_O* obj_gc_safe = reinterpret_cast<core::VectorNs_O*>(client);
    GC<core::VectorNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StrNs_O:
{
    core::StrNs_O* obj_gc_safe = reinterpret_cast<core::StrNs_O*>(client);
    GC<core::StrNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Str8Ns_O:
{
    core::Str8Ns_O* obj_gc_safe = reinterpret_cast<core::Str8Ns_O*>(client);
    GC<core::Str8Ns_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StrWNs_O:
{
    core::StrWNs_O* obj_gc_safe = reinterpret_cast<core::StrWNs_O*>(client);
    GC<core::StrWNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BitVectorNs_O:
{
    core::BitVectorNs_O* obj_gc_safe = reinterpret_cast<core::BitVectorNs_O*>(client);
    GC<core::BitVectorNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecializedVectorNs_O:
{
    core::SpecializedVectorNs_O* obj_gc_safe = reinterpret_cast<core::SpecializedVectorNs_O*>(client);
    GC<core::SpecializedVectorNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VectorTNs_O:
{
    core::VectorTNs_O* obj_gc_safe = reinterpret_cast<core::VectorTNs_O*>(client);
    GC<core::VectorTNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayNs_O:
{
    core::MDArrayNs_O* obj_gc_safe = reinterpret_cast<core::MDArrayNs_O*>(client);
    GC<core::MDArrayNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecializedMDArrayNs_O:
{
    core::SpecializedMDArrayNs_O* obj_gc_safe = reinterpret_cast<core::SpecializedMDArrayNs_O*>(client);
    GC<core::SpecializedMDArrayNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ArrayTNs_O:
{
    core::ArrayTNs_O* obj_gc_safe = reinterpret_cast<core::ArrayTNs_O*>(client);
    GC<core::ArrayTNs_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BaseSimpleVector_O:
{
    core::BaseSimpleVector_O* obj_gc_safe = reinterpret_cast<core::BaseSimpleVector_O*>(client);
    GC<core::BaseSimpleVector_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecializedSimpleVector_O:
{
    core::SpecializedSimpleVector_O* obj_gc_safe = reinterpret_cast<core::SpecializedSimpleVector_O*>(client);
    GC<core::SpecializedSimpleVector_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleDoubleVector_O:
{
    core::SimpleDoubleVector_O* obj_gc_safe = reinterpret_cast<core::SimpleDoubleVector_O*>(client);
    GC<core::SimpleDoubleVector_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleString_O:
{
    core::SimpleString_O* obj_gc_safe = reinterpret_cast<core::SimpleString_O*>(client);
    GC<core::SimpleString_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleBaseCharString_O:
{
    core::SimpleBaseCharString_O* obj_gc_safe = reinterpret_cast<core::SimpleBaseCharString_O*>(client);
    GC<core::SimpleBaseCharString_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleCharacterString_O:
{
    core::SimpleCharacterString_O* obj_gc_safe = reinterpret_cast<core::SimpleCharacterString_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AsttoolingExposer_O:
{
    asttooling::AsttoolingExposer_O* obj_gc_safe = reinterpret_cast<asttooling::AsttoolingExposer_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clasp_ffi__ForeignData_O:
{
    clasp_ffi::ForeignData_O* obj_gc_safe = reinterpret_cast<clasp_ffi::ForeignData_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINode_O:
{
    llvmo::DINode_O* obj_gc_safe = reinterpret_cast<llvmo::DINode_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILocalScope_O:
{
    llvmo::DILocalScope_O* obj_gc_safe = reinterpret_cast<llvmo::DILocalScope_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILexicalBlockBase_O:
{
    llvmo::DILexicalBlockBase_O* obj_gc_safe = reinterpret_cast<llvmo::DILexicalBlockBase_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O:
{
    llvmo::TargetLibraryInfoWrapperPass_O* obj_gc_safe = reinterpret_cast<llvmo::TargetLibraryInfoWrapperPass_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O:
{
    clasp_ffi::ForeignTypeSpec_O* obj_gc_safe = reinterpret_cast<clasp_ffi::ForeignTypeSpec_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_float_O:
{
    core::NativeVector_float_O* obj_gc_safe = reinterpret_cast<core::NativeVector_float_O*>(client);
    GC<core::NativeVector_float_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Info_O:
{
    clcenv::Info_O* obj_gc_safe = reinterpret_cast<clcenv::Info_O*>(client);
    GC<clcenv::Info_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionInfo_O:
{
    clcenv::FunctionInfo_O* obj_gc_safe = reinterpret_cast<clcenv::FunctionInfo_O*>(client);
    GC<clcenv::FunctionInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LocalFunctionInfo_O:
{
    clcenv::LocalFunctionInfo_O* obj_gc_safe = reinterpret_cast<clcenv::LocalFunctionInfo_O*>(client);
    GC<clcenv::LocalFunctionInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O:
{
    clcenv::GlobalFunctionInfo_O* obj_gc_safe = reinterpret_cast<clcenv::GlobalFunctionInfo_O*>(client);
    GC<clcenv::GlobalFunctionInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LambdaNameInfo_O:
{
    clcenv::LambdaNameInfo_O* obj_gc_safe = reinterpret_cast<clcenv::LambdaNameInfo_O*>(client);
    GC<clcenv::LambdaNameInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O:
{
    clcenv::SpecialOperatorInfo_O* obj_gc_safe = reinterpret_cast<clcenv::SpecialOperatorInfo_O*>(client);
    GC<clcenv::SpecialOperatorInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalMacroInfo_O:
{
    clcenv::GlobalMacroInfo_O* obj_gc_safe = reinterpret_cast<clcenv::GlobalMacroInfo_O*>(client);
    GC<clcenv::GlobalMacroInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LocalMacroInfo_O:
{
    clcenv::LocalMacroInfo_O* obj_gc_safe = reinterpret_cast<clcenv::LocalMacroInfo_O*>(client);
    GC<clcenv::LocalMacroInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__OptimizeInfo_O:
{
    clcenv::OptimizeInfo_O* obj_gc_safe = reinterpret_cast<clcenv::OptimizeInfo_O*>(client);
    GC<clcenv::OptimizeInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__BlockInfo_O:
{
    clcenv::BlockInfo_O* obj_gc_safe = reinterpret_cast<clcenv::BlockInfo_O*>(client);
    GC<clcenv::BlockInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableInfo_O:
{
    clcenv::VariableInfo_O* obj_gc_safe = reinterpret_cast<clcenv::VariableInfo_O*>(client);
    GC<clcenv::VariableInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialVariableInfo_O:
{
    clcenv::SpecialVariableInfo_O* obj_gc_safe = reinterpret_cast<clcenv::SpecialVariableInfo_O*>(client);
    GC<clcenv::SpecialVariableInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SymbolMacroInfo_O:
{
    clcenv::SymbolMacroInfo_O* obj_gc_safe = reinterpret_cast<clcenv::SymbolMacroInfo_O*>(client);
    GC<clcenv::SymbolMacroInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__ConstantVariableInfo_O:
{
    clcenv::ConstantVariableInfo_O* obj_gc_safe = reinterpret_cast<clcenv::ConstantVariableInfo_O*>(client);
    GC<clcenv::ConstantVariableInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LexicalVariableInfo_O:
{
    clcenv::LexicalVariableInfo_O* obj_gc_safe = reinterpret_cast<clcenv::LexicalVariableInfo_O*>(client);
    GC<clcenv::LexicalVariableInfo_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_int_O:
{
    core::NativeVector_int_O* obj_gc_safe = reinterpret_cast<core::NativeVector_int_O*>(client);
    GC<core::NativeVector_int_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINodeArray_O:
{
    llvmo::DINodeArray_O* obj_gc_safe = reinterpret_cast<llvmo::DINodeArray_O*>(client);
    GC<llvmo::DINodeArray_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DITypeRefArray_O:
{
    llvmo::DITypeRefArray_O* obj_gc_safe = reinterpret_cast<llvmo::DITypeRefArray_O*>(client);
    GC<llvmo::DITypeRefArray_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Entry_O:
{
    clcenv::Entry_O* obj_gc_safe = reinterpret_cast<clcenv::Entry_O*>(client);
    GC<clcenv::Entry_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Inline_O:
{
    clcenv::Inline_O* obj_gc_safe = reinterpret_cast<clcenv::Inline_O*>(client);
    GC<clcenv::Inline_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Closure_O:
{
    clcenv::Closure_O* obj_gc_safe = reinterpret_cast<clcenv::Closure_O*>(client);
    GC<clcenv::Closure_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O:
{
    clcenv::FunctionDynamicExtent_O* obj_gc_safe = reinterpret_cast<clcenv::FunctionDynamicExtent_O*>(client);
    GC<clcenv::FunctionDynamicExtent_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableDynamicExtent_O:
{
    clcenv::VariableDynamicExtent_O* obj_gc_safe = reinterpret_cast<clcenv::VariableDynamicExtent_O*>(client);
    GC<clcenv::VariableDynamicExtent_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SymbolMacro_O:
{
    clcenv::SymbolMacro_O* obj_gc_safe = reinterpret_cast<clcenv::SymbolMacro_O*>(client);
    GC<clcenv::SymbolMacro_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionIgnore_O:
{
    clcenv::FunctionIgnore_O* obj_gc_safe = reinterpret_cast<clcenv::FunctionIgnore_O*>(client);
    GC<clcenv::FunctionIgnore_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Function_O:
{
    clcenv::Function_O* obj_gc_safe = reinterpret_cast<clcenv::Function_O*>(client);
    GC<clcenv::Function_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LambdaName_O:
{
    clcenv::LambdaName_O* obj_gc_safe = reinterpret_cast<clcenv::LambdaName_O*>(client);
    GC<clcenv::LambdaName_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Block_O:
{
    clcenv::Block_O* obj_gc_safe = reinterpret_cast<clcenv::Block_O*>(client);
    GC<clcenv::Block_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialVariable_O:
{
    clcenv::SpecialVariable_O* obj_gc_safe = reinterpret_cast<clcenv::SpecialVariable_O*>(client);
    GC<clcenv::SpecialVariable_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LexicalVariable_O:
{
    clcenv::LexicalVariable_O* obj_gc_safe = reinterpret_cast<clcenv::LexicalVariable_O*>(client);
    GC<clcenv::LexicalVariable_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalEnvironment_O:
{
    clcenv::GlobalEnvironment_O* obj_gc_safe = reinterpret_cast<clcenv::GlobalEnvironment_O*>(client);
    GC<clcenv::GlobalEnvironment_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Tag_O:
{
    clcenv::Tag_O* obj_gc_safe = reinterpret_cast<clcenv::Tag_O*>(client);
    GC<clcenv::Tag_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionType_O:
{
    clcenv::FunctionType_O* obj_gc_safe = reinterpret_cast<clcenv::FunctionType_O*>(client);
    GC<clcenv::FunctionType_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Macro_O:
{
    clcenv::Macro_O* obj_gc_safe = reinterpret_cast<clcenv::Macro_O*>(client);
    GC<clcenv::Macro_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableType_O:
{
    clcenv::VariableType_O* obj_gc_safe = reinterpret_cast<clcenv::VariableType_O*>(client);
    GC<clcenv::VariableType_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableIgnore_O:
{
    clcenv::VariableIgnore_O* obj_gc_safe = reinterpret_cast<clcenv::VariableIgnore_O*>(client);
    GC<clcenv::VariableIgnore_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Optimize_O:
{
    clcenv::Optimize_O* obj_gc_safe = reinterpret_cast<clcenv::Optimize_O*>(client);
    GC<clcenv::Optimize_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_double_O:
{
    core::NativeVector_double_O* obj_gc_safe = reinterpret_cast<core::NativeVector_double_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithSlots_O:
{
    core::ClosureWithSlots_O* obj_gc_safe = reinterpret_cast<core::ClosureWithSlots_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_:
{
    THROW_HARD_ERROR(BF("Should never deallocate gcbitunits gctools::GCBitUnitArray_moveable<1,unsigned long,long>"));}
...
static void* OBJ_DEALLOCATOR_table[] = { 
  /* 12 */ &&obj_deallocate_unmanaged_instance_KIND_ROOTCLASSALLOC_clbind__detail__class_map,
  /* 13 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__T_O,
  /* 14 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VaList_dummy_O,
  /* 15 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Cons_O,
  /* 16 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__General_O,
  /* 17 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MultiStringBuffer_O,
  /* 18 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ReadTable_O,
  /* 19 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Number_O,
  /* 20 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Complex_O,
  /* 21 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Real_O,
  /* 22 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Rational_O,
  /* 23 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Integer_O,
  /* 24 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Bignum_O,
  /* 25 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Fixnum_dummy_O,
  /* 26 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Ratio_O,
  /* 27 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Float_O,
  /* 28 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DoubleFloat_O,
  /* 29 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LongFloat_O,
  /* 30 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleFloat_dummy_O,
  /* 31 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ShortFloat_O,
  /* 32 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FileStatus_O,
  /* 33 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakHashTable_O,
  /* 34 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakKeyHashTable_O,
  /* 35 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Environment_O,
  /* 36 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ActivationFrame_O,
  /* 37 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TagbodyFrame_O,
  /* 38 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ValueFrame_O,
  /* 39 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionFrame_O,
  /* 40 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LexicalEnvironment_O,
  /* 41 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O,
  /* 42 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionValueEnvironment_O,
  /* 43 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ValueEnvironment_O,
  /* 44 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TagbodyEnvironment_O,
  /* 45 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompileTimeEnvironment_O,
  /* 46 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__UnwindProtectEnvironment_O,
  /* 47 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SymbolMacroletEnvironment_O,
  /* 48 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionContainerEnvironment_O,
  /* 49 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StackValueEnvironment_O,
  /* 50 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BlockEnvironment_O,
  /* 51 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MacroletEnvironment_O,
  /* 52 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CatchEnvironment_O,
  /* 53 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__GlueEnvironment_O,
  /* 54 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Array_O,
  /* 55 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArray_O,
  /* 56 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VectorNs_O,
  /* 57 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StrNs_O,
  /* 59 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Str8Ns_O,
  /* 61 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StrWNs_O,
  /* 62 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BitVectorNs_O,
  /* 63 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecializedVectorNs_O,
  /* 65 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VectorTNs_O,
  /* 66 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MDArrayNs_O,
  /* 67 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecializedMDArrayNs_O,
  /* 69 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ArrayTNs_O,
  /* 70 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BaseSimpleVector_O,
  /* 71 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecializedSimpleVector_O,
  /* 73 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleDoubleVector_O,
  /* 75 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleVector_O,
  /* 76 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleBitVector_O,
  /* 77 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleString_O,
  /* 79 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleBaseCharString_O,
  /* 81 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SimpleCharacterString_O,
  /* 82 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Exposer_O,
  /* 83 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AsttoolingExposer_O,
  /* 84 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CoreExposer_O,
  /* 85 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchMethod_O,
  /* 86 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__RandomState_O,
  /* 87 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O,
  /* 88 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SequenceStepper_O,
  /* 89 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ConsStepper_O,
  /* 90 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__VectorStepper_O,
  /* 91 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DebugLoc_O,
  /* 92 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Attribute_O,
  /* 93 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakPointer_O,
  /* 94 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StandardObject_O,
  /* 95 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Metaobject_O,
  /* 96 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Specializer_O,
  /* 97 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Class_O,
  /* 98 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StdClass_O,
  /* 99 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StandardClass_O,
  /* 100 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FuncallableStandardClass_O,
  /* 101 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__StructureClass_O,
  /* 102 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ForwardReferencedClass_O,
  /* 103 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxClass_O,
  /* 104 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__BuiltInClass_O,
  /* 105 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__ClassRep_O,
  /* 106 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ExternalObject_O,
  /* 107 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clasp_ffi__ForeignData_O,
  /* 108 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Value_O,
  /* 109 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Argument_O,
  /* 110 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__User_O,
  /* 111 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Instruction_O,
  /* 112 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AtomicRMWInst_O,
  /* 113 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LandingPadInst_O,
  /* 114 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PHINode_O,
  /* 115 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__CallInst_O,
  /* 116 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__StoreInst_O,
  /* 117 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__UnaryInstruction_O,
  /* 118 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LoadInst_O,
  /* 119 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AllocaInst_O,
  /* 120 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__VAArgInst_O,
  /* 121 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O,
  /* 122 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TerminatorInst_O,
  /* 123 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__UnreachableInst_O,
  /* 124 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__SwitchInst_O,
  /* 125 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ReturnInst_O,
  /* 126 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ResumeInst_O,
  /* 127 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__BranchInst_O,
  /* 128 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__InvokeInst_O,
  /* 129 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IndirectBrInst_O,
  /* 130 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FenceInst_O,
  /* 131 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Constant_O,
  /* 132 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__BlockAddress_O,
  /* 133 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__GlobalValue_O,
  /* 134 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__GlobalVariable_O,
  /* 135 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Function_O,
  /* 136 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantArray_O,
  /* 137 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantInt_O,
  /* 138 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantDataSequential_O,
  /* 139 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantDataArray_O,
  /* 140 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantStruct_O,
  /* 141 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantFP_O,
  /* 142 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__UndefValue_O,
  /* 143 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantPointerNull_O,
  /* 144 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ConstantExpr_O,
  /* 145 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__BasicBlock_O,
  /* 146 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IRBuilderBase_O,
  /* 147 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IRBuilder_O,
  /* 148 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIBuilder_O,
  /* 149 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Metadata_O,
  /* 150 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ValueAsMetadata_O,
  /* 151 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__MDNode_O,
  /* 152 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINode_O,
  /* 153 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIScope_O,
  /* 154 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DICompileUnit_O,
  /* 155 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILocalScope_O,
  /* 156 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DISubprogram_O,
  /* 157 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILexicalBlockBase_O,
  /* 158 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DILexicalBlock_O,
  /* 159 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIType_O,
  /* 160 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIDerivedType_O,
  /* 161 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIBasicType_O,
  /* 162 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DISubroutineType_O,
  /* 163 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DICompositeType_O,
  /* 164 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DIFile_O,
  /* 165 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__MDString_O,
  /* 166 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ExecutionEngine_O,
  /* 167 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__APFloat_O,
  /* 168 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PassManagerBuilder_O,
  /* 169 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Triple_O,
  /* 170 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__APInt_O,
  /* 171 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PassManagerBase_O,
  /* 172 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FunctionPassManager_O,
  /* 173 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PassManager_O,
  /* 174 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetMachine_O,
  /* 175 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O,
  /* 176 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetOptions_O,
  /* 177 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Type_O,
  /* 178 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__IntegerType_O,
  /* 179 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__CompositeType_O,
  /* 180 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__SequentialType_O,
  /* 181 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__VectorType_O,
  /* 182 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__PointerType_O,
  /* 183 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ArrayType_O,
  /* 184 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__StructType_O,
  /* 185 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FunctionType_O,
  /* 186 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__NamedMDNode_O,
  /* 187 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Linker_O,
  /* 188 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Pass_O,
  /* 189 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__FunctionPass_O,
  /* 190 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ModulePass_O,
  /* 191 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__ImmutablePass_O,
  /* 192 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetLibraryInfoWrapperPass_O,
  /* 193 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O,
  /* 194 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O,
  /* 195 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Module_O,
  /* 196 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__EngineBuilder_O,
  /* 197 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__LLVMContext_O,
  /* 198 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__Target_O,
  /* 199 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LoadTimeValues_O,
  /* 200 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__IntArray_O,
  /* 201 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourceManager_O,
  /* 202 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Record_O,
  /* 203 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LightUserData_O,
  /* 204 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__UserData_O,
  /* 205 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DataLayout_O,
  /* 206 */ &&obj_deallocate_unmanaged_instance_KIND_BOOTSTRAP_core__Symbol_O,
  /* 207 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Null_O,
  /* 208 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourcePosInfo_O,
  /* 209 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__Iterator_O,
  /* 210 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DirectoryIterator_O,
  /* 211 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O,
  /* 212 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__PosixTimeDuration_O,
  /* 213 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SymbolToEnumConverter_O,
  /* 214 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CandoException_O,
  /* 215 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clasp_ffi__ForeignTypeSpec_O,
  /* 216 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Stream_O,
  /* 217 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__AnsiStream_O,
  /* 218 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FileStream_O,
  /* 219 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__IOStreamStream_O,
  /* 220 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__IOFileStream_O,
  /* 221 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ConcatenatedStream_O,
  /* 222 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StringStream_O,
  /* 223 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StringInputStream_O,
  /* 224 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StringOutputStream_O,
  /* 225 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SynonymStream_O,
  /* 226 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__EchoStream_O,
  /* 227 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TwoWayStream_O,
  /* 228 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BroadcastStream_O,
  /* 229 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Reader_O,
  /* 230 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SharpEqualWrapper_O,
  /* 231 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Archive_O,
  /* 232 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SaveArchive_O,
  /* 233 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SexpSaveArchive_O,
  /* 234 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LoadArchive_O,
  /* 235 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SexpLoadArchive_O,
  /* 236 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTable_O,
  /* 237 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEq_O,
  /* 238 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEqualp_O,
  /* 239 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEql_O,
  /* 240 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__HashTableEqual_O,
  /* 241 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__Creator_O,
  /* 242 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__DummyCreator_O,
  /* 243 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_clbind__ConstructorCreator_O,
  /* 244 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InstanceCreator_O,
  /* 245 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxObject_O,
  /* 246 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_float_O,
  /* 247 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Info_O,
  /* 248 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionInfo_O,
  /* 249 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LocalFunctionInfo_O,
  /* 250 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalFunctionInfo_O,
  /* 251 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LambdaNameInfo_O,
  /* 252 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialOperatorInfo_O,
  /* 253 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalMacroInfo_O,
  /* 254 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LocalMacroInfo_O,
  /* 255 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__OptimizeInfo_O,
  /* 256 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__BlockInfo_O,
  /* 257 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableInfo_O,
  /* 258 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialVariableInfo_O,
  /* 259 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SymbolMacroInfo_O,
  /* 260 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__ConstantVariableInfo_O,
  /* 261 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LexicalVariableInfo_O,
  /* 262 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_int_O,
  /* 263 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINodeArray_O,
  /* 264 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DITypeRefArray_O,
  /* 265 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Entry_O,
  /* 266 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Inline_O,
  /* 267 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Closure_O,
  /* 268 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionDynamicExtent_O,
  /* 269 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableDynamicExtent_O,
  /* 270 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SymbolMacro_O,
  /* 271 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionIgnore_O,
  /* 272 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Function_O,
  /* 273 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LambdaName_O,
  /* 274 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Block_O,
  /* 275 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__SpecialVariable_O,
  /* 276 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__LexicalVariable_O,
  /* 277 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__GlobalEnvironment_O,
  /* 278 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Tag_O,
  /* 279 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__FunctionType_O,
  /* 280 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Macro_O,
  /* 281 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableType_O,
  /* 282 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__VariableIgnore_O,
  /* 283 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clcenv__Optimize_O,
  /* 284 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NativeVector_double_O,
  /* 285 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 286 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Cache_O,
  /* 287 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 288 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 289 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 290 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SNode_O,
  /* 291 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LeafSNode_O,
  /* 292 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BranchSNode_O,
  /* 293 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Path_O,
  /* 295 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 296 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StructureObject_O,
  /* 297 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 298 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Package_O,
  /* 299 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 300 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Character_dummy_O,
  /* 301 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Function_O,
  /* 302 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NamedFunction_O,
  /* 303 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecialForm_O,
  /* 304 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Closure_O,
  /* 305 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 306 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionClosure_O,
  /* 307 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithSlots_O,
  /* 308 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O,
  /* 309 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__TranslationFunctor,
  /* 310 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MacroClosure_O,
  /* 311 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O,
  /* 312 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithFrame_O,
  /* 313 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledClosure_O,
  /* 314 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InterpretedClosure_O,
  /* 315 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchMethodFunction_O,
  /* 316 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxMethodFunction_O,
  /* 317 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 318 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O,
  /* 319 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Instance_O,
  /* 323 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction,
  /* 327 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction,
  /* 328 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pointer_O,
  /* 329 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__ClassRegistry_O,
  /* 330 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SmallMultimap_O,
  /* 331 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pathname_O,
  /* 332 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LogicalPathname_O,
  /* 333 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__PosixTime_O,
  /* 334 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SmallMap_O,
  /* 336 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__,
  /* 337 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_,
  /* 338 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_char_,
  /* 339 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_,
  /* 340 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__,
  /* 341 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SequenceStepper_O__,
  /* 342 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_,
  /* 343 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__,
  /* 344 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__,
  /* 345 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__,
  /* 346 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_,
  /* 347 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__,
  /* 348 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___,
  /* 349 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_,
  /* 350 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__,
  /* 351 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_int_,
  /* 352 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_double_,
  /* 353 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_,
  /* 354 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_double_,
  /* 355 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_std____1__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___,
  /* 356 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_int_,
  /* 357 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_,
  /* 358 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_,
  /* 359 */ &&obj_deallocate_unmanaged_instance_KIND_GCBITUNITCONTAINER1_gctools__GCBitUnitArray_moveable_1_unsigned_long_long_,
  /* 360 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_float_,
  /* 361 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__,
  /* 362 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_,
  /* 363 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__,
  /* 364 */ &&obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_,
  /* 365 */ &&obj_deallocate_unmanaged_instance_KIND_GCARRAY_gctools__GCArray_moveable_unsigned_long_,
  /* 368 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableMatchCallback,
  /* 370 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 371 */ &&obj_deallocate_unmanaged_instance_KIND_ROOTCLASSALLOC_core__Lisp_O,
  /* 375 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory,
   NULL
};
#endif // defined(GC_OBJ_DEALLOCATOR_TABLE)
#if defined(GC_GLOBALS)
 SMART_PTR_FIX(core::VectorTNs_O::static_creator);
 ...
 SMART_PTR_FIX(core::VectorNs_O::static_class_symbol);
 SMART_PTR_FIX(core::SimpleDoubleVector_O::static_creator);
 ...
 SMART_PTR_FIX(core::SpecializedVectorNs_O::static_class);
 ...
 SMART_PTR_FIX(core::SimpleDoubleVector_O::static_class);
 ...
 SMART_PTR_FIX(core::MDArrayNs_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::SpecializedSimpleVector_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::VectorTNs_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::VectorNs_O::static_creator);
 ...
 SMART_PTR_FIX(core::VectorTNs_O::static_class);
 ...
 SMART_PTR_FIX(core::BaseSimpleVector_O::static_class);
 SMART_PTR_FIX(core::MDArrayNs_O::static_class);
 ...
 SMART_PTR_FIX(core::SpecializedVectorNs_O::static_creator);
 ...
 SMART_PTR_FIX(core::SpecializedSimpleVector_O::static_class);
 ...
 SMART_PTR_FIX(core::BaseSimpleVector_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::SpecializedMDArrayNs_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::SimpleBaseCharString_O::static_creator);
 ...
 SMART_PTR_FIX(core::SpecializedVectorNs_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::BaseSimpleVector_O::static_creator);
 ...
 SMART_PTR_FIX(core::ArrayTNs_O::static_creator);
 ...
 SMART_PTR_FIX(core::SpecializedMDArrayNs_O::static_creator);
 ...
 SMART_PTR_FIX(core::SpecializedSimpleVector_O::static_creator);
 ...
 SMART_PTR_FIX(core::VectorNs_O::static_class);
 ...
 SMART_PTR_FIX(core::SimpleBaseCharString_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::SimpleDoubleVector_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::ArrayTNs_O::static_class_symbol);
 ...
 SMART_PTR_FIX(core::SpecializedMDArrayNs_O::static_class);
 ...
 SMART_PTR_FIX(core::ArrayTNs_O::static_class);
 ...
 SMART_PTR_FIX(core::MDArrayNs_O::static_creator);
 ...
 SMART_PTR_FIX(core::SimpleBaseCharString_O::static_class);
