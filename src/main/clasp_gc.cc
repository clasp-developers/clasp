...
struct DynamicCast<core::Cache *, FP> {
...
template <typename FP>
struct DynamicCast<core::SingleFloat_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 107 107
...
template <typename FP>
struct DynamicCast<core::Binder_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 248 248
...
template <typename FP>
struct DynamicCast<core::FuncallableStandardClass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 230 230
...
template <typename FP>
struct DynamicCast<core::RecursiveDirectoryIterator_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 73 73
...
template <typename FP>
struct DynamicCast<core::LoadArchive_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 80 81
...
template <typename FP>
struct DynamicCast<core::BaseChar_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 86 87
...
template <typename FP>
struct DynamicCast<llvmo::ConstantInt_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 207 207
...
template <typename FP>
struct DynamicCast<llvmo::FunctionPassManager_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 158 158
...
template <typename FP>
struct DynamicCast<llvmo::NamedMDNode_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 213 213
...
template <typename FP>
struct DynamicCast<core::SymbolSet_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 247 247
...
template <typename FP>
struct DynamicCast<core::HashTable_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 242 246
...
template <typename FP>
struct DynamicCast<core::BitVector_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 125 126
...
template <typename FP>
struct DynamicCast<core::VectorObjects_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 123 124
...
template <typename FP>
struct DynamicCast<core::StrWithFillPtr_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 122 122
...
template <typename FP>
struct DynamicCast<llvmo::CallInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 193 193
...
template <typename FP>
struct DynamicCast<core::WeakPointer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 241 241
...
template <typename FP>
struct DynamicCast<core::ValueFrame_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 47 47
...
template <typename FP>
struct DynamicCast<core::SymbolList_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 240 240
...
template <typename FP>
struct DynamicCast<llvmo::SwitchInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 191 191
...
template <typename FP>
struct DynamicCast<core::TagbodyEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 43 43
...
template <typename FP>
struct DynamicCast<core::MacroletEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 39 39
...
template <typename FP>
struct DynamicCast<core::MultiStringBuffer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 239 239
...
template <typename FP>
struct DynamicCast<llvmo::AllocaInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 183 183
...
template <typename FP>
struct DynamicCast<core::DoubleFloat_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 106 106
...
template <typename FP>
struct DynamicCast<core::SymbolToEnumConverter_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 238 238
...
template <typename FP>
struct DynamicCast<llvmo::Module_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 212 212
...
template <typename FP>
struct DynamicCast<llvmo::Triple_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 211 211
...
template <typename FP>
struct DynamicCast<core::StringSet_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 237 237
...
template <typename FP>
struct DynamicCast<core::Symbol_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 235 236
...
template <typename FP>
struct DynamicCast<core::UserData_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 219 219
...
template <typename FP>
struct DynamicCast<llvmo::FenceInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 192 192
...
template <typename FP>
struct DynamicCast<core::ActivationFrame_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 44 47
...
template <typename FP>
struct DynamicCast<core::Str_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 121 122
...
template <typename FP>
struct DynamicCast<core::T_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 11 248
...
template <typename FP>
struct DynamicCast<clbind::DummyCreator *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 6 6
...
template <typename FP>
struct DynamicCast<core::FunctionValueEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 42 42
...
template <typename FP>
struct DynamicCast<core::SymbolMacroletEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 38 38
...
template <typename FP>
struct DynamicCast<core::HashTableEq_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 246 246
...
template <typename FP>
struct DynamicCast<asttooling::AstVisitor_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 234 234
...
template <typename FP>
struct DynamicCast<llvmo::TerminatorInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 184 191
...
template <typename FP>
struct DynamicCast<llvmo::DILexicalBlock_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 68 68
...
template <typename FP>
struct DynamicCast<core::String_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 120 122
...
template <typename FP>
struct DynamicCast<core::StandardObject_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 223 233
...
template <typename FP>
struct DynamicCast<core::ConcatenatedStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 26 26
...
template <typename FP>
struct DynamicCast<core::WrappedPointer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 222 222
...
template <typename FP>
struct DynamicCast<llvmo::ResumeInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 190 190
...
template <typename FP>
struct DynamicCast<core::WeakHashTable_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 220 221
...
template <typename FP>
struct DynamicCast<core::FunctionContainerEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 37 37
...
template <typename FP>
struct DynamicCast<llvmo::LLVMContext_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 210 210
...
template <typename FP>
struct DynamicCast<llvmo::TargetMachine_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 208 209
...
template <typename FP>
struct DynamicCast<core::Rational_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 108 112
...
template <typename FP>
struct DynamicCast<core::StringInputStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 23 23
...
template <typename FP>
struct DynamicCast<llvmo::ImmutablePass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 136 138
...
template <typename FP>
struct DynamicCast<llvmo::Value_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 170 207
...
template <typename FP>
struct DynamicCast<llvmo::DIDerivedType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 67 67
...
template <typename FP>
struct DynamicCast<llvmo::GlobalVariable_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 204 204
...
template <typename FP>
struct DynamicCast<core::LeafSNode_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 216 216
...
template <typename FP>
struct DynamicCast<llvmo::PassManager_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 157 157
...
template <typename FP>
struct DynamicCast<clbind::detail::class_map *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 10 10
...
template <typename FP>
struct DynamicCast<core::LightUserData_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 218 219
...
template <typename FP>
struct DynamicCast<llvmo::FunctionType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 168 168
...
template <typename FP>
struct DynamicCast<llvmo::DICompileUnit_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 66 66
...
template <typename FP>
struct DynamicCast<llvmo::Linker_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 169 169
...
template <typename FP>
struct DynamicCast<llvmo::BranchInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 189 189
...
template <typename FP>
struct DynamicCast<llvmo::Constant_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 194 207
...
template <typename FP>
struct DynamicCast<llvmo::ReturnInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 188 188
...
template <typename FP>
struct DynamicCast<core::LexicalEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 31 43
...
template <typename FP>
struct DynamicCast<core::LoadTimeValues_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 217 217
...
template <typename FP>
struct DynamicCast<llvmo::Function_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 203 203
...
template <typename FP>
struct DynamicCast<core::SNode_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 214 216
...
template <typename FP>
struct DynamicCast<core::ExternalObject_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 132 213
...
template <typename FP>
struct DynamicCast<core::SourceManager_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 131 131
...
template <typename FP>
struct DynamicCast<llvmo::StructType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 166 166
...
template <typename FP>
struct DynamicCast<core::StandardChar_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 87 87
...
template <typename FP>
struct DynamicCast<core::Null_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 236 236
...
template <typename FP>
struct DynamicCast<llvmo::User_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 173 207
...
template <typename FP>
struct DynamicCast<llvmo::InsertPoint_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 130 130
...
template <typename FP>
struct DynamicCast<core::SequenceStepper *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 7 9
...
template <typename FP>
struct DynamicCast<core::SpecialForm_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 94 94
...
template <typename FP>
struct DynamicCast<llvmo::TargetLibraryInfo_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 138 138
...
template <typename FP>
struct DynamicCast<core::Specializer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 225 233
...
template <typename FP>
struct DynamicCast<core::StructureClass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 233 233
...
template <typename FP>
struct DynamicCast<core::ObjRef_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 129 129
...
template <typename FP>
struct DynamicCast<core::BuiltInClass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 231 232
...
template <typename FP>
struct DynamicCast<llvmo::IntegerType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 167 167
...
template <typename FP>
struct DynamicCast<core::Reader_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 128 128
...
template <typename FP>
struct DynamicCast<llvmo::Type_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 160 168
...
template <typename FP>
struct DynamicCast<core::RuntimeVisibleEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 40 43
...
template <typename FP>
struct DynamicCast<core::SmallMap_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 127 127
...
template <typename FP>
struct DynamicCast<llvmo::DataLayout_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 159 159
...
template <typename FP>
struct DynamicCast<llvmo::CompositeType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 161 166
...
template <typename FP>
struct DynamicCast<core::Instance_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 93 93
...
template <typename FP>
struct DynamicCast<llvmo::DIDescriptor_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 65 65
...
template <typename FP>
struct DynamicCast<llvmo::InvokeInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 187 187
...
template <typename FP>
struct DynamicCast<llvmo::PassManagerBase_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 156 158
...
template <typename FP>
struct DynamicCast<llvmo::DIFile_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 64 64
...
template <typename FP>
struct DynamicCast<llvmo::VAArgInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 182 182
...
template <typename FP>
struct DynamicCast<core::ShortFloat_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 105 105
...
template <typename FP>
struct DynamicCast<core::Array_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 117 126
...
template <typename FP>
struct DynamicCast<llvmo::PassManagerBuilder_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 155 155
...
template <typename FP>
struct DynamicCast<core::InstanceCreator *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 5 5
...
template <typename FP>
struct DynamicCast<core::UnwindProtectEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 36 36
...
template <typename FP>
struct DynamicCast<core::Fixnum_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 112 112
...
template <typename FP>
struct DynamicCast<core::ForeignData_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 154 154
...
template <typename FP>
struct DynamicCast<core::EchoStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 25 25
...
template <typename FP>
struct DynamicCast<llvmo::UndefValue_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 206 206
...
template <typename FP>
struct DynamicCast<core::Creator *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 3 6
...
template <typename FP>
struct DynamicCast<llvmo::BasicBlock_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 172 172
...
template <typename FP>
struct DynamicCast<llvmo::UnreachableInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 186 186
...
template <typename FP>
struct DynamicCast<core::CompileTimeEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 32 39
...
template <typename FP>
struct DynamicCast<llvmo::Attribute_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 116 116
...
template <typename FP>
struct DynamicCast<core::VectorStepper *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 9 9
...
template <typename FP>
struct DynamicCast<llvmo::ValueAsMetadata_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 144 144
...
template <typename FP>
struct DynamicCast<core::BranchSNode_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 215 215
...
template <typename FP>
struct DynamicCast<core::ReadTable_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 115 115
...
template <typename FP>
struct DynamicCast<core::CompiledFunction_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 92 92
...
template <typename FP>
struct DynamicCast<llvmo::DataLayoutPass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 137 137
...
template <typename FP>
struct DynamicCast<core::SynonymStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 24 24
...
template <typename FP>
struct DynamicCast<llvmo::LLVMTargetMachine_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 209 209
...
template <typename FP>
struct DynamicCast<core::PosixTime_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 114 114
...
template <typename FP>
struct DynamicCast<core::VectorObjectsWithFillPtr_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 124 124
...
template <typename FP>
struct DynamicCast<core::Number_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 102 113
...
template <typename FP>
struct DynamicCast<llvmo::UnaryInstruction_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 180 183
...
template <typename FP>
struct DynamicCast<core::IntArray_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 101 101
...
template <typename FP>
struct DynamicCast<core::Float_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 104 107
...
template <typename FP>
struct DynamicCast<core::Class_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 226 233
...
template <typename FP>
struct DynamicCast<llvmo::MDNode_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 143 143
...
template <typename FP>
struct DynamicCast<core::StringOutputStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 22 22
...
template <typename FP>
struct DynamicCast<llvmo::IndirectBrInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 185 185
...
template <typename FP>
struct DynamicCast<core::StringList_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 100 100
...
template <typename FP>
struct DynamicCast<llvmo::MDString_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 142 142
...
template <typename FP>
struct DynamicCast<core::StackValueEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 35 35
...
template <typename FP>
struct DynamicCast<llvmo::TargetSubtargetInfo_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 151 151
...
template <typename FP>
struct DynamicCast<core::CandoException_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 99 99
...
template <typename FP>
struct DynamicCast<core::Vector_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 119 126
...
template <typename FP>
struct DynamicCast<llvmo::SequentialType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 162 165
...
template <typename FP>
struct DynamicCast<llvmo::APFloat_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 153 153
...
template <typename FP>
struct DynamicCast<llvmo::ArrayType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 165 165
...
template <typename FP>
struct DynamicCast<llvmo::LandingPadInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 179 179
...
template <typename FP>
struct DynamicCast<llvmo::ConstantExpr_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 205 205
...
template <typename FP>
struct DynamicCast<core::IOStreamStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 19 19
...
template <typename FP>
struct DynamicCast<llvmo::VectorType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 164 164
...
template <typename FP>
struct DynamicCast<core::Package_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 98 98
...
template <typename FP>
struct DynamicCast<llvmo::DIScope_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 63 63
...
template <typename FP>
struct DynamicCast<core::Regex_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 97 97
...
template <typename FP>
struct DynamicCast<llvmo::DISubroutineType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 62 62
...
template <typename FP>
struct DynamicCast<core::GlueEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 30 30
...
template <typename FP>
struct DynamicCast<llvmo::Target_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 152 152
...
template <typename FP>
struct DynamicCast<core::StringStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 21 23
...
template <typename FP>
struct DynamicCast<core::Complex_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 113 113
...
template <typename FP>
struct DynamicCast<llvmo::MCSubtargetInfo_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 150 151
...
template <typename FP>
struct DynamicCast<core::SexpSaveArchive_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 79 79
...
template <typename FP>
struct DynamicCast<llvmo::DebugLoc_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 96 96
...
template <typename FP>
struct DynamicCast<llvmo::GlobalValue_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 202 204
...
template <typename FP>
struct DynamicCast<core::WeakKeyMapping_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 95 95
...
template <typename FP>
struct DynamicCast<core::Function_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 89 94
...
template <typename FP>
struct DynamicCast<core::Metaobject_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 224 233
...
template <typename FP>
struct DynamicCast<core::MicroHeap_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 88 88
...
template <typename FP>
struct DynamicCast<core::BroadcastStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 20 20
...
template <typename FP>
struct DynamicCast<llvmo::Argument_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 171 171
...
template <typename FP>
struct DynamicCast<llvmo::DITypeArray_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 61 61
...
template <typename FP>
struct DynamicCast<core::HashTableEql_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 245 245
...
template <typename FP>
struct DynamicCast<core::SexpLoadArchive_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 81 81
...
template <typename FP>
struct DynamicCast<core::FunctionFrame_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 46 46
...
template <typename FP>
struct DynamicCast<llvmo::DIArray_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 60 60
...
template <typename FP>
struct DynamicCast<core::Character_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 84 87
...
template <typename FP>
struct DynamicCast<core::ArrayObjects_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 118 118
...
template <typename FP>
struct DynamicCast<core::ConsStepper *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 8 8
...
template <typename FP>
struct DynamicCast<core::SourcePosInfo_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 83 83
...
template <typename FP>
struct DynamicCast<llvmo::ConstantDataArray_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 196 196
...
template <typename FP>
struct DynamicCast<llvmo::ConstantFP_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 201 201
...
template <typename FP>
struct DynamicCast<core::RegexMatch_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 82 82
...
template <typename FP>
struct DynamicCast<core::WeakKeyHashTable_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 221 221
...
template <typename FP>
struct DynamicCast<core::Archive_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 77 81
...
template <typename FP>
struct DynamicCast<clbind::ClassRegistry_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 76 76
...
template <typename FP>
struct DynamicCast<llvmo::AtomicCmpXchgInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 178 178
...
template <typename FP>
struct DynamicCast<core::BlockEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 34 34
...
template <typename FP>
struct DynamicCast<core::DirectoryIterator_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 72 72
...
template <typename FP>
struct DynamicCast<core::FileStatus_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 75 75
...
template <typename FP>
struct DynamicCast<core::PosixTimeDuration_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 74 74
...
template <typename FP>
struct DynamicCast<core::TagbodyFrame_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 45 45
...
template <typename FP>
struct DynamicCast<core::Integer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 110 112
...
template <typename FP>
struct DynamicCast<core::ExtendedChar_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 85 85
...
template <typename FP>
struct DynamicCast<core::SaveArchive_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 78 79
...
template <typename FP>
struct DynamicCast<core::Bignum_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 111 111
...
template <typename FP>
struct DynamicCast<llvmo::Instruction_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 174 193
...
template <typename FP>
struct DynamicCast<core::LogicalPathname_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 28 28
...
template <typename FP>
struct DynamicCast<core::StdClass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 228 230
...
template <typename FP>
struct DynamicCast<core::Real_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 103 112
...
template <typename FP>
struct DynamicCast<llvmo::APInt_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 149 149
...
template <typename FP>
struct DynamicCast<core::Iterator_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 71 73
...
template <typename FP>
struct DynamicCast<core::CatchEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 33 33
...
template <typename FP>
struct DynamicCast<llvmo::DISubprogram_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 59 59
...
template <typename FP>
struct DynamicCast<core::LambdaListHandler_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 70 70
...
template <typename FP>
struct DynamicCast<core::ValueEnvironment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 41 41
...
template <typename FP>
struct DynamicCast<llvmo::ConstantArray_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 200 200
...
template <typename FP>
struct DynamicCast<core::FileStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 17 19
...
template <typename FP>
struct DynamicCast<core::StructureObject_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 69 69
...
template <typename FP>
struct DynamicCast<llvmo::DebugInfo_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 55 68
...
template <typename FP>
struct DynamicCast<core::Path_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 54 54
...
template <typename FP>
struct DynamicCast<core::SingleDispatchGenericFunction_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 91 91
...
template <typename FP>
struct DynamicCast<core::Ratio_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 109 109
...
template <typename FP>
struct DynamicCast<llvmo::DIType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 58 58
...
template <typename FP>
struct DynamicCast<llvmo::ConstantPointerNull_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 199 199
...
template <typename FP>
struct DynamicCast<llvmo::AttributeSet_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 53 53
...
template <typename FP>
struct DynamicCast<core::SimpleBitVector_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 126 126
...
template <typename FP>
struct DynamicCast<llvmo::EngineBuilder_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 148 148
...
template <typename FP>
struct DynamicCast<asttooling::RegMap::RegistryMaps *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 2 2
...
template <typename FP>
struct DynamicCast<clbind::ConstructorCreator *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 4 4
...
template <typename FP>
struct DynamicCast<clbind::ClassRep_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 232 232
...
template <typename FP>
struct DynamicCast<llvmo::TargetOptions_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 147 147
...
template <typename FP>
struct DynamicCast<core::StandardClass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 229 229
...
template <typename FP>
struct DynamicCast<core::HashTableEqualp_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 244 244
...
template <typename FP>
struct DynamicCast<llvmo::PointerType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 163 163
...
template <typename FP>
struct DynamicCast<core::Pointer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 52 52
...
template <typename FP>
struct DynamicCast<core::DirectoryEntry_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 51 51
...
template <typename FP>
struct DynamicCast<core::HashTableEqual_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 243 243
...
template <typename FP>
struct DynamicCast<llvmo::ExecutionEngine_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 146 146
...
template <typename FP>
struct DynamicCast<llvmo::PHINode_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 177 177
...
template <typename FP>
struct DynamicCast<core::TwoWayStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 16 16
...
template <typename FP>
struct DynamicCast<core::ForwardReferencedClass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 227 227
...
template <typename FP>
struct DynamicCast<core::ObjectSet_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 50 50
...
template <typename FP>
struct DynamicCast<core::SourceFileInfo_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 49 49
...
template <typename FP>
struct DynamicCast<core::SingleDispatchMethod_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 48 48
...
template <typename FP>
struct DynamicCast<llvmo::DIBuilder_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 145 145
...
template <typename FP>
struct DynamicCast<llvmo::DIBasicType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 57 57
...
template <typename FP>
struct DynamicCast<llvmo::LoadInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 181 181
...
template <typename FP>
struct DynamicCast<llvmo::IRBuilder_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 140 140
...
template <typename FP>
struct DynamicCast<core::Environment_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 29 47
...
template <typename FP>
struct DynamicCast<llvmo::Metadata_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 141 144
...
template <typename FP>
struct DynamicCast<llvmo::IRBuilderBase_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 139 140
...
template <typename FP>
struct DynamicCast<llvmo::BlockAddress_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 198 198
...
template <typename FP>
struct DynamicCast<core::Pathname_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 27 28
...
template <typename FP>
struct DynamicCast<core::Lisp_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 1 1
...
template <typename FP>
struct DynamicCast<llvmo::DICompositeType_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 56 56
...
template <typename FP>
struct DynamicCast<llvmo::ModulePass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 135 138
...
template <typename FP>
struct DynamicCast<llvmo::StoreInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 176 176
...
template <typename FP>
struct DynamicCast<core::Stream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 14 26
...
template <typename FP>
struct DynamicCast<core::SingleDispatchEffectiveMethodFunction_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 90 90
...
template <typename FP>
struct DynamicCast<llvmo::ConstantStruct_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 197 197
...
template <typename FP>
struct DynamicCast<llvmo::FunctionPass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 134 134
...
template <typename FP>
struct DynamicCast<llvmo::AtomicRMWInst_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 175 175
...
template <typename FP>
struct DynamicCast<cffi::Pointer_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 13 13
...
template <typename FP>
struct DynamicCast<core::IOFileStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 18 18
...
template <typename FP>
struct DynamicCast<core::Cons_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 12 12
...
template <typename FP>
struct DynamicCast<core::AnsiStream_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 15 26
...
template <typename FP>
struct DynamicCast<llvmo::Pass_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 133 138
...
template <typename FP>
struct DynamicCast<llvmo::ConstantDataSequential_O *, FP> {
  static bool isA(FP client) {
    gctools::Header_s *header = reinterpret_cast<gctools::Header_s *>(ClientPtrToBasePtr(client));
    int kindVal = header->kind();
    // low high --> 195 196
...
template <>
class gctools::GCKind<core::SingleFloat_O> {
public:
...
template <>
class gctools::GCKind<core::BaseChar_O> {
public:
...
template <>
class gctools::GCKind<core::SymbolSet_O> {
public:
...
template <>
class gctools::GCKind<core::SymbolList_O> {
public:
...
template <>
class gctools::GCKind<gctools::GCVector_moveable<asttooling::internal::MatcherDescriptor *>> {
public:
...
template <>
class gctools::GCKind<core::StringSet_O> {
public:
...
template <>
class gctools::GCKind<core::StandardChar_O> {
public:
...
template <>
class gctools::GCKind<core::SequenceStepper> {
public:
...
template <>
class gctools::GCKind<core::ObjRef_O> {
public:
...
template <>
class gctools::GCKind<gctools::GCVector_moveable<gctools::smart_ptr<core::Character_O>>> {
public:
...
template <>
class gctools::GCKind<gctools::GCVector_moveable<core::SequenceStepper *>> {
public:
...
template <>
class gctools::GCKind<core::Fixnum_O> {
public:
...
template <>
class gctools::GCKind<core::StringList_O> {
public:
...
template <>
class gctools::GCKind<gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>, 3>> {
public:
...
template <>
class gctools::GCKind<core::MicroHeap_O> {
public:
...
template <>
class gctools::GCKind<core::Character_O> {
public:
...
template <>
class gctools::GCKind<core::ExtendedChar_O> {
public:
...
template <>
class gctools::GCKind<core::ObjectSet_O> {
public:
...
template <>
class gctools::GCKind<gctools::GCVector_moveable<gctools::smart_ptr<core::Str_O>>> {
public:
...
obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__internal__MatcherDescriptor_P_ : {
  ...
  sout << "gctools::GCVector_moveable<asttooling::internal::MatcherDescriptor *>"
       << " size/capacity[" << obj_gc_safe->size() << "/" << obj_gc_safe->capacity();
...
obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Character_O__ : {
  ...
  sout << "gctools::GCVector_moveable<gctools::smart_ptr<core::Character_O>>"
       << " size/capacity[" << obj_gc_safe->size() << "/" << obj_gc_safe->capacity();
...
obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SequenceStepper_P_ : {
  ...
  sout << "gctools::GCVector_moveable<core::SequenceStepper *>"
       << " size/capacity[" << obj_gc_safe->size() << "/" << obj_gc_safe->capacity();
...
obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__3_ : {
  ...
  sout << "gctools::GCArray_moveable<gctools::smart_ptr<core::T_O>,3>"
       << " size/capacity[" << obj_gc_safe->size() << "/" << obj_gc_safe->capacity();
...
obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Str_O__ : {
  ...
  sout << "gctools::GCVector_moveable<gctools::smart_ptr<core::Str_O>>"
       << " size/capacity[" << obj_gc_safe->size() << "/" << obj_gc_safe->capacity();
