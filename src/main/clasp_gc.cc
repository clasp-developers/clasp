...
KIND_LISPALLOC_asttooling__RegMap__RegistryMaps_O = 211,
...
KIND_LISPALLOC_cffi__Pointer_O = 226,
KIND_LISPALLOC_core__CxxObject_O = 227,
KIND_LISPALLOC_llvmo__DINodeArray_O = 228,
KIND_LISPALLOC_llvmo__DITypeRefArray_O = 229,
KIND_LISPALLOC_core__WeakKeyMapping_O = 230,
KIND_LISPALLOC_core__Cache_O = 231,
KIND_LISPALLOC_core__LambdaListHandler_O = 232,
KIND_LISPALLOC_llvmo__InsertPoint_O = 233,
KIND_LISPALLOC_core__SourceFileInfo_O = 234,
KIND_LISPALLOC_core__SNode_O = 235,
KIND_LISPALLOC_core__LeafSNode_O = 236,
KIND_LISPALLOC_core__BranchSNode_O = 237,
KIND_LISPALLOC_asttooling__MatcherDescriptor_O = 238,
KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O = 239,
KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O = 240,
KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O = 241,
KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O = 242,
KIND_LISPALLOC_core__Path_O = 243,
KIND_LISPALLOC_asttooling__AstVisitor_O = 244,
KIND_LISPALLOC_llvmo__AttributeSet_O = 245,
KIND_LISPALLOC_core__StructureObject_O = 246,
KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O = 247,
KIND_LISPALLOC_core__Package_O = 248,
KIND_LISPALLOC_core__DirectoryEntry_O = 249,
KIND_LISPALLOC_core__Character_dummy_O = 250,
KIND_LISPALLOC_core__Function_O = 251,
KIND_LISPALLOC_core__NamedFunction_O = 252,
KIND_LISPALLOC_core__SpecialForm_O = 253,
KIND_LISPALLOC_core__Closure_O = 254,
KIND_LISPALLOC_core__CompiledFunction_O = 255,
KIND_LISPALLOC_core__FunctionClosure_O = 256,
KIND_LISPALLOC_core__ClosureWithSlots_O = 257,
KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O = 258,
KIND_LISPALLOC_core__MacroClosure_O = 259,
KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O = 260,
KIND_LISPALLOC_core__ClosureWithFrame_O = 261,
KIND_LISPALLOC_core__CompiledClosure_O = 262,
KIND_LISPALLOC_core__InterpretedClosure_O = 263,
KIND_LISPALLOC_core__SingleDispatchMethodFunction_O = 264,
KIND_LISPALLOC_core__CxxMethodFunction_O = 265,
KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O = 266,
KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O = 267,
KIND_LISPALLOC_core__Instance_O = 268,
KIND_LISPALLOC_core__Pointer_O = 269,
KIND_LISPALLOC_clbind__ClassRegistry_O = 270,
...
template <typename FP> struct Cast<core::FunctionClosure_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 256 267 
      return ((256 <= kindVal) && (kindVal <= 267));
  };
};
...
template <typename FP> struct Cast<core::Function_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 251 268 
      return ((251 <= kindVal) && (kindVal <= 268));
  };
};
...
template <typename FP> struct Cast<asttooling::FixedArgCountMatcherDescriptor_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 241 241 
...
template <typename FP> struct Cast<asttooling::MatcherDescriptor_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 238 242 
...
template <typename FP> struct Cast<core::NamedFunction_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 252 267 
      return ((252 <= kindVal) && (kindVal <= 267));
  };
};
...
template <typename FP> struct Cast<asttooling::FreeFuncMatcherDescriptor_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 240 240 
...
template <typename FP> struct Cast<asttooling::OverloadedMatcherDescriptor_O*,FP> {
  inline static bool isA(FP client) {
      gctools::Header_s* header = reinterpret_cast<gctools::Header_s*>(ClientPtrToBasePtr(client));
      int kindVal = header->kind();
      // low high --> 239 239 
...
template <> class gctools::GCKind<asttooling::VariadicOperatorMatcherDescriptor_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O ;
};
...
template <> class gctools::GCKind<asttooling::FixedArgCountMatcherDescriptor_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O ;
};
...
template <> class gctools::GCKind<asttooling::MatcherDescriptor_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_asttooling__MatcherDescriptor_O ;
};
...
template <> class gctools::GCKind<asttooling::FreeFuncMatcherDescriptor_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O ;
};
...
template <> class gctools::GCKind<asttooling::OverloadedMatcherDescriptor_O> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O ;
};
...
template <> class gctools::GCKind<gctools::GCVector_moveable<gctools::smart_ptr<asttooling::MatcherDescriptor_O>>> {
public:
  static gctools::GCKindEnum const Kind = gctools::KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_asttooling__MatcherDescriptor_O__ ;
};
...
// not-exposing {  fixed_field, ctype__Bool, sizeof(_Bool), offsetof(SAFE_TYPE_MACRO(asttooling::RegMap::RegistryMaps_O),Initialized), "Initialized" }, // public: (NIL) fixable: NIL good-name: T
 {  fixed_field, TAGGED_POINTER_OFFSET, sizeof(gctools::tagged_pointer<gctools::GCVector_moveable<asttooling::RegMap::SymbolMatcherDescriptorPair_O>>), offsetof(SAFE_TYPE_MACRO(asttooling::RegMap::RegistryMaps_O),Constructors._Vector._Contents), "Constructors._Vector._Contents" }, // public: (NIL T T) fixable: TAGGED-POINTER-FIX good-name: T
...
{ class_kind, KIND_LISPALLOC_asttooling__MatcherDescriptor_O, sizeof(asttooling::MatcherDescriptor_O), 0, "asttooling::MatcherDescriptor_O" },
{ class_kind, KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O, sizeof(asttooling::OverloadedMatcherDescriptor_O), 0, "asttooling::OverloadedMatcherDescriptor_O" },
...
{ class_kind, KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O, sizeof(asttooling::FreeFuncMatcherDescriptor_O), 0, "asttooling::FreeFuncMatcherDescriptor_O" },
...
{ class_kind, KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O, sizeof(asttooling::FixedArgCountMatcherDescriptor_O), 0, "asttooling::FixedArgCountMatcherDescriptor_O" },
...
{ class_kind, KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O, sizeof(asttooling::VariadicOperatorMatcherDescriptor_O), 0, "asttooling::VariadicOperatorMatcherDescriptor_O" },
...
{ class_kind, KIND_LISPALLOC_core__ClosureWithSlots_O, sizeof(core::ClosureWithSlots_O), 0, "core::ClosureWithSlots_O" },
 ...
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::ClosureWithSlots_O),_associatedFunctions), "associatedFunctions" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
...
{ class_kind, KIND_LISPALLOC_core__CompiledClosure_O, sizeof(core::CompiledClosure_O), 0, "core::CompiledClosure_O" },
 ...
 {  fixed_field, SMART_PTR_OFFSET, sizeof(gctools::smart_ptr<core::T_O>), offsetof(SAFE_TYPE_MACRO(core::CompiledClosure_O),_associatedFunctions), "associatedFunctions" }, // public: (T) fixable: SMART-PTR-FIX good-name: T
...
{ container_kind, KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_asttooling__MatcherDescriptor_O__, sizeof(gctools::GCVector_moveable<gctools::smart_ptr<asttooling::MatcherDescriptor_O>>), 0, "gctools::GCVector_moveable<gctools::smart_ptr<asttooling::MatcherDescriptor_O>>" },
...
obj_finalize_KIND_LISPALLOC_asttooling__MatcherDescriptor_O:
{
    asttooling::MatcherDescriptor_O* obj_gc_safe = reinterpret_cast<asttooling::MatcherDescriptor_O*>(client);
    obj_gc_safe->~MatcherDescriptor_O();
    return;
}
obj_finalize_KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O:
{
...
obj_finalize_KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O:
{
...
obj_finalize_KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O:
{
...
obj_finalize_KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O:
{
...
obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_asttooling__MatcherDescriptor_O__:
{
...
static void* OBJ_FINALIZE_table[] = { 
  ...
  /* 211 */ &&obj_finalize_KIND_LISPALLOC_asttooling__RegMap__RegistryMaps_O,
  ...
  /* 226 */ &&obj_finalize_KIND_LISPALLOC_cffi__Pointer_O,
  /* 227 */ &&obj_finalize_KIND_LISPALLOC_core__CxxObject_O,
  /* 228 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DINodeArray_O,
  /* 229 */ &&obj_finalize_KIND_LISPALLOC_llvmo__DITypeRefArray_O,
  /* 230 */ &&obj_finalize_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 231 */ &&obj_finalize_KIND_LISPALLOC_core__Cache_O,
  /* 232 */ &&obj_finalize_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 233 */ &&obj_finalize_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 234 */ &&obj_finalize_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 235 */ &&obj_finalize_KIND_LISPALLOC_core__SNode_O,
  /* 236 */ &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O,
  /* 237 */ &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O,
  /* 238 */ &&obj_finalize_KIND_LISPALLOC_asttooling__MatcherDescriptor_O,
  /* 239 */ &&obj_finalize_KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O,
  /* 240 */ &&obj_finalize_KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O,
  /* 241 */ &&obj_finalize_KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O,
  /* 242 */ &&obj_finalize_KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O,
  /* 243 */ &&obj_finalize_KIND_LISPALLOC_core__Path_O,
  /* 244 */ &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 245 */ &&obj_finalize_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 246 */ &&obj_finalize_KIND_LISPALLOC_core__StructureObject_O,
  /* 247 */ &&obj_finalize_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 248 */ &&obj_finalize_KIND_LISPALLOC_core__Package_O,
  /* 249 */ &&obj_finalize_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 250 */ &&obj_finalize_KIND_LISPALLOC_core__Character_dummy_O,
  /* 251 */ &&obj_finalize_KIND_LISPALLOC_core__Function_O,
  /* 252 */ &&obj_finalize_KIND_LISPALLOC_core__NamedFunction_O,
  /* 253 */ &&obj_finalize_KIND_LISPALLOC_core__SpecialForm_O,
  /* 254 */ &&obj_finalize_KIND_LISPALLOC_core__Closure_O,
  /* 255 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 256 */ &&obj_finalize_KIND_LISPALLOC_core__FunctionClosure_O,
  /* 257 */ &&obj_finalize_KIND_LISPALLOC_core__ClosureWithSlots_O,
  /* 258 */ &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O,
  /* 259 */ &&obj_finalize_KIND_LISPALLOC_core__MacroClosure_O,
  /* 260 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O,
  /* 261 */ &&obj_finalize_KIND_LISPALLOC_core__ClosureWithFrame_O,
  /* 262 */ &&obj_finalize_KIND_LISPALLOC_core__CompiledClosure_O,
  /* 263 */ &&obj_finalize_KIND_LISPALLOC_core__InterpretedClosure_O,
  ...
  /* 266 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 267 */ &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O,
  /* 268 */ &&obj_finalize_KIND_LISPALLOC_core__Instance_O,
  /* 269 */ &&obj_finalize_KIND_LISPALLOC_core__Pointer_O,
  /* 270 */ &&obj_finalize_KIND_LISPALLOC_clbind__ClassRegistry_O,
...
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__MatcherDescriptor_O:
{
    asttooling::MatcherDescriptor_O* obj_gc_safe = reinterpret_cast<asttooling::MatcherDescriptor_O*>(client);
    GC<asttooling::MatcherDescriptor_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O:
{
    asttooling::OverloadedMatcherDescriptor_O* obj_gc_safe = reinterpret_cast<asttooling::OverloadedMatcherDescriptor_O*>(client);
    GC<asttooling::OverloadedMatcherDescriptor_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O:
{
    asttooling::FreeFuncMatcherDescriptor_O* obj_gc_safe = reinterpret_cast<asttooling::FreeFuncMatcherDescriptor_O*>(client);
    GC<asttooling::FreeFuncMatcherDescriptor_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O:
{
    asttooling::FixedArgCountMatcherDescriptor_O* obj_gc_safe = reinterpret_cast<asttooling::FixedArgCountMatcherDescriptor_O*>(client);
    GC<asttooling::FixedArgCountMatcherDescriptor_O>::deallocate_unmanaged_instance(obj_gc_safe);
    return;
}
obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O:
{
    asttooling::VariadicOperatorMatcherDescriptor_O* obj_gc_safe = reinterpret_cast<asttooling::VariadicOperatorMatcherDescriptor_O*>(client);
...
obj_deallocate_unmanaged_instance_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_asttooling__MatcherDescriptor_O__:
{
...
static void* OBJ_DEALLOCATOR_table[] = { 
  ...
  /* 211 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__RegMap__RegistryMaps_O,
  ...
  /* 226 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_cffi__Pointer_O,
  /* 227 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CxxObject_O,
  /* 228 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DINodeArray_O,
  /* 229 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__DITypeRefArray_O,
  /* 230 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__WeakKeyMapping_O,
  /* 231 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Cache_O,
  /* 232 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LambdaListHandler_O,
  /* 233 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__InsertPoint_O,
  /* 234 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SourceFileInfo_O,
  /* 235 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SNode_O,
  /* 236 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__LeafSNode_O,
  /* 237 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__BranchSNode_O,
  /* 238 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__MatcherDescriptor_O,
  /* 239 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__OverloadedMatcherDescriptor_O,
  /* 240 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__FreeFuncMatcherDescriptor_O,
  /* 241 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__FixedArgCountMatcherDescriptor_O,
  /* 242 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__VariadicOperatorMatcherDescriptor_O,
  /* 243 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Path_O,
  /* 244 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_asttooling__AstVisitor_O,
  /* 245 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_llvmo__AttributeSet_O,
  /* 246 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__StructureObject_O,
  /* 247 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O,
  /* 248 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Package_O,
  /* 249 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__DirectoryEntry_O,
  /* 250 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Character_dummy_O,
  /* 251 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Function_O,
  /* 252 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__NamedFunction_O,
  /* 253 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SpecialForm_O,
  /* 254 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Closure_O,
  /* 255 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledFunction_O,
  /* 256 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__FunctionClosure_O,
  /* 257 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithSlots_O,
  /* 258 */ &&obj_deallocate_unmanaged_instance_KIND_TEMPLATED_LISPALLOC_core__BuiltinClosure_O,
  /* 259 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__MacroClosure_O,
  /* 260 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchCxxEffectiveMethodFunction_O,
  /* 261 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__ClosureWithFrame_O,
  /* 262 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__CompiledClosure_O,
  /* 263 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__InterpretedClosure_O,
  ...
  /* 266 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O,
  /* 267 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__SingleDispatchGenericFunctionClosure_O,
  /* 268 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Instance_O,
  /* 269 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_core__Pointer_O,
  /* 270 */ &&obj_deallocate_unmanaged_instance_KIND_LISPALLOC_clbind__ClassRegistry_O,
