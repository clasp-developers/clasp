...
KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O = 58,
KIND_LISPALLOC_core__SingleDispatchMethod_O = 59,
KIND_LISPALLOC_core__RandomState_O = 60,
KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O = 61,
KIND_LISPALLOC_llvmo__DebugLoc_O = 62,
KIND_LISPALLOC_llvmo__Attribute_O = 63,
KIND_LISPALLOC_core__RegexMatch_O = 64,
KIND_LISPALLOC_core__WeakPointer_O = 65,
KIND_LISPALLOC_core__VaList_dummy_O = 66,
KIND_BOOTSTRAP_core__StandardObject_O = 67,
KIND_BOOTSTRAP_core__Metaobject_O = 68,
KIND_BOOTSTRAP_core__Specializer_O = 69,
KIND_BOOTSTRAP_core__Class_O = 70,
KIND_BOOTSTRAP_core__StdClass_O = 71,
KIND_BOOTSTRAP_core__StandardClass_O = 72,
KIND_LISPALLOC_core__FuncallableStandardClass_O = 73,
KIND_BOOTSTRAP_core__StructureClass_O = 74,
KIND_LISPALLOC_core__ForwardReferencedClass_O = 75,
KIND_LISPALLOC_core__CxxClass_O = 76,
KIND_BOOTSTRAP_core__BuiltInClass_O = 77,
KIND_LISPALLOC_clbind__ClassRep_O = 78,
KIND_LISPALLOC_core__ExternalObject_O = 79,
KIND_LISPALLOC_llvmo__Value_O = 80,
KIND_LISPALLOC_llvmo__Argument_O = 81,
KIND_LISPALLOC_llvmo__User_O = 82,
KIND_LISPALLOC_llvmo__Instruction_O = 83,
KIND_LISPALLOC_llvmo__AtomicRMWInst_O = 84,
KIND_LISPALLOC_llvmo__LandingPadInst_O = 85,
KIND_LISPALLOC_llvmo__PHINode_O = 86,
KIND_LISPALLOC_llvmo__CallInst_O = 87,
KIND_LISPALLOC_llvmo__StoreInst_O = 88,
KIND_LISPALLOC_llvmo__UnaryInstruction_O = 89,
KIND_LISPALLOC_llvmo__LoadInst_O = 90,
KIND_LISPALLOC_llvmo__AllocaInst_O = 91,
KIND_LISPALLOC_llvmo__VAArgInst_O = 92,
KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O = 93,
KIND_LISPALLOC_llvmo__TerminatorInst_O = 94,
KIND_LISPALLOC_llvmo__UnreachableInst_O = 95,
KIND_LISPALLOC_llvmo__SwitchInst_O = 96,
KIND_LISPALLOC_llvmo__ReturnInst_O = 97,
KIND_LISPALLOC_llvmo__ResumeInst_O = 98,
KIND_LISPALLOC_llvmo__BranchInst_O = 99,
KIND_LISPALLOC_llvmo__InvokeInst_O = 100,
KIND_LISPALLOC_llvmo__IndirectBrInst_O = 101,
KIND_LISPALLOC_llvmo__FenceInst_O = 102,
KIND_LISPALLOC_llvmo__Constant_O = 103,
KIND_LISPALLOC_llvmo__BlockAddress_O = 104,
KIND_LISPALLOC_llvmo__GlobalValue_O = 105,
KIND_LISPALLOC_llvmo__GlobalVariable_O = 106,
KIND_LISPALLOC_llvmo__Function_O = 107,
KIND_LISPALLOC_llvmo__ConstantArray_O = 108,
KIND_LISPALLOC_llvmo__ConstantInt_O = 109,
KIND_LISPALLOC_llvmo__ConstantDataSequential_O = 110,
KIND_LISPALLOC_llvmo__ConstantDataArray_O = 111,
KIND_LISPALLOC_llvmo__ConstantStruct_O = 112,
KIND_LISPALLOC_llvmo__ConstantFP_O = 113,
KIND_LISPALLOC_llvmo__UndefValue_O = 114,
KIND_LISPALLOC_llvmo__ConstantPointerNull_O = 115,
KIND_LISPALLOC_llvmo__ConstantExpr_O = 116,
KIND_LISPALLOC_llvmo__BasicBlock_O = 117,
KIND_LISPALLOC_llvmo__IRBuilderBase_O = 118,
KIND_LISPALLOC_llvmo__IRBuilder_O = 119,
KIND_LISPALLOC_llvmo__DIBuilder_O = 120,
KIND_LISPALLOC_llvmo__Metadata_O = 121,
KIND_LISPALLOC_llvmo__ValueAsMetadata_O = 122,
KIND_LISPALLOC_llvmo__MDNode_O = 123,
KIND_LISPALLOC_llvmo__MDString_O = 124,
KIND_LISPALLOC_llvmo__ExecutionEngine_O = 125,
KIND_LISPALLOC_llvmo__APFloat_O = 126,
KIND_LISPALLOC_llvmo__PassManagerBuilder_O = 127,
KIND_LISPALLOC_llvmo__DataLayout_O = 128,
KIND_LISPALLOC_llvmo__Triple_O = 129,
KIND_LISPALLOC_llvmo__APInt_O = 130,
KIND_LISPALLOC_llvmo__PassManagerBase_O = 131,
KIND_LISPALLOC_llvmo__FunctionPassManager_O = 132,
KIND_LISPALLOC_llvmo__PassManager_O = 133,
KIND_LISPALLOC_llvmo__TargetMachine_O = 134,
KIND_LISPALLOC_llvmo__LLVMTargetMachine_O = 135,
KIND_LISPALLOC_llvmo__TargetOptions_O = 136,
KIND_LISPALLOC_llvmo__Type_O = 137,
KIND_LISPALLOC_llvmo__IntegerType_O = 138,
KIND_LISPALLOC_llvmo__CompositeType_O = 139,
KIND_LISPALLOC_llvmo__SequentialType_O = 140,
KIND_LISPALLOC_llvmo__VectorType_O = 141,
KIND_LISPALLOC_llvmo__PointerType_O = 142,
KIND_LISPALLOC_llvmo__ArrayType_O = 143,
KIND_LISPALLOC_llvmo__StructType_O = 144,
KIND_LISPALLOC_llvmo__FunctionType_O = 145,
KIND_LISPALLOC_llvmo__NamedMDNode_O = 146,
KIND_LISPALLOC_llvmo__Linker_O = 147,
KIND_LISPALLOC_llvmo__Pass_O = 148,
KIND_LISPALLOC_llvmo__FunctionPass_O = 149,
KIND_LISPALLOC_llvmo__ModulePass_O = 150,
KIND_LISPALLOC_llvmo__ImmutablePass_O = 151,
KIND_LISPALLOC_llvmo__DataLayoutPass_O = 152,
KIND_LISPALLOC_llvmo__TargetLibraryInfo_O = 153,
KIND_LISPALLOC_llvmo__MCSubtargetInfo_O = 154,
KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O = 155,
KIND_LISPALLOC_llvmo__Module_O = 156,
KIND_LISPALLOC_llvmo__EngineBuilder_O = 157,
KIND_LISPALLOC_core__ForeignData_O = 158,
KIND_LISPALLOC_llvmo__LLVMContext_O = 159,
KIND_LISPALLOC_llvmo__Target_O = 160,
KIND_LISPALLOC_core__LoadTimeValues_O = 161,
KIND_LISPALLOC_core__Binder_O = 162,
KIND_LISPALLOC_core__IntArray_O = 163,
KIND_LISPALLOC_core__SourceManager_O = 164,
KIND_LISPALLOC_core__Record_O = 165,
KIND_LISPALLOC_core__LightUserData_O = 166,
KIND_LISPALLOC_core__UserData_O = 167,
KIND_BOOTSTRAP_core__Symbol_O = 168,
KIND_LISPALLOC_core__Null_O = 169,
KIND_LISPALLOC_core__SourcePosInfo_O = 170,
KIND_TEMPLATED_LISPALLOC_core__Iterator_O = 171,
KIND_LISPALLOC_core__DirectoryIterator_O = 172,
KIND_LISPALLOC_core__RecursiveDirectoryIterator_O = 173,
KIND_LISPALLOC_core__Regex_O = 174,
KIND_LISPALLOC_core__PosixTimeDuration_O = 175,
KIND_LISPALLOC_core__SymbolToEnumConverter_O = 176,
KIND_LISPALLOC_core__CandoException_O = 177,
KIND_LISPALLOC_core__Stream_O = 178,
KIND_LISPALLOC_core__AnsiStream_O = 179,
KIND_LISPALLOC_core__FileStream_O = 180,
KIND_LISPALLOC_core__IOStreamStream_O = 181,
KIND_LISPALLOC_core__IOFileStream_O = 182,
KIND_LISPALLOC_core__ConcatenatedStream_O = 183,
KIND_LISPALLOC_core__StringStream_O = 184,
KIND_LISPALLOC_core__StringInputStream_O = 185,
KIND_LISPALLOC_core__StringOutputStream_O = 186,
KIND_LISPALLOC_core__SynonymStream_O = 187,
KIND_LISPALLOC_core__EchoStream_O = 188,
KIND_LISPALLOC_core__TwoWayStream_O = 189,
KIND_LISPALLOC_core__BroadcastStream_O = 190,
KIND_LISPALLOC_core__Reader_O = 191,
KIND_LISPALLOC_core__Cons_O = 192,
KIND_LISPALLOC_core__Archive_O = 193,
KIND_LISPALLOC_core__SaveArchive_O = 194,
KIND_LISPALLOC_core__SexpSaveArchive_O = 195,
KIND_LISPALLOC_core__LoadArchive_O = 196,
KIND_LISPALLOC_core__SexpLoadArchive_O = 197,
KIND_LISPALLOC_core__HashTable_O = 198,
KIND_LISPALLOC_core__HashTableEq_O = 199,
KIND_LISPALLOC_core__HashTableEqualp_O = 200,
KIND_LISPALLOC_core__HashTableEql_O = 201,
KIND_LISPALLOC_core__HashTableEqual_O = 202,
KIND_LISPALLOC_cffi__Pointer_O = 203,
KIND_LISPALLOC_core__CxxObject_O = 204,
KIND_LISPALLOC_core__WeakKeyMapping_O = 205,
KIND_LISPALLOC_core__LambdaListHandler_O = 206,
KIND_LISPALLOC_llvmo__InsertPoint_O = 207,
KIND_LISPALLOC_core__SourceFileInfo_O = 208,
KIND_LISPALLOC_core__SNode_O = 209,
KIND_LISPALLOC_core__LeafSNode_O = 210,
KIND_LISPALLOC_core__BranchSNode_O = 211,
KIND_LISPALLOC_core__Path_O = 212,
KIND_LISPALLOC_asttooling__AstVisitor_O = 213,
KIND_LISPALLOC_llvmo__AttributeSet_O = 214,
KIND_LISPALLOC_core__StructureObject_O = 215,
KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O = 216,
KIND_LISPALLOC_core__Package_O = 217,
KIND_LISPALLOC_core__DirectoryEntry_O = 218,
KIND_LISPALLOC_core__Character_dummy_O = 219,
KIND_LISPALLOC_core__Function_O = 220,
KIND_LISPALLOC_core__CompiledFunction_O = 221,
KIND_LISPALLOC_core__SingleDispatchGenericFunction_O = 222,
KIND_LISPALLOC_core__SpecialForm_O = 223,
KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O = 224,
KIND_LISPALLOC_core__Instance_O = 225,
KIND_LISPALLOC_core__Pointer_O = 226,
KIND_LISPALLOC_clbind__ClassRegistry_O = 227,
KIND_LISPALLOC_llvmo__DebugInfo_O = 228,
KIND_LISPALLOC_llvmo__DIDerivedType_O = 229,
KIND_LISPALLOC_llvmo__DIArray_O = 230,
KIND_LISPALLOC_llvmo__DIBasicType_O = 231,
KIND_LISPALLOC_llvmo__DISubprogram_O = 232,
KIND_LISPALLOC_llvmo__DILexicalBlock_O = 233,
KIND_LISPALLOC_llvmo__DICompileUnit_O = 234,
KIND_LISPALLOC_llvmo__DIDescriptor_O = 235,
KIND_LISPALLOC_llvmo__DIType_O = 236,
KIND_LISPALLOC_llvmo__DISubroutineType_O = 237,
KIND_LISPALLOC_llvmo__DICompositeType_O = 238,
KIND_LISPALLOC_llvmo__DITypeArray_O = 239,
KIND_LISPALLOC_llvmo__DIFile_O = 240,
KIND_LISPALLOC_llvmo__DIScope_O = 241,
KIND_LISPALLOC_core__SmallMultimap_O = 242,
KIND_LISPALLOC_core__Pathname_O = 243,
KIND_LISPALLOC_core__LogicalPathname_O = 244,
KIND_LISPALLOC_core__PosixTime_O = 245,
KIND_LISPALLOC_core__SmallMap_O = 246,
KIND_CLASSALLOC_core__Cache = 247,
KIND_ROOTCLASSALLOC_core__Lisp_O = 248,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__ = 249,
KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_ = 250,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_ = 251,
KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure = 252,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__ = 253,
KIND_GCSTRING_gctools__GCString_moveable_char_ = 254,
KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_ = 255,
KIND_CLASSALLOC_llvmo__CompiledClosure = 256,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__ = 257,
KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor = 258,
KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___ = 259,
KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor = 260,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_ = 261,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_ = 262,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_ = 263,
KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor = 264,
KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_ = 265,
KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor = 266,
KIND_CLASSALLOC_core__MacroClosure = 267,
KIND_CLASSALLOC_core__ConsStepper = 268,
KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_ = 269,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_ = 270,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__ = 271,
KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_ = 272,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_ = 273,
KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___ = 274,
KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_ = 275,
KIND_CLASSALLOC_core__InstanceClosure = 276,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__ = 277,
KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory = 278,
KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_ = 279,
KIND_LISPALLOC_asttooling__DerivableMatchCallback = 280,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_ = 281,
KIND_LISPALLOC_asttooling__DerivableASTFrontendAction = 282,
KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_ = 283,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__ = 284,
KIND_CLASSALLOC_core__CoreExposer = 285,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__ = 286,
KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction = 287,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__ = 288,
KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_ = 289,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__ = 290,
KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure = 291,
KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_ = 292,
KIND_CLASSALLOC_core__InterpretedClosure = 293,
KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_ = 294,
KIND_CLASSALLOC_core__VectorStepper = 295,
KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__ = 296,
  KIND_max = 296
}
...
template <typename FP> struct Cast<core::Pathname_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 243 244 
      return ((243 <= kindVal) && (kindVal <= 244));
  };
};
...
template <typename FP> struct Cast<llvmo::DebugInfo_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 228 241 
      return ((228 <= kindVal) && (kindVal <= 241));
  };
};
...
template <typename FP> struct Cast<core::Function_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 220 225 
      return ((220 <= kindVal) && (kindVal <= 225));
  };
};
...
template <typename FP> struct Cast<llvmo::Type_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 137 145 
      return ((137 <= kindVal) && (kindVal <= 145));
  };
};
...
template <typename FP> struct Cast<llvmo::CompositeType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 139 144 
      return ((139 <= kindVal) && (kindVal <= 144));
  };
};
...
template <typename FP> struct Cast<core::Stream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 178 190 
      return ((178 <= kindVal) && (kindVal <= 190));
  };
};
...
template <typename FP> struct Cast<core::SaveArchive_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 194 195 
      return ((194 <= kindVal) && (kindVal <= 195));
  };
};
...
template <typename FP> struct Cast<llvmo::Constant_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 103 116 
      return ((103 <= kindVal) && (kindVal <= 116));
  };
};
...
template <typename FP> struct Cast<llvmo::ImmutablePass_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 151 153 
      return ((151 <= kindVal) && (kindVal <= 153));
  };
};
...
template <typename FP> struct Cast<llvmo::Metadata_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 121 124 
      return ((121 <= kindVal) && (kindVal <= 124));
  };
};
...
template <typename FP> struct Cast<llvmo::SequentialType_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 140 143 
      return ((140 <= kindVal) && (kindVal <= 143));
  };
};
...
template <typename FP> struct Cast<core::StringStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 184 186 
      return ((184 <= kindVal) && (kindVal <= 186));
  };
};
...
template <typename FP> struct Cast<llvmo::ConstantDataSequential_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 110 111 
      return ((110 <= kindVal) && (kindVal <= 111));
  };
};
...
template <typename FP> struct Cast<core::AnsiStream_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 179 190 
      return ((179 <= kindVal) && (kindVal <= 190));
  };
};
...
template <typename FP> struct Cast<llvmo::ModulePass_O*,FP> {
  inline static bool isA(FP client) {
      ...
      int kindVal = header->kind();
      // low high --> 150 153 
      return ((150 <= kindVal) && (kindVal <= 153));
  };
};
...
static void* KIND_NAME_MAP_table[] = { NULL 
  ...
  /* 54 */ , &&kind_name_KIND_LISPALLOC_core__String_O
  /* 55 */ , &&kind_name_KIND_BOOTSTRAP_core__Str_O
  /* 56 */ , &&kind_name_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 57 */ , &&kind_name_KIND_LISPALLOC_core__VectorObjects_O
  /* 58 */ , &&kind_name_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 59 */ , &&kind_name_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 60 */ , &&kind_name_KIND_LISPALLOC_core__RandomState_O
  /* 61 */ , &&kind_name_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 62 */ , &&kind_name_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 63 */ , &&kind_name_KIND_LISPALLOC_llvmo__Attribute_O
  /* 64 */ , &&kind_name_KIND_LISPALLOC_core__RegexMatch_O
  /* 65 */ , &&kind_name_KIND_LISPALLOC_core__WeakPointer_O
  /* 66 */ , &&kind_name_KIND_LISPALLOC_core__VaList_dummy_O
  /* 67 */ , &&kind_name_KIND_BOOTSTRAP_core__StandardObject_O
  /* 68 */ , &&kind_name_KIND_BOOTSTRAP_core__Metaobject_O
  /* 69 */ , &&kind_name_KIND_BOOTSTRAP_core__Specializer_O
  /* 70 */ , &&kind_name_KIND_BOOTSTRAP_core__Class_O
  /* 71 */ , &&kind_name_KIND_BOOTSTRAP_core__StdClass_O
  /* 72 */ , &&kind_name_KIND_BOOTSTRAP_core__StandardClass_O
  /* 73 */ , &&kind_name_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 74 */ , &&kind_name_KIND_BOOTSTRAP_core__StructureClass_O
  /* 75 */ , &&kind_name_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 76 */ , &&kind_name_KIND_LISPALLOC_core__CxxClass_O
  /* 77 */ , &&kind_name_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 78 */ , &&kind_name_KIND_LISPALLOC_clbind__ClassRep_O
  /* 79 */ , &&kind_name_KIND_LISPALLOC_core__ExternalObject_O
  /* 80 */ , &&kind_name_KIND_LISPALLOC_llvmo__Value_O
  /* 81 */ , &&kind_name_KIND_LISPALLOC_llvmo__Argument_O
  /* 82 */ , &&kind_name_KIND_LISPALLOC_llvmo__User_O
  /* 83 */ , &&kind_name_KIND_LISPALLOC_llvmo__Instruction_O
  /* 84 */ , &&kind_name_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 85 */ , &&kind_name_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 86 */ , &&kind_name_KIND_LISPALLOC_llvmo__PHINode_O
  /* 87 */ , &&kind_name_KIND_LISPALLOC_llvmo__CallInst_O
  /* 88 */ , &&kind_name_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 89 */ , &&kind_name_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 90 */ , &&kind_name_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 91 */ , &&kind_name_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 92 */ , &&kind_name_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 93 */ , &&kind_name_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 94 */ , &&kind_name_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 95 */ , &&kind_name_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 96 */ , &&kind_name_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 97 */ , &&kind_name_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 98 */ , &&kind_name_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 99 */ , &&kind_name_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 100 */ , &&kind_name_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 101 */ , &&kind_name_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 102 */ , &&kind_name_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 103 */ , &&kind_name_KIND_LISPALLOC_llvmo__Constant_O
  /* 104 */ , &&kind_name_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 105 */ , &&kind_name_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 106 */ , &&kind_name_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 107 */ , &&kind_name_KIND_LISPALLOC_llvmo__Function_O
  /* 108 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 109 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 110 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 111 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 112 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 113 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 114 */ , &&kind_name_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 115 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 116 */ , &&kind_name_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 117 */ , &&kind_name_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 118 */ , &&kind_name_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 119 */ , &&kind_name_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 120 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 121 */ , &&kind_name_KIND_LISPALLOC_llvmo__Metadata_O
  /* 122 */ , &&kind_name_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 123 */ , &&kind_name_KIND_LISPALLOC_llvmo__MDNode_O
  /* 124 */ , &&kind_name_KIND_LISPALLOC_llvmo__MDString_O
  /* 125 */ , &&kind_name_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 126 */ , &&kind_name_KIND_LISPALLOC_llvmo__APFloat_O
  /* 127 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 128 */ , &&kind_name_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 129 */ , &&kind_name_KIND_LISPALLOC_llvmo__Triple_O
  /* 130 */ , &&kind_name_KIND_LISPALLOC_llvmo__APInt_O
  /* 131 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 132 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 133 */ , &&kind_name_KIND_LISPALLOC_llvmo__PassManager_O
  /* 134 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 135 */ , &&kind_name_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 136 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 137 */ , &&kind_name_KIND_LISPALLOC_llvmo__Type_O
  /* 138 */ , &&kind_name_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 139 */ , &&kind_name_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 140 */ , &&kind_name_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 141 */ , &&kind_name_KIND_LISPALLOC_llvmo__VectorType_O
  /* 142 */ , &&kind_name_KIND_LISPALLOC_llvmo__PointerType_O
  /* 143 */ , &&kind_name_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 144 */ , &&kind_name_KIND_LISPALLOC_llvmo__StructType_O
  /* 145 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 146 */ , &&kind_name_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 147 */ , &&kind_name_KIND_LISPALLOC_llvmo__Linker_O
  /* 148 */ , &&kind_name_KIND_LISPALLOC_llvmo__Pass_O
  /* 149 */ , &&kind_name_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 150 */ , &&kind_name_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 151 */ , &&kind_name_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 152 */ , &&kind_name_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 153 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 154 */ , &&kind_name_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 155 */ , &&kind_name_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 156 */ , &&kind_name_KIND_LISPALLOC_llvmo__Module_O
  /* 157 */ , &&kind_name_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 158 */ , &&kind_name_KIND_LISPALLOC_core__ForeignData_O
  /* 159 */ , &&kind_name_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 160 */ , &&kind_name_KIND_LISPALLOC_llvmo__Target_O
  /* 161 */ , &&kind_name_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 162 */ , &&kind_name_KIND_LISPALLOC_core__Binder_O
  /* 163 */ , &&kind_name_KIND_LISPALLOC_core__IntArray_O
  /* 164 */ , &&kind_name_KIND_LISPALLOC_core__SourceManager_O
  /* 165 */ , &&kind_name_KIND_LISPALLOC_core__Record_O
  /* 166 */ , &&kind_name_KIND_LISPALLOC_core__LightUserData_O
  /* 167 */ , &&kind_name_KIND_LISPALLOC_core__UserData_O
  /* 168 */ , &&kind_name_KIND_BOOTSTRAP_core__Symbol_O
  /* 169 */ , &&kind_name_KIND_LISPALLOC_core__Null_O
  /* 170 */ , &&kind_name_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 171 */ , &&kind_name_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 172 */ , &&kind_name_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 173 */ , &&kind_name_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 174 */ , &&kind_name_KIND_LISPALLOC_core__Regex_O
  /* 175 */ , &&kind_name_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 176 */ , &&kind_name_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 177 */ , &&kind_name_KIND_LISPALLOC_core__CandoException_O
  /* 178 */ , &&kind_name_KIND_LISPALLOC_core__Stream_O
  /* 179 */ , &&kind_name_KIND_LISPALLOC_core__AnsiStream_O
  /* 180 */ , &&kind_name_KIND_LISPALLOC_core__FileStream_O
  /* 181 */ , &&kind_name_KIND_LISPALLOC_core__IOStreamStream_O
  /* 182 */ , &&kind_name_KIND_LISPALLOC_core__IOFileStream_O
  /* 183 */ , &&kind_name_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 184 */ , &&kind_name_KIND_LISPALLOC_core__StringStream_O
  /* 185 */ , &&kind_name_KIND_LISPALLOC_core__StringInputStream_O
  /* 186 */ , &&kind_name_KIND_LISPALLOC_core__StringOutputStream_O
  /* 187 */ , &&kind_name_KIND_LISPALLOC_core__SynonymStream_O
  /* 188 */ , &&kind_name_KIND_LISPALLOC_core__EchoStream_O
  /* 189 */ , &&kind_name_KIND_LISPALLOC_core__TwoWayStream_O
  /* 190 */ , &&kind_name_KIND_LISPALLOC_core__BroadcastStream_O
  /* 191 */ , &&kind_name_KIND_LISPALLOC_core__Reader_O
  /* 192 */ , &&kind_name_KIND_LISPALLOC_core__Cons_O
  /* 193 */ , &&kind_name_KIND_LISPALLOC_core__Archive_O
  /* 194 */ , &&kind_name_KIND_LISPALLOC_core__SaveArchive_O
  /* 195 */ , &&kind_name_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 196 */ , &&kind_name_KIND_LISPALLOC_core__LoadArchive_O
  /* 197 */ , &&kind_name_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 198 */ , &&kind_name_KIND_LISPALLOC_core__HashTable_O
  /* 199 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEq_O
  /* 200 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 201 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEql_O
  /* 202 */ , &&kind_name_KIND_LISPALLOC_core__HashTableEqual_O
  /* 203 */ , &&kind_name_KIND_LISPALLOC_cffi__Pointer_O
  /* 204 */ , &&kind_name_KIND_LISPALLOC_core__CxxObject_O
  /* 205 */ , &&kind_name_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 206 */ , &&kind_name_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 207 */ , &&kind_name_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 208 */ , &&kind_name_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 209 */ , &&kind_name_KIND_LISPALLOC_core__SNode_O
  /* 210 */ , &&kind_name_KIND_LISPALLOC_core__LeafSNode_O
  /* 211 */ , &&kind_name_KIND_LISPALLOC_core__BranchSNode_O
  /* 212 */ , &&kind_name_KIND_LISPALLOC_core__Path_O
  /* 213 */ , &&kind_name_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 214 */ , &&kind_name_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 215 */ , &&kind_name_KIND_LISPALLOC_core__StructureObject_O
  /* 216 */ , &&kind_name_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 217 */ , &&kind_name_KIND_LISPALLOC_core__Package_O
  /* 218 */ , &&kind_name_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 219 */ , &&kind_name_KIND_LISPALLOC_core__Character_dummy_O
  /* 220 */ , &&kind_name_KIND_LISPALLOC_core__Function_O
  /* 221 */ , &&kind_name_KIND_LISPALLOC_core__CompiledFunction_O
  /* 222 */ , &&kind_name_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 223 */ , &&kind_name_KIND_LISPALLOC_core__SpecialForm_O
  /* 224 */ , &&kind_name_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 225 */ , &&kind_name_KIND_LISPALLOC_core__Instance_O
  /* 226 */ , &&kind_name_KIND_LISPALLOC_core__Pointer_O
  /* 227 */ , &&kind_name_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 228 */ , &&kind_name_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 229 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 230 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIArray_O
  /* 231 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 232 */ , &&kind_name_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 233 */ , &&kind_name_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 234 */ , &&kind_name_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 235 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 236 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIType_O
  /* 237 */ , &&kind_name_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 238 */ , &&kind_name_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 239 */ , &&kind_name_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 240 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIFile_O
  /* 241 */ , &&kind_name_KIND_LISPALLOC_llvmo__DIScope_O
  /* 242 */ , &&kind_name_KIND_LISPALLOC_core__SmallMultimap_O
  /* 243 */ , &&kind_name_KIND_LISPALLOC_core__Pathname_O
  /* 244 */ , &&kind_name_KIND_LISPALLOC_core__LogicalPathname_O
  /* 245 */ , &&kind_name_KIND_LISPALLOC_core__PosixTime_O
  /* 246 */ , &&kind_name_KIND_LISPALLOC_core__SmallMap_O
  /* 247 */ , &&kind_name_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&kind_name_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 249 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 250 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 251 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 252 */ , &&kind_name_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 253 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 254 */ , &&kind_name_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 255 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 256 */ , &&kind_name_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 257 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 258 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 259 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 260 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 261 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 262 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 263 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 264 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 265 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 266 */ , &&kind_name_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 267 */ , &&kind_name_KIND_CLASSALLOC_core__MacroClosure
  /* 268 */ , &&kind_name_KIND_CLASSALLOC_core__ConsStepper
  /* 269 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 270 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 271 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 272 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 273 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 274 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 275 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 276 */ , &&kind_name_KIND_CLASSALLOC_core__InstanceClosure
  /* 277 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 278 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 279 */ , &&kind_name_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 280 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 281 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 282 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 283 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 284 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__
  /* 285 */ , &&kind_name_KIND_CLASSALLOC_core__CoreExposer
  /* 286 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 287 */ , &&kind_name_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 288 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 289 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 290 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 291 */ , &&kind_name_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 292 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 293 */ , &&kind_name_KIND_CLASSALLOC_core__InterpretedClosure
  /* 294 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 295 */ , &&kind_name_KIND_CLASSALLOC_core__VectorStepper
  /* 296 */ , &&kind_name_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
static void* OBJ_DUMP_MAP_table[] = { NULL 
  ...
  /* 54 */ , &&obj_dump_KIND_LISPALLOC_core__String_O
  /* 55 */ , &&obj_dump_KIND_BOOTSTRAP_core__Str_O
  /* 56 */ , &&obj_dump_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 57 */ , &&obj_dump_KIND_LISPALLOC_core__VectorObjects_O
  /* 58 */ , &&obj_dump_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 59 */ , &&obj_dump_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 60 */ , &&obj_dump_KIND_LISPALLOC_core__RandomState_O
  /* 61 */ , &&obj_dump_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 62 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 63 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Attribute_O
  /* 64 */ , &&obj_dump_KIND_LISPALLOC_core__RegexMatch_O
  /* 65 */ , &&obj_dump_KIND_LISPALLOC_core__WeakPointer_O
  /* 66 */ , &&obj_dump_KIND_LISPALLOC_core__VaList_dummy_O
  /* 67 */ , &&obj_dump_KIND_BOOTSTRAP_core__StandardObject_O
  /* 68 */ , &&obj_dump_KIND_BOOTSTRAP_core__Metaobject_O
  /* 69 */ , &&obj_dump_KIND_BOOTSTRAP_core__Specializer_O
  /* 70 */ , &&obj_dump_KIND_BOOTSTRAP_core__Class_O
  /* 71 */ , &&obj_dump_KIND_BOOTSTRAP_core__StdClass_O
  /* 72 */ , &&obj_dump_KIND_BOOTSTRAP_core__StandardClass_O
  /* 73 */ , &&obj_dump_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 74 */ , &&obj_dump_KIND_BOOTSTRAP_core__StructureClass_O
  /* 75 */ , &&obj_dump_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 76 */ , &&obj_dump_KIND_LISPALLOC_core__CxxClass_O
  /* 77 */ , &&obj_dump_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 78 */ , &&obj_dump_KIND_LISPALLOC_clbind__ClassRep_O
  /* 79 */ , &&obj_dump_KIND_LISPALLOC_core__ExternalObject_O
  /* 80 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Value_O
  /* 81 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Argument_O
  /* 82 */ , &&obj_dump_KIND_LISPALLOC_llvmo__User_O
  /* 83 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Instruction_O
  /* 84 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 85 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 86 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PHINode_O
  /* 87 */ , &&obj_dump_KIND_LISPALLOC_llvmo__CallInst_O
  /* 88 */ , &&obj_dump_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 89 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 90 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 91 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 92 */ , &&obj_dump_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 93 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 94 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 95 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 96 */ , &&obj_dump_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 97 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 98 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 99 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 100 */ , &&obj_dump_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 101 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 102 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 103 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Constant_O
  /* 104 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 105 */ , &&obj_dump_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 106 */ , &&obj_dump_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 107 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Function_O
  /* 108 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 109 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 110 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 111 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 112 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 113 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 114 */ , &&obj_dump_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 115 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 116 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 117 */ , &&obj_dump_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 118 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 119 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 120 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 121 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Metadata_O
  /* 122 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 123 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MDNode_O
  /* 124 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MDString_O
  /* 125 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 126 */ , &&obj_dump_KIND_LISPALLOC_llvmo__APFloat_O
  /* 127 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 128 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 129 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Triple_O
  /* 130 */ , &&obj_dump_KIND_LISPALLOC_llvmo__APInt_O
  /* 131 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 132 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 133 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PassManager_O
  /* 134 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 135 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 136 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 137 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Type_O
  /* 138 */ , &&obj_dump_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 139 */ , &&obj_dump_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 140 */ , &&obj_dump_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 141 */ , &&obj_dump_KIND_LISPALLOC_llvmo__VectorType_O
  /* 142 */ , &&obj_dump_KIND_LISPALLOC_llvmo__PointerType_O
  /* 143 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 144 */ , &&obj_dump_KIND_LISPALLOC_llvmo__StructType_O
  /* 145 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 146 */ , &&obj_dump_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 147 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Linker_O
  /* 148 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Pass_O
  /* 149 */ , &&obj_dump_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 150 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 151 */ , &&obj_dump_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 152 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 153 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 154 */ , &&obj_dump_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 155 */ , &&obj_dump_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 156 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Module_O
  /* 157 */ , &&obj_dump_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 158 */ , &&obj_dump_KIND_LISPALLOC_core__ForeignData_O
  /* 159 */ , &&obj_dump_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 160 */ , &&obj_dump_KIND_LISPALLOC_llvmo__Target_O
  /* 161 */ , &&obj_dump_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 162 */ , &&obj_dump_KIND_LISPALLOC_core__Binder_O
  /* 163 */ , &&obj_dump_KIND_LISPALLOC_core__IntArray_O
  /* 164 */ , &&obj_dump_KIND_LISPALLOC_core__SourceManager_O
  /* 165 */ , &&obj_dump_KIND_LISPALLOC_core__Record_O
  /* 166 */ , &&obj_dump_KIND_LISPALLOC_core__LightUserData_O
  /* 167 */ , &&obj_dump_KIND_LISPALLOC_core__UserData_O
  /* 168 */ , &&obj_dump_KIND_BOOTSTRAP_core__Symbol_O
  /* 169 */ , &&obj_dump_KIND_LISPALLOC_core__Null_O
  /* 170 */ , &&obj_dump_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 171 */ , &&obj_dump_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 172 */ , &&obj_dump_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 173 */ , &&obj_dump_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 174 */ , &&obj_dump_KIND_LISPALLOC_core__Regex_O
  /* 175 */ , &&obj_dump_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 176 */ , &&obj_dump_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 177 */ , &&obj_dump_KIND_LISPALLOC_core__CandoException_O
  /* 178 */ , &&obj_dump_KIND_LISPALLOC_core__Stream_O
  /* 179 */ , &&obj_dump_KIND_LISPALLOC_core__AnsiStream_O
  /* 180 */ , &&obj_dump_KIND_LISPALLOC_core__FileStream_O
  /* 181 */ , &&obj_dump_KIND_LISPALLOC_core__IOStreamStream_O
  /* 182 */ , &&obj_dump_KIND_LISPALLOC_core__IOFileStream_O
  /* 183 */ , &&obj_dump_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 184 */ , &&obj_dump_KIND_LISPALLOC_core__StringStream_O
  /* 185 */ , &&obj_dump_KIND_LISPALLOC_core__StringInputStream_O
  /* 186 */ , &&obj_dump_KIND_LISPALLOC_core__StringOutputStream_O
  /* 187 */ , &&obj_dump_KIND_LISPALLOC_core__SynonymStream_O
  /* 188 */ , &&obj_dump_KIND_LISPALLOC_core__EchoStream_O
  /* 189 */ , &&obj_dump_KIND_LISPALLOC_core__TwoWayStream_O
  /* 190 */ , &&obj_dump_KIND_LISPALLOC_core__BroadcastStream_O
  /* 191 */ , &&obj_dump_KIND_LISPALLOC_core__Reader_O
  /* 192 */ , &&obj_dump_KIND_LISPALLOC_core__Cons_O
  /* 193 */ , &&obj_dump_KIND_LISPALLOC_core__Archive_O
  /* 194 */ , &&obj_dump_KIND_LISPALLOC_core__SaveArchive_O
  /* 195 */ , &&obj_dump_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 196 */ , &&obj_dump_KIND_LISPALLOC_core__LoadArchive_O
  /* 197 */ , &&obj_dump_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 198 */ , &&obj_dump_KIND_LISPALLOC_core__HashTable_O
  /* 199 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEq_O
  /* 200 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 201 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEql_O
  /* 202 */ , &&obj_dump_KIND_LISPALLOC_core__HashTableEqual_O
  /* 203 */ , &&obj_dump_KIND_LISPALLOC_cffi__Pointer_O
  /* 204 */ , &&obj_dump_KIND_LISPALLOC_core__CxxObject_O
  /* 205 */ , &&obj_dump_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 206 */ , &&obj_dump_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 207 */ , &&obj_dump_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 208 */ , &&obj_dump_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 209 */ , &&obj_dump_KIND_LISPALLOC_core__SNode_O
  /* 210 */ , &&obj_dump_KIND_LISPALLOC_core__LeafSNode_O
  /* 211 */ , &&obj_dump_KIND_LISPALLOC_core__BranchSNode_O
  /* 212 */ , &&obj_dump_KIND_LISPALLOC_core__Path_O
  /* 213 */ , &&obj_dump_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 214 */ , &&obj_dump_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 215 */ , &&obj_dump_KIND_LISPALLOC_core__StructureObject_O
  /* 216 */ , &&obj_dump_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 217 */ , &&obj_dump_KIND_LISPALLOC_core__Package_O
  /* 218 */ , &&obj_dump_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 219 */ , &&obj_dump_KIND_LISPALLOC_core__Character_dummy_O
  /* 220 */ , &&obj_dump_KIND_LISPALLOC_core__Function_O
  /* 221 */ , &&obj_dump_KIND_LISPALLOC_core__CompiledFunction_O
  /* 222 */ , &&obj_dump_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 223 */ , &&obj_dump_KIND_LISPALLOC_core__SpecialForm_O
  /* 224 */ , &&obj_dump_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 225 */ , &&obj_dump_KIND_LISPALLOC_core__Instance_O
  /* 226 */ , &&obj_dump_KIND_LISPALLOC_core__Pointer_O
  /* 227 */ , &&obj_dump_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 228 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 229 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 230 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIArray_O
  /* 231 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 232 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 233 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 234 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 235 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 236 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIType_O
  /* 237 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 238 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 239 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 240 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIFile_O
  /* 241 */ , &&obj_dump_KIND_LISPALLOC_llvmo__DIScope_O
  /* 242 */ , &&obj_dump_KIND_LISPALLOC_core__SmallMultimap_O
  /* 243 */ , &&obj_dump_KIND_LISPALLOC_core__Pathname_O
  /* 244 */ , &&obj_dump_KIND_LISPALLOC_core__LogicalPathname_O
  /* 245 */ , &&obj_dump_KIND_LISPALLOC_core__PosixTime_O
  /* 246 */ , &&obj_dump_KIND_LISPALLOC_core__SmallMap_O
  /* 247 */ , &&obj_dump_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_dump_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 249 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 250 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 251 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 252 */ , &&obj_dump_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 253 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 254 */ , &&obj_dump_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 255 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 256 */ , &&obj_dump_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 257 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 258 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 259 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 260 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 261 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 262 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 263 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 264 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 265 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 266 */ , &&obj_dump_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 267 */ , &&obj_dump_KIND_CLASSALLOC_core__MacroClosure
  /* 268 */ , &&obj_dump_KIND_CLASSALLOC_core__ConsStepper
  /* 269 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 270 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 271 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 272 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 273 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 274 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 275 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 276 */ , &&obj_dump_KIND_CLASSALLOC_core__InstanceClosure
  /* 277 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 278 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 279 */ , &&obj_dump_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 280 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 281 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 282 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 283 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 284 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__
  /* 285 */ , &&obj_dump_KIND_CLASSALLOC_core__CoreExposer
  /* 286 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 287 */ , &&obj_dump_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 288 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 289 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 290 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 291 */ , &&obj_dump_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 292 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 293 */ , &&obj_dump_KIND_CLASSALLOC_core__InterpretedClosure
  /* 294 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 295 */ , &&obj_dump_KIND_CLASSALLOC_core__VectorStepper
  /* 296 */ , &&obj_dump_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
static void* OBJ_SKIP_table[] = { NULL 
  ...
  /* 54 */ , &&obj_skip_KIND_LISPALLOC_core__String_O
  /* 55 */ , &&obj_skip_KIND_BOOTSTRAP_core__Str_O
  /* 56 */ , &&obj_skip_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 57 */ , &&obj_skip_KIND_LISPALLOC_core__VectorObjects_O
  /* 58 */ , &&obj_skip_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 59 */ , &&obj_skip_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 60 */ , &&obj_skip_KIND_LISPALLOC_core__RandomState_O
  /* 61 */ , &&obj_skip_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 62 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 63 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Attribute_O
  /* 64 */ , &&obj_skip_KIND_LISPALLOC_core__RegexMatch_O
  /* 65 */ , &&obj_skip_KIND_LISPALLOC_core__WeakPointer_O
  /* 66 */ , &&obj_skip_KIND_LISPALLOC_core__VaList_dummy_O
  /* 67 */ , &&obj_skip_KIND_BOOTSTRAP_core__StandardObject_O
  /* 68 */ , &&obj_skip_KIND_BOOTSTRAP_core__Metaobject_O
  /* 69 */ , &&obj_skip_KIND_BOOTSTRAP_core__Specializer_O
  /* 70 */ , &&obj_skip_KIND_BOOTSTRAP_core__Class_O
  /* 71 */ , &&obj_skip_KIND_BOOTSTRAP_core__StdClass_O
  /* 72 */ , &&obj_skip_KIND_BOOTSTRAP_core__StandardClass_O
  /* 73 */ , &&obj_skip_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 74 */ , &&obj_skip_KIND_BOOTSTRAP_core__StructureClass_O
  /* 75 */ , &&obj_skip_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 76 */ , &&obj_skip_KIND_LISPALLOC_core__CxxClass_O
  /* 77 */ , &&obj_skip_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 78 */ , &&obj_skip_KIND_LISPALLOC_clbind__ClassRep_O
  /* 79 */ , &&obj_skip_KIND_LISPALLOC_core__ExternalObject_O
  /* 80 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Value_O
  /* 81 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Argument_O
  /* 82 */ , &&obj_skip_KIND_LISPALLOC_llvmo__User_O
  /* 83 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Instruction_O
  /* 84 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 85 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 86 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PHINode_O
  /* 87 */ , &&obj_skip_KIND_LISPALLOC_llvmo__CallInst_O
  /* 88 */ , &&obj_skip_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 89 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 90 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 91 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 92 */ , &&obj_skip_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 93 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 94 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 95 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 96 */ , &&obj_skip_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 97 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 98 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 99 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 100 */ , &&obj_skip_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 101 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 102 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 103 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Constant_O
  /* 104 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 105 */ , &&obj_skip_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 106 */ , &&obj_skip_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 107 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Function_O
  /* 108 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 109 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 110 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 111 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 112 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 113 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 114 */ , &&obj_skip_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 115 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 116 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 117 */ , &&obj_skip_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 118 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 119 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 120 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 121 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Metadata_O
  /* 122 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 123 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MDNode_O
  /* 124 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MDString_O
  /* 125 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 126 */ , &&obj_skip_KIND_LISPALLOC_llvmo__APFloat_O
  /* 127 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 128 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 129 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Triple_O
  /* 130 */ , &&obj_skip_KIND_LISPALLOC_llvmo__APInt_O
  /* 131 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 132 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 133 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PassManager_O
  /* 134 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 135 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 136 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 137 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Type_O
  /* 138 */ , &&obj_skip_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 139 */ , &&obj_skip_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 140 */ , &&obj_skip_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 141 */ , &&obj_skip_KIND_LISPALLOC_llvmo__VectorType_O
  /* 142 */ , &&obj_skip_KIND_LISPALLOC_llvmo__PointerType_O
  /* 143 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 144 */ , &&obj_skip_KIND_LISPALLOC_llvmo__StructType_O
  /* 145 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 146 */ , &&obj_skip_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 147 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Linker_O
  /* 148 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Pass_O
  /* 149 */ , &&obj_skip_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 150 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 151 */ , &&obj_skip_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 152 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 153 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 154 */ , &&obj_skip_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 155 */ , &&obj_skip_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 156 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Module_O
  /* 157 */ , &&obj_skip_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 158 */ , &&obj_skip_KIND_LISPALLOC_core__ForeignData_O
  /* 159 */ , &&obj_skip_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 160 */ , &&obj_skip_KIND_LISPALLOC_llvmo__Target_O
  /* 161 */ , &&obj_skip_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 162 */ , &&obj_skip_KIND_LISPALLOC_core__Binder_O
  /* 163 */ , &&obj_skip_KIND_LISPALLOC_core__IntArray_O
  /* 164 */ , &&obj_skip_KIND_LISPALLOC_core__SourceManager_O
  /* 165 */ , &&obj_skip_KIND_LISPALLOC_core__Record_O
  /* 166 */ , &&obj_skip_KIND_LISPALLOC_core__LightUserData_O
  /* 167 */ , &&obj_skip_KIND_LISPALLOC_core__UserData_O
  /* 168 */ , &&obj_skip_KIND_BOOTSTRAP_core__Symbol_O
  /* 169 */ , &&obj_skip_KIND_LISPALLOC_core__Null_O
  /* 170 */ , &&obj_skip_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 171 */ , &&obj_skip_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 172 */ , &&obj_skip_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 173 */ , &&obj_skip_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 174 */ , &&obj_skip_KIND_LISPALLOC_core__Regex_O
  /* 175 */ , &&obj_skip_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 176 */ , &&obj_skip_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 177 */ , &&obj_skip_KIND_LISPALLOC_core__CandoException_O
  /* 178 */ , &&obj_skip_KIND_LISPALLOC_core__Stream_O
  /* 179 */ , &&obj_skip_KIND_LISPALLOC_core__AnsiStream_O
  /* 180 */ , &&obj_skip_KIND_LISPALLOC_core__FileStream_O
  /* 181 */ , &&obj_skip_KIND_LISPALLOC_core__IOStreamStream_O
  /* 182 */ , &&obj_skip_KIND_LISPALLOC_core__IOFileStream_O
  /* 183 */ , &&obj_skip_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 184 */ , &&obj_skip_KIND_LISPALLOC_core__StringStream_O
  /* 185 */ , &&obj_skip_KIND_LISPALLOC_core__StringInputStream_O
  /* 186 */ , &&obj_skip_KIND_LISPALLOC_core__StringOutputStream_O
  /* 187 */ , &&obj_skip_KIND_LISPALLOC_core__SynonymStream_O
  /* 188 */ , &&obj_skip_KIND_LISPALLOC_core__EchoStream_O
  /* 189 */ , &&obj_skip_KIND_LISPALLOC_core__TwoWayStream_O
  /* 190 */ , &&obj_skip_KIND_LISPALLOC_core__BroadcastStream_O
  /* 191 */ , &&obj_skip_KIND_LISPALLOC_core__Reader_O
  /* 192 */ , &&obj_skip_KIND_LISPALLOC_core__Cons_O
  /* 193 */ , &&obj_skip_KIND_LISPALLOC_core__Archive_O
  /* 194 */ , &&obj_skip_KIND_LISPALLOC_core__SaveArchive_O
  /* 195 */ , &&obj_skip_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 196 */ , &&obj_skip_KIND_LISPALLOC_core__LoadArchive_O
  /* 197 */ , &&obj_skip_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 198 */ , &&obj_skip_KIND_LISPALLOC_core__HashTable_O
  /* 199 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEq_O
  /* 200 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 201 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEql_O
  /* 202 */ , &&obj_skip_KIND_LISPALLOC_core__HashTableEqual_O
  /* 203 */ , &&obj_skip_KIND_LISPALLOC_cffi__Pointer_O
  /* 204 */ , &&obj_skip_KIND_LISPALLOC_core__CxxObject_O
  /* 205 */ , &&obj_skip_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 206 */ , &&obj_skip_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 207 */ , &&obj_skip_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 208 */ , &&obj_skip_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 209 */ , &&obj_skip_KIND_LISPALLOC_core__SNode_O
  /* 210 */ , &&obj_skip_KIND_LISPALLOC_core__LeafSNode_O
  /* 211 */ , &&obj_skip_KIND_LISPALLOC_core__BranchSNode_O
  /* 212 */ , &&obj_skip_KIND_LISPALLOC_core__Path_O
  /* 213 */ , &&obj_skip_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 214 */ , &&obj_skip_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 215 */ , &&obj_skip_KIND_LISPALLOC_core__StructureObject_O
  /* 216 */ , &&obj_skip_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 217 */ , &&obj_skip_KIND_LISPALLOC_core__Package_O
  /* 218 */ , &&obj_skip_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 219 */ , &&obj_skip_KIND_LISPALLOC_core__Character_dummy_O
  /* 220 */ , &&obj_skip_KIND_LISPALLOC_core__Function_O
  /* 221 */ , &&obj_skip_KIND_LISPALLOC_core__CompiledFunction_O
  /* 222 */ , &&obj_skip_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 223 */ , &&obj_skip_KIND_LISPALLOC_core__SpecialForm_O
  /* 224 */ , &&obj_skip_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 225 */ , &&obj_skip_KIND_LISPALLOC_core__Instance_O
  /* 226 */ , &&obj_skip_KIND_LISPALLOC_core__Pointer_O
  /* 227 */ , &&obj_skip_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 228 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 229 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 230 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIArray_O
  /* 231 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 232 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 233 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 234 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 235 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 236 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIType_O
  /* 237 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 238 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 239 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 240 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIFile_O
  /* 241 */ , &&obj_skip_KIND_LISPALLOC_llvmo__DIScope_O
  /* 242 */ , &&obj_skip_KIND_LISPALLOC_core__SmallMultimap_O
  /* 243 */ , &&obj_skip_KIND_LISPALLOC_core__Pathname_O
  /* 244 */ , &&obj_skip_KIND_LISPALLOC_core__LogicalPathname_O
  /* 245 */ , &&obj_skip_KIND_LISPALLOC_core__PosixTime_O
  /* 246 */ , &&obj_skip_KIND_LISPALLOC_core__SmallMap_O
  /* 247 */ , &&obj_skip_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_skip_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 249 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 250 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 251 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 252 */ , &&obj_skip_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 253 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 254 */ , &&obj_skip_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 255 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 256 */ , &&obj_skip_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 257 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 258 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 259 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 260 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 261 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 262 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 263 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 264 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 265 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 266 */ , &&obj_skip_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 267 */ , &&obj_skip_KIND_CLASSALLOC_core__MacroClosure
  /* 268 */ , &&obj_skip_KIND_CLASSALLOC_core__ConsStepper
  /* 269 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 270 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 271 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 272 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 273 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 274 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 275 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 276 */ , &&obj_skip_KIND_CLASSALLOC_core__InstanceClosure
  /* 277 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 278 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 279 */ , &&obj_skip_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 280 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 281 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 282 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 283 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 284 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__
  /* 285 */ , &&obj_skip_KIND_CLASSALLOC_core__CoreExposer
  /* 286 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 287 */ , &&obj_skip_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 288 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 289 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 290 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 291 */ , &&obj_skip_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 292 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 293 */ , &&obj_skip_KIND_CLASSALLOC_core__InterpretedClosure
  /* 294 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 295 */ , &&obj_skip_KIND_CLASSALLOC_core__VectorStepper
  /* 296 */ , &&obj_skip_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
#endif // defined(GC_OBJ_SKIP_TABLE)
#if defined(GC_OBJ_SCAN)
obj_scan_KIND_ROOTCLASSALLOC_asttooling__RegMap__RegistryMaps:
{
  mps_res_t result = obj_scan_helper<asttooling::RegMap::RegistryMaps>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_ROOTCLASSALLOC_clbind__detail__class_map:
{
  mps_res_t result = obj_scan_helper<clbind::detail::class_map>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<clbind::DummyCreator>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_CLASSALLOC_core__InstanceCreator:
{
  mps_res_t result = obj_scan_helper<core::InstanceCreator>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::T_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__MultiStringBuffer_O:
{
  mps_res_t result = obj_scan_helper<core::MultiStringBuffer_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ReadTable_O:
{
  mps_res_t result = obj_scan_helper<core::ReadTable_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Number_O:
{
  mps_res_t result = obj_scan_helper<core::Number_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Complex_O:
{
  mps_res_t result = obj_scan_helper<core::Complex_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Real_O:
{
  mps_res_t result = obj_scan_helper<core::Real_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Rational_O:
{
  mps_res_t result = obj_scan_helper<core::Rational_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Integer_O:
{
  mps_res_t result = obj_scan_helper<core::Integer_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Bignum_O:
{
  mps_res_t result = obj_scan_helper<core::Bignum_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Fixnum_dummy_O:
{
  mps_res_t result = obj_scan_helper<core::Fixnum_dummy_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Ratio_O:
{
  mps_res_t result = obj_scan_helper<core::Ratio_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Float_O:
{
  mps_res_t result = obj_scan_helper<core::Float_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__DoubleFloat_O:
{
  mps_res_t result = obj_scan_helper<core::DoubleFloat_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LongFloat_O:
{
  mps_res_t result = obj_scan_helper<core::LongFloat_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SingleFloat_dummy_O:
{
  mps_res_t result = obj_scan_helper<core::SingleFloat_dummy_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ShortFloat_O:
{
  mps_res_t result = obj_scan_helper<core::ShortFloat_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__FileStatus_O:
{
  mps_res_t result = obj_scan_helper<core::FileStatus_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__WeakHashTable_O:
{
  mps_res_t result = obj_scan_helper<core::WeakHashTable_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__WeakKeyHashTable_O:
{
  mps_res_t result = obj_scan_helper<core::WeakKeyHashTable_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Environment_O:
{
  mps_res_t result = obj_scan_helper<core::Environment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ActivationFrame_O:
{
  mps_res_t result = obj_scan_helper<core::ActivationFrame_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__TagbodyFrame_O:
{
  mps_res_t result = obj_scan_helper<core::TagbodyFrame_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ValueFrame_O:
{
  mps_res_t result = obj_scan_helper<core::ValueFrame_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__FunctionFrame_O:
{
  mps_res_t result = obj_scan_helper<core::FunctionFrame_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LexicalEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::LexicalEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__RuntimeVisibleEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::RuntimeVisibleEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__FunctionValueEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::FunctionValueEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ValueEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::ValueEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__TagbodyEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::TagbodyEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__CompileTimeEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::CompileTimeEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__UnwindProtectEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::UnwindProtectEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SymbolMacroletEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::SymbolMacroletEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__FunctionContainerEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::FunctionContainerEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__StackValueEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::StackValueEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__BlockEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::BlockEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__MacroletEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::MacroletEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__CatchEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::CatchEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__GlueEnvironment_O:
{
  mps_res_t result = obj_scan_helper<core::GlueEnvironment_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Array_O:
{
  mps_res_t result = obj_scan_helper<core::Array_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ArrayObjects_O:
{
  mps_res_t result = obj_scan_helper<core::ArrayObjects_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ArrayDisplaced_O:
{
  mps_res_t result = obj_scan_helper<core::ArrayDisplaced_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Vector_O:
{
  mps_res_t result = obj_scan_helper<core::Vector_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__BitVector_O:
{
  mps_res_t result = obj_scan_helper<core::BitVector_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SimpleBitVector_O:
{
  mps_res_t result = obj_scan_helper<core::SimpleBitVector_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__String_O:
{
  mps_res_t result = obj_scan_helper<core::String_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__Str_O:
{
  mps_res_t result = obj_scan_helper<core::Str_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__StrWithFillPtr_O:
{
  mps_res_t result = obj_scan_helper<core::StrWithFillPtr_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__VectorObjects_O:
{
  mps_res_t result = obj_scan_helper<core::VectorObjects_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O:
{
  mps_res_t result = obj_scan_helper<core::VectorObjectsWithFillPtr_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SingleDispatchMethod_O:
{
  mps_res_t result = obj_scan_helper<core::SingleDispatchMethod_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__RandomState_O:
{
  mps_res_t result = obj_scan_helper<core::RandomState_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<llvmo::DebugLoc_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Attribute_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Attribute_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__RegexMatch_O:
{
  mps_res_t result = obj_scan_helper<core::RegexMatch_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__WeakPointer_O:
{
  mps_res_t result = obj_scan_helper<core::WeakPointer_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__VaList_dummy_O:
{
  mps_res_t result = obj_scan_helper<core::VaList_dummy_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__StandardObject_O:
{
  mps_res_t result = obj_scan_helper<core::StandardObject_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__Metaobject_O:
{
  mps_res_t result = obj_scan_helper<core::Metaobject_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__Specializer_O:
{
  mps_res_t result = obj_scan_helper<core::Specializer_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__Class_O:
{
  mps_res_t result = obj_scan_helper<core::Class_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__StdClass_O:
{
  mps_res_t result = obj_scan_helper<core::StdClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__StandardClass_O:
{
  mps_res_t result = obj_scan_helper<core::StandardClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__FuncallableStandardClass_O:
{
  mps_res_t result = obj_scan_helper<core::FuncallableStandardClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__StructureClass_O:
{
  mps_res_t result = obj_scan_helper<core::StructureClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ForwardReferencedClass_O:
{
  mps_res_t result = obj_scan_helper<core::ForwardReferencedClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__CxxClass_O:
{
  mps_res_t result = obj_scan_helper<core::CxxClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__BuiltInClass_O:
{
  mps_res_t result = obj_scan_helper<core::BuiltInClass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_clbind__ClassRep_O:
{
  mps_res_t result = obj_scan_helper<clbind::ClassRep_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ExternalObject_O:
{
  mps_res_t result = obj_scan_helper<core::ExternalObject_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Value_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Value_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Argument_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Argument_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__User_O:
{
  mps_res_t result = obj_scan_helper<llvmo::User_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Instruction_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Instruction_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__AtomicRMWInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::AtomicRMWInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__LandingPadInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::LandingPadInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__PHINode_O:
{
  mps_res_t result = obj_scan_helper<llvmo::PHINode_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__CallInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::CallInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__StoreInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::StoreInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__UnaryInstruction_O:
{
  mps_res_t result = obj_scan_helper<llvmo::UnaryInstruction_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__LoadInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::LoadInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__AllocaInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::AllocaInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__VAArgInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::VAArgInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::AtomicCmpXchgInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__TerminatorInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::TerminatorInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__UnreachableInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::UnreachableInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__SwitchInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::SwitchInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ReturnInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ReturnInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ResumeInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ResumeInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__BranchInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::BranchInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__InvokeInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::InvokeInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__IndirectBrInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::IndirectBrInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__FenceInst_O:
{
  mps_res_t result = obj_scan_helper<llvmo::FenceInst_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Constant_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Constant_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__BlockAddress_O:
{
  mps_res_t result = obj_scan_helper<llvmo::BlockAddress_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__GlobalValue_O:
{
  mps_res_t result = obj_scan_helper<llvmo::GlobalValue_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__GlobalVariable_O:
{
  mps_res_t result = obj_scan_helper<llvmo::GlobalVariable_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Function_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Function_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantArray_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantArray_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantInt_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantInt_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantDataSequential_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantDataSequential_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantDataArray_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantDataArray_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantStruct_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantStruct_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantFP_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantFP_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__UndefValue_O:
{
  mps_res_t result = obj_scan_helper<llvmo::UndefValue_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantPointerNull_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantPointerNull_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ConstantExpr_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ConstantExpr_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__BasicBlock_O:
{
  mps_res_t result = obj_scan_helper<llvmo::BasicBlock_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__IRBuilderBase_O:
{
  mps_res_t result = obj_scan_helper<llvmo::IRBuilderBase_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__IRBuilder_O:
{
  mps_res_t result = obj_scan_helper<llvmo::IRBuilder_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIBuilder_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIBuilder_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Metadata_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Metadata_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ValueAsMetadata_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ValueAsMetadata_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__MDNode_O:
{
  mps_res_t result = obj_scan_helper<llvmo::MDNode_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__MDString_O:
{
  mps_res_t result = obj_scan_helper<llvmo::MDString_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ExecutionEngine_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ExecutionEngine_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__APFloat_O:
{
  mps_res_t result = obj_scan_helper<llvmo::APFloat_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__PassManagerBuilder_O:
{
  mps_res_t result = obj_scan_helper<llvmo::PassManagerBuilder_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DataLayout_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DataLayout_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Triple_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Triple_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__APInt_O:
{
  mps_res_t result = obj_scan_helper<llvmo::APInt_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__PassManagerBase_O:
{
  mps_res_t result = obj_scan_helper<llvmo::PassManagerBase_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__FunctionPassManager_O:
{
  mps_res_t result = obj_scan_helper<llvmo::FunctionPassManager_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__PassManager_O:
{
  mps_res_t result = obj_scan_helper<llvmo::PassManager_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__TargetMachine_O:
{
  mps_res_t result = obj_scan_helper<llvmo::TargetMachine_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O:
{
  mps_res_t result = obj_scan_helper<llvmo::LLVMTargetMachine_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__TargetOptions_O:
{
  mps_res_t result = obj_scan_helper<llvmo::TargetOptions_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Type_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Type_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__IntegerType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::IntegerType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__CompositeType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::CompositeType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__SequentialType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::SequentialType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__VectorType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::VectorType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__PointerType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::PointerType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ArrayType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ArrayType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__StructType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::StructType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__FunctionType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::FunctionType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__NamedMDNode_O:
{
  mps_res_t result = obj_scan_helper<llvmo::NamedMDNode_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Linker_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Linker_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Pass_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Pass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__FunctionPass_O:
{
  mps_res_t result = obj_scan_helper<llvmo::FunctionPass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ModulePass_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ModulePass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__ImmutablePass_O:
{
  mps_res_t result = obj_scan_helper<llvmo::ImmutablePass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DataLayoutPass_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DataLayoutPass_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O:
{
  mps_res_t result = obj_scan_helper<llvmo::TargetLibraryInfo_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O:
{
  mps_res_t result = obj_scan_helper<llvmo::MCSubtargetInfo_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O:
{
  mps_res_t result = obj_scan_helper<llvmo::TargetSubtargetInfo_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Module_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Module_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__EngineBuilder_O:
{
  mps_res_t result = obj_scan_helper<llvmo::EngineBuilder_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ForeignData_O:
{
  mps_res_t result = obj_scan_helper<core::ForeignData_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__LLVMContext_O:
{
  mps_res_t result = obj_scan_helper<llvmo::LLVMContext_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__Target_O:
{
  mps_res_t result = obj_scan_helper<llvmo::Target_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LoadTimeValues_O:
{
  mps_res_t result = obj_scan_helper<core::LoadTimeValues_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Binder_O:
{
  mps_res_t result = obj_scan_helper<core::Binder_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__IntArray_O:
{
  mps_res_t result = obj_scan_helper<core::IntArray_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SourceManager_O:
{
  mps_res_t result = obj_scan_helper<core::SourceManager_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Record_O:
{
  mps_res_t result = obj_scan_helper<core::Record_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LightUserData_O:
{
  mps_res_t result = obj_scan_helper<core::LightUserData_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__UserData_O:
{
  mps_res_t result = obj_scan_helper<core::UserData_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_BOOTSTRAP_core__Symbol_O:
{
  mps_res_t result = obj_scan_helper<core::Symbol_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Null_O:
{
  mps_res_t result = obj_scan_helper<core::Null_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SourcePosInfo_O:
{
  mps_res_t result = obj_scan_helper<core::SourcePosInfo_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::DirectoryIterator_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O:
{
  mps_res_t result = obj_scan_helper<core::RecursiveDirectoryIterator_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Regex_O:
{
  mps_res_t result = obj_scan_helper<core::Regex_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__PosixTimeDuration_O:
{
  mps_res_t result = obj_scan_helper<core::PosixTimeDuration_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SymbolToEnumConverter_O:
{
  mps_res_t result = obj_scan_helper<core::SymbolToEnumConverter_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__CandoException_O:
{
  mps_res_t result = obj_scan_helper<core::CandoException_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Stream_O:
{
  mps_res_t result = obj_scan_helper<core::Stream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__AnsiStream_O:
{
  mps_res_t result = obj_scan_helper<core::AnsiStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__FileStream_O:
{
  mps_res_t result = obj_scan_helper<core::FileStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__IOStreamStream_O:
{
  mps_res_t result = obj_scan_helper<core::IOStreamStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__IOFileStream_O:
{
  mps_res_t result = obj_scan_helper<core::IOFileStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__ConcatenatedStream_O:
{
  mps_res_t result = obj_scan_helper<core::ConcatenatedStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__StringStream_O:
{
  mps_res_t result = obj_scan_helper<core::StringStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__StringInputStream_O:
{
  mps_res_t result = obj_scan_helper<core::StringInputStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__StringOutputStream_O:
{
  mps_res_t result = obj_scan_helper<core::StringOutputStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SynonymStream_O:
{
  mps_res_t result = obj_scan_helper<core::SynonymStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__EchoStream_O:
{
  mps_res_t result = obj_scan_helper<core::EchoStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__TwoWayStream_O:
{
  mps_res_t result = obj_scan_helper<core::TwoWayStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__BroadcastStream_O:
{
  mps_res_t result = obj_scan_helper<core::BroadcastStream_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Reader_O:
{
  mps_res_t result = obj_scan_helper<core::Reader_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Cons_O:
{
  mps_res_t result = obj_scan_helper<core::Cons_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Archive_O:
{
  mps_res_t result = obj_scan_helper<core::Archive_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SaveArchive_O:
{
  mps_res_t result = obj_scan_helper<core::SaveArchive_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SexpSaveArchive_O:
{
  mps_res_t result = obj_scan_helper<core::SexpSaveArchive_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LoadArchive_O:
{
  mps_res_t result = obj_scan_helper<core::LoadArchive_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SexpLoadArchive_O:
{
  mps_res_t result = obj_scan_helper<core::SexpLoadArchive_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__HashTable_O:
{
  mps_res_t result = obj_scan_helper<core::HashTable_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__HashTableEq_O:
{
  mps_res_t result = obj_scan_helper<core::HashTableEq_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__HashTableEqualp_O:
{
  mps_res_t result = obj_scan_helper<core::HashTableEqualp_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__HashTableEql_O:
{
  mps_res_t result = obj_scan_helper<core::HashTableEql_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__HashTableEqual_O:
{
  mps_res_t result = obj_scan_helper<core::HashTableEqual_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_cffi__Pointer_O:
{
  mps_res_t result = obj_scan_helper<cffi::Pointer_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__CxxObject_O:
{
  mps_res_t result = obj_scan_helper<core::CxxObject_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__WeakKeyMapping_O:
{
  mps_res_t result = obj_scan_helper<core::WeakKeyMapping_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LambdaListHandler_O:
{
  mps_res_t result = obj_scan_helper<core::LambdaListHandler_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__InsertPoint_O:
{
  mps_res_t result = obj_scan_helper<llvmo::InsertPoint_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SourceFileInfo_O:
{
  mps_res_t result = obj_scan_helper<core::SourceFileInfo_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SNode_O:
{
  mps_res_t result = obj_scan_helper<core::SNode_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LeafSNode_O:
{
  mps_res_t result = obj_scan_helper<core::LeafSNode_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__BranchSNode_O:
{
  mps_res_t result = obj_scan_helper<core::BranchSNode_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Path_O:
{
  mps_res_t result = obj_scan_helper<core::Path_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_asttooling__AstVisitor_O:
{
  mps_res_t result = obj_scan_helper<asttooling::AstVisitor_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__AttributeSet_O:
{
  mps_res_t result = obj_scan_helper<llvmo::AttributeSet_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__StructureObject_O:
{
  mps_res_t result = obj_scan_helper<core::StructureObject_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O:
{
  mps_res_t result = obj_scan_helper<core::InvocationHistoryFrameIterator_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Package_O:
{
  mps_res_t result = obj_scan_helper<core::Package_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__DirectoryEntry_O:
{
  mps_res_t result = obj_scan_helper<core::DirectoryEntry_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Character_dummy_O:
{
  mps_res_t result = obj_scan_helper<core::Character_dummy_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Function_O:
{
  mps_res_t result = obj_scan_helper<core::Function_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__CompiledFunction_O:
{
  mps_res_t result = obj_scan_helper<core::CompiledFunction_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O:
{
  mps_res_t result = obj_scan_helper<core::SingleDispatchGenericFunction_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SpecialForm_O:
{
  mps_res_t result = obj_scan_helper<core::SpecialForm_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O:
{
  mps_res_t result = obj_scan_helper<core::SingleDispatchEffectiveMethodFunction_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Instance_O:
{
  mps_res_t result = obj_scan_helper<core::Instance_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Pointer_O:
{
  mps_res_t result = obj_scan_helper<core::Pointer_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_clbind__ClassRegistry_O:
{
  mps_res_t result = obj_scan_helper<clbind::ClassRegistry_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DebugInfo_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DebugInfo_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIDerivedType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIDerivedType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIArray_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIArray_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIBasicType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIBasicType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DISubprogram_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DISubprogram_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DILexicalBlock_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DILexicalBlock_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DICompileUnit_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DICompileUnit_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIDescriptor_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIDescriptor_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DISubroutineType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DISubroutineType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DICompositeType_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DICompositeType_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DITypeArray_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DITypeArray_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIFile_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIFile_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_llvmo__DIScope_O:
{
  mps_res_t result = obj_scan_helper<llvmo::DIScope_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SmallMultimap_O:
{
  mps_res_t result = obj_scan_helper<core::SmallMultimap_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__Pathname_O:
{
  mps_res_t result = obj_scan_helper<core::Pathname_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__LogicalPathname_O:
{
  mps_res_t result = obj_scan_helper<core::LogicalPathname_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__PosixTime_O:
{
  mps_res_t result = obj_scan_helper<core::PosixTime_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_LISPALLOC_core__SmallMap_O:
{
  mps_res_t result = obj_scan_helper<core::SmallMap_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_CLASSALLOC_core__Cache:
{
  mps_res_t result = obj_scan_helper<core::Cache>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_ROOTCLASSALLOC_core__Lisp_O:
{
  mps_res_t result = obj_scan_helper<core::Lisp_O>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::SingleDispatchGenericFunctionClosure>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<llvmo::CompiledClosure>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::internal::VariadicOperatorMatcherDescriptor>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::internal::OverloadedMatcherDescriptor>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::internal::FixedArgCountMatcherDescriptor>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::internal::FreeFuncMatcherDescriptor>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_CLASSALLOC_core__MacroClosure:
{
  mps_res_t result = obj_scan_helper<core::MacroClosure>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
obj_scan_KIND_CLASSALLOC_core__ConsStepper:
{
  mps_res_t result = obj_scan_helper<core::ConsStepper>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::InstanceClosure>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::DerivableFrontendActionFactory>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::DerivableMatchCallback>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::DerivableASTFrontendAction>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::CoreExposer>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<asttooling::DerivableSyntaxOnlyAction>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::InterpretedClosure>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
{
  mps_res_t result = obj_scan_helper<core::VectorStepper>(_ss,_mps_zs,_mps_w,_mps_ufs,_mps_wt,client);
  if ( result != MPS_RES_OK ) return result;
}
goto TOP;
...
template <>
 mps_res_t obj_scan_helper<asttooling::RegMap::RegistryMaps>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<clbind::detail::class_map>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<clbind::DummyCreator>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef clbind::DummyCreator type_KIND_CLASSALLOC_clbind__DummyCreator;
    client = (char*)client + AlignUp(sizeof(type_KIND_CLASSALLOC_clbind__DummyCreator)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::InstanceCreator>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::T_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::T_O type_KIND_BOOTSTRAP_core__T_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_BOOTSTRAP_core__T_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::MultiStringBuffer_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::MultiStringBuffer_O type_KIND_LISPALLOC_core__MultiStringBuffer_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__MultiStringBuffer_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::ReadTable_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Number_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Number_O type_KIND_LISPALLOC_core__Number_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Number_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Complex_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Real_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Real_O type_KIND_LISPALLOC_core__Real_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Real_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Rational_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Rational_O type_KIND_LISPALLOC_core__Rational_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Rational_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Integer_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Integer_O type_KIND_LISPALLOC_core__Integer_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Integer_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Bignum_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Bignum_O type_KIND_LISPALLOC_core__Bignum_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Bignum_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Fixnum_dummy_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Fixnum_dummy_O type_KIND_LISPALLOC_core__Fixnum_dummy_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Fixnum_dummy_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Ratio_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Float_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Float_O type_KIND_LISPALLOC_core__Float_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Float_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::DoubleFloat_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::DoubleFloat_O type_KIND_LISPALLOC_core__DoubleFloat_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__DoubleFloat_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::LongFloat_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::LongFloat_O type_KIND_LISPALLOC_core__LongFloat_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__LongFloat_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SingleFloat_dummy_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::SingleFloat_dummy_O type_KIND_LISPALLOC_core__SingleFloat_dummy_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__SingleFloat_dummy_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::ShortFloat_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::ShortFloat_O type_KIND_LISPALLOC_core__ShortFloat_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__ShortFloat_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::FileStatus_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::FileStatus_O type_KIND_LISPALLOC_core__FileStatus_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__FileStatus_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::WeakHashTable_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::WeakHashTable_O type_KIND_LISPALLOC_core__WeakHashTable_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__WeakHashTable_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::WeakKeyHashTable_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Environment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Environment_O type_KIND_LISPALLOC_core__Environment_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Environment_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::ActivationFrame_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::ActivationFrame_O type_KIND_LISPALLOC_core__ActivationFrame_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__ActivationFrame_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::TagbodyFrame_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ValueFrame_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::FunctionFrame_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::LexicalEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::RuntimeVisibleEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::FunctionValueEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ValueEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::TagbodyEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::CompileTimeEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::UnwindProtectEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SymbolMacroletEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::FunctionContainerEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StackValueEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::BlockEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::MacroletEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::CatchEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::GlueEnvironment_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Array_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Array_O type_KIND_LISPALLOC_core__Array_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Array_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::ArrayObjects_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ArrayDisplaced_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Vector_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Vector_O type_KIND_LISPALLOC_core__Vector_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Vector_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::BitVector_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::BitVector_O type_KIND_LISPALLOC_core__BitVector_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__BitVector_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SimpleBitVector_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::SimpleBitVector_O type_KIND_LISPALLOC_core__SimpleBitVector_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__SimpleBitVector_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::String_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::String_O type_KIND_LISPALLOC_core__String_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__String_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Str_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StrWithFillPtr_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::VectorObjects_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::VectorObjectsWithFillPtr_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SingleDispatchMethod_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::RandomState_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::RandomState_O type_KIND_LISPALLOC_core__RandomState_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__RandomState_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DebugLoc_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DebugLoc_O type_KIND_LISPALLOC_llvmo__DebugLoc_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DebugLoc_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::Attribute_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::Attribute_O type_KIND_LISPALLOC_llvmo__Attribute_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__Attribute_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::RegexMatch_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::RegexMatch_O type_KIND_LISPALLOC_core__RegexMatch_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__RegexMatch_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::WeakPointer_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::VaList_dummy_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::VaList_dummy_O type_KIND_LISPALLOC_core__VaList_dummy_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__VaList_dummy_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::StandardObject_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::StandardObject_O type_KIND_BOOTSTRAP_core__StandardObject_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_BOOTSTRAP_core__StandardObject_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Metaobject_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Metaobject_O type_KIND_BOOTSTRAP_core__Metaobject_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_BOOTSTRAP_core__Metaobject_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Specializer_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Specializer_O type_KIND_BOOTSTRAP_core__Specializer_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_BOOTSTRAP_core__Specializer_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Class_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StdClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StandardClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::FuncallableStandardClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StructureClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ForwardReferencedClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::CxxClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::BuiltInClass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<clbind::ClassRep_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ExternalObject_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Value_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Argument_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::User_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Instruction_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::AtomicRMWInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::LandingPadInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::PHINode_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::CallInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::StoreInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::UnaryInstruction_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::LoadInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::AllocaInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::VAArgInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::AtomicCmpXchgInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::TerminatorInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::UnreachableInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::SwitchInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ReturnInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ResumeInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::BranchInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::InvokeInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::IndirectBrInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::FenceInst_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Constant_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::BlockAddress_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::GlobalValue_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::GlobalVariable_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Function_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantArray_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantInt_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantDataSequential_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantDataArray_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantStruct_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantFP_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::UndefValue_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantPointerNull_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ConstantExpr_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::BasicBlock_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::IRBuilderBase_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::IRBuilder_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIBuilder_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Metadata_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ValueAsMetadata_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::MDNode_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::MDString_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ExecutionEngine_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::APFloat_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::PassManagerBuilder_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::DataLayout_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Triple_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::APInt_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::PassManagerBase_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::FunctionPassManager_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::PassManager_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::TargetMachine_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::LLVMTargetMachine_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::TargetOptions_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Type_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::IntegerType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::CompositeType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::SequentialType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::VectorType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::PointerType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ArrayType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::StructType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::FunctionType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::NamedMDNode_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Linker_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Pass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::FunctionPass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ModulePass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::ImmutablePass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::DataLayoutPass_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::TargetLibraryInfo_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::MCSubtargetInfo_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::TargetSubtargetInfo_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Module_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::EngineBuilder_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ForeignData_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::LLVMContext_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::Target_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::LoadTimeValues_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Binder_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::IntArray_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::IntArray_O type_KIND_LISPALLOC_core__IntArray_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__IntArray_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SourceManager_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Record_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::LightUserData_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::LightUserData_O type_KIND_LISPALLOC_core__LightUserData_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__LightUserData_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::UserData_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::UserData_O type_KIND_LISPALLOC_core__UserData_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__UserData_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Symbol_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Null_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SourcePosInfo_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::SourcePosInfo_O type_KIND_LISPALLOC_core__SourcePosInfo_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__SourcePosInfo_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::DirectoryIterator_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::RecursiveDirectoryIterator_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Regex_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Regex_O type_KIND_LISPALLOC_core__Regex_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Regex_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::PosixTimeDuration_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::PosixTimeDuration_O type_KIND_LISPALLOC_core__PosixTimeDuration_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__PosixTimeDuration_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SymbolToEnumConverter_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::CandoException_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Stream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::AnsiStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::FileStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::IOStreamStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::IOFileStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ConcatenatedStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StringStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StringInputStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::StringOutputStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SynonymStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::EchoStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::TwoWayStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::BroadcastStream_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Reader_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Cons_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Archive_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SaveArchive_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SexpSaveArchive_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::LoadArchive_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SexpLoadArchive_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::HashTable_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::HashTableEq_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::HashTableEqualp_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::HashTableEql_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::HashTableEqual_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<cffi::Pointer_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef cffi::Pointer_O type_KIND_LISPALLOC_cffi__Pointer_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_cffi__Pointer_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::CxxObject_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::CxxObject_O type_KIND_LISPALLOC_core__CxxObject_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__CxxObject_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::WeakKeyMapping_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::LambdaListHandler_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::InsertPoint_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::InsertPoint_O type_KIND_LISPALLOC_llvmo__InsertPoint_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__InsertPoint_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SourceFileInfo_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SNode_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::SNode_O type_KIND_LISPALLOC_core__SNode_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__SNode_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::LeafSNode_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::BranchSNode_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Path_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Path_O type_KIND_LISPALLOC_core__Path_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Path_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<asttooling::AstVisitor_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::AttributeSet_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::AttributeSet_O type_KIND_LISPALLOC_llvmo__AttributeSet_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__AttributeSet_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::StructureObject_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::InvocationHistoryFrameIterator_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::InvocationHistoryFrameIterator_O type_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Package_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::DirectoryEntry_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::DirectoryEntry_O type_KIND_LISPALLOC_core__DirectoryEntry_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__DirectoryEntry_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Character_dummy_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Character_dummy_O type_KIND_LISPALLOC_core__Character_dummy_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Character_dummy_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::Function_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::CompiledFunction_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SingleDispatchGenericFunction_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SpecialForm_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SingleDispatchEffectiveMethodFunction_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Instance_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Pointer_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::Pointer_O type_KIND_LISPALLOC_core__Pointer_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__Pointer_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<clbind::ClassRegistry_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::DebugInfo_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DebugInfo_O type_KIND_LISPALLOC_llvmo__DebugInfo_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DebugInfo_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIDerivedType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIDerivedType_O type_KIND_LISPALLOC_llvmo__DIDerivedType_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIDerivedType_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIArray_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIArray_O type_KIND_LISPALLOC_llvmo__DIArray_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIArray_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIBasicType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIBasicType_O type_KIND_LISPALLOC_llvmo__DIBasicType_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIBasicType_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DISubprogram_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DISubprogram_O type_KIND_LISPALLOC_llvmo__DISubprogram_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DISubprogram_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DILexicalBlock_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DILexicalBlock_O type_KIND_LISPALLOC_llvmo__DILexicalBlock_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DILexicalBlock_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DICompileUnit_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DICompileUnit_O type_KIND_LISPALLOC_llvmo__DICompileUnit_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DICompileUnit_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIDescriptor_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIDescriptor_O type_KIND_LISPALLOC_llvmo__DIDescriptor_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIDescriptor_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIType_O type_KIND_LISPALLOC_llvmo__DIType_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIType_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DISubroutineType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DISubroutineType_O type_KIND_LISPALLOC_llvmo__DISubroutineType_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DISubroutineType_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DICompositeType_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DICompositeType_O type_KIND_LISPALLOC_llvmo__DICompositeType_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DICompositeType_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DITypeArray_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DITypeArray_O type_KIND_LISPALLOC_llvmo__DITypeArray_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DITypeArray_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIFile_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIFile_O type_KIND_LISPALLOC_llvmo__DIFile_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIFile_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<llvmo::DIScope_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef llvmo::DIScope_O type_KIND_LISPALLOC_llvmo__DIScope_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_llvmo__DIScope_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SmallMultimap_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Pathname_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::LogicalPathname_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::PosixTime_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
    typedef core::PosixTime_O type_KIND_LISPALLOC_core__PosixTime_O;
    client = (char*)client + AlignUp(sizeof(type_KIND_LISPALLOC_core__PosixTime_O)) + global_alignup_sizeof_header;
    return MPS_RES_OK;
...
template <>
 mps_res_t obj_scan_helper<core::SmallMap_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Cache>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::Lisp_O>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::SingleDispatchGenericFunctionClosure>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<llvmo::CompiledClosure>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::internal::VariadicOperatorMatcherDescriptor>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::internal::OverloadedMatcherDescriptor>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::internal::FixedArgCountMatcherDescriptor>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::internal::FreeFuncMatcherDescriptor>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::MacroClosure>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::ConsStepper>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::InstanceClosure>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::DerivableFrontendActionFactory>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::DerivableMatchCallback>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::DerivableASTFrontendAction>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::CoreExposer>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<asttooling::DerivableSyntaxOnlyAction>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::InterpretedClosure>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
template <>
 mps_res_t obj_scan_helper<core::VectorStepper>(mps_ss_t _ss, mps_word_t _mps_zs, mps_word_t _mps_w, mps_word_t &_mps_ufs, mps_word_t _mps_wt, mps_addr_t& client)
{
...
static void* OBJ_SCAN_table[] = { NULL 
  ...
  /* 54 */ , &&obj_scan_KIND_LISPALLOC_core__String_O
  /* 55 */ , &&obj_scan_KIND_BOOTSTRAP_core__Str_O
  /* 56 */ , &&obj_scan_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 57 */ , &&obj_scan_KIND_LISPALLOC_core__VectorObjects_O
  /* 58 */ , &&obj_scan_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 59 */ , &&obj_scan_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 60 */ , &&obj_scan_KIND_LISPALLOC_core__RandomState_O
  /* 61 */ , &&obj_scan_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 62 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 63 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Attribute_O
  /* 64 */ , &&obj_scan_KIND_LISPALLOC_core__RegexMatch_O
  /* 65 */ , &&obj_scan_KIND_LISPALLOC_core__WeakPointer_O
  /* 66 */ , &&obj_scan_KIND_LISPALLOC_core__VaList_dummy_O
  /* 67 */ , &&obj_scan_KIND_BOOTSTRAP_core__StandardObject_O
  /* 68 */ , &&obj_scan_KIND_BOOTSTRAP_core__Metaobject_O
  /* 69 */ , &&obj_scan_KIND_BOOTSTRAP_core__Specializer_O
  /* 70 */ , &&obj_scan_KIND_BOOTSTRAP_core__Class_O
  /* 71 */ , &&obj_scan_KIND_BOOTSTRAP_core__StdClass_O
  /* 72 */ , &&obj_scan_KIND_BOOTSTRAP_core__StandardClass_O
  /* 73 */ , &&obj_scan_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 74 */ , &&obj_scan_KIND_BOOTSTRAP_core__StructureClass_O
  /* 75 */ , &&obj_scan_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 76 */ , &&obj_scan_KIND_LISPALLOC_core__CxxClass_O
  /* 77 */ , &&obj_scan_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 78 */ , &&obj_scan_KIND_LISPALLOC_clbind__ClassRep_O
  /* 79 */ , &&obj_scan_KIND_LISPALLOC_core__ExternalObject_O
  /* 80 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Value_O
  /* 81 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Argument_O
  /* 82 */ , &&obj_scan_KIND_LISPALLOC_llvmo__User_O
  /* 83 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Instruction_O
  /* 84 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 85 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 86 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PHINode_O
  /* 87 */ , &&obj_scan_KIND_LISPALLOC_llvmo__CallInst_O
  /* 88 */ , &&obj_scan_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 89 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 90 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 91 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 92 */ , &&obj_scan_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 93 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 94 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 95 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 96 */ , &&obj_scan_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 97 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 98 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 99 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 100 */ , &&obj_scan_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 101 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 102 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 103 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Constant_O
  /* 104 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 105 */ , &&obj_scan_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 106 */ , &&obj_scan_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 107 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Function_O
  /* 108 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 109 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 110 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 111 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 112 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 113 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 114 */ , &&obj_scan_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 115 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 116 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 117 */ , &&obj_scan_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 118 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 119 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 120 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 121 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Metadata_O
  /* 122 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 123 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MDNode_O
  /* 124 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MDString_O
  /* 125 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 126 */ , &&obj_scan_KIND_LISPALLOC_llvmo__APFloat_O
  /* 127 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 128 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 129 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Triple_O
  /* 130 */ , &&obj_scan_KIND_LISPALLOC_llvmo__APInt_O
  /* 131 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 132 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 133 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PassManager_O
  /* 134 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 135 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 136 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 137 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Type_O
  /* 138 */ , &&obj_scan_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 139 */ , &&obj_scan_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 140 */ , &&obj_scan_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 141 */ , &&obj_scan_KIND_LISPALLOC_llvmo__VectorType_O
  /* 142 */ , &&obj_scan_KIND_LISPALLOC_llvmo__PointerType_O
  /* 143 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 144 */ , &&obj_scan_KIND_LISPALLOC_llvmo__StructType_O
  /* 145 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 146 */ , &&obj_scan_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 147 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Linker_O
  /* 148 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Pass_O
  /* 149 */ , &&obj_scan_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 150 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 151 */ , &&obj_scan_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 152 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 153 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 154 */ , &&obj_scan_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 155 */ , &&obj_scan_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 156 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Module_O
  /* 157 */ , &&obj_scan_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 158 */ , &&obj_scan_KIND_LISPALLOC_core__ForeignData_O
  /* 159 */ , &&obj_scan_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 160 */ , &&obj_scan_KIND_LISPALLOC_llvmo__Target_O
  /* 161 */ , &&obj_scan_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 162 */ , &&obj_scan_KIND_LISPALLOC_core__Binder_O
  /* 163 */ , &&obj_scan_KIND_LISPALLOC_core__IntArray_O
  /* 164 */ , &&obj_scan_KIND_LISPALLOC_core__SourceManager_O
  /* 165 */ , &&obj_scan_KIND_LISPALLOC_core__Record_O
  /* 166 */ , &&obj_scan_KIND_LISPALLOC_core__LightUserData_O
  /* 167 */ , &&obj_scan_KIND_LISPALLOC_core__UserData_O
  /* 168 */ , &&obj_scan_KIND_BOOTSTRAP_core__Symbol_O
  /* 169 */ , &&obj_scan_KIND_LISPALLOC_core__Null_O
  /* 170 */ , &&obj_scan_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 171 */ , &&obj_scan_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 172 */ , &&obj_scan_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 173 */ , &&obj_scan_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 174 */ , &&obj_scan_KIND_LISPALLOC_core__Regex_O
  /* 175 */ , &&obj_scan_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 176 */ , &&obj_scan_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 177 */ , &&obj_scan_KIND_LISPALLOC_core__CandoException_O
  /* 178 */ , &&obj_scan_KIND_LISPALLOC_core__Stream_O
  /* 179 */ , &&obj_scan_KIND_LISPALLOC_core__AnsiStream_O
  /* 180 */ , &&obj_scan_KIND_LISPALLOC_core__FileStream_O
  /* 181 */ , &&obj_scan_KIND_LISPALLOC_core__IOStreamStream_O
  /* 182 */ , &&obj_scan_KIND_LISPALLOC_core__IOFileStream_O
  /* 183 */ , &&obj_scan_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 184 */ , &&obj_scan_KIND_LISPALLOC_core__StringStream_O
  /* 185 */ , &&obj_scan_KIND_LISPALLOC_core__StringInputStream_O
  /* 186 */ , &&obj_scan_KIND_LISPALLOC_core__StringOutputStream_O
  /* 187 */ , &&obj_scan_KIND_LISPALLOC_core__SynonymStream_O
  /* 188 */ , &&obj_scan_KIND_LISPALLOC_core__EchoStream_O
  /* 189 */ , &&obj_scan_KIND_LISPALLOC_core__TwoWayStream_O
  /* 190 */ , &&obj_scan_KIND_LISPALLOC_core__BroadcastStream_O
  /* 191 */ , &&obj_scan_KIND_LISPALLOC_core__Reader_O
  /* 192 */ , &&obj_scan_KIND_LISPALLOC_core__Cons_O
  /* 193 */ , &&obj_scan_KIND_LISPALLOC_core__Archive_O
  /* 194 */ , &&obj_scan_KIND_LISPALLOC_core__SaveArchive_O
  /* 195 */ , &&obj_scan_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 196 */ , &&obj_scan_KIND_LISPALLOC_core__LoadArchive_O
  /* 197 */ , &&obj_scan_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 198 */ , &&obj_scan_KIND_LISPALLOC_core__HashTable_O
  /* 199 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEq_O
  /* 200 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 201 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEql_O
  /* 202 */ , &&obj_scan_KIND_LISPALLOC_core__HashTableEqual_O
  /* 203 */ , &&obj_scan_KIND_LISPALLOC_cffi__Pointer_O
  /* 204 */ , &&obj_scan_KIND_LISPALLOC_core__CxxObject_O
  /* 205 */ , &&obj_scan_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 206 */ , &&obj_scan_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 207 */ , &&obj_scan_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 208 */ , &&obj_scan_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 209 */ , &&obj_scan_KIND_LISPALLOC_core__SNode_O
  /* 210 */ , &&obj_scan_KIND_LISPALLOC_core__LeafSNode_O
  /* 211 */ , &&obj_scan_KIND_LISPALLOC_core__BranchSNode_O
  /* 212 */ , &&obj_scan_KIND_LISPALLOC_core__Path_O
  /* 213 */ , &&obj_scan_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 214 */ , &&obj_scan_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 215 */ , &&obj_scan_KIND_LISPALLOC_core__StructureObject_O
  /* 216 */ , &&obj_scan_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 217 */ , &&obj_scan_KIND_LISPALLOC_core__Package_O
  /* 218 */ , &&obj_scan_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 219 */ , &&obj_scan_KIND_LISPALLOC_core__Character_dummy_O
  /* 220 */ , &&obj_scan_KIND_LISPALLOC_core__Function_O
  /* 221 */ , &&obj_scan_KIND_LISPALLOC_core__CompiledFunction_O
  /* 222 */ , &&obj_scan_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 223 */ , &&obj_scan_KIND_LISPALLOC_core__SpecialForm_O
  /* 224 */ , &&obj_scan_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 225 */ , &&obj_scan_KIND_LISPALLOC_core__Instance_O
  /* 226 */ , &&obj_scan_KIND_LISPALLOC_core__Pointer_O
  /* 227 */ , &&obj_scan_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 228 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 229 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 230 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIArray_O
  /* 231 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 232 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 233 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 234 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DICompileUnit_O
  /* 235 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIDescriptor_O
  /* 236 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIType_O
  /* 237 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DISubroutineType_O
  /* 238 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 239 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 240 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIFile_O
  /* 241 */ , &&obj_scan_KIND_LISPALLOC_llvmo__DIScope_O
  /* 242 */ , &&obj_scan_KIND_LISPALLOC_core__SmallMultimap_O
  /* 243 */ , &&obj_scan_KIND_LISPALLOC_core__Pathname_O
  /* 244 */ , &&obj_scan_KIND_LISPALLOC_core__LogicalPathname_O
  /* 245 */ , &&obj_scan_KIND_LISPALLOC_core__PosixTime_O
  /* 246 */ , &&obj_scan_KIND_LISPALLOC_core__SmallMap_O
  /* 247 */ , &&obj_scan_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_scan_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 249 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 250 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 251 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 252 */ , &&obj_scan_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 253 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 254 */ , &&obj_scan_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 255 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 256 */ , &&obj_scan_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 257 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 258 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 259 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 260 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 261 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 262 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 263 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 264 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 265 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 266 */ , &&obj_scan_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 267 */ , &&obj_scan_KIND_CLASSALLOC_core__MacroClosure
  /* 268 */ , &&obj_scan_KIND_CLASSALLOC_core__ConsStepper
  /* 269 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 270 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 271 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 272 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 273 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 274 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 275 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 276 */ , &&obj_scan_KIND_CLASSALLOC_core__InstanceClosure
  /* 277 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 278 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 279 */ , &&obj_scan_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 280 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 281 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 282 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 283 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 284 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__
  /* 285 */ , &&obj_scan_KIND_CLASSALLOC_core__CoreExposer
  /* 286 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 287 */ , &&obj_scan_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 288 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 289 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 290 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 291 */ , &&obj_scan_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 292 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 293 */ , &&obj_scan_KIND_CLASSALLOC_core__InterpretedClosure
  /* 294 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 295 */ , &&obj_scan_KIND_CLASSALLOC_core__VectorStepper
  /* 296 */ , &&obj_scan_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
...
static void* OBJ_FINALIZE_table[] = { NULL 
  ...
  /* 54 */ , &&obj_finalize_KIND_LISPALLOC_core__String_O
  /* 55 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Str_O
  /* 56 */ , &&obj_finalize_KIND_LISPALLOC_core__StrWithFillPtr_O
  /* 57 */ , &&obj_finalize_KIND_LISPALLOC_core__VectorObjects_O
  /* 58 */ , &&obj_finalize_KIND_LISPALLOC_core__VectorObjectsWithFillPtr_O
  /* 59 */ , &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchMethod_O
  /* 60 */ , &&obj_finalize_KIND_LISPALLOC_core__RandomState_O
  /* 61 */ , &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__WrappedPointer_O
  /* 62 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DebugLoc_O
  /* 63 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Attribute_O
  /* 64 */ , &&obj_finalize_KIND_LISPALLOC_core__RegexMatch_O
  /* 65 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakPointer_O
  /* 66 */ , &&obj_finalize_KIND_LISPALLOC_core__VaList_dummy_O
  /* 67 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StandardObject_O
  /* 68 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Metaobject_O
  /* 69 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Specializer_O
  /* 70 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Class_O
  /* 71 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StdClass_O
  /* 72 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StandardClass_O
  /* 73 */ , &&obj_finalize_KIND_LISPALLOC_core__FuncallableStandardClass_O
  /* 74 */ , &&obj_finalize_KIND_BOOTSTRAP_core__StructureClass_O
  /* 75 */ , &&obj_finalize_KIND_LISPALLOC_core__ForwardReferencedClass_O
  /* 76 */ , &&obj_finalize_KIND_LISPALLOC_core__CxxClass_O
  /* 77 */ , &&obj_finalize_KIND_BOOTSTRAP_core__BuiltInClass_O
  /* 78 */ , &&obj_finalize_KIND_LISPALLOC_clbind__ClassRep_O
  /* 79 */ , &&obj_finalize_KIND_LISPALLOC_core__ExternalObject_O
  /* 80 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Value_O
  /* 81 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Argument_O
  /* 82 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__User_O
  /* 83 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Instruction_O
  /* 84 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicRMWInst_O
  /* 85 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LandingPadInst_O
  /* 86 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PHINode_O
  /* 87 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__CallInst_O
  /* 88 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__StoreInst_O
  /* 89 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__UnaryInstruction_O
  /* 90 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LoadInst_O
  /* 91 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AllocaInst_O
  /* 92 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__VAArgInst_O
  /* 93 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AtomicCmpXchgInst_O
  /* 94 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TerminatorInst_O
  /* 95 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__UnreachableInst_O
  /* 96 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__SwitchInst_O
  /* 97 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ReturnInst_O
  /* 98 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ResumeInst_O
  /* 99 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__BranchInst_O
  /* 100 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__InvokeInst_O
  /* 101 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__IndirectBrInst_O
  /* 102 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FenceInst_O
  /* 103 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Constant_O
  /* 104 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__BlockAddress_O
  /* 105 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalValue_O
  /* 106 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__GlobalVariable_O
  /* 107 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Function_O
  /* 108 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantArray_O
  /* 109 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantInt_O
  /* 110 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataSequential_O
  /* 111 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantDataArray_O
  /* 112 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantStruct_O
  /* 113 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantFP_O
  /* 114 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__UndefValue_O
  /* 115 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantPointerNull_O
  /* 116 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ConstantExpr_O
  /* 117 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__BasicBlock_O
  /* 118 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__IRBuilderBase_O
  /* 119 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__IRBuilder_O
  /* 120 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIBuilder_O
  /* 121 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Metadata_O
  /* 122 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ValueAsMetadata_O
  /* 123 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__MDNode_O
  /* 124 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__MDString_O
  /* 125 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ExecutionEngine_O
  /* 126 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__APFloat_O
  /* 127 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBuilder_O
  /* 128 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DataLayout_O
  /* 129 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Triple_O
  /* 130 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__APInt_O
  /* 131 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PassManagerBase_O
  /* 132 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPassManager_O
  /* 133 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PassManager_O
  /* 134 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetMachine_O
  /* 135 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMTargetMachine_O
  /* 136 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetOptions_O
  /* 137 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Type_O
  /* 138 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__IntegerType_O
  /* 139 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__CompositeType_O
  /* 140 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__SequentialType_O
  /* 141 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__VectorType_O
  /* 142 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__PointerType_O
  /* 143 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ArrayType_O
  /* 144 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__StructType_O
  /* 145 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionType_O
  /* 146 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__NamedMDNode_O
  /* 147 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Linker_O
  /* 148 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Pass_O
  /* 149 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__FunctionPass_O
  /* 150 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ModulePass_O
  /* 151 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__ImmutablePass_O
  /* 152 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DataLayoutPass_O
  /* 153 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetLibraryInfo_O
  /* 154 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__MCSubtargetInfo_O
  /* 155 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__TargetSubtargetInfo_O
  /* 156 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Module_O
  /* 157 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__EngineBuilder_O
  /* 158 */ , &&obj_finalize_KIND_LISPALLOC_core__ForeignData_O
  /* 159 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__LLVMContext_O
  /* 160 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__Target_O
  /* 161 */ , &&obj_finalize_KIND_LISPALLOC_core__LoadTimeValues_O
  /* 162 */ , &&obj_finalize_KIND_LISPALLOC_core__Binder_O
  /* 163 */ , &&obj_finalize_KIND_LISPALLOC_core__IntArray_O
  /* 164 */ , &&obj_finalize_KIND_LISPALLOC_core__SourceManager_O
  /* 165 */ , &&obj_finalize_KIND_LISPALLOC_core__Record_O
  /* 166 */ , &&obj_finalize_KIND_LISPALLOC_core__LightUserData_O
  /* 167 */ , &&obj_finalize_KIND_LISPALLOC_core__UserData_O
  /* 168 */ , &&obj_finalize_KIND_BOOTSTRAP_core__Symbol_O
  /* 169 */ , &&obj_finalize_KIND_LISPALLOC_core__Null_O
  /* 170 */ , &&obj_finalize_KIND_LISPALLOC_core__SourcePosInfo_O
  /* 171 */ , &&obj_finalize_KIND_TEMPLATED_LISPALLOC_core__Iterator_O
  /* 172 */ , &&obj_finalize_KIND_LISPALLOC_core__DirectoryIterator_O
  /* 173 */ , &&obj_finalize_KIND_LISPALLOC_core__RecursiveDirectoryIterator_O
  /* 174 */ , &&obj_finalize_KIND_LISPALLOC_core__Regex_O
  /* 175 */ , &&obj_finalize_KIND_LISPALLOC_core__PosixTimeDuration_O
  /* 176 */ , &&obj_finalize_KIND_LISPALLOC_core__SymbolToEnumConverter_O
  /* 177 */ , &&obj_finalize_KIND_LISPALLOC_core__CandoException_O
  /* 178 */ , &&obj_finalize_KIND_LISPALLOC_core__Stream_O
  /* 179 */ , &&obj_finalize_KIND_LISPALLOC_core__AnsiStream_O
  /* 180 */ , &&obj_finalize_KIND_LISPALLOC_core__FileStream_O
  /* 181 */ , &&obj_finalize_KIND_LISPALLOC_core__IOStreamStream_O
  /* 182 */ , &&obj_finalize_KIND_LISPALLOC_core__IOFileStream_O
  /* 183 */ , &&obj_finalize_KIND_LISPALLOC_core__ConcatenatedStream_O
  /* 184 */ , &&obj_finalize_KIND_LISPALLOC_core__StringStream_O
  /* 185 */ , &&obj_finalize_KIND_LISPALLOC_core__StringInputStream_O
  /* 186 */ , &&obj_finalize_KIND_LISPALLOC_core__StringOutputStream_O
  /* 187 */ , &&obj_finalize_KIND_LISPALLOC_core__SynonymStream_O
  /* 188 */ , &&obj_finalize_KIND_LISPALLOC_core__EchoStream_O
  /* 189 */ , &&obj_finalize_KIND_LISPALLOC_core__TwoWayStream_O
  /* 190 */ , &&obj_finalize_KIND_LISPALLOC_core__BroadcastStream_O
  /* 191 */ , &&obj_finalize_KIND_LISPALLOC_core__Reader_O
  /* 192 */ , &&obj_finalize_KIND_LISPALLOC_core__Cons_O
  /* 193 */ , &&obj_finalize_KIND_LISPALLOC_core__Archive_O
  /* 194 */ , &&obj_finalize_KIND_LISPALLOC_core__SaveArchive_O
  /* 195 */ , &&obj_finalize_KIND_LISPALLOC_core__SexpSaveArchive_O
  /* 196 */ , &&obj_finalize_KIND_LISPALLOC_core__LoadArchive_O
  /* 197 */ , &&obj_finalize_KIND_LISPALLOC_core__SexpLoadArchive_O
  /* 198 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTable_O
  /* 199 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEq_O
  /* 200 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEqualp_O
  /* 201 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEql_O
  /* 202 */ , &&obj_finalize_KIND_LISPALLOC_core__HashTableEqual_O
  /* 203 */ , &&obj_finalize_KIND_LISPALLOC_cffi__Pointer_O
  /* 204 */ , &&obj_finalize_KIND_LISPALLOC_core__CxxObject_O
  /* 205 */ , &&obj_finalize_KIND_LISPALLOC_core__WeakKeyMapping_O
  /* 206 */ , &&obj_finalize_KIND_LISPALLOC_core__LambdaListHandler_O
  /* 207 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__InsertPoint_O
  /* 208 */ , &&obj_finalize_KIND_LISPALLOC_core__SourceFileInfo_O
  /* 209 */ , &&obj_finalize_KIND_LISPALLOC_core__SNode_O
  /* 210 */ , &&obj_finalize_KIND_LISPALLOC_core__LeafSNode_O
  /* 211 */ , &&obj_finalize_KIND_LISPALLOC_core__BranchSNode_O
  /* 212 */ , &&obj_finalize_KIND_LISPALLOC_core__Path_O
  /* 213 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__AstVisitor_O
  /* 214 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__AttributeSet_O
  /* 215 */ , &&obj_finalize_KIND_LISPALLOC_core__StructureObject_O
  /* 216 */ , &&obj_finalize_KIND_LISPALLOC_core__InvocationHistoryFrameIterator_O
  /* 217 */ , &&obj_finalize_KIND_LISPALLOC_core__Package_O
  /* 218 */ , &&obj_finalize_KIND_LISPALLOC_core__DirectoryEntry_O
  /* 219 */ , &&obj_finalize_KIND_LISPALLOC_core__Character_dummy_O
  /* 220 */ , &&obj_finalize_KIND_LISPALLOC_core__Function_O
  /* 221 */ , &&obj_finalize_KIND_LISPALLOC_core__CompiledFunction_O
  /* 222 */ , &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchGenericFunction_O
  /* 223 */ , &&obj_finalize_KIND_LISPALLOC_core__SpecialForm_O
  /* 224 */ , &&obj_finalize_KIND_LISPALLOC_core__SingleDispatchEffectiveMethodFunction_O
  /* 225 */ , &&obj_finalize_KIND_LISPALLOC_core__Instance_O
  /* 226 */ , &&obj_finalize_KIND_LISPALLOC_core__Pointer_O
  /* 227 */ , &&obj_finalize_KIND_LISPALLOC_clbind__ClassRegistry_O
  /* 228 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DebugInfo_O
  /* 229 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIDerivedType_O
  /* 230 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIArray_O
  /* 231 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIBasicType_O
  /* 232 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DISubprogram_O
  /* 233 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DILexicalBlock_O
  /* 234 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DICompileUnit_O
  ...
  /* 238 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DICompositeType_O
  /* 239 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DITypeArray_O
  /* 240 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIFile_O
  /* 241 */ , &&obj_finalize_KIND_LISPALLOC_llvmo__DIScope_O
  /* 242 */ , &&obj_finalize_KIND_LISPALLOC_core__SmallMultimap_O
  /* 243 */ , &&obj_finalize_KIND_LISPALLOC_core__Pathname_O
  /* 244 */ , &&obj_finalize_KIND_LISPALLOC_core__LogicalPathname_O
  /* 245 */ , &&obj_finalize_KIND_LISPALLOC_core__PosixTime_O
  /* 246 */ , &&obj_finalize_KIND_LISPALLOC_core__SmallMap_O
  /* 247 */ , &&obj_finalize_KIND_CLASSALLOC_core__Cache
  /* 248 */ , &&obj_finalize_KIND_ROOTCLASSALLOC_core__Lisp_O
  /* 249 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_core__SequenceStepper__
  /* 250 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__KeywordArgument_
  /* 251 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__0_
  /* 252 */ , &&obj_finalize_KIND_CLASSALLOC_core__SingleDispatchGenericFunctionClosure
  /* 253 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__List_V__
  /* 254 */ , &&obj_finalize_KIND_GCSTRING_gctools__GCString_moveable_char_
  /* 255 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__RequiredArgument_
  /* 256 */ , &&obj_finalize_KIND_CLASSALLOC_llvmo__CompiledClosure
  /* 257 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SourceFileInfo_O__
  /* 258 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__VariadicOperatorMatcherDescriptor
  /* 259 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__Symbol_O__gctools__smart_ptr_core__T_O___
  /* 260 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__OverloadedMatcherDescriptor
  /* 261 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolStorage_
  /* 262 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__4_
  /* 263 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ContextFrame_
  /* 264 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__FixedArgCountMatcherDescriptor
  /* 265 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__T_O_P_
  /* 266 */ , &&obj_finalize_KIND_CLASSALLOC_asttooling__internal__FreeFuncMatcherDescriptor
  /* 267 */ , &&obj_finalize_KIND_CLASSALLOC_core__MacroClosure
  /* 268 */ , &&obj_finalize_KIND_CLASSALLOC_core__ConsStepper
  /* 269 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__AuxArgument_
  /* 270 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ParserValue_
  /* 271 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Symbol_O__
  /* 272 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__SymbolClassPair_
  /* 273 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__RegMap__SymbolMatcherDescriptorPair_
  /* 274 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_std__pair_gctools__smart_ptr_core__T_O__gctools__smart_ptr_core__T_O___
  /* 275 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__CacheRecord_
  /* 276 */ , &&obj_finalize_KIND_CLASSALLOC_core__InstanceClosure
  /* 277 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Cons_O__
  /* 278 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableFrontendActionFactory
  /* 279 */ , &&obj_finalize_KIND_GCARRAY_gctools__GCArray_moveable_gctools__smart_ptr_core__T_O__1_
  /* 280 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableMatchCallback
  /* 281 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__ErrorContent_
  /* 282 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableASTFrontendAction
  /* 283 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_asttooling__Message_
  /* 284 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__tagged_pointer_asttooling__internal__MatcherDescriptor__
  /* 285 */ , &&obj_finalize_KIND_CLASSALLOC_core__CoreExposer
  /* 286 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__T_O__
  /* 287 */ , &&obj_finalize_KIND_LISPALLOC_asttooling__DerivableSyntaxOnlyAction
  /* 288 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__SingleDispatchMethod_O__
  /* 289 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__OptionalArgument_
  /* 290 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_core__Package_O__
  /* 291 */ , &&obj_finalize_KIND_TEMPLATED_CLASSALLOC_core__BuiltinClosure
  /* 292 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__ExceptionEntry_
  /* 293 */ , &&obj_finalize_KIND_CLASSALLOC_core__InterpretedClosure
  /* 294 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_core__DynamicBinding_
  /* 295 */ , &&obj_finalize_KIND_CLASSALLOC_core__VectorStepper
  /* 296 */ , &&obj_finalize_KIND_GCVECTOR_gctools__GCVector_moveable_gctools__smart_ptr_clbind__ClassRep_O__
};
