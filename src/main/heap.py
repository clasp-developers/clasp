...
lldb.debugger.HandleCommand('command script add -f heap.ptr_refs ptr_refs')
lldb.debugger.HandleCommand('command script add -f heap.cstr_refs cstr_refs')
lldb.debugger.HandleCommand('command script add -f heap.malloc_info malloc_info')
lldb.debugger.HandleCommand('command script add -f heap.malloc_history malloc_history')
