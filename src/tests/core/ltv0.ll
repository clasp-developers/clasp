...
@":::global-str-/Users/meister/Development/cando/brcl/src/tests/core/ltv0.lsp" = internal unnamed_addr constant [62 x i8] c"/Users/meister/Development/cando/brcl/src/tests/core/ltv0.lsp\00"
...
@":::global-str-___user_ltv0" = internal unnamed_addr constant [13 x i8] c"___user_ltv0\00"
...
entry:
  call void @getLoadTimeValueArray({ i32*, {}* }** @load-time-value-vector, i8* getelementptr inbounds ([62 x i8]* @":::global-str-/Users/meister/Development/cando/brcl/src/tests/core/ltv0.lsp", i64 0, i64 0), i32 5, i32 2)
  ...
  %2 = call { i32*, {}* }* @loadTimeValueReference({ i32*, {}* }** @load-time-value-vector, i32 3)
  call void @makeFixnum({ i32*, {}* }* %2, i32 3)
  %3 = call { i32*, {}* }* @loadTimeValueReference({ i32*, {}* }** @load-time-value-vector, i32 4)
  call void @makeFixnum({ i32*, {}* }* %3, i32 7)
  %4 = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 0)
  call void @internSymbol_symsp({ i32*, i32* }* %4, i8* getelementptr inbounds ([2 x i8]* @":::symbol-name-+", i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @":::package-name-COMMON-LISP", i64 0, i64 0))
  %5 = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 1)
  call void @internSymbol_symsp({ i32*, i32* }* %5, i8* getelementptr inbounds ([6 x i8]* @":::symbol-name-PRINT", i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @":::package-name-COMMON-LISP", i64 0, i64 0))
  ret void
}
...
entry:
  ...
  call void @trace_setLineNumberColumnForIHSTop(i32 2, i32 1)
  call void @makeValueFrame({ i32*, {}* }* %call-args, i32 1, i32 2000002)
  ...
  call void @sp_getLoadTimeValue({ i32*, {}* }* %call-args-ref-0, { i32*, {}* }** @load-time-value-vector, i32 2)
  call void @singleStepCallback()
  %"SYMBOL->COMMON-LISP:PRINT" = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 1)
...
entry:
  ...
  %call-args = alloca { i32*, {}* }, align 8
  call void @newAFsp({ i32*, {}* }* %call-args)
  %0 = call { i32*, {}* }* @loadTimeValueReference({ i32*, {}* }** @load-time-value-vector, i32 2)
  call void @trace_setLineNumberColumnForIHSTop(i32 2, i32 25)
  call void @makeValueFrame({ i32*, {}* }* %call-args, i32 2, i32 2000003)
  ...
  call void @sp_copyLoadTimeValue({ i32*, {}* }* %call-args-ref-1, { i32*, {}* }** @load-time-value-vector, i32 4)
  call void @singleStepCallback()
  %"SYMBOL->COMMON-LISP:+" = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 0)
  invoke void @sp_invokePossibleMultipleValueSymbolFunction({ i32*, {}* }* %0, { i32*, i32* }* %"SYMBOL->COMMON-LISP:+", { i32*, {}* }* %call-args)
          to label %normal-dest unwind label %func-cleanup-landing-pad
...
!0 = metadata !{i32 786449, metadata !1, i32 32768, metadata !"brcl Common Lisp compiler", i1 false, metadata !"-v", i32 1, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !"split-name.log"} ; [ DW_TAG_compile_unit ] [/Users/meister/Development/cando/brcl/src/tests/core/ltv0.lsp] [DW_LANG_lo_user]
!1 = metadata !{metadata !"ltv0.lsp", metadata !"/Users/meister/Development/cando/brcl/src/tests/core"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !9, metadata !11}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/Users/meister/Development/cando/brcl/src/tests/core/ltv0.lsp]
...
!9 = metadata !{i32 786478, metadata !1, metadata !10, metadata !"load-time-value-func", metadata !"load-time-value-func", metadata !"load-time-value-func", i32 2, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void ({ i32*, {}*, i32 }*, { i32*, {}* }*)* @load-time-value-func, null, null, metadata !2, i32 2} ; [ DW_TAG_subprogram ] [line 2] [def] [load-time-value-func]
!10 = metadata !{i32 786443, metadata !1, metadata !4, i32 2, i32 1, i32 3} ; [ DW_TAG_lexical_block ] [/Users/meister/Development/cando/brcl/src/tests/core/ltv0.lsp]
!11 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"___user_ltv0", metadata !"___user_ltv0", metadata !"___user_ltv0", i32 0, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void ()* @___user_ltv0, null, null, metadata !2, i32 0} ; [ DW_TAG_subprogram ] [line 0] [def] [___user_ltv0]
