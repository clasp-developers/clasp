...
entry:
  ...
  call void @trace_setLineNumberColumnForIHSTop(i32 2, i32 13), !dbg !19
  call void @makeValueFrame({ i32*, {}* }* %call-args, i32 3, i32 2000000), !dbg !19
  %0 = call { i32*, {}* }* @activationFrameNil(), !dbg !19
  call void @setParentOfActivationFrame({ i32*, {}* }* %call-args, { i32*, {}* }* %0), !dbg !19
  %call-args-ref-0 = call { i32*, {}* }* @valueFrameReference({ i32*, {}* }* %call-args, i32 0), !dbg !19
  call void @sp_copyLoadTimeValue({ i32*, {}* }* %call-args-ref-0, { i32*, {}* }** @load-time-value-vector, i32 2), !dbg !19
  %call-args-ref-1 = call { i32*, {}* }* @valueFrameReference({ i32*, {}* }* %call-args, i32 1), !dbg !19
  %"SYMBOL->COMMON-LISP:NIL" = call { i32*, {}* }* @loadTimeValueReference({ i32*, {}* }** @load-time-value-vector, i32 0), !dbg !19
  %"SYMBOL->A" = call { i32*, {}* }* @loadTimeValueReference({ i32*, {}* }** @load-time-value-vector, i32 2), !dbg !19
  %1 = call { i32*, {}* }* @activationFrameNil(), !dbg !19
  invoke void @sp_makeCompiledFunction({ i32*, {}* }* %call-args-ref-1, void ({ i32*, {}*, i32 }*, { i32*, {}* }*)* @A, i8* getelementptr inbounds ([69 x i8]* @":::global-str-/Users/meister/Development/cando/brcl/src/tests/random/testDwarf.lsp", i64 0, i64 0), { i32*, {}* }* %"SYMBOL->A", { i32*, {}* }* %"SYMBOL->COMMON-LISP:NIL", { i32*, {}* }* %1)
          to label %normal-dest unwind label %func-cleanup-landing-pad, !dbg !19

normal-dest:                                      ; preds = %entry
  %call-args-ref-2 = call { i32*, {}* }* @valueFrameReference({ i32*, {}* }* %call-args, i32 2), !dbg !19
  call void @sp_copyLoadTimeValue({ i32*, {}* }* %call-args-ref-2, { i32*, {}* }** @load-time-value-vector, i32 0), !dbg !19
  call void @singleStepCallback(), !dbg !19
  %"SYMBOL->*FSET" = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 1), !dbg !19
  invoke void @mv_invokePossibleMultipleValueSymbolFunction({ i32*, {}*, i32 }* %result-ptr, { i32*, i32* }* %"SYMBOL->*FSET", { i32*, {}* }* %call-args)
          to label %normal-dest1 unwind label %func-cleanup-landing-pad, !dbg !19

normal-dest1:                                     ; preds = %normal-dest
  call void @destructAFsp({ i32*, {}* }* %call-args), !dbg !19
  ret void, !dbg !19

func-cleanup-landing-pad:                         ; preds = %normal-dest, %entry
  %2 = landingpad { i8*, i32 } personality i32 (...)* @__gxx_personality_v0
          cleanup, !dbg !19
  %3 = extractvalue { i8*, i32 } %2, 0, !dbg !19
  store i8* %3, i8** %exn.slot, align 8, !dbg !19
  %4 = extractvalue { i8*, i32 } %2, 1, !dbg !19
  store i32 %4, i32* %ehselector.slot, align 4, !dbg !19
  call void @destructAFsp({ i32*, {}* }* %call-args), !dbg !19
  resume { i8*, i32 } %2, !dbg !19
}
...
"(TRY-0).landing-pad":                            ; preds = %continue3
  ...
  br i1 %4, label %"(TRY-0).handler-block4799", label %func-ehcleanup, !dbg !20

"(TRY-0).handler-block4799":                      ; preds = %"(TRY-0).landing-pad"
...
"(TRY-0).normal-dest5":                           ; preds = %"(TRY-0).handler-block4799"
...
"(TRY-0).landing-pad8":                           ; preds = %"(TRY-0).normal-dest5", %"(TRY-0).handler-block4799"
...
continue3:                                        ; preds = %entry
  ...
  call void @trace_setLineNumberColumnForIHSTop(i32 5, i32 3), !dbg !24
  call void @makeValueFrame({ i32*, {}* }* %call-args, i32 0, i32 2000003), !dbg !24
  call void @setParentOfActivationFrame({ i32*, {}* }* %call-args, { i32*, {}* }* %lambda-args-2-), !dbg !24
  call void @singleStepCallback(), !dbg !24
  %"SYMBOL->A" = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 2), !dbg !24
  invoke void @sp_invokePossibleMultipleValueSymbolFunction({ i32*, {}* }* %temp, { i32*, i32* }* %"SYMBOL->A", { i32*, {}* }* %call-args)
          to label %"(TRY-0).normal-dest" unwind label %"(TRY-0).landing-pad", !dbg !24

"(TRY-0).normal-dest":                            ; preds = %continue3
  call void @trace_setLineNumberColumnForIHSTop(i32 6, i32 3), !dbg !27
  call void @makeValueFrame({ i32*, {}* }* %call-args5, i32 1, i32 2000004), !dbg !27
  call void @setParentOfActivationFrame({ i32*, {}* }* %call-args5, { i32*, {}* }* %lambda-args-2-), !dbg !27
  %call-args5-ref-0 = call { i32*, {}* }* @valueFrameReference({ i32*, {}* }* %call-args5, i32 0), !dbg !27
  call void @sp_copyLoadTimeValue({ i32*, {}* }* %call-args5-ref-0, { i32*, {}* }** @load-time-value-vector, i32 8), !dbg !27
  call void @singleStepCallback(), !dbg !27
  %"SYMBOL->COMMON-LISP:PRINT" = call { i32*, i32* }* @loadTimeSymbolReference({ i32*, {}* }** @load-time-value-vector, i32 0), !dbg !27
  invoke void @mv_invokePossibleMultipleValueSymbolFunction({ i32*, {}*, i32 }* %result-ptr, { i32*, i32* }* %"SYMBOL->COMMON-LISP:PRINT", { i32*, {}* }* %call-args5)
          to label %"(TRY-0).try-cont" unwind label %"(TRY-0).landing-pad", !dbg !27

"(TRY-0).landing-pad":                            ; preds = %"(TRY-0).normal-dest", %continue3
  %0 = landingpad { i8*, i32 } personality i32 (...)* @__gxx_personality_v0
          cleanup
          catch i8* @_ZTIN4core10ReturnFromE, !dbg !27
  %1 = extractvalue { i8*, i32 } %0, 0, !dbg !27
  store i8* %1, i8** %exn.slot, align 8, !dbg !27
  %2 = extractvalue { i8*, i32 } %0, 1, !dbg !27
  store i32 %2, i32* %ehselector.slot, align 4, !dbg !27
  %3 = call i32 @llvm.eh.typeid.for(i8* @_ZTIN4core10ReturnFromE), !dbg !27
  %4 = icmp eq i32 %2, %3, !dbg !27
  br i1 %4, label %"(TRY-0).handler-block5364", label %func-ehcleanup, !dbg !27

"(TRY-0).handler-block5364":                      ; preds = %"(TRY-0).landing-pad"
  %5 = call i8* @__cxa_begin_catch(i8* %1), !dbg !27
  invoke void @mv_blockHandleReturnFrom({ i32*, {}*, i32 }* %result-ptr, i8* %5)
          to label %"(TRY-0).normal-dest7" unwind label %"(TRY-0).landing-pad10", !dbg !27

"(TRY-0).normal-dest7":                           ; preds = %"(TRY-0).handler-block5364"
  invoke void @__cxa_end_catch()
          to label %"(TRY-0).try-cont" unwind label %"(TRY-0).landing-pad10", !dbg !27

"(TRY-0).try-cont":                               ; preds = %"(TRY-0).normal-dest7", %"(TRY-0).normal-dest"
  call void @destructAFsp({ i32*, {}* }* %call-args5), !dbg !27
  call void @destructAFsp({ i32*, {}* }* %call-args), !dbg !27
  call void @destructTsp({ i32*, {}* }* %temp), !dbg !27
  call void @destructAFsp({ i32*, {}* }* %lambda-args-2-), !dbg !27
  ret void, !dbg !27

"(TRY-0).landing-pad10":                          ; preds = %"(TRY-0).normal-dest7", %"(TRY-0).handler-block5364"
  %6 = landingpad { i8*, i32 } personality i32 (...)* @__gxx_personality_v0
          cleanup, !dbg !27
  %7 = extractvalue { i8*, i32 } %6, 0, !dbg !27
  store i8* %7, i8** %exn.slot, align 8, !dbg !27
  %8 = extractvalue { i8*, i32 } %6, 1, !dbg !27
  store i32 %8, i32* %ehselector.slot, align 4, !dbg !27
  br label %func-ehcleanup, !dbg !27

func-cleanup-landing-pad:                         ; preds = %continue, %error1
  %9 = landingpad { i8*, i32 } personality i32 (...)* @__gxx_personality_v0
          cleanup, !dbg !27
  %10 = extractvalue { i8*, i32 } %9, 0, !dbg !27
  store i8* %10, i8** %exn.slot, align 8, !dbg !27
  %11 = extractvalue { i8*, i32 } %9, 1, !dbg !27
  store i32 %11, i32* %ehselector.slot, align 4, !dbg !27
  br label %func-ehcleanup, !dbg !27
...
func-ehcleanup:                                   ; preds = %func-cleanup-landing-pad, %"(TRY-0).landing-pad10", %"(TRY-0).landing-pad"
  ...
  call void @destructTsp({ i32*, {}* }* %temp), !dbg !27
  call void @destructAFsp({ i32*, {}* }* %lambda-args-2-), !dbg !27
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn7, 0, !dbg !27
  %lpad.val8 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !27
  resume { i8*, i32 } %lpad.val8, !dbg !27
}
...
!0 = metadata !{i32 786449, metadata !1, i32 32768, metadata !"brcl Common Lisp compiler", i1 false, metadata !"-v", i32 1, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !"split-name.log"} ; [ DW_TAG_compile_unit ] [/Users/meister/Development/cando/brcl/src/tests/random//testDwarf] [DW_LANG_lo_user]
!1 = metadata !{metadata !"testDwarf", metadata !"/Users/meister/Development/cando/brcl/src/tests/random/"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !9, metadata !11, metadata !12, metadata !13, metadata !14, metadata !16, metadata !17, metadata !18}
...
!10 = metadata !{i32 786443, metadata !1, metadata !4, i32 2, i32 13, i32 0} ; [ DW_TAG_lexical_block ] [/Users/meister/Development/cando/brcl/src/tests/random//testDwarf]
...
!15 = metadata !{i32 786443, metadata !1, metadata !13, i32 505, i32 3, i32 5} ; [ DW_TAG_lexical_block ] [/Users/meister/Development/cando/brcl/src/tests/random//testDwarf]
!16 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"repl8", metadata !"repl8", metadata !"repl8", i32 0, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void ({ i32*, {}*, i32 }*, { i32*, {}* }*)* @repl8, null, null, metadata !2, i32 0} ; [ DW_TAG_subprogram ] [line 0] [def] [repl8]
!17 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"repl9", metadata !"repl9", metadata !"repl9", i32 0, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void ({ i32*, {}*, i32 }*, { i32*, {}* }*)* @repl9, null, null, metadata !2, i32 0} ; [ DW_TAG_subprogram ] [line 0] [def] [repl9]
!18 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"__MAIN_testDwarf", metadata !"__MAIN_testDwarf", metadata !"__MAIN_testDwarf", i32 0, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void ()* @__MAIN_testDwarf, null, null, metadata !2, i32 0} ; [ DW_TAG_subprogram ] [line 0] [def] [__MAIN_testDwarf]
!19 = metadata !{i32 2, i32 13, metadata !10, null}
...
!23 = metadata !{i32 505, i32 3, metadata !15, null}
!24 = metadata !{i32 5, i32 3, metadata !25, null}
!25 = metadata !{i32 786443, metadata !1, metadata !26, i32 0, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/Users/meister/Development/cando/brcl/src/tests/random//testDwarf]
!26 = metadata !{i32 786443, metadata !1, metadata !14, i32 0, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/Users/meister/Development/cando/brcl/src/tests/random//testDwarf]
!27 = metadata !{i32 6, i32 3, metadata !25, null}
