...
Ltmp1:
	jmp	LBB0_8
LBB0_38:                                ## %(TRY-0).landing-pad.preheader
                                        ##   in Loop: Header=BB0_7 Depth=1
Ltmp2:
	jmp	LBB0_19
	.align	4, 0x90
LBB0_18:                                ## %(TRY-0).landing-pad.split-lp
                                        ##   in Loop: Header=BB0_19 Depth=2
Ltmp18:
LBB0_19:                                ## %(TRY-0).dispatch-TYPEID-CORE-DYNAMIC-GO-6302
...
Ltmp4:
## BB#21:                               ## %(TRY-0).normal-dest27
                                        ##   in Loop: Header=BB0_19 Depth=2
	cmpl	$1, %eax
	je	LBB0_9
## BB#22:                               ## %(TRY-0).normal-dest27
                                        ##   in Loop: Header=BB0_19 Depth=2
	cmpl	$2, %eax
	jne	LBB0_23
LBB0_15:                                ## %(TRY-0).tagbody-#:G6263-2
                                        ##   in Loop: Header=BB0_19 Depth=2
	leaq	72(%rsp), %rbp
	movq	%rbp, %rdi
	movl	$1, %esi
...
## BB#14:                               ## %(TRY-0).normal-dest22
	...
	callq	_sp_copyTsp
	jmp	LBB0_15
LBB0_23:                                ## %(TRY-0).normal-dest27
                                        ##   in Loop: Header=BB0_7 Depth=1
	testl	%eax, %eax
	je	LBB0_7
## BB#24:                               ## %(TRY-0).switch-default
Ltmp19:
	movl	%eax, %edi
	movl	$3, %esi
...
Ltmp20:
	jmp	LBB0_25
LBB0_27:                                ## %(TRY-0).landing-pad32.nonloopexit
Ltmp21:
	jmp	LBB0_28
LBB0_26:                                ## %(TRY-0).landing-pad32.loopexit
Ltmp5:
LBB0_28:                                ## %(TRY-0).landing-pad32
	movq	%rax, 352(%rsp)
	movl	%edx, 348(%rsp)
LBB0_29:                                ## %(TRY-0).dispatch-TYPEID-CORE-RETURN-FROM-6155
	cmpl	$1, 348(%rsp)
	jne	LBB0_35
## BB#30:                               ## %(TRY-0).handler-block6159
	movq	352(%rsp), %rdi
	callq	___cxa_begin_catch
Ltmp22:
...
Ltmp23:
## BB#31:                               ## %(TRY-0).normal-dest40
Ltmp24:
	callq	___cxa_end_catch
Ltmp25:
	jmp	LBB0_37
LBB0_32:                                ## %(TRY-0).landing-pad44
Ltmp26:
	jmp	LBB0_34
LBB0_36:                                ## %(TRY-0).try-cont
	leaq	264(%rsp), %rbx
...
Ltmp30:
## BB#3:                                ## %normal-dest
	callq	_unreachableError
LBB0_8:                                 ## %(TRY-0).normal-dest
	callq	_unreachableError
LBB0_17:                                ## %(TRY-0).normal-dest25
	callq	_unreachableError
LBB0_25:                                ## %(TRY-0).normal-dest28
	callq	_unreachableError
LBB0_4:                                 ## %continue
Ltmp27:
	leaq	"_:::global-str-lambda"(%rip), %rcx
...
## BB#5:                                ## %normal-dest2
	callq	_unreachableError
LBB0_33:                                ## %func-cleanup-landing-pad
Ltmp31:
LBB0_34:                                ## %func-ehresume
	movq	%rdx, %rcx
	movq	%rax, 352(%rsp)
	movl	%ecx, 348(%rsp)
LBB0_35:                                ## %func-ehresume
	leaq	56(%rsp), %rax
	movq	%rax, %rdi
	callq	_destructTsp
	leaq	72(%rsp), %rax
...
Lset5 = Ltmp5-Leh_func_begin0           ##     jumps to Ltmp5
	.long	Lset5
	.byte	3                       ##   On action: 2
Lset6 = Ltmp16-Leh_func_begin0          ## >> Call Site 3 <<
	.long	Lset6
Lset7 = Ltmp15-Ltmp16                   ##   Call between Ltmp16 and Ltmp15
	.long	Lset7
Lset8 = Ltmp18-Leh_func_begin0          ##     jumps to Ltmp18
	.long	Lset8
	.byte	5                       ##   On action: 3
