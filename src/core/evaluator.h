...
namespace core
{
    ...
    Function_sp af_interpreter_lookup_function(Symbol_sp sym, Environment_sp env);
	...
	extern void evaluateIntoActivationFrame(ActivationFrame_sp af, Cons_sp args, Environment_sp environment );
