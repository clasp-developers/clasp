...
SYMBOL_EXPORT_SC_(KeywordPkg,LineTablesOnly);
    ...
    SYMBOL_EXPORT_SC_(CorePkg,STARloadCurrentSourceFileInfoSTAR);
    SYMBOL_EXPORT_SC_(CorePkg,STARloadCurrentLinenumberSTAR);
    SYMBOL_EXPORT_SC_(CorePkg,STARloadCurrentColumnSTAR);
    SYMBOL_EXPORT_SC_(CorePkg,STARloadCurrentFilePosSTAR);
...
//        testPointers();
	...
	core::_sym_STARloadCurrentFilePosSTAR->defparameter(Fixnum_O::create(0));
