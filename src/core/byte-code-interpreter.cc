...
void parse_ltvc_toplevel_funcall(gctools::GCRootsInModule* roots, T_sp fin, bool log, size_t& byte_index) {
  ...
  case 80: parse_ltvc_make_bignum(roots,fin,log,byte_index);
           break;
  case 81: parse_ltvc_make_next_bignum(roots,fin,log,byte_index);
           break;
  case 82: parse_ltvc_make_bitvector(roots,fin,log,byte_index);
           break;
  case 83: parse_ltvc_make_symbol(roots,fin,log,byte_index);
           break;
  case 84: parse_ltvc_make_character(roots,fin,log,byte_index);
           break;
  case 85: parse_ltvc_make_base_string(roots,fin,log,byte_index);
           break;
  case 86: parse_ltvc_make_pathname(roots,fin,log,byte_index);
           break;
  case 87: parse_ltvc_make_random_state(roots,fin,log,byte_index);
           break;
  case 88: parse_ltvc_make_float(roots,fin,log,byte_index);
           break;
  case 89: parse_ltvc_make_double(roots,fin,log,byte_index);
           break;
  case 90: parse_ltvc_enclose(roots,fin,log,byte_index);
           break;
  case 91: parse_ltvc_make_closurette(roots,fin,log,byte_index);
           break;
  ...
  case 93: parse_ltvc_mlf_init_funcall(roots,fin,log,byte_index);
           break;
  case 94: parse_ltvc_mlf_init_basic_call(roots,fin,log,byte_index);
           break;
  case 95: parse_ltvc_mlf_create_basic_call(roots,fin,log,byte_index);
           break;
  case 96: parse_ltvc_set_ltv_funcall(roots,fin,log,byte_index);
           break;
  case 97: parse_ltvc_toplevel_funcall(roots,fin,log,byte_index);
           break;
#endif // DEFINE_SWITCH
