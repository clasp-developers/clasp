...
void parse_ltvc_set_ltv_funcall_cleavir(gctools::GCRootsInModule* roots, T_sp fin, bool log, size_t& byte_index) {
  if (log) printf("%s:%d:%s parse_ltvc_set_ltv_funcall_cleavir\n", __FILE__, __LINE__, __FUNCTION__);
  char tag = ltvc_read_char( fin, log, byte_index );
  size_t index = ltvc_read_size_t( fin, log, byte_index );
  size_t arg2 = ltvc_read_size_t( fin, log, byte_index );
  string arg3 = ltvc_read_string( fin, log, byte_index );
  ltvc_set_ltv_funcall_cleavir( roots, tag, index, arg2, arg3.c_str());
};
void parse_ltvc_toplevel_funcall(gctools::GCRootsInModule* roots, T_sp fin, bool log, size_t& byte_index) {
  ...
  case 72: parse_ltvc_make_array(roots,fin,log,byte_index);
           break;
  case 73: parse_ltvc_setf_row_major_aref(roots,fin,log,byte_index);
           break;
  case 74: parse_ltvc_make_hash_table(roots,fin,log,byte_index);
           break;
  case 75: parse_ltvc_setf_gethash(roots,fin,log,byte_index);
           break;
  case 76: parse_ltvc_make_fixnum(roots,fin,log,byte_index);
           break;
  case 77: parse_ltvc_make_package(roots,fin,log,byte_index);
           break;
  case 78: parse_ltvc_make_bignum(roots,fin,log,byte_index);
           break;
  case 79: parse_ltvc_make_bitvector(roots,fin,log,byte_index);
           break;
  case 80: parse_ltvc_make_symbol(roots,fin,log,byte_index);
           break;
  case 81: parse_ltvc_make_character(roots,fin,log,byte_index);
           break;
  case 82: parse_ltvc_make_base_string(roots,fin,log,byte_index);
           break;
  case 83: parse_ltvc_make_pathname(roots,fin,log,byte_index);
           break;
  case 84: parse_ltvc_make_random_state(roots,fin,log,byte_index);
           break;
  case 85: parse_ltvc_make_float(roots,fin,log,byte_index);
           break;
  case 86: parse_ltvc_make_double(roots,fin,log,byte_index);
           break;
  case 87: parse_ltvc_enclose(roots,fin,log,byte_index);
           break;
  case 88: parse_ltvc_allocate_instance(roots,fin,log,byte_index);
           break;
  case 89: parse_ltvc_find_class(roots,fin,log,byte_index);
           break;
  ...
  case 91: parse_ltvc_mlf_init_funcall(roots,fin,log,byte_index);
           break;
  case 92: parse_ltvc_set_ltv_funcall(roots,fin,log,byte_index);
           break;
  case 93: parse_ltvc_set_ltv_funcall_cleavir(roots,fin,log,byte_index);
           break;
  case 94: parse_ltvc_toplevel_funcall(roots,fin,log,byte_index);
           break;
#endif // DEFINE_SWITCH
