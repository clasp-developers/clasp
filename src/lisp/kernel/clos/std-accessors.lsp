...
(defun std-class-optimized-accessors (slot-name)
  ...
  (with-early-accessors (+standard-class-slots+)
    (values #'(lambda (.combined-method-args. .next-methods. self)
		(declare (optimize (safety 0) (speed 3) (debug 0))
                         (ignore .combined-method-args. .next-methods.)
	    ...
	    #'(lambda (.combined-method-args. .next-methods. value self)
		(declare (optimize (safety 0) (speed 3) (debug 0))
                         (ignore .combined-method-args. .next-methods.)
			 (standard-object self))
		(ensure-up-to-date-instance self)
...
(defun std-class-accessors (slot-name)
  ...
  (values #'(lambda (.combined-method-args. .next-methods. self)
              (declare (ignore .combined-method-args. .next-methods.))
