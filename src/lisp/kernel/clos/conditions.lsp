...
;;; Following is debug message for a bug in clasp
  ...
  (do ((prevr nil r)
      ...
      ((null r))
    (unless (listp (cdr r))
      (print "'*restart-clusters* address")
      (print (core:object-address '*restart-clusters*))
      (print (core:symbol-value-address '*restart-clusters*))
      (print "*restart-clusters* symbol-value -> ")
      (print (core:object-address *restart-clusters*))
      (print "prevr ->")
      (print prevr)
      (print (core:object-address prevr))
      (print "r ->")
      (print r)
      (print (core:object-address r))))
