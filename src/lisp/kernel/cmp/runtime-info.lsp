...
(defvar +closure-function-description-offset+ (get-cxx-data-structure-info :closure-function-description-offset))
(defvar +function-description-entry-points-offset+ (get-cxx-data-structure-info :function-description-entry-points-offset))
...
(defvar +vaslist-ptag-mask+ (get-cxx-data-structure-info :vaslist-ptag-mask))
(defvar +alignment+ (get-cxx-data-structure-info :alignment))
(defvar +vaslist0-tag+ (get-cxx-data-structure-info :vaslist0-tag))
(defvar +vaslist1-tag+ (get-cxx-data-structure-info :vaslist1-tag))
(defvar +fixnum00-tag+ (get-cxx-data-structure-info :fixnum00-tag))
(defvar +fixnum01-tag+ (get-cxx-data-structure-info :fixnum01-tag))
(defvar +fixnum10-tag+ (get-cxx-data-structure-info :fixnum10-tag))
(defvar +fixnum11-tag+ (get-cxx-data-structure-info :fixnum11-tag))
