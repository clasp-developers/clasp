...
(defun primitives-in-thread ()
  (let ((*primitives* (make-hash-table :test 'equal)))
    ...
    (primitive         "ltvc_make_nil" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t%))
    (primitive         "ltvc_make_t" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t%))
    (primitive         "ltvc_make_ratio" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*%))
    (primitive         "ltvc_make_complex" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*%))
    (primitive         "ltvc_make_cons" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*%))
    (primitive         "ltvc_nconc" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*%))
    (primitive         "ltvc_make_list" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %size_t%) :varargs t)
    (primitive         "ltvc_make_array" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*%))
    (primitive         "ltvc_setf_row_major_aref" %ltvc-return% (list %t*% %size_t% %t*%))
    (primitive         "ltvc_make_hash_table" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive         "ltvc_setf_gethash" %ltvc-return% (list %t*% %t*% %t*%))
    (primitive         "ltvc_make_fixnum" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %uintptr_t%))
    (primitive         "ltvc_make_package" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive         "ltvc_make_bignum" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive         "ltvc_make_bitvector" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive         "ltvc_make_symbol" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*%))
    (primitive         "ltvc_make_character" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %uintptr_t%))
    (primitive         "ltvc_make_base_string" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %i8*%))
    (primitive         "ltvc_make_pathname" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*% %t*% %t*% %t*% %t*% %t*%))
    (primitive         "ltvc_make_package" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive         "ltvc_make_random_state" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive         "ltvc_make_float" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %float%))
    (primitive         "ltvc_make_double" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %double%))
    ...
    (primitive         "ltvc_enclose" %ltvc-return% (list %gcroots-in-module*%
                                                          ...
                                                          %size_t%
                                                          %size_t%))
    (primitive-unwinds "ltvc_allocate_instance" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive-unwinds "ltvc_find_class" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %t*%))
    (primitive-unwinds "ltvc_set_mlf_creator_funcall" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %fn-prototype*% %i8*%))
    (primitive-unwinds "ltvc_mlf_init_funcall" %ltvc-return% (list %fn-prototype*% %i8*%))
    (primitive-unwinds "ltvc_set_ltv_funcall" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %fn-prototype*% %i8*%))
    (primitive-unwinds "ltvc_set_ltv_funcall_cleavir" %ltvc-return% (list %gcroots-in-module*% %i8% %size_t% %fn-prototype*% %i8*%))
    (primitive-unwinds "ltvc_toplevel_funcall" %ltvc-return% (list %fn-prototype*% %i8*%))

    (primitive         "cc_lookup_transient" %t*% (list %gcroots-in-module*% %i8% %size_t%))
