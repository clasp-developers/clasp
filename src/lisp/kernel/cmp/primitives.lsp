...
(defvar *startup-primitives-as-list*
  '((primitive         "ltvc_make_nil" :ltvc-return (list :gcroots-in-module* :i8 :size_t) :ltvc t)
    ...
    (primitive         "ltvc_make_global_entry_point" :ltvc-return (list :gcroots-in-module* :i8 :size_t :size_t :t*) :ltvc t)
...
;;;    (primitive-unwinds "invokeTopLevelFunction" :void (list :tmv* :fn-prototype* :i8* :i32* :size_t :size_t :size_t :ltv**))
         ...
         (primitive         "llvm.log.f32" :float (list :float))
         (primitive         "llvm.trunc.f32" :float (list :float))
         (primitive         "llvm.pow.f32" :float (list :float :float))
         (primitive         "tanf" :float (list :float))
         (primitive         "asinf" :float (list :float))
         (primitive         "acosf" :float (list :float))
         ;; atan's two argument form might be tricky FIXME
         (primitive         "sinhf" :float (list :float))
         (primitive         "coshf" :float (list :float))
         (primitive         "tanhf" :float (list :float))
         (primitive         "asinhf" :float (list :float))
         (primitive         "acoshf" :float (list :float))
         (primitive         "atanhf" :float (list :float))

         (primitive         "llvm.cos.f64" :double (list :double))
         (primitive         "llvm.sin.f64" :double (list :double))
         (primitive         "llvm.fabs.f64" :double (list :double))
         (primitive         "llvm.sqrt.f64" :double (list :double))
         (primitive         "llvm.exp.f64" :double (list :double))
         (primitive         "llvm.log.f64" :double (list :double))
         (primitive         "llvm.trunc.f64" :double (list :double))
         (primitive         "llvm.pow.f64" :double (list :double :double))
         (primitive         "tan" :double (list :double))
         (primitive         "asin" :double (list :double))
         (primitive         "acos" :double (list :double))
         ;; atan here but tricky FIXME
         (primitive         "sinh" :double (list :double))
         (primitive         "cosh" :double (list :double))
         (primitive         "tanh" :double (list :double))
         (primitive         "asinh" :double (list :double))
         (primitive         "acosh" :double (list :double))
         (primitive         "atanh" :double (list :double))
...
;;         (primitive-unwinds "cc_throw" :void (list :t*) :does-not-return t)
         ...
         (primitive-unwinds "cc_unbox_single_float" :float (list :t*))
         (primitive-unwinds "cc_unbox_double_float" :double (list :t*))
