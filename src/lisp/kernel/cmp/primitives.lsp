...
;;;    (primitive-unwinds "cc_dispatch_slot_writer_index_debug"   %return_type% (list %t*% %size_t% %t*% %t*%)) ; effective-method gf gf-args
    ...
    (primitive         "cc_dispatch_slot_writer_index"  %return_type% (list %t*% %size_t% %t*%)) ; value index instance
    (primitive         "cc_dispatch_slot_writer_cons"   %return_type% (list %t*% %t*%)) ; value cons
    ...
    (primitive-unwinds "cc_bound_or_error" %return_type% (list %t*% %t*% %t*%)) ; optimized-data instance value
