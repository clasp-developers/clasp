...
(defun direct-mv-local-call (tmv abi callee-info nreq nopt rest-var)
    ...
    (multiple-value-bind (req opt rest-var key-flag keyargs aok aux varest-p)
      ...
      (if (or key-flag varest-p)
          ...
          (direct-mv-local-call
           tmv abi callee-info (car req) (car opt) rest-var)))))
...
(defun values-collect-multi (inst abi)
