...
(define-unary-primop core::df-abs    "llvm.fabs.f64" cmp:%double%)
(define-unary-primop core::df-sqrt   "llvm.sqrt.f64" cmp:%double%)
(define-unary-primop core::df-exp    "llvm.exp.f64"  cmp:%double%)
(define-unary-primop core::df-log    "llvm.log.f64"  cmp:%double%)
(define-unary-primop core::df-cos    "llvm.cos.f64"  cmp:%double%)
(define-unary-primop core::df-sin    "llvm.sin.f64"  cmp:%double%)
