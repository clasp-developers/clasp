...
(defmacro define-float-specializer (instruction-class-name llvm-type)
  `(defmethod cleavir-ir:specialize ((instruction ,instruction-class-name)
     ...
     (convert-tll-list (cleavir-ir:inputs instruction) ,llvm-type)
     (convert-tll-list (cleavir-ir:outputs instruction) ,llvm-type)
     instruction))

(define-float-specializer cleavir-ir:double-float-add-instruction cmp::%double%)
(define-float-specializer cleavir-ir:double-float-sub-instruction cmp::%double%)
(define-float-specializer cleavir-ir:double-float-mul-instruction cmp::%double%)
(define-float-specializer cleavir-ir:double-float-div-instruction cmp::%double%)

(define-float-specializer cleavir-ir:single-float-add-instruction cmp::%float%)
(define-float-specializer cleavir-ir:single-float-sub-instruction cmp::%float%)
(define-float-specializer cleavir-ir:single-float-mul-instruction cmp::%float%)
(define-float-specializer cleavir-ir:single-float-div-instruction cmp::%float%)
