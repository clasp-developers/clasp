...
(defvar +block-dynenv-size+ (get-cxx-data-structure-info :block-dynenv-size))
(defvar +tagbody-dynenv-size+ (get-cxx-data-structure-info :tagbody-dynenv-size))
...
(defvar +progv-dynenv-size+ (get-cxx-data-structure-info :progv-dynenv-size))
(defvar +alignment+ (get-cxx-data-structure-info :alignment))
...
(defvar +bignum-size+ (get-cxx-data-structure-info :bignum-size))
(defvar +limb-size+ (get-cxx-data-structure-info :limb-size))
