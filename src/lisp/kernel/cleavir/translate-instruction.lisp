...
(defmethod translate-simple-instruction
  ...
  (let* ((enter-instruction (cleavir-ir:code instruction))
         ...
         (enclosed-function-name (llvm-sys:get-name enclosed-function))
         (function-description (llvm-sys:get-named-global *the-module* (cmp::function-description-name enclosed-function-name)))
