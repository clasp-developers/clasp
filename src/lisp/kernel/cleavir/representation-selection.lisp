...
(defmethod %definition-rtype ((inst bir:instruction) (datum bir:datum))
  ...
  '(:object))
(defmethod %definition-rtype ((inst bir:eq-test) (datum bir:datum))
  '(:boolean))
(defmethod %definition-rtype ((inst cc-bmir:fixnump) (datum bir:datum))
  '(:boolean))
(defmethod %definition-rtype ((inst cc-bmir:consp) (datum bir:datum))
  '(:boolean))
(defmethod %definition-rtype ((inst cc-bmir:characterp) (datum bir:datum))
  '(:boolean))
(defmethod %definition-rtype ((inst cc-bmir:single-float-p) (datum bir:datum))
  '(:boolean))
(defmethod %definition-rtype ((inst cc-bmir:generalp) (datum bir:datum))
  '(:boolean))
...
(defmethod %definition-rtype ((inst cc-vaslist:butlast) (datum bir:datum))
  '(:vaslist))
(defmethod %definition-rtype ((inst cc-vaslist:nendp) (datum bir:datum))
  '(:boolean))
...
(defmethod insert-casts ((instruction bir:eq-test))
  (object-inputs instruction)
  (cast-output instruction '(:boolean)))
(defmethod insert-casts ((instruction cc-bmir:fixnump))
  (object-inputs instruction)
  (cast-output instruction '(:boolean)))
(defmethod insert-casts ((instruction cc-bmir:consp))
  (object-inputs instruction)
  (cast-output instruction '(:boolean)))
(defmethod insert-casts ((instruction cc-bmir:characterp))
  (object-inputs instruction)
  (cast-output instruction '(:boolean)))
(defmethod insert-casts ((instruction cc-bmir:single-float-p))
  (object-inputs instruction)
  (cast-output instruction '(:boolean)))
(defmethod insert-casts ((instruction cc-bmir:generalp))
  (object-inputs instruction)
  (cast-output instruction '(:boolean)))
