...
(defmethod vrtype->llvm ((vrtype (eql :ub1))) cmp:%i1%)
(defmethod vrtype->llvm ((vrtype (eql :ub2))) cmp:%i2%)
(defmethod vrtype->llvm ((vrtype (eql :ub4))) cmp:%i4%)
...
(defmethod vrtype->llvm ((vrtype (eql :sb1))) cmp:%i1%)
(defmethod vrtype->llvm ((vrtype (eql :sb2))) cmp:%i2%)
(defmethod vrtype->llvm ((vrtype (eql :sb4))) cmp:%i4%)
