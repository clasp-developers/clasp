...
;;    (bformat t "About to check generic-function-table for symbol[%s]\n" symbol)
...
;;; Instance creation and initialization
  ...
  (clos-log "-----Instance creation and initialization")
...
;;;
  ...
  (clos-log "-----Class meta object methods")
...
;;; Class precedence lists
  ...
  (clos-log "-----Class precedence lists")
...
;;;
  ...
  (clos-log "-----Methods having to do with generic function metaobjects")
...
;;;
  ...
  (clos-log "-----Methods having to do with method metaobjects")
...
;;;
  ...
  (clos-log "-----Methods having to do with generic function invocation")
...
;;; describe-object is a handy tool for enquiring minds:
  ...
  (clos-log "----- Generic function describe-object is a handy tool for enquiring minds")
...
(clos-log "..closette initialization done..")
