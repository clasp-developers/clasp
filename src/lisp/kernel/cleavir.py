cleavir_parts = [
    ...
    "src/lisp/kernel/contrib/alexandria/LICENCE",
    "src/lisp/kernel/contrib/alexandria/tests",
    ...
    "src/lisp/kernel/contrib/Eclector/README",
    "src/lisp/kernel/contrib/Eclector/LICENSE-BSD",
