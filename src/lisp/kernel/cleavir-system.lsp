...
(#P"kernel/contrib/sicl/Code/Cleavir/Input-output/packages"
 ...
 #P"kernel/cleavir/packages" #P"kernel/cleavir/cleavir-fixups-and-hacks"
 ...
 #P"kernel/cleavir/arguments" #P"kernel/cleavir/closure-optimize"
 #P"kernel/cleavir/translate" #P"kernel/cleavir/inline-prep" :PRE-INLINE
 #P"kernel/cleavir/auto-compile" #P"kernel/cleavir/inline") 