...
;;;;
;;;;  top.lisp -- Top-level loop, break loop, and error handlers
;;;;
...
(defparameter *step-level* 0)			; repeated from trace.lisp
  ...
  (with-standard-io-syntax
    (let* ((*standard-input* *debug-io*)
	   ...
	   (*break-condition* condition)
           ...
           (break-level *break-level*)
           (*break-env* nil)
	   (cmp:*implicit-compile-hook* 'cmp:bytecode-implicit-compile-form))
