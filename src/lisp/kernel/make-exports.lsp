...
(in-package :clsymbols)

(eval-when (evaluate)
  (defvar *all-cl-symbols* '(
...
(create-export-file (bformat nil "%s/lsp/exportcore.lsp" (getenv "LISP_BRCL_DIR")) :core)
(create-export-file (bformat nil "%s/clos/exportclos.lsp" (getenv "LISP_BRCL_DIR")) :clos)
