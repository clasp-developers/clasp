...
(defun print-header (prefix stream &rest urls)
  (format stream "~a This file is automatically generated.~%~a command: ninja -C build update-unicode~%"
          prefix prefix)
...
(defun generate (c-file names-file &optional (data-url "http://unicode.org/Public/UNIDATA/UnicodeData.txt")
  ...
  (let* ((data (make-unicode-data))
    ...
    (ninja:with-timestamp-preserving-stream (stream c-file)
      ...
      (print-interval-function "clasp_isgraph" "cc" (unicode-data-graphic-intervals data) stream)
      (print-interval-function "clasp_isprint" "cc" (unicode-data-printing-intervals data) stream)
      (print-interval-function "clasp_isupper" "cc" (unicode-data-uppercase-intervals data) stream)
      (print-interval-function "clasp_islower" "cc" (unicode-data-lowercase-intervals data) stream)
      (print-interval-function "clasp_isboth" "cc" (unicode-data-bothcase-intervals data) stream)
      (print-interval-function "clasp_isalpha" "cc" (unicode-data-alpha-intervals data) stream)
      (print-interval-function "clasp_isalnum" "cc" (unicode-data-alphanumeric-intervals data) stream)
      (print-mapping-function "clasp_toupper" "cc" (unicode-data-uppercase-mappings data) stream)
      (print-mapping-function "clasp_tolower" "cc" (unicode-data-lowercase-mappings data) stream))
    (let ((*print-radix* t)
          (*print-base* 16))
