...
(test-true stamp-of-builtin
           (= (core:instance-stamp (make-hash-table))
              (core:class-stamp-for-instances (class-of (make-hash-table)))))
;; Test that rack stamps work for CLOS classes
(defclass mygoofytestclass () ())
(test-true stamp-from-rack
