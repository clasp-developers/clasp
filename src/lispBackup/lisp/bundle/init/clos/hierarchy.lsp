...
;;
;; Ensure that the +class-slots+ defined above match the ones
;; hard-coded into the MetaClass_O class in llcl
;;
#+cando (make-sure-clos-class-slots-match-meta-class +class-slots+)
