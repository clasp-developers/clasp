...
#undef SET_SYMBOL
    ...
    core::BuiltInClass_sp classcffi__Pointer_Oval = core::BuiltInClass_O::create();
    ...
    cffi::Pointer_O::static_Kind = gctools::GCInfo<cffi::Pointer_O>::Kind;
    core::af_setf_findClass(classcffi__Pointer_Oval,cffi::Pointer_O::static_classSymbol(),true,_Nil<core::Environment_O>());
    {
        LispObjectAllocatorFunctor<cffi::Pointer_O>* cb = new LispObjectAllocatorFunctor<cffi::Pointer_O>();
        cffi::Pointer_O::___set_static_allocator(cb);
    }
    LOG(BF("Set static_allocator for class(%s) to %X")% cffi::Pointer_O::static_className() % (void*)(cffi::Pointer_O::static_allocator) );
    classcffi__Pointer_Oval->setAllocator(cffi::Pointer_O::static_allocator);
    {
        LOG(BF("Created nil for class[%s]") % cffi::Pointer_O::static_className() );
//        cffi::Pointer_O::___staticDereferencedNilInstance = new cffi::Pointer_O();
//        cffi::Pointer_O::___staticDereferencedNilInstance->___make_nil(); /* Unique NIL for class*/
//        cffi::Pointer_O::___staticDereferencedUnboundInstance = new cffi::Pointer_O();
//        cffi::Pointer_O::___staticDereferencedUnboundInstance->___make_unbound(); /* Unique UNBOUND for class */
//        cffi::Pointer_O::_nil = _Nil<cffi::Pointer_O>();
//        cffi::Pointer_O::_unbound = _Unbound<cffi::Pointer_O>();
    }
//    classcffi__Pointer_Oval->setSupportsSlots(cffi::Pointer_O::static_supportsSlots());
    /* ----- the class and its nil are now defined and so is classcffi__Pointer_Oval::___staticClass but the class _Slots and _Signature_ClassSlots are undefined - set them both to T_O::_nil in stage3   ----- */
#endif // CREATE_CLASS
#undef CREATE_CLASS
