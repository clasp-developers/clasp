...
def collect_bclasp_lisp_files(**kwargs):
    files = collect_aclasp_lisp_files(**kwargs) + [
        ...
        "src/lisp/kernel/cmp/opt/opt", # need loop
        "src/lisp/kernel/cmp/opt/opt-character",
        "src/lisp/kernel/cmp/opt/opt-number",
        "src/lisp/kernel/cmp/opt/opt-type",
        "src/lisp/kernel/cmp/opt/opt-control",
        "src/lisp/kernel/cmp/opt/opt-sequence",
        "src/lisp/kernel/cmp/opt/opt-cons",
        "src/lisp/kernel/cmp/opt/opt-array",
        "src/lisp/kernel/cmp/opt/opt-object",
        "src/lisp/kernel/cmp/opt/opt-condition",
        "src/lisp/kernel/cmp/opt/opt-print",
