...
cleavir_file_list = [
    ...
    "src/lisp/kernel/contrib/sicl/Code/Cleavir/Attributes/packages",
    "src/lisp/kernel/contrib/sicl/Code/Cleavir/Attributes/attributes",
    ...
    "src/lisp/kernel/contrib/sicl/Code/Cleavir/HIR-transformations/value-type-infer",
