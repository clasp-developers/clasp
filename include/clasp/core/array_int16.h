...
namespace core {
  ...
  public:
    ...
    static value_type from_object(T_sp obj) { return clasp_to_uint16_t(gc::As<core::Integer_sp>(obj)); };
...
namespace core {
  ...
  public:
    ...
    static value_type from_object(T_sp obj) { return clasp_to_int16_t(gc::As<core::Integer_sp>(obj)); };
    static T_sp to_object(const value_type& v) { return core::Integer_O::create(v); };
  public:
  ...
  public:
    ...
    virtual T_sp arrayElementType() const override { return ext::_sym_integer16; };
