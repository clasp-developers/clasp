// ============================================================
// Arrays specialized for uint16_t
//
namespace core {
  FORWARD(SimpleVector_uint16_t);
  FORWARD(MDArray_uint16_t);
  FORWARD(SimpleMDArray_uint16_t);
};
template <>
struct gctools::GCInfo<core::SimpleVector_uint16_t_O> {
...
namespace core {
  ...
  typedef template_SimpleVector<SimpleVector_uint16_t_O,uint16_t,AbstractSimpleVector_O> specialized_SimpleVector_uint16_t;
  class SimpleVector_uint16_t_O : public specialized_SimpleVector_uint16_t {
    LISP_CLASS(core, CorePkg, SimpleVector_uint16_t_O, "SimpleVector_uint16_t",AbstractSimpleVector_O);
    virtual ~SimpleVector_uint16_t_O() {};
  public:
    typedef specialized_SimpleVector_uint16_t TemplatedBase;
  ...
  public:
  SimpleVector_uint16_t_O(size_t length, value_type initialElement=value_type(),
  ...
  public:
    ...
    virtual T_sp element_type() const override { return core::_sym_uint16_t;};
    virtual T_sp arrayElementType() const override { return core::_sym_uint16_t; };
    virtual clasp_elttype elttype() const { return clasp_aet_uint16_t; };
  };
};


namespace core {
  class MDArray_uint16_t_O : public template_Array<MDArray_uint16_t_O,SimpleVector_uint16_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, MDArray_uint16_t_O, "MDArray_uint16_t",MDArray_O);
    virtual ~MDArray_uint16_t_O() {};
  public:
    typedef template_Array<MDArray_uint16_t_O,SimpleVector_uint16_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  MDArray_uint16_t_O(size_t dummy_rank_1,
                     size_t dimension,
                     T_sp fillPointer,
                     Array_sp data,
                     bool displacedToP,
  ...
  public: // make array
  MDArray_uint16_t_O(size_t rank,
                     List_sp dimensions,
                     Array_sp data,
                     bool displacedToP,
...
namespace core {
  class SimpleMDArray_uint16_t_O : public template_SimpleArray<SimpleMDArray_uint16_t_O,SimpleVector_uint16_t_O,SimpleMDArray_O> {
    LISP_CLASS(core, CorePkg, SimpleMDArray_uint16_t_O, "SimpleMDArray_uint16_t",SimpleMDArray_O);
    virtual ~SimpleMDArray_uint16_t_O() {};
  public:
    typedef template_SimpleArray<SimpleMDArray_uint16_t_O,SimpleVector_uint16_t_O,SimpleMDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  SimpleMDArray_uint16_t_O(size_t rank1, size_t dimension, Array_sp data) : TemplatedBase(dimension,data) {};
  ...
  public: // make array
  SimpleMDArray_uint16_t_O(size_t rank,
                           List_sp dimensions,
    ...
    static smart_ptr_type make_multi_dimensional(List_sp dim_desig, simple_element_type initialElement, T_sp data) {
      ...
      size_t arrayTotalSize = calculateArrayTotalSizeAndValidateDimensions(dim_desig,rank);
      LIKELY_if (data.nilp()) {
        data = SimpleVector_uint16_t_O::make(arrayTotalSize,initialElement,true);
      }
...
namespace core {
  ...
  public:
    virtual T_sp array_type() const final { return cl::_sym_simple_array; };
    virtual T_sp element_type() const override { return core::_sym_int16_t;};
    virtual T_sp arrayElementType() const override { return core::_sym_int16_t; };
    virtual clasp_elttype elttype() const { return clasp_aet_int16_t; };
  };
};


namespace core {
  class MDArray_int16_t_O : public template_Array<MDArray_int16_t_O,SimpleVector_int16_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, MDArray_int16_t_O, "MDArray_int16_t",MDArray_O);
    virtual ~MDArray_int16_t_O() {};
  public:
    typedef template_Array<MDArray_int16_t_O,SimpleVector_int16_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  MDArray_int16_t_O(size_t dummy_rank_1,
                     size_t dimension,
                     T_sp fillPointer,
                     Array_sp data,
                     bool displacedToP,
