...
namespace core {
  ...
  public:
    ...
    virtual T_sp element_type() const override { return core::_sym_byte16;};
    virtual T_sp arrayElementType() const override { return core::_sym_byte16; };
...
namespace core {
  class MDArray_byte16_t_O : public template_Array<MDArray_byte16_t_O,SimpleVector_byte16_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, MDArray_byte16_t_O, "MDArray_byte16_t",MDArray_O);
    virtual ~MDArray_byte16_t_O() {};
  public:
    typedef template_Array<MDArray_byte16_t_O,SimpleVector_byte16_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  MDArray_byte16_t_O(size_t dummy_rank_1,
                     size_t dimension,
                     T_sp fillPointer,
                     Array_sp data,
                     bool displacedToP,
...
namespace core {
  ...
  public:
    virtual T_sp array_type() const final { return cl::_sym_simple_array; };
    virtual T_sp element_type() const override { return core::_sym_integer16;};
    virtual T_sp arrayElementType() const override { return core::_sym_integer16; };
