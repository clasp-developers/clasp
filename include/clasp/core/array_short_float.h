...
typedef template_SimpleVector<SimpleVector_short_float_O, short_float_t, AbstractSimpleVector_O> specialized_SimpleVector_short_float;
...
public:
  ...
  static SimpleVector_short_float_sp create(size_t sz) { return make(sz, 0.0, false, 0, NULL); }
...
class ComplexVector_short_float_O : public template_Vector<ComplexVector_short_float_O, SimpleVector_short_float_O, ComplexVector_O> {
