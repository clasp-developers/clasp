...
namespace core {
  ...
  public:
    inline int& operator[](size_t i) { return this->_Vector[i]; };
    inline const int& operator[](size_t i) const { return this->_Vector[i]; };
  ...
  public:
    inline double& operator[](size_t i) { return this->_Vector[i]; };
    inline const double& operator[](size_t i) const { return this->_Vector[i]; };
  ...
  public:
    inline float& operator[](size_t i) { return this->_Vector[i]; };
    inline const float& operator[](size_t i) const { return this->_Vector[i]; };
