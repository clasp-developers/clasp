...
#define LAMBDA(...) BEGIN_TAG LAMBDA ( :FILE __FILE__ :LINE __LINE__ :LAMBDA-LIST  #__VA_ARGS__ )
#define DOCSTRING(...) BEGIN_TAG DOCSTRING ( :FILE __FILE__ :LINE __LINE__ :DOCSTRING __VA_ARGS__ )
#define DECLARE(...) BEGIN_TAG DECLARE ( :FILE __FILE__ :LINE __LINE__ :DECLARE #__VA_ARGS__ )
...
#define NAMESPACE_PACKAGE_ASSOCIATION(ns,pkg,pkgname) BEGIN_TAG NAMESPACE_PACKAGE_ASSOCIATION ( :NAMESPACE #ns :PACKAGE #pkg :PACKAGE-NAME pkgname )
