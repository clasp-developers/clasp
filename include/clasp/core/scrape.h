...
#define CL_BEGIN_ENUM(type, symbol, desc)                                                                                          \
  BEGIN_TAG CL_BEGIN_ENUM_TAG ( :FILE __FILE__ :LINE __LINE__ :TYPE #type :SYMBOL #symbol :DESCRIPTION desc )
...
#define CL_EXTERN_DEFMETHOD(type, pointer)                                                                                         \
  BEGIN_TAG CL_EXTERN_DEFMETHOD_TAG (:FILE __FILE__ :LINE __LINE__ :TYPE #type :POINTER #pointer )
...
#define DETAILED_SYMBOL_EXPORT_SC_(pkg, cxxname, name)                                                                             \
  BEGIN_TAG DETAILED_SYMBOL_EXTERNAL ( :FILE __FILE__ :LINE __LINE__  :PACKAGE #pkg :CXX-NAME #cxxname :NAME name )
...
#define NAMESPACE_PACKAGE_ASSOCIATION(ns, pkg, pkgname)                                                                            \
  BEGIN_TAG NAMESPACE_PACKAGE_ASSOCIATION_TAG ( :FILE __FILE__ :LINE __LINE__ :NAMESPACE #ns :PACKAGE #pkg :PACKAGE-NAME pkgname )
#define LISP_META_CLASS(...) BEGIN_TAG META_CLASS_TAG ( :FILE __FILE__ :LINE __LINE__ :META-CLASS  #__VA_ARGS__ )
#define LISP_CLASS(n, p, c, s, b)                                                                                                  \
  BEGIN_TAG LISP_CLASS_TAG ( :FILE __FILE__ :LINE __LINE__ :NAMESPACE #n :PACKAGE #p :CLASS #c :CLASS-SYMBOL s :BASE #b)           \
                                DETAILED_SYMBOL_EXPORT_SC_(p, c, s)
#define LISP_ABSTRACT_CLASS(n, p, c, s, b)                                                                                         \
  BEGIN_TAG LISP_CLASS_TAG ( :FILE __FILE__ :LINE __LINE__ :NAMESPACE #n :PACKAGE #p :CLASS #c :CLASS-SYMBOL s :BASE #b )          \
                                DETAILED_SYMBOL_EXPORT_SC_(p, c, s)
#define LISP_EXTERNAL_CLASS(n, p, l, c, s, b)                                                                                      \
  BEGIN_TAG LISP_EXTERNAL_CLASS_TAG ( :FILE __FILE__ :LINE __LINE__ :NAMESPACE #n :PACKAGE #p :CXXCLASS #l :CLASS #c :CLASS-SYMBOL s :BASE #b ) DETAILED_SYMBOL_EXPORT_SC_(p, c, s)
#else
