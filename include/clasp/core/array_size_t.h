...
template <> struct gctools::GCInfo<core::SimpleVector_size_t_O> {
...
public: // make array
  MDArray_size_t_O(size_t rank, List_sp dimensions, Array_sp data, bool displacedToP, Fixnum_sp displacedIndexOffset)
...
public: // make array
  SimpleMDArray_size_t_O(size_t rank, List_sp dimensions, Array_sp data) : TemplatedBase(rank, dimensions, data){};
};
}; // namespace core
...
public: // make vector
  ComplexVector_size_t_O(size_t rank1, size_t dimension, T_sp fillPointer, Array_sp data, bool displacedToP,
  ...
  static smart_ptr_type make_vector(size_t dimension, simple_element_type initialElement /*=simple_element_type()*/,
                                    ...
                                    bool displacedToP /*=false*/, Fixnum_sp displacedIndexOffset /*=clasp_make_size_t(0)*/) {
