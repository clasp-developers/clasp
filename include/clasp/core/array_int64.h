...
namespace core {
  ...
  public:
    ...
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  SimpleMDArray_byte64_t_O(size_t rank1, size_t dimension, Array_sp data) : TemplatedBase(dimension,data) {};
  ...
  SimpleMDArray_byte64_t_O(size_t rank,
    ...
    static smart_ptr_type make_multi_dimensional(List_sp dim_desig, simple_element_type initialElement, T_sp data) {
      ...
      size_t arrayTotalSize = calculateArrayTotalSizeAndValidateDimensions(dim_desig,rank);
      LIKELY_if (data.nilp()) {
        data = SimpleVector_byte64_t_O::make(arrayTotalSize,initialElement,true);
      }
...
namespace core {
  class ComplexVector_byte64_t_O : public template_Array<ComplexVector_byte64_t_O,ComplexVector_byte64_t_O,SimpleVector_byte64_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, ComplexVector_byte64_t_O, "ComplexVector_byte64_t",MDArray_O);
    virtual ~ComplexVector_byte64_t_O() {};
  public:
    typedef template_Array<ComplexVector_byte64_t_O,ComplexVector_byte64_t_O,SimpleVector_byte64_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  ComplexVector_byte64_t_O(size_t dimension,
                          T_sp fillPointer,
                          Array_sp data,
                          bool displacedToP,
...
namespace core {
  class ComplexVector_int64_t_O : public template_Array<ComplexVector_int64_t_O,ComplexVector_int64_t_O,SimpleVector_int64_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, ComplexVector_int64_t_O, "ComplexVector_int64_t",MDArray_O);
    virtual ~ComplexVector_int64_t_O() {};
  public:
    typedef template_Array<ComplexVector_int64_t_O,ComplexVector_int64_t_O,SimpleVector_int64_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
    ComplexVector_int64_t_O(size_t dimension,
                           T_sp fillPointer,
                           Array_sp data,
                           bool displacedToP,
                           Fixnum_sp displacedIndexOffset) : TemplatedBase(Rank1(),dimension,fillPointer,data,displacedToP,displacedIndexOffset) {};
