...
namespace core {
  class ComplexVector_byte32_t_O : public template_Array<ComplexVector_byte32_t_O,ComplexVector_byte32_t_O,SimpleVector_byte32_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, ComplexVector_byte32_t_O, "ComplexVector_byte32_t",MDArray_O);
    virtual ~ComplexVector_byte32_t_O() {};
  public:
    typedef template_Array<ComplexVector_byte32_t_O,ComplexVector_byte32_t_O,SimpleVector_byte32_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
...
namespace core {
  class ComplexVector_int32_t_O : public template_Array<ComplexVector_int32_t_O,ComplexVector_int32_t_O,SimpleVector_int32_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, ComplexVector_int32_t_O, "ComplexVector_int32_t",MDArray_O);
    virtual ~ComplexVector_int32_t_O() {};
  public:
    typedef template_Array<ComplexVector_int32_t_O,ComplexVector_int32_t_O,SimpleVector_int32_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
