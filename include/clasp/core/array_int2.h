...
template <> struct gctools::GCInfo<core::SimpleVector_byte2_t_O> {
...
public:
  SimpleVector_byte2_t_O(size_t length, bit_array_word initialElement = 0, bool initialElementSupplied = false, size_t initialContentsSize = 0,
...
public: // make array
  MDArray_byte2_t_O(size_t rank, List_sp dimensions, Array_sp data, bool displacedToP, Fixnum_sp displacedIndexOffset)
...
public: // make array
  SimpleMDArray_byte2_t_O(size_t rank, List_sp dimensions, Array_sp data) : TemplatedBase(rank, dimensions, data){};
};
}; // namespace core
...
public: // make vector
  ComplexVector_byte2_t_O(size_t rank1, size_t dimension, T_sp fillPointer, Array_sp data, bool displacedToP,
...
template <> struct gctools::GCInfo<core::SimpleVector_int2_t_O> {
  static bool constexpr NeedsInitialization = false;
  static bool constexpr NeedsFinalization = false;
  static GCInfo_policy constexpr Policy = atomic;
};
...
public:
  SimpleVector_int2_t_O(size_t length, bit_array_word initialElement = 0, bool initialElementSupplied = false, size_t initialContentsSize = 0,
                        const bit_array_word* initialContents = NULL)
      : TemplatedBase(length, initialElement, initialElementSupplied, initialContentsSize, initialContents){};
  static smart_ptr_type make(size_t length, value_type initialElement = 0, bool initialElementSupplied = false,
                             size_t initialContentsSize = 0, const bit_array_word* initialContents = NULL,
...
public: // make array
  MDArray_int2_t_O(size_t rank, List_sp dimensions, Array_sp data, bool displacedToP, Fixnum_sp displacedIndexOffset)
      : TemplatedBase(rank, dimensions, data, displacedToP, displacedIndexOffset){};
};
}; // namespace core
...
public: // make array
  SimpleMDArray_int2_t_O(size_t rank, List_sp dimensions, Array_sp data) : TemplatedBase(rank, dimensions, data){};
};
}; // namespace core
...
public: // make vector
  ComplexVector_int2_t_O(size_t rank1, size_t dimension, T_sp fillPointer, Array_sp data, bool displacedToP,
                         Fixnum_sp displacedIndexOffset)
      : TemplatedBase(dimension, fillPointer, data, displacedToP, displacedIndexOffset){};
  static smart_ptr_type make(size_t dimension, simple_element_type initialElement, bool initialElementSuppliedP, T_sp fillPointer,
                             T_sp dataOrDisplacedTo, bool displacedToP, Fixnum_sp displacedIndexOffset) {
