// ============================================================
// Arrays specialized for uint8_t
//
namespace core {
  FORWARD(SimpleVector_uint8_t);
  FORWARD(MDArray_uint8_t);
  FORWARD(SimpleMDArray_uint8_t);
};
template <>
struct gctools::GCInfo<core::SimpleVector_uint8_t_O> {
...
namespace core {
  ...
  typedef template_SimpleVector<SimpleVector_uint8_t_O,uint8_t,AbstractSimpleVector_O> specialized_SimpleVector_uint8_t;
  class SimpleVector_uint8_t_O : public specialized_SimpleVector_uint8_t {
    LISP_CLASS(core, CorePkg, SimpleVector_uint8_t_O, "SimpleVector_uint8_t",AbstractSimpleVector_O);
    virtual ~SimpleVector_uint8_t_O() {};
  public:
    typedef specialized_SimpleVector_uint8_t TemplatedBase;
  ...
  public:
  SimpleVector_uint8_t_O(size_t length, value_type initialElement=value_type(),
  ...
  public:
    ...
    virtual T_sp element_type() const override { return core::_sym_uint8_t;};
    virtual T_sp arrayElementType() const override { return core::_sym_uint8_t; };
    virtual clasp_elttype elttype() const { return clasp_aet_uint8_t; };
  };
};


namespace core {
  class MDArray_uint8_t_O : public template_Array<MDArray_uint8_t_O,SimpleVector_uint8_t_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, MDArray_uint8_t_O, "MDArray_uint8_t",MDArray_O);
    virtual ~MDArray_uint8_t_O() {};
  public:
    typedef template_Array<MDArray_uint8_t_O,SimpleVector_uint8_t_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  MDArray_uint8_t_O(size_t dummy_rank_1,
                     size_t dimension,
                     T_sp fillPointer,
                     Array_sp data,
                     bool displacedToP,
...
namespace core {
  class SimpleMDArray_uint8_t_O : public template_SimpleArray<SimpleMDArray_uint8_t_O,SimpleVector_uint8_t_O,SimpleMDArray_O> {
    LISP_CLASS(core, CorePkg, SimpleMDArray_uint8_t_O, "SimpleMDArray_uint8_t",SimpleMDArray_O);
    virtual ~SimpleMDArray_uint8_t_O() {};
  public:
    typedef template_SimpleArray<SimpleMDArray_uint8_t_O,SimpleVector_uint8_t_O,SimpleMDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  SimpleMDArray_uint8_t_O(size_t rank1, size_t dimension, Array_sp data) : TemplatedBase(dimension,data) {};
  ...
  public: // make array
  SimpleMDArray_uint8_t_O(size_t rank,
                           List_sp dimensions,
    ...
    static smart_ptr_type make_multi_dimensional(List_sp dim_desig, simple_element_type initialElement, T_sp data) {
      ...
      size_t arrayTotalSize = calculateArrayTotalSizeAndValidateDimensions(dim_desig,rank);
      LIKELY_if (data.nilp()) {
        data = SimpleVector_uint8_t_O::make(arrayTotalSize,initialElement,true);
      }
...
namespace core {
  ...
  public:
    virtual T_sp array_type() const final { return cl::_sym_simple_array; };
    virtual T_sp element_type() const override { return core::_sym_int8_t;};
    virtual T_sp arrayElementType() const override { return core::_sym_int8_t; };
...
namespace core {
  ...
  public:
    ...
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
  MDArray_int8_t_O(size_t dummy_rank_1,
                     size_t dimension,
                     T_sp fillPointer,
                     Array_sp data,
                     bool displacedToP,
