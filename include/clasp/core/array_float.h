...
template <> struct gctools::GCInfo<core::SimpleVector_float_O> {
...
public: // make array
  MDArray_float_O(size_t rank, List_sp dimensions, Array_sp data, bool displacedToP, Fixnum_sp displacedIndexOffset)
...
public: // make array
  SimpleMDArray_float_O(size_t rank, List_sp dimensions, Array_sp data) : TemplatedBase(rank, dimensions, data){};
};
}; // namespace core
...
public: // make vector
  ComplexVector_float_O(size_t rank1, size_t dimension, T_sp fillPointer, Array_sp data, bool displacedToP,
