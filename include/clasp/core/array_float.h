...
namespace core {
  ...
  SimpleMDArray_float_O(size_t rank,
    ...
    static smart_ptr_type make_multi_dimensional(List_sp dim_desig, simple_element_type initialElement, T_sp data) {
      ...
      size_t arrayTotalSize = calculateArrayTotalSizeAndValidateDimensions(dim_desig,rank);
      LIKELY_if (data.nilp()) {
        data = SimpleVector_float_O::make(arrayTotalSize,initialElement,true);
      }
...
namespace core {
  class ComplexVector_float_O : public template_Array<ComplexVector_float_O,ComplexVector_float_O,SimpleVector_float_O,MDArray_O> {
    LISP_CLASS(core, CorePkg, ComplexVector_float_O, "ComplexVector_float",MDArray_O);
    virtual ~ComplexVector_float_O() {};
  public:
    typedef template_Array<ComplexVector_float_O,ComplexVector_float_O,SimpleVector_float_O,MDArray_O> TemplatedBase;
    typedef typename TemplatedBase::simple_element_type simple_element_type;
    typedef typename TemplatedBase::simple_type simple_type;
  public: // make vector
