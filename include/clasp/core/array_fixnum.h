...
template <> struct gctools::GCInfo<core::SimpleVector_fixnum_O> {
...
public:
  SimpleVector_fixnum_O(size_t length, value_type initialElement = value_type(), bool initialElementSupplied = false,
...
public: // make array
  MDArray_fixnum_O(size_t rank, List_sp dimensions, Array_sp data, bool displacedToP, Fixnum_sp displacedIndexOffset)
...
public: // make array
  SimpleMDArray_fixnum_O(size_t rank, List_sp dimensions, Array_sp data) : TemplatedBase(rank, dimensions, data){};
};
}; // namespace core
...
public: // make vector
  ComplexVector_fixnum_O(size_t rank1, size_t dimension, T_sp fillPointer, Array_sp data, bool displacedToP,
